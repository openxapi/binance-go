...
// checks if the CmfuturesUpdateBatchOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesUpdateBatchOrdersV1RespItem{}

// CmfuturesUpdateBatchOrdersV1RespItem struct for CmfuturesUpdateBatchOrdersV1RespItem
type CmfuturesUpdateBatchOrdersV1RespItem struct {
...
func NewCmfuturesUpdateBatchOrdersV1RespItem() *CmfuturesUpdateBatchOrdersV1RespItem {
	this := CmfuturesUpdateBatchOrdersV1RespItem{}
	return &this
}
...
func (o CmfuturesUpdateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesUpdateBatchOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesUpdateBatchOrdersV1RespItem struct {
	value *CmfuturesUpdateBatchOrdersV1RespItem
	isSet bool
}

func (v NullableCmfuturesUpdateBatchOrdersV1RespItem) Get() *CmfuturesUpdateBatchOrdersV1RespItem {
	return v.value
}

func (v *NullableCmfuturesUpdateBatchOrdersV1RespItem) Set(val *CmfuturesUpdateBatchOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesUpdateBatchOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesUpdateBatchOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesUpdateBatchOrdersV1RespItem(val *CmfuturesUpdateBatchOrdersV1RespItem) *NullableCmfuturesUpdateBatchOrdersV1RespItem {
	return &NullableCmfuturesUpdateBatchOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableCmfuturesUpdateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesUpdateBatchOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
