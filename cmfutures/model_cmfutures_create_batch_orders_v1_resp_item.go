...
// checks if the CmfuturesCreateBatchOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesCreateBatchOrdersV1RespItem{}

// CmfuturesCreateBatchOrdersV1RespItem struct for CmfuturesCreateBatchOrdersV1RespItem
type CmfuturesCreateBatchOrdersV1RespItem struct {
...
func NewCmfuturesCreateBatchOrdersV1RespItem() *CmfuturesCreateBatchOrdersV1RespItem {
	this := CmfuturesCreateBatchOrdersV1RespItem{}
	return &this
}
...
func (o CmfuturesCreateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesCreateBatchOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesCreateBatchOrdersV1RespItem struct {
	value *CmfuturesCreateBatchOrdersV1RespItem
	isSet bool
}

func (v NullableCmfuturesCreateBatchOrdersV1RespItem) Get() *CmfuturesCreateBatchOrdersV1RespItem {
	return v.value
}

func (v *NullableCmfuturesCreateBatchOrdersV1RespItem) Set(val *CmfuturesCreateBatchOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesCreateBatchOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesCreateBatchOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesCreateBatchOrdersV1RespItem(val *CmfuturesCreateBatchOrdersV1RespItem) *NullableCmfuturesCreateBatchOrdersV1RespItem {
	return &NullableCmfuturesCreateBatchOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableCmfuturesCreateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesCreateBatchOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
