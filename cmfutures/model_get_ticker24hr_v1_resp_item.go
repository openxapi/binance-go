...
// checks if the GetTicker24hrV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetTicker24hrV1RespItem{}

// GetTicker24hrV1RespItem struct for GetTicker24hrV1RespItem
type GetTicker24hrV1RespItem struct {
...
func (o *GetTicker24hrV1RespItem) GetBaseVolumeOk() (*string, bool) {
	if o == nil || IsNil(o.BaseVolume) {
		return nil, false
	}
...
func (o *GetTicker24hrV1RespItem) SetCount(v int32) {
	o.Count = &v
}
...
func (o *GetTicker24hrV1RespItem) HasPair() bool {
	if o != nil && !IsNil(o.Pair) {
		return true
	}
...
func (o *GetTicker24hrV1RespItem) GetSymbol() string {
...
func (o GetTicker24hrV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetTicker24hrV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetTicker24hrV1RespItem struct {
	value *GetTicker24hrV1RespItem
	isSet bool
}

func (v NullableGetTicker24hrV1RespItem) Get() *GetTicker24hrV1RespItem {
	return v.value
}

func (v *NullableGetTicker24hrV1RespItem) Set(val *GetTicker24hrV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetTicker24hrV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetTicker24hrV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetTicker24hrV1RespItem(val *GetTicker24hrV1RespItem) *NullableGetTicker24hrV1RespItem {
	return &NullableGetTicker24hrV1RespItem{value: val, isSet: true}
}

func (v NullableGetTicker24hrV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetTicker24hrV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
