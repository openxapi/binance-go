...
// checks if the GetCmUserTradesV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCmUserTradesV1RespItem{}
...
func NewGetCmUserTradesV1RespItem() *GetCmUserTradesV1RespItem {
	this := GetCmUserTradesV1RespItem{}
	return &this
}
...
type NullableGetCmUserTradesV1RespItem struct {
	value *GetCmUserTradesV1RespItem
	isSet bool
}

func (v NullableGetCmUserTradesV1RespItem) Get() *GetCmUserTradesV1RespItem {
	return v.value
}

func (v *NullableGetCmUserTradesV1RespItem) Set(val *GetCmUserTradesV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCmUserTradesV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCmUserTradesV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCmUserTradesV1RespItem(val *GetCmUserTradesV1RespItem) *NullableGetCmUserTradesV1RespItem {
	return &NullableGetCmUserTradesV1RespItem{value: val, isSet: true}
}
