...
// checks if the GetUmConditionalAllOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUmConditionalAllOrdersV1RespItem{}
...
func NewGetUmConditionalAllOrdersV1RespItem() *GetUmConditionalAllOrdersV1RespItem {
	this := GetUmConditionalAllOrdersV1RespItem{}
	return &this
}
...
type NullableGetUmConditionalAllOrdersV1RespItem struct {
	value *GetUmConditionalAllOrdersV1RespItem
	isSet bool
}

func (v NullableGetUmConditionalAllOrdersV1RespItem) Get() *GetUmConditionalAllOrdersV1RespItem {
	return v.value
}

func (v *NullableGetUmConditionalAllOrdersV1RespItem) Set(val *GetUmConditionalAllOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUmConditionalAllOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUmConditionalAllOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUmConditionalAllOrdersV1RespItem(val *GetUmConditionalAllOrdersV1RespItem) *NullableGetUmConditionalAllOrdersV1RespItem {
	return &NullableGetUmConditionalAllOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableGetUmConditionalAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
