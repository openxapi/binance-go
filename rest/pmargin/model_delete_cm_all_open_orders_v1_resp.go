...
// checks if the DeleteCmAllOpenOrdersV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteCmAllOpenOrdersV1Resp{}
...
func NewDeleteCmAllOpenOrdersV1Resp() *DeleteCmAllOpenOrdersV1Resp {
	this := DeleteCmAllOpenOrdersV1Resp{}
	return &this
}
...
type NullableDeleteCmAllOpenOrdersV1Resp struct {
	value *DeleteCmAllOpenOrdersV1Resp
	isSet bool
}

func (v NullableDeleteCmAllOpenOrdersV1Resp) Get() *DeleteCmAllOpenOrdersV1Resp {
	return v.value
}

func (v *NullableDeleteCmAllOpenOrdersV1Resp) Set(val *DeleteCmAllOpenOrdersV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteCmAllOpenOrdersV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteCmAllOpenOrdersV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteCmAllOpenOrdersV1Resp(val *DeleteCmAllOpenOrdersV1Resp) *NullableDeleteCmAllOpenOrdersV1Resp {
	return &NullableDeleteCmAllOpenOrdersV1Resp{value: val, isSet: true}
}
