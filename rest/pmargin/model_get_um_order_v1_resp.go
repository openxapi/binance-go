...
// checks if the GetUmOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUmOrderV1Resp{}
...
type NullableGetUmOrderV1Resp struct {
	value *GetUmOrderV1Resp
	isSet bool
}

func (v NullableGetUmOrderV1Resp) Get() *GetUmOrderV1Resp {
	return v.value
}

func (v *NullableGetUmOrderV1Resp) Set(val *GetUmOrderV1Resp) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGetUmOrderV1Resp(val *GetUmOrderV1Resp) *NullableGetUmOrderV1Resp {
	return &NullableGetUmOrderV1Resp{value: val, isSet: true}
}
