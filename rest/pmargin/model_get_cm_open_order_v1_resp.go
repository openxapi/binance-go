...
// checks if the GetCmOpenOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCmOpenOrderV1Resp{}
...
type NullableGetCmOpenOrderV1Resp struct {
	value *GetCmOpenOrderV1Resp
	isSet bool
}

func (v NullableGetCmOpenOrderV1Resp) Get() *GetCmOpenOrderV1Resp {
	return v.value
}

func (v *NullableGetCmOpenOrderV1Resp) Set(val *GetCmOpenOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCmOpenOrderV1Resp) IsSet() bool {
	return v.isSet
}
...
func NewNullableGetCmOpenOrderV1Resp(val *GetCmOpenOrderV1Resp) *NullableGetCmOpenOrderV1Resp {
	return &NullableGetCmOpenOrderV1Resp{value: val, isSet: true}
}
