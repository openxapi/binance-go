...
// checks if the GetForceOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetForceOrdersV1RespItem{}

// GetForceOrdersV1RespItem struct for GetForceOrdersV1RespItem
type GetForceOrdersV1RespItem struct {
...
func (o GetForceOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetForceOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetForceOrdersV1RespItem struct {
	value *GetForceOrdersV1RespItem
	isSet bool
}

func (v NullableGetForceOrdersV1RespItem) Get() *GetForceOrdersV1RespItem {
	return v.value
}

func (v *NullableGetForceOrdersV1RespItem) Set(val *GetForceOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetForceOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetForceOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetForceOrdersV1RespItem(val *GetForceOrdersV1RespItem) *NullableGetForceOrdersV1RespItem {
	return &NullableGetForceOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableGetForceOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetForceOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
