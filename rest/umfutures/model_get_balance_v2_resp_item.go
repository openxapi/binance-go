...
// checks if the GetBalanceV2RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBalanceV2RespItem{}

// GetBalanceV2RespItem struct for GetBalanceV2RespItem
type GetBalanceV2RespItem struct {
...
func (o GetBalanceV2RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetBalanceV2RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetBalanceV2RespItem struct {
	value *GetBalanceV2RespItem
	isSet bool
}

func (v NullableGetBalanceV2RespItem) Get() *GetBalanceV2RespItem {
	return v.value
}

func (v *NullableGetBalanceV2RespItem) Set(val *GetBalanceV2RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBalanceV2RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBalanceV2RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBalanceV2RespItem(val *GetBalanceV2RespItem) *NullableGetBalanceV2RespItem {
	return &NullableGetBalanceV2RespItem{value: val, isSet: true}
}

func (v NullableGetBalanceV2RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBalanceV2RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
