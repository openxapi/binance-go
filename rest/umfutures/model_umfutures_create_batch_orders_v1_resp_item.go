...
// checks if the UmfuturesCreateBatchOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesCreateBatchOrdersV1RespItem{}

// UmfuturesCreateBatchOrdersV1RespItem struct for UmfuturesCreateBatchOrdersV1RespItem
type UmfuturesCreateBatchOrdersV1RespItem struct {
...
func NewUmfuturesCreateBatchOrdersV1RespItem() *UmfuturesCreateBatchOrdersV1RespItem {
	this := UmfuturesCreateBatchOrdersV1RespItem{}
	return &this
}
...
func (o UmfuturesCreateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesCreateBatchOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesCreateBatchOrdersV1RespItem struct {
	value *UmfuturesCreateBatchOrdersV1RespItem
	isSet bool
}

func (v NullableUmfuturesCreateBatchOrdersV1RespItem) Get() *UmfuturesCreateBatchOrdersV1RespItem {
	return v.value
}

func (v *NullableUmfuturesCreateBatchOrdersV1RespItem) Set(val *UmfuturesCreateBatchOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesCreateBatchOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesCreateBatchOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesCreateBatchOrdersV1RespItem(val *UmfuturesCreateBatchOrdersV1RespItem) *NullableUmfuturesCreateBatchOrdersV1RespItem {
	return &NullableUmfuturesCreateBatchOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableUmfuturesCreateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesCreateBatchOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
