...
// checks if the UmfuturesGetExchangeInfoV1RespSymbolsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetExchangeInfoV1RespSymbolsInner{}

// UmfuturesGetExchangeInfoV1RespSymbolsInner struct for UmfuturesGetExchangeInfoV1RespSymbolsInner
type UmfuturesGetExchangeInfoV1RespSymbolsInner struct {
	...
	Filters []UmfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner `json:"filters,omitempty"`
...
func NewUmfuturesGetExchangeInfoV1RespSymbolsInner() *UmfuturesGetExchangeInfoV1RespSymbolsInner {
	this := UmfuturesGetExchangeInfoV1RespSymbolsInner{}
	return &this
}
...
func (o *UmfuturesGetExchangeInfoV1RespSymbolsInner) GetFilters() []UmfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner {
	if o == nil || IsNil(o.Filters) {
		var ret []UmfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner
		return ret
	}
	return o.Filters
}
...
// SetFilters gets a reference to the given []UmfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner and assigns it to the Filters field.
...
func (o UmfuturesGetExchangeInfoV1RespSymbolsInner) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetExchangeInfoV1RespSymbolsInner) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetExchangeInfoV1RespSymbolsInner struct {
	value *UmfuturesGetExchangeInfoV1RespSymbolsInner
	isSet bool
}

func (v NullableUmfuturesGetExchangeInfoV1RespSymbolsInner) Get() *UmfuturesGetExchangeInfoV1RespSymbolsInner {
	return v.value
}

func (v *NullableUmfuturesGetExchangeInfoV1RespSymbolsInner) Set(val *UmfuturesGetExchangeInfoV1RespSymbolsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetExchangeInfoV1RespSymbolsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetExchangeInfoV1RespSymbolsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetExchangeInfoV1RespSymbolsInner(val *UmfuturesGetExchangeInfoV1RespSymbolsInner) *NullableUmfuturesGetExchangeInfoV1RespSymbolsInner {
	return &NullableUmfuturesGetExchangeInfoV1RespSymbolsInner{value: val, isSet: true}
}

func (v NullableUmfuturesGetExchangeInfoV1RespSymbolsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetExchangeInfoV1RespSymbolsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
