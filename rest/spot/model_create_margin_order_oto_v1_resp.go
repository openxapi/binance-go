...
// checks if the CreateMarginOrderOtoV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMarginOrderOtoV1Resp{}

// CreateMarginOrderOtoV1Resp struct for CreateMarginOrderOtoV1Resp
type CreateMarginOrderOtoV1Resp struct {
...
func NewCreateMarginOrderOtoV1Resp() *CreateMarginOrderOtoV1Resp {
	this := CreateMarginOrderOtoV1Resp{}
	return &this
}
...
func (o CreateMarginOrderOtoV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateMarginOrderOtoV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateMarginOrderOtoV1Resp struct {
	value *CreateMarginOrderOtoV1Resp
	isSet bool
}

func (v NullableCreateMarginOrderOtoV1Resp) Get() *CreateMarginOrderOtoV1Resp {
	return v.value
}

func (v *NullableCreateMarginOrderOtoV1Resp) Set(val *CreateMarginOrderOtoV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMarginOrderOtoV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMarginOrderOtoV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMarginOrderOtoV1Resp(val *CreateMarginOrderOtoV1Resp) *NullableCreateMarginOrderOtoV1Resp {
	return &NullableCreateMarginOrderOtoV1Resp{value: val, isSet: true}
}

func (v NullableCreateMarginOrderOtoV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMarginOrderOtoV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
