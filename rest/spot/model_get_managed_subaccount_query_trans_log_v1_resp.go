...
// checks if the GetManagedSubaccountQueryTransLogV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetManagedSubaccountQueryTransLogV1Resp{}

// GetManagedSubaccountQueryTransLogV1Resp struct for GetManagedSubaccountQueryTransLogV1Resp
type GetManagedSubaccountQueryTransLogV1Resp struct {
...
func NewGetManagedSubaccountQueryTransLogV1Resp() *GetManagedSubaccountQueryTransLogV1Resp {
	this := GetManagedSubaccountQueryTransLogV1Resp{}
	return &this
}
...
func (o GetManagedSubaccountQueryTransLogV1Resp) MarshalJSON() ([]byte, error) {
...
func (o GetManagedSubaccountQueryTransLogV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetManagedSubaccountQueryTransLogV1Resp struct {
	value *GetManagedSubaccountQueryTransLogV1Resp
	isSet bool
}

func (v NullableGetManagedSubaccountQueryTransLogV1Resp) Get() *GetManagedSubaccountQueryTransLogV1Resp {
	return v.value
}

func (v *NullableGetManagedSubaccountQueryTransLogV1Resp) Set(val *GetManagedSubaccountQueryTransLogV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetManagedSubaccountQueryTransLogV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetManagedSubaccountQueryTransLogV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetManagedSubaccountQueryTransLogV1Resp(val *GetManagedSubaccountQueryTransLogV1Resp) *NullableGetManagedSubaccountQueryTransLogV1Resp {
	return &NullableGetManagedSubaccountQueryTransLogV1Resp{value: val, isSet: true}
}

func (v NullableGetManagedSubaccountQueryTransLogV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetManagedSubaccountQueryTransLogV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
