...
// checks if the CreateAlgoFuturesNewOrderVpV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAlgoFuturesNewOrderVpV1Resp{}

// CreateAlgoFuturesNewOrderVpV1Resp struct for CreateAlgoFuturesNewOrderVpV1Resp
type CreateAlgoFuturesNewOrderVpV1Resp struct {
...
func NewCreateAlgoFuturesNewOrderVpV1Resp() *CreateAlgoFuturesNewOrderVpV1Resp {
	this := CreateAlgoFuturesNewOrderVpV1Resp{}
	return &this
}
...
func (o CreateAlgoFuturesNewOrderVpV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateAlgoFuturesNewOrderVpV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAlgoFuturesNewOrderVpV1Resp struct {
	value *CreateAlgoFuturesNewOrderVpV1Resp
	isSet bool
}

func (v NullableCreateAlgoFuturesNewOrderVpV1Resp) Get() *CreateAlgoFuturesNewOrderVpV1Resp {
	return v.value
}

func (v *NullableCreateAlgoFuturesNewOrderVpV1Resp) Set(val *CreateAlgoFuturesNewOrderVpV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAlgoFuturesNewOrderVpV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAlgoFuturesNewOrderVpV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAlgoFuturesNewOrderVpV1Resp(val *CreateAlgoFuturesNewOrderVpV1Resp) *NullableCreateAlgoFuturesNewOrderVpV1Resp {
	return &NullableCreateAlgoFuturesNewOrderVpV1Resp{value: val, isSet: true}
}

func (v NullableCreateAlgoFuturesNewOrderVpV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAlgoFuturesNewOrderVpV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
