...
// checks if the GetAvgPriceV3Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAvgPriceV3Resp{}

// GetAvgPriceV3Resp struct for GetAvgPriceV3Resp
type GetAvgPriceV3Resp struct {
...
func (o GetAvgPriceV3Resp) MarshalJSON() ([]byte, error) {
...
func (o GetAvgPriceV3Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetAvgPriceV3Resp struct {
	value *GetAvgPriceV3Resp
	isSet bool
}

func (v NullableGetAvgPriceV3Resp) Get() *GetAvgPriceV3Resp {
	return v.value
}

func (v *NullableGetAvgPriceV3Resp) Set(val *GetAvgPriceV3Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAvgPriceV3Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAvgPriceV3Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAvgPriceV3Resp(val *GetAvgPriceV3Resp) *NullableGetAvgPriceV3Resp {
	return &NullableGetAvgPriceV3Resp{value: val, isSet: true}
}

func (v NullableGetAvgPriceV3Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAvgPriceV3Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
