...
// checks if the GetAccountInfoV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountInfoV1Resp{}

// GetAccountInfoV1Resp struct for GetAccountInfoV1Resp
type GetAccountInfoV1Resp struct {
...
func (o GetAccountInfoV1Resp) MarshalJSON() ([]byte, error) {
...
func (o GetAccountInfoV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountInfoV1Resp struct {
	value *GetAccountInfoV1Resp
	isSet bool
}

func (v NullableGetAccountInfoV1Resp) Get() *GetAccountInfoV1Resp {
	return v.value
}

func (v *NullableGetAccountInfoV1Resp) Set(val *GetAccountInfoV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountInfoV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountInfoV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountInfoV1Resp(val *GetAccountInfoV1Resp) *NullableGetAccountInfoV1Resp {
	return &NullableGetAccountInfoV1Resp{value: val, isSet: true}
}

func (v NullableGetAccountInfoV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountInfoV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
