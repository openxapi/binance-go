...
// checks if the GetLocalentityWithdrawHistoryV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLocalentityWithdrawHistoryV1RespItem{}

// GetLocalentityWithdrawHistoryV1RespItem struct for GetLocalentityWithdrawHistoryV1RespItem
type GetLocalentityWithdrawHistoryV1RespItem struct {
...
func NewGetLocalentityWithdrawHistoryV1RespItem() *GetLocalentityWithdrawHistoryV1RespItem {
	this := GetLocalentityWithdrawHistoryV1RespItem{}
	return &this
}
...
func (o *GetLocalentityWithdrawHistoryV1RespItem) GetAddress() string {
...
// and a boolean to check if the value has been set.
func (o *GetLocalentityWithdrawHistoryV1RespItem) GetNetworkOk() (*string, bool) {
	if o == nil || IsNil(o.Network) {
		return nil, false
	}
...
func (o *GetLocalentityWithdrawHistoryV1RespItem) SetTrId(v int64) {
	o.TrId = &v
}
...
func (o *GetLocalentityWithdrawHistoryV1RespItem) HasTransferType() bool {
	if o != nil && !IsNil(o.TransferType) {
		return true
	}
...
func (o *GetLocalentityWithdrawHistoryV1RespItem) GetTxKey() string {
...
func (o GetLocalentityWithdrawHistoryV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetLocalentityWithdrawHistoryV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetLocalentityWithdrawHistoryV1RespItem struct {
	value *GetLocalentityWithdrawHistoryV1RespItem
	isSet bool
}

func (v NullableGetLocalentityWithdrawHistoryV1RespItem) Get() *GetLocalentityWithdrawHistoryV1RespItem {
	return v.value
}

func (v *NullableGetLocalentityWithdrawHistoryV1RespItem) Set(val *GetLocalentityWithdrawHistoryV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLocalentityWithdrawHistoryV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLocalentityWithdrawHistoryV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLocalentityWithdrawHistoryV1RespItem(val *GetLocalentityWithdrawHistoryV1RespItem) *NullableGetLocalentityWithdrawHistoryV1RespItem {
	return &NullableGetLocalentityWithdrawHistoryV1RespItem{value: val, isSet: true}
}

func (v NullableGetLocalentityWithdrawHistoryV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLocalentityWithdrawHistoryV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
