...
// checks if the GetMarginCapitalFlowV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarginCapitalFlowV1RespItem{}

// GetMarginCapitalFlowV1RespItem struct for GetMarginCapitalFlowV1RespItem
...
func NewGetMarginCapitalFlowV1RespItem() *GetMarginCapitalFlowV1RespItem {
	this := GetMarginCapitalFlowV1RespItem{}
	return &this
}
...
func (o GetMarginCapitalFlowV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetMarginCapitalFlowV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetMarginCapitalFlowV1RespItem struct {
	value *GetMarginCapitalFlowV1RespItem
	isSet bool
}

func (v NullableGetMarginCapitalFlowV1RespItem) Get() *GetMarginCapitalFlowV1RespItem {
	return v.value
}

func (v *NullableGetMarginCapitalFlowV1RespItem) Set(val *GetMarginCapitalFlowV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarginCapitalFlowV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarginCapitalFlowV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarginCapitalFlowV1RespItem(val *GetMarginCapitalFlowV1RespItem) *NullableGetMarginCapitalFlowV1RespItem {
	return &NullableGetMarginCapitalFlowV1RespItem{value: val, isSet: true}
}

func (v NullableGetMarginCapitalFlowV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarginCapitalFlowV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
