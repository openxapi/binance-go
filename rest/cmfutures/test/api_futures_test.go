...
func Test_cmfutures_FuturesAPIService(t *testing.T) {
	...
	t.Run("Test FuturesAPIService GetAccountV1", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.FuturesAPI.GetAccountV1(context.Background()).Execute()
	...
	t.Run("Test FuturesAPIService GetBalanceV1", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.FuturesAPI.GetBalanceV1(context.Background()).Execute()
	...
	t.Run("Test FuturesAPIService GetFuturesDataTakerBuySellVol", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.FuturesAPI.GetFuturesDataTakerBuySellVol(context.Background()).Execute()
	...
	t.Run("Test FuturesAPIService GetIncomeV1", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.FuturesAPI.GetIncomeV1(context.Background()).Execute()
	...
	t.Run("Test FuturesAPIService GetLeverageBracketV2", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.FuturesAPI.GetLeverageBracketV2(context.Background()).Execute()
	...
	t.Run("Test FuturesAPIService GetPositionRiskV1", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.FuturesAPI.GetPositionRiskV1(context.Background()).Execute()
