...
// checks if the GetBalanceV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBalanceV1RespItem{}

// GetBalanceV1RespItem struct for GetBalanceV1RespItem
type GetBalanceV1RespItem struct {
...
func (o GetBalanceV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetBalanceV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetBalanceV1RespItem struct {
	value *GetBalanceV1RespItem
	isSet bool
}

func (v NullableGetBalanceV1RespItem) Get() *GetBalanceV1RespItem {
	return v.value
}

func (v *NullableGetBalanceV1RespItem) Set(val *GetBalanceV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBalanceV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBalanceV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBalanceV1RespItem(val *GetBalanceV1RespItem) *NullableGetBalanceV1RespItem {
	return &NullableGetBalanceV1RespItem{value: val, isSet: true}
}

func (v NullableGetBalanceV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBalanceV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
