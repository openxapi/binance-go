...
// checks if the OptionsCreateBlockOrderExecuteV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionsCreateBlockOrderExecuteV1Resp{}

// OptionsCreateBlockOrderExecuteV1Resp struct for OptionsCreateBlockOrderExecuteV1Resp
type OptionsCreateBlockOrderExecuteV1Resp struct {
...
func NewOptionsCreateBlockOrderExecuteV1Resp() *OptionsCreateBlockOrderExecuteV1Resp {
	this := OptionsCreateBlockOrderExecuteV1Resp{}
	return &this
}
...
func (o OptionsCreateBlockOrderExecuteV1Resp) MarshalJSON() ([]byte, error) {
...
func (o OptionsCreateBlockOrderExecuteV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableOptionsCreateBlockOrderExecuteV1Resp struct {
	value *OptionsCreateBlockOrderExecuteV1Resp
	isSet bool
}

func (v NullableOptionsCreateBlockOrderExecuteV1Resp) Get() *OptionsCreateBlockOrderExecuteV1Resp {
	return v.value
}

func (v *NullableOptionsCreateBlockOrderExecuteV1Resp) Set(val *OptionsCreateBlockOrderExecuteV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionsCreateBlockOrderExecuteV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionsCreateBlockOrderExecuteV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionsCreateBlockOrderExecuteV1Resp(val *OptionsCreateBlockOrderExecuteV1Resp) *NullableOptionsCreateBlockOrderExecuteV1Resp {
	return &NullableOptionsCreateBlockOrderExecuteV1Resp{value: val, isSet: true}
}

func (v NullableOptionsCreateBlockOrderExecuteV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionsCreateBlockOrderExecuteV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
