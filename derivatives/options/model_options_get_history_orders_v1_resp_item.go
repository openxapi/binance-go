...
// checks if the OptionsGetHistoryOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionsGetHistoryOrdersV1RespItem{}

// OptionsGetHistoryOrdersV1RespItem struct for OptionsGetHistoryOrdersV1RespItem
type OptionsGetHistoryOrdersV1RespItem struct {
...
func NewOptionsGetHistoryOrdersV1RespItem() *OptionsGetHistoryOrdersV1RespItem {
	this := OptionsGetHistoryOrdersV1RespItem{}
	return &this
}
...
func (o OptionsGetHistoryOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o OptionsGetHistoryOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableOptionsGetHistoryOrdersV1RespItem struct {
	value *OptionsGetHistoryOrdersV1RespItem
	isSet bool
}

func (v NullableOptionsGetHistoryOrdersV1RespItem) Get() *OptionsGetHistoryOrdersV1RespItem {
	return v.value
}

func (v *NullableOptionsGetHistoryOrdersV1RespItem) Set(val *OptionsGetHistoryOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionsGetHistoryOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionsGetHistoryOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionsGetHistoryOrdersV1RespItem(val *OptionsGetHistoryOrdersV1RespItem) *NullableOptionsGetHistoryOrdersV1RespItem {
	return &NullableOptionsGetHistoryOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableOptionsGetHistoryOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionsGetHistoryOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
