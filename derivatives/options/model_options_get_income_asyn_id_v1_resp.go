...
// checks if the OptionsGetIncomeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionsGetIncomeAsynIdV1Resp{}

// OptionsGetIncomeAsynIdV1Resp struct for OptionsGetIncomeAsynIdV1Resp
type OptionsGetIncomeAsynIdV1Resp struct {
...
func NewOptionsGetIncomeAsynIdV1Resp() *OptionsGetIncomeAsynIdV1Resp {
	this := OptionsGetIncomeAsynIdV1Resp{}
	return &this
}
...
func (o OptionsGetIncomeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o OptionsGetIncomeAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableOptionsGetIncomeAsynIdV1Resp struct {
	value *OptionsGetIncomeAsynIdV1Resp
	isSet bool
}

func (v NullableOptionsGetIncomeAsynIdV1Resp) Get() *OptionsGetIncomeAsynIdV1Resp {
	return v.value
}

func (v *NullableOptionsGetIncomeAsynIdV1Resp) Set(val *OptionsGetIncomeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionsGetIncomeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionsGetIncomeAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionsGetIncomeAsynIdV1Resp(val *OptionsGetIncomeAsynIdV1Resp) *NullableOptionsGetIncomeAsynIdV1Resp {
	return &NullableOptionsGetIncomeAsynIdV1Resp{value: val, isSet: true}
}

func (v NullableOptionsGetIncomeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionsGetIncomeAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
