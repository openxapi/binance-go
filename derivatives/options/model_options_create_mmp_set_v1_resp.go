...
// checks if the OptionsCreateMmpSetV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionsCreateMmpSetV1Resp{}

// OptionsCreateMmpSetV1Resp struct for OptionsCreateMmpSetV1Resp
type OptionsCreateMmpSetV1Resp struct {
...
func NewOptionsCreateMmpSetV1Resp() *OptionsCreateMmpSetV1Resp {
	this := OptionsCreateMmpSetV1Resp{}
	return &this
}
...
func (o OptionsCreateMmpSetV1Resp) MarshalJSON() ([]byte, error) {
...
func (o OptionsCreateMmpSetV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableOptionsCreateMmpSetV1Resp struct {
	value *OptionsCreateMmpSetV1Resp
	isSet bool
}

func (v NullableOptionsCreateMmpSetV1Resp) Get() *OptionsCreateMmpSetV1Resp {
	return v.value
}

func (v *NullableOptionsCreateMmpSetV1Resp) Set(val *OptionsCreateMmpSetV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionsCreateMmpSetV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionsCreateMmpSetV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionsCreateMmpSetV1Resp(val *OptionsCreateMmpSetV1Resp) *NullableOptionsCreateMmpSetV1Resp {
	return &NullableOptionsCreateMmpSetV1Resp{value: val, isSet: true}
}

func (v NullableOptionsCreateMmpSetV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionsCreateMmpSetV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
