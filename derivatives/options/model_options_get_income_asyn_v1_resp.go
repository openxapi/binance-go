...
// checks if the OptionsGetIncomeAsynV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionsGetIncomeAsynV1Resp{}

// OptionsGetIncomeAsynV1Resp struct for OptionsGetIncomeAsynV1Resp
type OptionsGetIncomeAsynV1Resp struct {
...
func NewOptionsGetIncomeAsynV1Resp() *OptionsGetIncomeAsynV1Resp {
	this := OptionsGetIncomeAsynV1Resp{}
	return &this
}
...
func (o OptionsGetIncomeAsynV1Resp) MarshalJSON() ([]byte, error) {
...
func (o OptionsGetIncomeAsynV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableOptionsGetIncomeAsynV1Resp struct {
	value *OptionsGetIncomeAsynV1Resp
	isSet bool
}

func (v NullableOptionsGetIncomeAsynV1Resp) Get() *OptionsGetIncomeAsynV1Resp {
	return v.value
}

func (v *NullableOptionsGetIncomeAsynV1Resp) Set(val *OptionsGetIncomeAsynV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionsGetIncomeAsynV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionsGetIncomeAsynV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionsGetIncomeAsynV1Resp(val *OptionsGetIncomeAsynV1Resp) *NullableOptionsGetIncomeAsynV1Resp {
	return &NullableOptionsGetIncomeAsynV1Resp{value: val, isSet: true}
}

func (v NullableOptionsGetIncomeAsynV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionsGetIncomeAsynV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
