...
// checks if the OptionsGetOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionsGetOrderV1Resp{}

// OptionsGetOrderV1Resp struct for OptionsGetOrderV1Resp
type OptionsGetOrderV1Resp struct {
...
func (o OptionsGetOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o OptionsGetOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableOptionsGetOrderV1Resp struct {
	value *OptionsGetOrderV1Resp
	isSet bool
}

func (v NullableOptionsGetOrderV1Resp) Get() *OptionsGetOrderV1Resp {
	return v.value
}

func (v *NullableOptionsGetOrderV1Resp) Set(val *OptionsGetOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionsGetOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionsGetOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionsGetOrderV1Resp(val *OptionsGetOrderV1Resp) *NullableOptionsGetOrderV1Resp {
	return &NullableOptionsGetOrderV1Resp{value: val, isSet: true}
}

func (v NullableOptionsGetOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionsGetOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
