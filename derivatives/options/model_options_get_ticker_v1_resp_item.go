...
// checks if the OptionsGetTickerV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionsGetTickerV1RespItem{}

// OptionsGetTickerV1RespItem struct for OptionsGetTickerV1RespItem
type OptionsGetTickerV1RespItem struct {
...
func NewOptionsGetTickerV1RespItem() *OptionsGetTickerV1RespItem {
	this := OptionsGetTickerV1RespItem{}
	return &this
}
...
func (o *OptionsGetTickerV1RespItem) GetAmountOk() (*string, bool) {
	if o == nil || IsNil(o.Amount) {
		return nil, false
	}
...
func (o *OptionsGetTickerV1RespItem) SetBidPrice(v string) {
	o.BidPrice = &v
}
...
func (o *OptionsGetTickerV1RespItem) HasExercisePrice() bool {
	if o != nil && !IsNil(o.ExercisePrice) {
		return true
	}
...
func (o *OptionsGetTickerV1RespItem) HasOpenTime() bool {
	if o != nil && !IsNil(o.OpenTime) {
		return true
	}
...
func (o *OptionsGetTickerV1RespItem) GetStrikePrice() string {
...
func (o OptionsGetTickerV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o OptionsGetTickerV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableOptionsGetTickerV1RespItem struct {
	value *OptionsGetTickerV1RespItem
	isSet bool
}

func (v NullableOptionsGetTickerV1RespItem) Get() *OptionsGetTickerV1RespItem {
	return v.value
}

func (v *NullableOptionsGetTickerV1RespItem) Set(val *OptionsGetTickerV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionsGetTickerV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionsGetTickerV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionsGetTickerV1RespItem(val *OptionsGetTickerV1RespItem) *NullableOptionsGetTickerV1RespItem {
	return &NullableOptionsGetTickerV1RespItem{value: val, isSet: true}
}

func (v NullableOptionsGetTickerV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionsGetTickerV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
