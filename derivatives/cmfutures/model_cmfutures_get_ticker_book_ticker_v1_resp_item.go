...
// checks if the CmfuturesGetTickerBookTickerV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetTickerBookTickerV1RespItem{}

// CmfuturesGetTickerBookTickerV1RespItem struct for CmfuturesGetTickerBookTickerV1RespItem
type CmfuturesGetTickerBookTickerV1RespItem struct {
...
func NewCmfuturesGetTickerBookTickerV1RespItem() *CmfuturesGetTickerBookTickerV1RespItem {
	this := CmfuturesGetTickerBookTickerV1RespItem{}
	return &this
}
...
func (o *CmfuturesGetTickerBookTickerV1RespItem) SetAskPrice(v string) {
	o.AskPrice = &v
}
...
func (o CmfuturesGetTickerBookTickerV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetTickerBookTickerV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetTickerBookTickerV1RespItem struct {
	value *CmfuturesGetTickerBookTickerV1RespItem
	isSet bool
}

func (v NullableCmfuturesGetTickerBookTickerV1RespItem) Get() *CmfuturesGetTickerBookTickerV1RespItem {
	return v.value
}

func (v *NullableCmfuturesGetTickerBookTickerV1RespItem) Set(val *CmfuturesGetTickerBookTickerV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetTickerBookTickerV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetTickerBookTickerV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetTickerBookTickerV1RespItem(val *CmfuturesGetTickerBookTickerV1RespItem) *NullableCmfuturesGetTickerBookTickerV1RespItem {
	return &NullableCmfuturesGetTickerBookTickerV1RespItem{value: val, isSet: true}
}

func (v NullableCmfuturesGetTickerBookTickerV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetTickerBookTickerV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
