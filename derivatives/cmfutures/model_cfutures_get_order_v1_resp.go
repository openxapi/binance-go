...
// checks if the CfuturesGetOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetOrderV1Resp{}

// CfuturesGetOrderV1Resp struct for CfuturesGetOrderV1Resp
type CfuturesGetOrderV1Resp struct {
...
func (o CfuturesGetOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetOrderV1Resp struct {
	value *CfuturesGetOrderV1Resp
	isSet bool
}

func (v NullableCfuturesGetOrderV1Resp) Get() *CfuturesGetOrderV1Resp {
	return v.value
}

func (v *NullableCfuturesGetOrderV1Resp) Set(val *CfuturesGetOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetOrderV1Resp(val *CfuturesGetOrderV1Resp) *NullableCfuturesGetOrderV1Resp {
	return &NullableCfuturesGetOrderV1Resp{value: val, isSet: true}
}

func (v NullableCfuturesGetOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
