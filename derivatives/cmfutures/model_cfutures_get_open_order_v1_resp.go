...
// checks if the CfuturesGetOpenOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetOpenOrderV1Resp{}

// CfuturesGetOpenOrderV1Resp struct for CfuturesGetOpenOrderV1Resp
type CfuturesGetOpenOrderV1Resp struct {
...
func NewCfuturesGetOpenOrderV1Resp() *CfuturesGetOpenOrderV1Resp {
	this := CfuturesGetOpenOrderV1Resp{}
	return &this
}
...
func (o CfuturesGetOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetOpenOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetOpenOrderV1Resp struct {
	value *CfuturesGetOpenOrderV1Resp
	isSet bool
}

func (v NullableCfuturesGetOpenOrderV1Resp) Get() *CfuturesGetOpenOrderV1Resp {
	return v.value
}

func (v *NullableCfuturesGetOpenOrderV1Resp) Set(val *CfuturesGetOpenOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetOpenOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetOpenOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetOpenOrderV1Resp(val *CfuturesGetOpenOrderV1Resp) *NullableCfuturesGetOpenOrderV1Resp {
	return &NullableCfuturesGetOpenOrderV1Resp{value: val, isSet: true}
}

func (v NullableCfuturesGetOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetOpenOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
