...
// checks if the CfuturesCreateBatchOrderV1ReqBatchOrdersItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesCreateBatchOrderV1ReqBatchOrdersItem{}

// CfuturesCreateBatchOrderV1ReqBatchOrdersItem struct for CfuturesCreateBatchOrderV1ReqBatchOrdersItem
type CfuturesCreateBatchOrderV1ReqBatchOrdersItem struct {
...
type _CfuturesCreateBatchOrderV1ReqBatchOrdersItem CfuturesCreateBatchOrderV1ReqBatchOrdersItem
...
func NewCfuturesCreateBatchOrderV1ReqBatchOrdersItem(side string, symbol string, type_ string) *CfuturesCreateBatchOrderV1ReqBatchOrdersItem {
	this := CfuturesCreateBatchOrderV1ReqBatchOrdersItem{}
...
func (o CfuturesCreateBatchOrderV1ReqBatchOrdersItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesCreateBatchOrderV1ReqBatchOrdersItem) ToMap() (map[string]interface{}, error) {
...
func (o *CfuturesCreateBatchOrderV1ReqBatchOrdersItem) UnmarshalJSON(data []byte) (err error) {
	...
	varCfuturesCreateBatchOrderV1ReqBatchOrdersItem := _CfuturesCreateBatchOrderV1ReqBatchOrdersItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCfuturesCreateBatchOrderV1ReqBatchOrdersItem)

	if err != nil {
		return err
	}

	*o = CfuturesCreateBatchOrderV1ReqBatchOrdersItem(varCfuturesCreateBatchOrderV1ReqBatchOrdersItem)

	return err
}

type NullableCfuturesCreateBatchOrderV1ReqBatchOrdersItem struct {
	value *CfuturesCreateBatchOrderV1ReqBatchOrdersItem
	isSet bool
}

func (v NullableCfuturesCreateBatchOrderV1ReqBatchOrdersItem) Get() *CfuturesCreateBatchOrderV1ReqBatchOrdersItem {
	return v.value
}

func (v *NullableCfuturesCreateBatchOrderV1ReqBatchOrdersItem) Set(val *CfuturesCreateBatchOrderV1ReqBatchOrdersItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesCreateBatchOrderV1ReqBatchOrdersItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesCreateBatchOrderV1ReqBatchOrdersItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesCreateBatchOrderV1ReqBatchOrdersItem(val *CfuturesCreateBatchOrderV1ReqBatchOrdersItem) *NullableCfuturesCreateBatchOrderV1ReqBatchOrdersItem {
	return &NullableCfuturesCreateBatchOrderV1ReqBatchOrdersItem{value: val, isSet: true}
}

func (v NullableCfuturesCreateBatchOrderV1ReqBatchOrdersItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesCreateBatchOrderV1ReqBatchOrdersItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
