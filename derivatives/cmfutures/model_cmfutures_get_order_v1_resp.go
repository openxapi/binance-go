...
// checks if the CmfuturesGetOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetOrderV1Resp{}

// CmfuturesGetOrderV1Resp struct for CmfuturesGetOrderV1Resp
type CmfuturesGetOrderV1Resp struct {
...
func (o CmfuturesGetOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetOrderV1Resp struct {
	value *CmfuturesGetOrderV1Resp
	isSet bool
}

func (v NullableCmfuturesGetOrderV1Resp) Get() *CmfuturesGetOrderV1Resp {
	return v.value
}

func (v *NullableCmfuturesGetOrderV1Resp) Set(val *CmfuturesGetOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetOrderV1Resp(val *CmfuturesGetOrderV1Resp) *NullableCmfuturesGetOrderV1Resp {
	return &NullableCmfuturesGetOrderV1Resp{value: val, isSet: true}
}

func (v NullableCmfuturesGetOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
