...
// checks if the CfuturesGetOrderAmendmentV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetOrderAmendmentV1RespItem{}

// CfuturesGetOrderAmendmentV1RespItem struct for CfuturesGetOrderAmendmentV1RespItem
type CfuturesGetOrderAmendmentV1RespItem struct {
	Amendment *CfuturesGetOrderAmendmentV1RespItemAmendment `json:"amendment,omitempty"`
...
func NewCfuturesGetOrderAmendmentV1RespItem() *CfuturesGetOrderAmendmentV1RespItem {
	this := CfuturesGetOrderAmendmentV1RespItem{}
	return &this
}
...
func (o *CfuturesGetOrderAmendmentV1RespItem) GetAmendment() CfuturesGetOrderAmendmentV1RespItemAmendment {
	if o == nil || IsNil(o.Amendment) {
		var ret CfuturesGetOrderAmendmentV1RespItemAmendment
		return ret
	}
	return *o.Amendment
}
...
// SetAmendment gets a reference to the given CfuturesGetOrderAmendmentV1RespItemAmendment and assigns it to the Amendment field.
...
func (o CfuturesGetOrderAmendmentV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetOrderAmendmentV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetOrderAmendmentV1RespItem struct {
	value *CfuturesGetOrderAmendmentV1RespItem
	isSet bool
}

func (v NullableCfuturesGetOrderAmendmentV1RespItem) Get() *CfuturesGetOrderAmendmentV1RespItem {
	return v.value
}

func (v *NullableCfuturesGetOrderAmendmentV1RespItem) Set(val *CfuturesGetOrderAmendmentV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetOrderAmendmentV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetOrderAmendmentV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetOrderAmendmentV1RespItem(val *CfuturesGetOrderAmendmentV1RespItem) *NullableCfuturesGetOrderAmendmentV1RespItem {
	return &NullableCfuturesGetOrderAmendmentV1RespItem{value: val, isSet: true}
}

func (v NullableCfuturesGetOrderAmendmentV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetOrderAmendmentV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
