...
// checks if the CmfuturesGetOrderAmendmentV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetOrderAmendmentV1RespItem{}

// CmfuturesGetOrderAmendmentV1RespItem struct for CmfuturesGetOrderAmendmentV1RespItem
type CmfuturesGetOrderAmendmentV1RespItem struct {
	Amendment *CmfuturesGetOrderAmendmentV1RespItemAmendment `json:"amendment,omitempty"`
...
func NewCmfuturesGetOrderAmendmentV1RespItem() *CmfuturesGetOrderAmendmentV1RespItem {
	this := CmfuturesGetOrderAmendmentV1RespItem{}
	return &this
}
...
func (o *CmfuturesGetOrderAmendmentV1RespItem) GetAmendment() CmfuturesGetOrderAmendmentV1RespItemAmendment {
	if o == nil || IsNil(o.Amendment) {
		var ret CmfuturesGetOrderAmendmentV1RespItemAmendment
		return ret
	}
	return *o.Amendment
}
...
// SetAmendment gets a reference to the given CmfuturesGetOrderAmendmentV1RespItemAmendment and assigns it to the Amendment field.
...
func (o CmfuturesGetOrderAmendmentV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetOrderAmendmentV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetOrderAmendmentV1RespItem struct {
	value *CmfuturesGetOrderAmendmentV1RespItem
	isSet bool
}

func (v NullableCmfuturesGetOrderAmendmentV1RespItem) Get() *CmfuturesGetOrderAmendmentV1RespItem {
	return v.value
}

func (v *NullableCmfuturesGetOrderAmendmentV1RespItem) Set(val *CmfuturesGetOrderAmendmentV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetOrderAmendmentV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetOrderAmendmentV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetOrderAmendmentV1RespItem(val *CmfuturesGetOrderAmendmentV1RespItem) *NullableCmfuturesGetOrderAmendmentV1RespItem {
	return &NullableCmfuturesGetOrderAmendmentV1RespItem{value: val, isSet: true}
}

func (v NullableCmfuturesGetOrderAmendmentV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetOrderAmendmentV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
