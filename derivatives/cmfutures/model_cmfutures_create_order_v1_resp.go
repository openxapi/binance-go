...
// checks if the CmfuturesCreateOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesCreateOrderV1Resp{}

// CmfuturesCreateOrderV1Resp struct for CmfuturesCreateOrderV1Resp
type CmfuturesCreateOrderV1Resp struct {
...
func NewCmfuturesCreateOrderV1Resp() *CmfuturesCreateOrderV1Resp {
	this := CmfuturesCreateOrderV1Resp{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *CmfuturesCreateOrderV1Resp) GetPositionSideOk() (*string, bool) {
	if o == nil || IsNil(o.PositionSide) {
		return nil, false
	}
...
func (o *CmfuturesCreateOrderV1Resp) SetPriceMatch(v string) {
	o.PriceMatch = &v
}
...
func (o *CmfuturesCreateOrderV1Resp) GetSide() string {
...
func (o CmfuturesCreateOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesCreateOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesCreateOrderV1Resp struct {
	value *CmfuturesCreateOrderV1Resp
	isSet bool
}

func (v NullableCmfuturesCreateOrderV1Resp) Get() *CmfuturesCreateOrderV1Resp {
	return v.value
}

func (v *NullableCmfuturesCreateOrderV1Resp) Set(val *CmfuturesCreateOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesCreateOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesCreateOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesCreateOrderV1Resp(val *CmfuturesCreateOrderV1Resp) *NullableCmfuturesCreateOrderV1Resp {
	return &NullableCmfuturesCreateOrderV1Resp{value: val, isSet: true}
}

func (v NullableCmfuturesCreateOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesCreateOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
