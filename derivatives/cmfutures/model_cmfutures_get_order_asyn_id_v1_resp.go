...
// checks if the CmfuturesGetOrderAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetOrderAsynIdV1Resp{}

// CmfuturesGetOrderAsynIdV1Resp struct for CmfuturesGetOrderAsynIdV1Resp
type CmfuturesGetOrderAsynIdV1Resp struct {
...
func NewCmfuturesGetOrderAsynIdV1Resp() *CmfuturesGetOrderAsynIdV1Resp {
	this := CmfuturesGetOrderAsynIdV1Resp{}
	return &this
}
...
func (o CmfuturesGetOrderAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetOrderAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetOrderAsynIdV1Resp struct {
	value *CmfuturesGetOrderAsynIdV1Resp
	isSet bool
}

func (v NullableCmfuturesGetOrderAsynIdV1Resp) Get() *CmfuturesGetOrderAsynIdV1Resp {
	return v.value
}

func (v *NullableCmfuturesGetOrderAsynIdV1Resp) Set(val *CmfuturesGetOrderAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetOrderAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetOrderAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetOrderAsynIdV1Resp(val *CmfuturesGetOrderAsynIdV1Resp) *NullableCmfuturesGetOrderAsynIdV1Resp {
	return &NullableCmfuturesGetOrderAsynIdV1Resp{value: val, isSet: true}
}

func (v NullableCmfuturesGetOrderAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetOrderAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
