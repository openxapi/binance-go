...
// checks if the CmfuturesGetOpenOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetOpenOrdersV1RespItem{}

// CmfuturesGetOpenOrdersV1RespItem struct for CmfuturesGetOpenOrdersV1RespItem
type CmfuturesGetOpenOrdersV1RespItem struct {
...
func NewCmfuturesGetOpenOrdersV1RespItem() *CmfuturesGetOpenOrdersV1RespItem {
	this := CmfuturesGetOpenOrdersV1RespItem{}
	return &this
}
...
func (o CmfuturesGetOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetOpenOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetOpenOrdersV1RespItem struct {
	value *CmfuturesGetOpenOrdersV1RespItem
	isSet bool
}

func (v NullableCmfuturesGetOpenOrdersV1RespItem) Get() *CmfuturesGetOpenOrdersV1RespItem {
	return v.value
}

func (v *NullableCmfuturesGetOpenOrdersV1RespItem) Set(val *CmfuturesGetOpenOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetOpenOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetOpenOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetOpenOrdersV1RespItem(val *CmfuturesGetOpenOrdersV1RespItem) *NullableCmfuturesGetOpenOrdersV1RespItem {
	return &NullableCmfuturesGetOpenOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableCmfuturesGetOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetOpenOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
