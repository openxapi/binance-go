...
// checks if the CfuturesGetUserTradesV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetUserTradesV1RespItem{}

// CfuturesGetUserTradesV1RespItem struct for CfuturesGetUserTradesV1RespItem
type CfuturesGetUserTradesV1RespItem struct {
...
func NewCfuturesGetUserTradesV1RespItem() *CfuturesGetUserTradesV1RespItem {
	this := CfuturesGetUserTradesV1RespItem{}
	return &this
}
...
func (o CfuturesGetUserTradesV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetUserTradesV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetUserTradesV1RespItem struct {
	value *CfuturesGetUserTradesV1RespItem
	isSet bool
}

func (v NullableCfuturesGetUserTradesV1RespItem) Get() *CfuturesGetUserTradesV1RespItem {
	return v.value
}

func (v *NullableCfuturesGetUserTradesV1RespItem) Set(val *CfuturesGetUserTradesV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetUserTradesV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetUserTradesV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetUserTradesV1RespItem(val *CfuturesGetUserTradesV1RespItem) *NullableCfuturesGetUserTradesV1RespItem {
	return &NullableCfuturesGetUserTradesV1RespItem{value: val, isSet: true}
}

func (v NullableCfuturesGetUserTradesV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetUserTradesV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
