...
// checks if the CfuturesGetLeverageBracketV1RespItemBracketsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetLeverageBracketV1RespItemBracketsInner{}

// CfuturesGetLeverageBracketV1RespItemBracketsInner struct for CfuturesGetLeverageBracketV1RespItemBracketsInner
type CfuturesGetLeverageBracketV1RespItemBracketsInner struct {
...
func NewCfuturesGetLeverageBracketV1RespItemBracketsInner() *CfuturesGetLeverageBracketV1RespItemBracketsInner {
	this := CfuturesGetLeverageBracketV1RespItemBracketsInner{}
	return &this
}
...
func (o CfuturesGetLeverageBracketV1RespItemBracketsInner) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetLeverageBracketV1RespItemBracketsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetLeverageBracketV1RespItemBracketsInner struct {
	value *CfuturesGetLeverageBracketV1RespItemBracketsInner
	isSet bool
}

func (v NullableCfuturesGetLeverageBracketV1RespItemBracketsInner) Get() *CfuturesGetLeverageBracketV1RespItemBracketsInner {
	return v.value
}

func (v *NullableCfuturesGetLeverageBracketV1RespItemBracketsInner) Set(val *CfuturesGetLeverageBracketV1RespItemBracketsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetLeverageBracketV1RespItemBracketsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetLeverageBracketV1RespItemBracketsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetLeverageBracketV1RespItemBracketsInner(val *CfuturesGetLeverageBracketV1RespItemBracketsInner) *NullableCfuturesGetLeverageBracketV1RespItemBracketsInner {
	return &NullableCfuturesGetLeverageBracketV1RespItemBracketsInner{value: val, isSet: true}
}

func (v NullableCfuturesGetLeverageBracketV1RespItemBracketsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetLeverageBracketV1RespItemBracketsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
