...
// checks if the CfuturesGetAllOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetAllOrdersV1RespItem{}

// CfuturesGetAllOrdersV1RespItem struct for CfuturesGetAllOrdersV1RespItem
type CfuturesGetAllOrdersV1RespItem struct {
...
func NewCfuturesGetAllOrdersV1RespItem() *CfuturesGetAllOrdersV1RespItem {
	this := CfuturesGetAllOrdersV1RespItem{}
	return &this
}
...
func (o CfuturesGetAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetAllOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetAllOrdersV1RespItem struct {
	value *CfuturesGetAllOrdersV1RespItem
	isSet bool
}

func (v NullableCfuturesGetAllOrdersV1RespItem) Get() *CfuturesGetAllOrdersV1RespItem {
	return v.value
}

func (v *NullableCfuturesGetAllOrdersV1RespItem) Set(val *CfuturesGetAllOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetAllOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetAllOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetAllOrdersV1RespItem(val *CfuturesGetAllOrdersV1RespItem) *NullableCfuturesGetAllOrdersV1RespItem {
	return &NullableCfuturesGetAllOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableCfuturesGetAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetAllOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
