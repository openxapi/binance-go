...
// checks if the CmfuturesGetTicker24hrV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetTicker24hrV1RespItem{}

// CmfuturesGetTicker24hrV1RespItem struct for CmfuturesGetTicker24hrV1RespItem
type CmfuturesGetTicker24hrV1RespItem struct {
...
func NewCmfuturesGetTicker24hrV1RespItem() *CmfuturesGetTicker24hrV1RespItem {
	this := CmfuturesGetTicker24hrV1RespItem{}
	return &this
}
...
func (o CmfuturesGetTicker24hrV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetTicker24hrV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetTicker24hrV1RespItem struct {
	value *CmfuturesGetTicker24hrV1RespItem
	isSet bool
}

func (v NullableCmfuturesGetTicker24hrV1RespItem) Get() *CmfuturesGetTicker24hrV1RespItem {
	return v.value
}

func (v *NullableCmfuturesGetTicker24hrV1RespItem) Set(val *CmfuturesGetTicker24hrV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetTicker24hrV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetTicker24hrV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetTicker24hrV1RespItem(val *CmfuturesGetTicker24hrV1RespItem) *NullableCmfuturesGetTicker24hrV1RespItem {
	return &NullableCmfuturesGetTicker24hrV1RespItem{value: val, isSet: true}
}

func (v NullableCmfuturesGetTicker24hrV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetTicker24hrV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
