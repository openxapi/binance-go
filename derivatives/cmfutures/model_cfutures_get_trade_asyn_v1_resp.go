...
// checks if the CfuturesGetTradeAsynV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetTradeAsynV1Resp{}

// CfuturesGetTradeAsynV1Resp struct for CfuturesGetTradeAsynV1Resp
type CfuturesGetTradeAsynV1Resp struct {
...
func NewCfuturesGetTradeAsynV1Resp() *CfuturesGetTradeAsynV1Resp {
	this := CfuturesGetTradeAsynV1Resp{}
	return &this
}
...
func (o CfuturesGetTradeAsynV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetTradeAsynV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetTradeAsynV1Resp struct {
	value *CfuturesGetTradeAsynV1Resp
	isSet bool
}

func (v NullableCfuturesGetTradeAsynV1Resp) Get() *CfuturesGetTradeAsynV1Resp {
	return v.value
}

func (v *NullableCfuturesGetTradeAsynV1Resp) Set(val *CfuturesGetTradeAsynV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetTradeAsynV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetTradeAsynV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetTradeAsynV1Resp(val *CfuturesGetTradeAsynV1Resp) *NullableCfuturesGetTradeAsynV1Resp {
	return &NullableCfuturesGetTradeAsynV1Resp{value: val, isSet: true}
}

func (v NullableCfuturesGetTradeAsynV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetTradeAsynV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
