...
// checks if the CfuturesUpdateBatchOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesUpdateBatchOrdersV1RespItem{}

// CfuturesUpdateBatchOrdersV1RespItem struct for CfuturesUpdateBatchOrdersV1RespItem
type CfuturesUpdateBatchOrdersV1RespItem struct {
...
func NewCfuturesUpdateBatchOrdersV1RespItem() *CfuturesUpdateBatchOrdersV1RespItem {
	this := CfuturesUpdateBatchOrdersV1RespItem{}
	return &this
}
...
func (o *CfuturesUpdateBatchOrdersV1RespItem) HasOrderId() bool {
	if o != nil && !IsNil(o.OrderId) {
		return true
	}
...
func (o *CfuturesUpdateBatchOrdersV1RespItem) HasPriceProtect() bool {
	if o != nil && !IsNil(o.PriceProtect) {
		return true
	}
...
func (o *CfuturesUpdateBatchOrdersV1RespItem) GetSide() string {
...
func (o CfuturesUpdateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesUpdateBatchOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesUpdateBatchOrdersV1RespItem struct {
	value *CfuturesUpdateBatchOrdersV1RespItem
	isSet bool
}

func (v NullableCfuturesUpdateBatchOrdersV1RespItem) Get() *CfuturesUpdateBatchOrdersV1RespItem {
	return v.value
}

func (v *NullableCfuturesUpdateBatchOrdersV1RespItem) Set(val *CfuturesUpdateBatchOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesUpdateBatchOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesUpdateBatchOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesUpdateBatchOrdersV1RespItem(val *CfuturesUpdateBatchOrdersV1RespItem) *NullableCfuturesUpdateBatchOrdersV1RespItem {
	return &NullableCfuturesUpdateBatchOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableCfuturesUpdateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesUpdateBatchOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
