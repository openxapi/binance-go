...
// checks if the CfuturesGetTradeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetTradeAsynIdV1Resp{}

// CfuturesGetTradeAsynIdV1Resp struct for CfuturesGetTradeAsynIdV1Resp
type CfuturesGetTradeAsynIdV1Resp struct {
...
func NewCfuturesGetTradeAsynIdV1Resp() *CfuturesGetTradeAsynIdV1Resp {
	this := CfuturesGetTradeAsynIdV1Resp{}
	return &this
}
...
func (o CfuturesGetTradeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetTradeAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetTradeAsynIdV1Resp struct {
	value *CfuturesGetTradeAsynIdV1Resp
	isSet bool
}

func (v NullableCfuturesGetTradeAsynIdV1Resp) Get() *CfuturesGetTradeAsynIdV1Resp {
	return v.value
}

func (v *NullableCfuturesGetTradeAsynIdV1Resp) Set(val *CfuturesGetTradeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetTradeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetTradeAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetTradeAsynIdV1Resp(val *CfuturesGetTradeAsynIdV1Resp) *NullableCfuturesGetTradeAsynIdV1Resp {
	return &NullableCfuturesGetTradeAsynIdV1Resp{value: val, isSet: true}
}

func (v NullableCfuturesGetTradeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetTradeAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
