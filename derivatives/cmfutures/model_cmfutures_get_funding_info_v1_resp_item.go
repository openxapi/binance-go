...
// checks if the CmfuturesGetFundingInfoV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetFundingInfoV1RespItem{}

// CmfuturesGetFundingInfoV1RespItem struct for CmfuturesGetFundingInfoV1RespItem
type CmfuturesGetFundingInfoV1RespItem struct {
...
func NewCmfuturesGetFundingInfoV1RespItem() *CmfuturesGetFundingInfoV1RespItem {
	this := CmfuturesGetFundingInfoV1RespItem{}
	return &this
}
...
func (o CmfuturesGetFundingInfoV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetFundingInfoV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetFundingInfoV1RespItem struct {
	value *CmfuturesGetFundingInfoV1RespItem
	isSet bool
}

func (v NullableCmfuturesGetFundingInfoV1RespItem) Get() *CmfuturesGetFundingInfoV1RespItem {
	return v.value
}

func (v *NullableCmfuturesGetFundingInfoV1RespItem) Set(val *CmfuturesGetFundingInfoV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetFundingInfoV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetFundingInfoV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetFundingInfoV1RespItem(val *CmfuturesGetFundingInfoV1RespItem) *NullableCmfuturesGetFundingInfoV1RespItem {
	return &NullableCmfuturesGetFundingInfoV1RespItem{value: val, isSet: true}
}

func (v NullableCmfuturesGetFundingInfoV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetFundingInfoV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
