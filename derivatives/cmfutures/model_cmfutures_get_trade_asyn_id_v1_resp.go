...
// checks if the CmfuturesGetTradeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetTradeAsynIdV1Resp{}

// CmfuturesGetTradeAsynIdV1Resp struct for CmfuturesGetTradeAsynIdV1Resp
type CmfuturesGetTradeAsynIdV1Resp struct {
...
func NewCmfuturesGetTradeAsynIdV1Resp() *CmfuturesGetTradeAsynIdV1Resp {
	this := CmfuturesGetTradeAsynIdV1Resp{}
	return &this
}
...
func (o CmfuturesGetTradeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetTradeAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetTradeAsynIdV1Resp struct {
	value *CmfuturesGetTradeAsynIdV1Resp
	isSet bool
}

func (v NullableCmfuturesGetTradeAsynIdV1Resp) Get() *CmfuturesGetTradeAsynIdV1Resp {
	return v.value
}

func (v *NullableCmfuturesGetTradeAsynIdV1Resp) Set(val *CmfuturesGetTradeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetTradeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetTradeAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetTradeAsynIdV1Resp(val *CmfuturesGetTradeAsynIdV1Resp) *NullableCmfuturesGetTradeAsynIdV1Resp {
	return &NullableCmfuturesGetTradeAsynIdV1Resp{value: val, isSet: true}
}

func (v NullableCmfuturesGetTradeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetTradeAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
