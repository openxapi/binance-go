...
// checks if the CmfuturesDeleteOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesDeleteOrderV1Resp{}

// CmfuturesDeleteOrderV1Resp struct for CmfuturesDeleteOrderV1Resp
type CmfuturesDeleteOrderV1Resp struct {
...
func NewCmfuturesDeleteOrderV1Resp() *CmfuturesDeleteOrderV1Resp {
	this := CmfuturesDeleteOrderV1Resp{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *CmfuturesDeleteOrderV1Resp) GetPositionSideOk() (*string, bool) {
	if o == nil || IsNil(o.PositionSide) {
		return nil, false
	}
...
func (o *CmfuturesDeleteOrderV1Resp) SetPriceMatch(v string) {
	o.PriceMatch = &v
}
...
func (o *CmfuturesDeleteOrderV1Resp) GetSide() string {
...
func (o CmfuturesDeleteOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesDeleteOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesDeleteOrderV1Resp struct {
	value *CmfuturesDeleteOrderV1Resp
	isSet bool
}

func (v NullableCmfuturesDeleteOrderV1Resp) Get() *CmfuturesDeleteOrderV1Resp {
	return v.value
}

func (v *NullableCmfuturesDeleteOrderV1Resp) Set(val *CmfuturesDeleteOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesDeleteOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesDeleteOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesDeleteOrderV1Resp(val *CmfuturesDeleteOrderV1Resp) *NullableCmfuturesDeleteOrderV1Resp {
	return &NullableCmfuturesDeleteOrderV1Resp{value: val, isSet: true}
}

func (v NullableCmfuturesDeleteOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesDeleteOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
