...
// checks if the CfuturesGetOrderAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetOrderAsynIdV1Resp{}

// CfuturesGetOrderAsynIdV1Resp struct for CfuturesGetOrderAsynIdV1Resp
type CfuturesGetOrderAsynIdV1Resp struct {
...
func NewCfuturesGetOrderAsynIdV1Resp() *CfuturesGetOrderAsynIdV1Resp {
	this := CfuturesGetOrderAsynIdV1Resp{}
	return &this
}
...
func (o CfuturesGetOrderAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetOrderAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetOrderAsynIdV1Resp struct {
	value *CfuturesGetOrderAsynIdV1Resp
	isSet bool
}

func (v NullableCfuturesGetOrderAsynIdV1Resp) Get() *CfuturesGetOrderAsynIdV1Resp {
	return v.value
}

func (v *NullableCfuturesGetOrderAsynIdV1Resp) Set(val *CfuturesGetOrderAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetOrderAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetOrderAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetOrderAsynIdV1Resp(val *CfuturesGetOrderAsynIdV1Resp) *NullableCfuturesGetOrderAsynIdV1Resp {
	return &NullableCfuturesGetOrderAsynIdV1Resp{value: val, isSet: true}
}

func (v NullableCfuturesGetOrderAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetOrderAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
