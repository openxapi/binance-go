...
// checks if the CfuturesGetAccountV1RespPositionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetAccountV1RespPositionsInner{}

// CfuturesGetAccountV1RespPositionsInner struct for CfuturesGetAccountV1RespPositionsInner
type CfuturesGetAccountV1RespPositionsInner struct {
...
func NewCfuturesGetAccountV1RespPositionsInner() *CfuturesGetAccountV1RespPositionsInner {
	this := CfuturesGetAccountV1RespPositionsInner{}
	return &this
}
...
func (o *CfuturesGetAccountV1RespPositionsInner) GetBreakEvenPriceOk() (*string, bool) {
	if o == nil || IsNil(o.BreakEvenPrice) {
		return nil, false
	}
...
func (o *CfuturesGetAccountV1RespPositionsInner) HasLeverage() bool {
	if o != nil && !IsNil(o.Leverage) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *CfuturesGetAccountV1RespPositionsInner) GetPositionInitialMarginOk() (*string, bool) {
	if o == nil || IsNil(o.PositionInitialMargin) {
		return nil, false
	}
...
func (o *CfuturesGetAccountV1RespPositionsInner) SetSymbol(v string) {
	o.Symbol = &v
}
...
func (o CfuturesGetAccountV1RespPositionsInner) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetAccountV1RespPositionsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetAccountV1RespPositionsInner struct {
	value *CfuturesGetAccountV1RespPositionsInner
	isSet bool
}

func (v NullableCfuturesGetAccountV1RespPositionsInner) Get() *CfuturesGetAccountV1RespPositionsInner {
	return v.value
}

func (v *NullableCfuturesGetAccountV1RespPositionsInner) Set(val *CfuturesGetAccountV1RespPositionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetAccountV1RespPositionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetAccountV1RespPositionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetAccountV1RespPositionsInner(val *CfuturesGetAccountV1RespPositionsInner) *NullableCfuturesGetAccountV1RespPositionsInner {
	return &NullableCfuturesGetAccountV1RespPositionsInner{value: val, isSet: true}
}

func (v NullableCfuturesGetAccountV1RespPositionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetAccountV1RespPositionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
