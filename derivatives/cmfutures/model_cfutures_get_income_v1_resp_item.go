...
// checks if the CfuturesGetIncomeV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetIncomeV1RespItem{}

// CfuturesGetIncomeV1RespItem struct for CfuturesGetIncomeV1RespItem
type CfuturesGetIncomeV1RespItem struct {
...
func NewCfuturesGetIncomeV1RespItem() *CfuturesGetIncomeV1RespItem {
	this := CfuturesGetIncomeV1RespItem{}
	return &this
}
...
func (o *CfuturesGetIncomeV1RespItem) GetInfo() string {
...
func (o CfuturesGetIncomeV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetIncomeV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetIncomeV1RespItem struct {
	value *CfuturesGetIncomeV1RespItem
	isSet bool
}

func (v NullableCfuturesGetIncomeV1RespItem) Get() *CfuturesGetIncomeV1RespItem {
	return v.value
}

func (v *NullableCfuturesGetIncomeV1RespItem) Set(val *CfuturesGetIncomeV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetIncomeV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetIncomeV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetIncomeV1RespItem(val *CfuturesGetIncomeV1RespItem) *NullableCfuturesGetIncomeV1RespItem {
	return &NullableCfuturesGetIncomeV1RespItem{value: val, isSet: true}
}

func (v NullableCfuturesGetIncomeV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetIncomeV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
