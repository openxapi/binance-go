...
// checks if the CfuturesDeleteOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesDeleteOrderV1Resp{}

// CfuturesDeleteOrderV1Resp struct for CfuturesDeleteOrderV1Resp
type CfuturesDeleteOrderV1Resp struct {
...
func NewCfuturesDeleteOrderV1Resp() *CfuturesDeleteOrderV1Resp {
	this := CfuturesDeleteOrderV1Resp{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *CfuturesDeleteOrderV1Resp) GetPositionSideOk() (*string, bool) {
	if o == nil || IsNil(o.PositionSide) {
		return nil, false
	}
...
func (o *CfuturesDeleteOrderV1Resp) SetPriceMatch(v string) {
	o.PriceMatch = &v
}
...
func (o *CfuturesDeleteOrderV1Resp) GetSide() string {
...
func (o CfuturesDeleteOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CfuturesDeleteOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesDeleteOrderV1Resp struct {
	value *CfuturesDeleteOrderV1Resp
	isSet bool
}

func (v NullableCfuturesDeleteOrderV1Resp) Get() *CfuturesDeleteOrderV1Resp {
	return v.value
}

func (v *NullableCfuturesDeleteOrderV1Resp) Set(val *CfuturesDeleteOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesDeleteOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesDeleteOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesDeleteOrderV1Resp(val *CfuturesDeleteOrderV1Resp) *NullableCfuturesDeleteOrderV1Resp {
	return &NullableCfuturesDeleteOrderV1Resp{value: val, isSet: true}
}

func (v NullableCfuturesDeleteOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesDeleteOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
