...
// checks if the CmfuturesGetAllOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetAllOrdersV1RespItem{}

// CmfuturesGetAllOrdersV1RespItem struct for CmfuturesGetAllOrdersV1RespItem
type CmfuturesGetAllOrdersV1RespItem struct {
...
func NewCmfuturesGetAllOrdersV1RespItem() *CmfuturesGetAllOrdersV1RespItem {
	this := CmfuturesGetAllOrdersV1RespItem{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *CmfuturesGetAllOrdersV1RespItem) GetPriceOk() (*string, bool) {
	if o == nil || IsNil(o.Price) {
		return nil, false
	}
	return o.Price, true
...
func (o *CmfuturesGetAllOrdersV1RespItem) SetPriceProtect(v bool) {
	o.PriceProtect = &v
}
...
func (o *CmfuturesGetAllOrdersV1RespItem) GetStatus() string {
...
func (o CmfuturesGetAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetAllOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetAllOrdersV1RespItem struct {
	value *CmfuturesGetAllOrdersV1RespItem
	isSet bool
}

func (v NullableCmfuturesGetAllOrdersV1RespItem) Get() *CmfuturesGetAllOrdersV1RespItem {
	return v.value
}

func (v *NullableCmfuturesGetAllOrdersV1RespItem) Set(val *CmfuturesGetAllOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetAllOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetAllOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetAllOrdersV1RespItem(val *CmfuturesGetAllOrdersV1RespItem) *NullableCmfuturesGetAllOrdersV1RespItem {
	return &NullableCmfuturesGetAllOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableCmfuturesGetAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetAllOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
