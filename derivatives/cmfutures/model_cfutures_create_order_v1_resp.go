...
// checks if the CfuturesCreateOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesCreateOrderV1Resp{}

// CfuturesCreateOrderV1Resp struct for CfuturesCreateOrderV1Resp
type CfuturesCreateOrderV1Resp struct {
...
func NewCfuturesCreateOrderV1Resp() *CfuturesCreateOrderV1Resp {
	this := CfuturesCreateOrderV1Resp{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *CfuturesCreateOrderV1Resp) GetPositionSideOk() (*string, bool) {
	if o == nil || IsNil(o.PositionSide) {
		return nil, false
	}
...
func (o *CfuturesCreateOrderV1Resp) SetPriceMatch(v string) {
	o.PriceMatch = &v
}
...
func (o *CfuturesCreateOrderV1Resp) GetSide() string {
...
func (o CfuturesCreateOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CfuturesCreateOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesCreateOrderV1Resp struct {
	value *CfuturesCreateOrderV1Resp
	isSet bool
}

func (v NullableCfuturesCreateOrderV1Resp) Get() *CfuturesCreateOrderV1Resp {
	return v.value
}

func (v *NullableCfuturesCreateOrderV1Resp) Set(val *CfuturesCreateOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesCreateOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesCreateOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesCreateOrderV1Resp(val *CfuturesCreateOrderV1Resp) *NullableCfuturesCreateOrderV1Resp {
	return &NullableCfuturesCreateOrderV1Resp{value: val, isSet: true}
}

func (v NullableCfuturesCreateOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesCreateOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
