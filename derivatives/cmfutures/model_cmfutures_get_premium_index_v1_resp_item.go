...
// checks if the CmfuturesGetPremiumIndexV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetPremiumIndexV1RespItem{}

// CmfuturesGetPremiumIndexV1RespItem struct for CmfuturesGetPremiumIndexV1RespItem
type CmfuturesGetPremiumIndexV1RespItem struct {
...
func NewCmfuturesGetPremiumIndexV1RespItem() *CmfuturesGetPremiumIndexV1RespItem {
	this := CmfuturesGetPremiumIndexV1RespItem{}
	return &this
}
...
func (o *CmfuturesGetPremiumIndexV1RespItem) SetEstimatedSettlePrice(v string) {
...
func (o CmfuturesGetPremiumIndexV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetPremiumIndexV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetPremiumIndexV1RespItem struct {
	value *CmfuturesGetPremiumIndexV1RespItem
	isSet bool
}

func (v NullableCmfuturesGetPremiumIndexV1RespItem) Get() *CmfuturesGetPremiumIndexV1RespItem {
	return v.value
}

func (v *NullableCmfuturesGetPremiumIndexV1RespItem) Set(val *CmfuturesGetPremiumIndexV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetPremiumIndexV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetPremiumIndexV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetPremiumIndexV1RespItem(val *CmfuturesGetPremiumIndexV1RespItem) *NullableCmfuturesGetPremiumIndexV1RespItem {
	return &NullableCmfuturesGetPremiumIndexV1RespItem{value: val, isSet: true}
}

func (v NullableCmfuturesGetPremiumIndexV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetPremiumIndexV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
