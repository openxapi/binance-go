...
// checks if the CmfuturesDeleteBatchOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesDeleteBatchOrdersV1RespItem{}

// CmfuturesDeleteBatchOrdersV1RespItem struct for CmfuturesDeleteBatchOrdersV1RespItem
type CmfuturesDeleteBatchOrdersV1RespItem struct {
...
func NewCmfuturesDeleteBatchOrdersV1RespItem() *CmfuturesDeleteBatchOrdersV1RespItem {
	this := CmfuturesDeleteBatchOrdersV1RespItem{}
	return &this
}
...
func (o CmfuturesDeleteBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesDeleteBatchOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesDeleteBatchOrdersV1RespItem struct {
	value *CmfuturesDeleteBatchOrdersV1RespItem
	isSet bool
}

func (v NullableCmfuturesDeleteBatchOrdersV1RespItem) Get() *CmfuturesDeleteBatchOrdersV1RespItem {
	return v.value
}

func (v *NullableCmfuturesDeleteBatchOrdersV1RespItem) Set(val *CmfuturesDeleteBatchOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesDeleteBatchOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesDeleteBatchOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesDeleteBatchOrdersV1RespItem(val *CmfuturesDeleteBatchOrdersV1RespItem) *NullableCmfuturesDeleteBatchOrdersV1RespItem {
	return &NullableCmfuturesDeleteBatchOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableCmfuturesDeleteBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesDeleteBatchOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
