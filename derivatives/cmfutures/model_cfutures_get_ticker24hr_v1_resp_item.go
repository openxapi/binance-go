...
// checks if the CfuturesGetTicker24hrV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetTicker24hrV1RespItem{}

// CfuturesGetTicker24hrV1RespItem struct for CfuturesGetTicker24hrV1RespItem
type CfuturesGetTicker24hrV1RespItem struct {
...
func NewCfuturesGetTicker24hrV1RespItem() *CfuturesGetTicker24hrV1RespItem {
	this := CfuturesGetTicker24hrV1RespItem{}
	return &this
}
...
func (o *CfuturesGetTicker24hrV1RespItem) GetBaseVolumeOk() (*string, bool) {
	if o == nil || IsNil(o.BaseVolume) {
		return nil, false
	}
...
func (o *CfuturesGetTicker24hrV1RespItem) SetCount(v int32) {
	o.Count = &v
}
...
func (o *CfuturesGetTicker24hrV1RespItem) HasPair() bool {
	if o != nil && !IsNil(o.Pair) {
		return true
	}
...
func (o *CfuturesGetTicker24hrV1RespItem) GetSymbol() string {
...
func (o CfuturesGetTicker24hrV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetTicker24hrV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetTicker24hrV1RespItem struct {
	value *CfuturesGetTicker24hrV1RespItem
	isSet bool
}

func (v NullableCfuturesGetTicker24hrV1RespItem) Get() *CfuturesGetTicker24hrV1RespItem {
	return v.value
}

func (v *NullableCfuturesGetTicker24hrV1RespItem) Set(val *CfuturesGetTicker24hrV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetTicker24hrV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetTicker24hrV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetTicker24hrV1RespItem(val *CfuturesGetTicker24hrV1RespItem) *NullableCfuturesGetTicker24hrV1RespItem {
	return &NullableCfuturesGetTicker24hrV1RespItem{value: val, isSet: true}
}

func (v NullableCfuturesGetTicker24hrV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetTicker24hrV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
