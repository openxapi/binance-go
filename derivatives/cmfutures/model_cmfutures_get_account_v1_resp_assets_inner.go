...
// checks if the CmfuturesGetAccountV1RespAssetsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetAccountV1RespAssetsInner{}

// CmfuturesGetAccountV1RespAssetsInner struct for CmfuturesGetAccountV1RespAssetsInner
type CmfuturesGetAccountV1RespAssetsInner struct {
...
func NewCmfuturesGetAccountV1RespAssetsInner() *CmfuturesGetAccountV1RespAssetsInner {
	this := CmfuturesGetAccountV1RespAssetsInner{}
	return &this
}
...
func (o *CmfuturesGetAccountV1RespAssetsInner) SetCrossUnPnl(v string) {
	o.CrossUnPnl = &v
}
...
func (o *CmfuturesGetAccountV1RespAssetsInner) HasInitialMargin() bool {
	if o != nil && !IsNil(o.InitialMargin) {
		return true
	}
...
func (o *CmfuturesGetAccountV1RespAssetsInner) GetMaxWithdrawAmount() string {
...
func (o CmfuturesGetAccountV1RespAssetsInner) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetAccountV1RespAssetsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetAccountV1RespAssetsInner struct {
	value *CmfuturesGetAccountV1RespAssetsInner
	isSet bool
}

func (v NullableCmfuturesGetAccountV1RespAssetsInner) Get() *CmfuturesGetAccountV1RespAssetsInner {
	return v.value
}

func (v *NullableCmfuturesGetAccountV1RespAssetsInner) Set(val *CmfuturesGetAccountV1RespAssetsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetAccountV1RespAssetsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetAccountV1RespAssetsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetAccountV1RespAssetsInner(val *CmfuturesGetAccountV1RespAssetsInner) *NullableCmfuturesGetAccountV1RespAssetsInner {
	return &NullableCmfuturesGetAccountV1RespAssetsInner{value: val, isSet: true}
}

func (v NullableCmfuturesGetAccountV1RespAssetsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetAccountV1RespAssetsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
