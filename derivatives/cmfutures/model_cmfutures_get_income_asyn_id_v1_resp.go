...
// checks if the CmfuturesGetIncomeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetIncomeAsynIdV1Resp{}

// CmfuturesGetIncomeAsynIdV1Resp struct for CmfuturesGetIncomeAsynIdV1Resp
type CmfuturesGetIncomeAsynIdV1Resp struct {
...
func NewCmfuturesGetIncomeAsynIdV1Resp() *CmfuturesGetIncomeAsynIdV1Resp {
	this := CmfuturesGetIncomeAsynIdV1Resp{}
	return &this
}
...
func (o CmfuturesGetIncomeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetIncomeAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetIncomeAsynIdV1Resp struct {
	value *CmfuturesGetIncomeAsynIdV1Resp
	isSet bool
}

func (v NullableCmfuturesGetIncomeAsynIdV1Resp) Get() *CmfuturesGetIncomeAsynIdV1Resp {
	return v.value
}

func (v *NullableCmfuturesGetIncomeAsynIdV1Resp) Set(val *CmfuturesGetIncomeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetIncomeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetIncomeAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetIncomeAsynIdV1Resp(val *CmfuturesGetIncomeAsynIdV1Resp) *NullableCmfuturesGetIncomeAsynIdV1Resp {
	return &NullableCmfuturesGetIncomeAsynIdV1Resp{value: val, isSet: true}
}

func (v NullableCmfuturesGetIncomeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetIncomeAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
