...
// checks if the CfuturesGetOpenOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetOpenOrdersV1RespItem{}

// CfuturesGetOpenOrdersV1RespItem struct for CfuturesGetOpenOrdersV1RespItem
type CfuturesGetOpenOrdersV1RespItem struct {
...
func NewCfuturesGetOpenOrdersV1RespItem() *CfuturesGetOpenOrdersV1RespItem {
	this := CfuturesGetOpenOrdersV1RespItem{}
	return &this
}
...
func (o CfuturesGetOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetOpenOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetOpenOrdersV1RespItem struct {
	value *CfuturesGetOpenOrdersV1RespItem
	isSet bool
}

func (v NullableCfuturesGetOpenOrdersV1RespItem) Get() *CfuturesGetOpenOrdersV1RespItem {
	return v.value
}

func (v *NullableCfuturesGetOpenOrdersV1RespItem) Set(val *CfuturesGetOpenOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetOpenOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetOpenOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetOpenOrdersV1RespItem(val *CfuturesGetOpenOrdersV1RespItem) *NullableCfuturesGetOpenOrdersV1RespItem {
	return &NullableCfuturesGetOpenOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableCfuturesGetOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetOpenOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
