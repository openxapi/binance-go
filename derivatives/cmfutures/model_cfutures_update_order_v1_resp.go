...
// checks if the CfuturesUpdateOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesUpdateOrderV1Resp{}

// CfuturesUpdateOrderV1Resp struct for CfuturesUpdateOrderV1Resp
type CfuturesUpdateOrderV1Resp struct {
...
func NewCfuturesUpdateOrderV1Resp() *CfuturesUpdateOrderV1Resp {
	this := CfuturesUpdateOrderV1Resp{}
	return &this
}
...
func (o CfuturesUpdateOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CfuturesUpdateOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesUpdateOrderV1Resp struct {
	value *CfuturesUpdateOrderV1Resp
	isSet bool
}

func (v NullableCfuturesUpdateOrderV1Resp) Get() *CfuturesUpdateOrderV1Resp {
	return v.value
}

func (v *NullableCfuturesUpdateOrderV1Resp) Set(val *CfuturesUpdateOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesUpdateOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesUpdateOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesUpdateOrderV1Resp(val *CfuturesUpdateOrderV1Resp) *NullableCfuturesUpdateOrderV1Resp {
	return &NullableCfuturesUpdateOrderV1Resp{value: val, isSet: true}
}

func (v NullableCfuturesUpdateOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesUpdateOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
