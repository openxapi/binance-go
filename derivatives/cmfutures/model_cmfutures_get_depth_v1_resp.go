...
// checks if the CmfuturesGetDepthV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetDepthV1Resp{}

// CmfuturesGetDepthV1Resp struct for CmfuturesGetDepthV1Resp
type CmfuturesGetDepthV1Resp struct {
...
func (o CmfuturesGetDepthV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetDepthV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetDepthV1Resp struct {
	value *CmfuturesGetDepthV1Resp
	isSet bool
}

func (v NullableCmfuturesGetDepthV1Resp) Get() *CmfuturesGetDepthV1Resp {
	return v.value
}

func (v *NullableCmfuturesGetDepthV1Resp) Set(val *CmfuturesGetDepthV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetDepthV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetDepthV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetDepthV1Resp(val *CmfuturesGetDepthV1Resp) *NullableCmfuturesGetDepthV1Resp {
	return &NullableCmfuturesGetDepthV1Resp{value: val, isSet: true}
}

func (v NullableCmfuturesGetDepthV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetDepthV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
