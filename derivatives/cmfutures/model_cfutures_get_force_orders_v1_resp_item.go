...
// checks if the CfuturesGetForceOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetForceOrdersV1RespItem{}

// CfuturesGetForceOrdersV1RespItem struct for CfuturesGetForceOrdersV1RespItem
type CfuturesGetForceOrdersV1RespItem struct {
...
func NewCfuturesGetForceOrdersV1RespItem() *CfuturesGetForceOrdersV1RespItem {
	this := CfuturesGetForceOrdersV1RespItem{}
	return &this
}
...
func (o CfuturesGetForceOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetForceOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetForceOrdersV1RespItem struct {
	value *CfuturesGetForceOrdersV1RespItem
	isSet bool
}

func (v NullableCfuturesGetForceOrdersV1RespItem) Get() *CfuturesGetForceOrdersV1RespItem {
	return v.value
}

func (v *NullableCfuturesGetForceOrdersV1RespItem) Set(val *CfuturesGetForceOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetForceOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetForceOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetForceOrdersV1RespItem(val *CfuturesGetForceOrdersV1RespItem) *NullableCfuturesGetForceOrdersV1RespItem {
	return &NullableCfuturesGetForceOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableCfuturesGetForceOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetForceOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
