...
// checks if the CmfuturesGetUserTradesV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetUserTradesV1RespItem{}

// CmfuturesGetUserTradesV1RespItem struct for CmfuturesGetUserTradesV1RespItem
type CmfuturesGetUserTradesV1RespItem struct {
...
func NewCmfuturesGetUserTradesV1RespItem() *CmfuturesGetUserTradesV1RespItem {
	this := CmfuturesGetUserTradesV1RespItem{}
	return &this
}
...
func (o *CmfuturesGetUserTradesV1RespItem) GetBaseQtyOk() (*string, bool) {
	if o == nil || IsNil(o.BaseQty) {
		return nil, false
	}
...
func (o *CmfuturesGetUserTradesV1RespItem) SetCommission(v string) {
	o.Commission = &v
}
...
func (o *CmfuturesGetUserTradesV1RespItem) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *CmfuturesGetUserTradesV1RespItem) HasQty() bool {
	if o != nil && !IsNil(o.Qty) {
		return true
	}
...
func (o CmfuturesGetUserTradesV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetUserTradesV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetUserTradesV1RespItem struct {
	value *CmfuturesGetUserTradesV1RespItem
	isSet bool
}

func (v NullableCmfuturesGetUserTradesV1RespItem) Get() *CmfuturesGetUserTradesV1RespItem {
	return v.value
}

func (v *NullableCmfuturesGetUserTradesV1RespItem) Set(val *CmfuturesGetUserTradesV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetUserTradesV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetUserTradesV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetUserTradesV1RespItem(val *CmfuturesGetUserTradesV1RespItem) *NullableCmfuturesGetUserTradesV1RespItem {
	return &NullableCmfuturesGetUserTradesV1RespItem{value: val, isSet: true}
}

func (v NullableCmfuturesGetUserTradesV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetUserTradesV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
