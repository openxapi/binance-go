...
// checks if the CfuturesGetTickerBookTickerV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetTickerBookTickerV1RespItem{}

// CfuturesGetTickerBookTickerV1RespItem struct for CfuturesGetTickerBookTickerV1RespItem
type CfuturesGetTickerBookTickerV1RespItem struct {
...
func NewCfuturesGetTickerBookTickerV1RespItem() *CfuturesGetTickerBookTickerV1RespItem {
	this := CfuturesGetTickerBookTickerV1RespItem{}
	return &this
}
...
func (o *CfuturesGetTickerBookTickerV1RespItem) SetAskPrice(v string) {
	o.AskPrice = &v
}
...
func (o CfuturesGetTickerBookTickerV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetTickerBookTickerV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetTickerBookTickerV1RespItem struct {
	value *CfuturesGetTickerBookTickerV1RespItem
	isSet bool
}

func (v NullableCfuturesGetTickerBookTickerV1RespItem) Get() *CfuturesGetTickerBookTickerV1RespItem {
	return v.value
}

func (v *NullableCfuturesGetTickerBookTickerV1RespItem) Set(val *CfuturesGetTickerBookTickerV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetTickerBookTickerV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetTickerBookTickerV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetTickerBookTickerV1RespItem(val *CfuturesGetTickerBookTickerV1RespItem) *NullableCfuturesGetTickerBookTickerV1RespItem {
	return &NullableCfuturesGetTickerBookTickerV1RespItem{value: val, isSet: true}
}

func (v NullableCfuturesGetTickerBookTickerV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetTickerBookTickerV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
