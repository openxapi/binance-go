...
// checks if the CmfuturesGetOpenOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmfuturesGetOpenOrderV1Resp{}

// CmfuturesGetOpenOrderV1Resp struct for CmfuturesGetOpenOrderV1Resp
type CmfuturesGetOpenOrderV1Resp struct {
...
func NewCmfuturesGetOpenOrderV1Resp() *CmfuturesGetOpenOrderV1Resp {
	this := CmfuturesGetOpenOrderV1Resp{}
	return &this
}
...
func (o CmfuturesGetOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CmfuturesGetOpenOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCmfuturesGetOpenOrderV1Resp struct {
	value *CmfuturesGetOpenOrderV1Resp
	isSet bool
}

func (v NullableCmfuturesGetOpenOrderV1Resp) Get() *CmfuturesGetOpenOrderV1Resp {
	return v.value
}

func (v *NullableCmfuturesGetOpenOrderV1Resp) Set(val *CmfuturesGetOpenOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCmfuturesGetOpenOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCmfuturesGetOpenOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmfuturesGetOpenOrderV1Resp(val *CmfuturesGetOpenOrderV1Resp) *NullableCmfuturesGetOpenOrderV1Resp {
	return &NullableCmfuturesGetOpenOrderV1Resp{value: val, isSet: true}
}

func (v NullableCmfuturesGetOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmfuturesGetOpenOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
