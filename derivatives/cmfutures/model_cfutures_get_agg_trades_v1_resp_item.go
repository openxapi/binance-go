...
// checks if the CfuturesGetAggTradesV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetAggTradesV1RespItem{}

// CfuturesGetAggTradesV1RespItem struct for CfuturesGetAggTradesV1RespItem
type CfuturesGetAggTradesV1RespItem struct {
...
func NewCfuturesGetAggTradesV1RespItem() *CfuturesGetAggTradesV1RespItem {
	this := CfuturesGetAggTradesV1RespItem{}
	return &this
}
...
func (o CfuturesGetAggTradesV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetAggTradesV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetAggTradesV1RespItem struct {
	value *CfuturesGetAggTradesV1RespItem
	isSet bool
}

func (v NullableCfuturesGetAggTradesV1RespItem) Get() *CfuturesGetAggTradesV1RespItem {
	return v.value
}

func (v *NullableCfuturesGetAggTradesV1RespItem) Set(val *CfuturesGetAggTradesV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetAggTradesV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetAggTradesV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetAggTradesV1RespItem(val *CfuturesGetAggTradesV1RespItem) *NullableCfuturesGetAggTradesV1RespItem {
	return &NullableCfuturesGetAggTradesV1RespItem{value: val, isSet: true}
}

func (v NullableCfuturesGetAggTradesV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetAggTradesV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
