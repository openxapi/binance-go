...
// checks if the CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem{}

// CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem struct for CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem
type CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem struct {
...
func NewCfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem() *CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem {
	this := CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem{}
	return &this
}
...
func (o CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem) MarshalJSON() ([]byte, error) {
...
func (o CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem) ToMap() (map[string]interface{}, error) {
...
type NullableCfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem struct {
	value *CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem
	isSet bool
}

func (v NullableCfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem) Get() *CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem {
	return v.value
}

func (v *NullableCfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem) Set(val *CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem(val *CfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem) *NullableCfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem {
	return &NullableCfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem{value: val, isSet: true}
}

func (v NullableCfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCfuturesGetFuturesDataGlobalLongShortAccountRatioRespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
