...
// checks if the UfuturesUpdateBatchOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesUpdateBatchOrdersV1RespItem{}

// UfuturesUpdateBatchOrdersV1RespItem struct for UfuturesUpdateBatchOrdersV1RespItem
type UfuturesUpdateBatchOrdersV1RespItem struct {
...
func NewUfuturesUpdateBatchOrdersV1RespItem() *UfuturesUpdateBatchOrdersV1RespItem {
	this := UfuturesUpdateBatchOrdersV1RespItem{}
	return &this
}
...
func (o UfuturesUpdateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesUpdateBatchOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesUpdateBatchOrdersV1RespItem struct {
	value *UfuturesUpdateBatchOrdersV1RespItem
	isSet bool
}

func (v NullableUfuturesUpdateBatchOrdersV1RespItem) Get() *UfuturesUpdateBatchOrdersV1RespItem {
	return v.value
}

func (v *NullableUfuturesUpdateBatchOrdersV1RespItem) Set(val *UfuturesUpdateBatchOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesUpdateBatchOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesUpdateBatchOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesUpdateBatchOrdersV1RespItem(val *UfuturesUpdateBatchOrdersV1RespItem) *NullableUfuturesUpdateBatchOrdersV1RespItem {
	return &NullableUfuturesUpdateBatchOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableUfuturesUpdateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesUpdateBatchOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
