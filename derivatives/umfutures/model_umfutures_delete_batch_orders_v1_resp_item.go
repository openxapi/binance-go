...
// checks if the UmfuturesDeleteBatchOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesDeleteBatchOrdersV1RespItem{}

// UmfuturesDeleteBatchOrdersV1RespItem struct for UmfuturesDeleteBatchOrdersV1RespItem
type UmfuturesDeleteBatchOrdersV1RespItem struct {
...
func NewUmfuturesDeleteBatchOrdersV1RespItem() *UmfuturesDeleteBatchOrdersV1RespItem {
	this := UmfuturesDeleteBatchOrdersV1RespItem{}
	return &this
}
...
func (o UmfuturesDeleteBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesDeleteBatchOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesDeleteBatchOrdersV1RespItem struct {
	value *UmfuturesDeleteBatchOrdersV1RespItem
	isSet bool
}

func (v NullableUmfuturesDeleteBatchOrdersV1RespItem) Get() *UmfuturesDeleteBatchOrdersV1RespItem {
	return v.value
}

func (v *NullableUmfuturesDeleteBatchOrdersV1RespItem) Set(val *UmfuturesDeleteBatchOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesDeleteBatchOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesDeleteBatchOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesDeleteBatchOrdersV1RespItem(val *UmfuturesDeleteBatchOrdersV1RespItem) *NullableUmfuturesDeleteBatchOrdersV1RespItem {
	return &NullableUmfuturesDeleteBatchOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableUmfuturesDeleteBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesDeleteBatchOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
