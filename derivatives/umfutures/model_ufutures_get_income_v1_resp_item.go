...
// checks if the UfuturesGetIncomeV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetIncomeV1RespItem{}

// UfuturesGetIncomeV1RespItem struct for UfuturesGetIncomeV1RespItem
type UfuturesGetIncomeV1RespItem struct {
...
func NewUfuturesGetIncomeV1RespItem() *UfuturesGetIncomeV1RespItem {
	this := UfuturesGetIncomeV1RespItem{}
	return &this
}
...
func (o *UfuturesGetIncomeV1RespItem) GetInfo() string {
...
func (o UfuturesGetIncomeV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetIncomeV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetIncomeV1RespItem struct {
	value *UfuturesGetIncomeV1RespItem
	isSet bool
}

func (v NullableUfuturesGetIncomeV1RespItem) Get() *UfuturesGetIncomeV1RespItem {
	return v.value
}

func (v *NullableUfuturesGetIncomeV1RespItem) Set(val *UfuturesGetIncomeV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetIncomeV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetIncomeV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetIncomeV1RespItem(val *UfuturesGetIncomeV1RespItem) *NullableUfuturesGetIncomeV1RespItem {
	return &NullableUfuturesGetIncomeV1RespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetIncomeV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetIncomeV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
