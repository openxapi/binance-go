...
// checks if the UmfuturesGetAccountV2RespAssetsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetAccountV2RespAssetsInner{}

// UmfuturesGetAccountV2RespAssetsInner struct for UmfuturesGetAccountV2RespAssetsInner
type UmfuturesGetAccountV2RespAssetsInner struct {
...
func NewUmfuturesGetAccountV2RespAssetsInner() *UmfuturesGetAccountV2RespAssetsInner {
	this := UmfuturesGetAccountV2RespAssetsInner{}
	return &this
}
...
func (o *UmfuturesGetAccountV2RespAssetsInner) SetCrossUnPnl(v string) {
	o.CrossUnPnl = &v
}
...
func (o *UmfuturesGetAccountV2RespAssetsInner) HasInitialMargin() bool {
	if o != nil && !IsNil(o.InitialMargin) {
		return true
	}
...
func (o *UmfuturesGetAccountV2RespAssetsInner) GetMarginBalance() string {
...
func (o *UmfuturesGetAccountV2RespAssetsInner) SetWalletBalance(v string) {
	o.WalletBalance = &v
}

func (o UmfuturesGetAccountV2RespAssetsInner) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetAccountV2RespAssetsInner) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetAccountV2RespAssetsInner struct {
	value *UmfuturesGetAccountV2RespAssetsInner
	isSet bool
}

func (v NullableUmfuturesGetAccountV2RespAssetsInner) Get() *UmfuturesGetAccountV2RespAssetsInner {
	return v.value
}

func (v *NullableUmfuturesGetAccountV2RespAssetsInner) Set(val *UmfuturesGetAccountV2RespAssetsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetAccountV2RespAssetsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetAccountV2RespAssetsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetAccountV2RespAssetsInner(val *UmfuturesGetAccountV2RespAssetsInner) *NullableUmfuturesGetAccountV2RespAssetsInner {
	return &NullableUmfuturesGetAccountV2RespAssetsInner{value: val, isSet: true}
}

func (v NullableUmfuturesGetAccountV2RespAssetsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetAccountV2RespAssetsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
