...
// checks if the UfuturesCreateBatchOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesCreateBatchOrdersV1RespItem{}

// UfuturesCreateBatchOrdersV1RespItem struct for UfuturesCreateBatchOrdersV1RespItem
type UfuturesCreateBatchOrdersV1RespItem struct {
...
func NewUfuturesCreateBatchOrdersV1RespItem() *UfuturesCreateBatchOrdersV1RespItem {
	this := UfuturesCreateBatchOrdersV1RespItem{}
	return &this
}
...
func (o UfuturesCreateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesCreateBatchOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesCreateBatchOrdersV1RespItem struct {
	value *UfuturesCreateBatchOrdersV1RespItem
	isSet bool
}

func (v NullableUfuturesCreateBatchOrdersV1RespItem) Get() *UfuturesCreateBatchOrdersV1RespItem {
	return v.value
}

func (v *NullableUfuturesCreateBatchOrdersV1RespItem) Set(val *UfuturesCreateBatchOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesCreateBatchOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesCreateBatchOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesCreateBatchOrdersV1RespItem(val *UfuturesCreateBatchOrdersV1RespItem) *NullableUfuturesCreateBatchOrdersV1RespItem {
	return &NullableUfuturesCreateBatchOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableUfuturesCreateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesCreateBatchOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
