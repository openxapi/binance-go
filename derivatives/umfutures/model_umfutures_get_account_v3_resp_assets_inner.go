...
// checks if the UmfuturesGetAccountV3RespAssetsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetAccountV3RespAssetsInner{}

// UmfuturesGetAccountV3RespAssetsInner struct for UmfuturesGetAccountV3RespAssetsInner
type UmfuturesGetAccountV3RespAssetsInner struct {
...
func NewUmfuturesGetAccountV3RespAssetsInner() *UmfuturesGetAccountV3RespAssetsInner {
	this := UmfuturesGetAccountV3RespAssetsInner{}
	return &this
}
...
func (o *UmfuturesGetAccountV3RespAssetsInner) SetCrossUnPnl(v string) {
	o.CrossUnPnl = &v
}
...
func (o *UmfuturesGetAccountV3RespAssetsInner) HasInitialMargin() bool {
	if o != nil && !IsNil(o.InitialMargin) {
		return true
	}
...
func (o *UmfuturesGetAccountV3RespAssetsInner) GetMaxWithdrawAmount() string {
...
func (o UmfuturesGetAccountV3RespAssetsInner) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetAccountV3RespAssetsInner) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetAccountV3RespAssetsInner struct {
	value *UmfuturesGetAccountV3RespAssetsInner
	isSet bool
}

func (v NullableUmfuturesGetAccountV3RespAssetsInner) Get() *UmfuturesGetAccountV3RespAssetsInner {
	return v.value
}

func (v *NullableUmfuturesGetAccountV3RespAssetsInner) Set(val *UmfuturesGetAccountV3RespAssetsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetAccountV3RespAssetsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetAccountV3RespAssetsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetAccountV3RespAssetsInner(val *UmfuturesGetAccountV3RespAssetsInner) *NullableUmfuturesGetAccountV3RespAssetsInner {
	return &NullableUmfuturesGetAccountV3RespAssetsInner{value: val, isSet: true}
}

func (v NullableUmfuturesGetAccountV3RespAssetsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetAccountV3RespAssetsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
