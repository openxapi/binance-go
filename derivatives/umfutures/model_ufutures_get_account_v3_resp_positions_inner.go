...
// checks if the UfuturesGetAccountV3RespPositionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetAccountV3RespPositionsInner{}

// UfuturesGetAccountV3RespPositionsInner struct for UfuturesGetAccountV3RespPositionsInner
type UfuturesGetAccountV3RespPositionsInner struct {
...
func NewUfuturesGetAccountV3RespPositionsInner() *UfuturesGetAccountV3RespPositionsInner {
	this := UfuturesGetAccountV3RespPositionsInner{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *UfuturesGetAccountV3RespPositionsInner) GetSymbolOk() (*string, bool) {
	if o == nil || IsNil(o.Symbol) {
		return nil, false
	}
...
func (o *UfuturesGetAccountV3RespPositionsInner) SetUpdateTime(v int64) {
	o.UpdateTime = &v
}

func (o UfuturesGetAccountV3RespPositionsInner) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetAccountV3RespPositionsInner) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetAccountV3RespPositionsInner struct {
	value *UfuturesGetAccountV3RespPositionsInner
	isSet bool
}

func (v NullableUfuturesGetAccountV3RespPositionsInner) Get() *UfuturesGetAccountV3RespPositionsInner {
	return v.value
}

func (v *NullableUfuturesGetAccountV3RespPositionsInner) Set(val *UfuturesGetAccountV3RespPositionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetAccountV3RespPositionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetAccountV3RespPositionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetAccountV3RespPositionsInner(val *UfuturesGetAccountV3RespPositionsInner) *NullableUfuturesGetAccountV3RespPositionsInner {
	return &NullableUfuturesGetAccountV3RespPositionsInner{value: val, isSet: true}
}

func (v NullableUfuturesGetAccountV3RespPositionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetAccountV3RespPositionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
