...
// checks if the UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem{}

// UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem struct for UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem
type UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem struct {
...
type _UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem
...
func NewUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem(price string, quantity string, side string, symbol string) *UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem {
	this := UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem{}
...
func (o UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem) ToMap() (map[string]interface{}, error) {
...
func (o *UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem) UnmarshalJSON(data []byte) (err error) {
	...
	varUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem := _UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem)

	if err != nil {
		return err
	}

	*o = UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem(varUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem)

	return err
}

type NullableUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem struct {
	value *UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem
	isSet bool
}

func (v NullableUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem) Get() *UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem {
	return v.value
}

func (v *NullableUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem) Set(val *UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem(val *UfuturesUpdateBatchOrdersV1ReqBatchOrdersItem) *NullableUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem {
	return &NullableUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem{value: val, isSet: true}
}

func (v NullableUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesUpdateBatchOrdersV1ReqBatchOrdersItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
