...
// checks if the UmfuturesGetPositionRiskV2RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetPositionRiskV2RespItem{}

// UmfuturesGetPositionRiskV2RespItem struct for UmfuturesGetPositionRiskV2RespItem
type UmfuturesGetPositionRiskV2RespItem struct {
...
func NewUmfuturesGetPositionRiskV2RespItem() *UmfuturesGetPositionRiskV2RespItem {
	this := UmfuturesGetPositionRiskV2RespItem{}
	return &this
}
...
func (o *UmfuturesGetPositionRiskV2RespItem) GetBreakEvenPriceOk() (*string, bool) {
	if o == nil || IsNil(o.BreakEvenPrice) {
		return nil, false
	}
...
func (o *UmfuturesGetPositionRiskV2RespItem) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o UmfuturesGetPositionRiskV2RespItem) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetPositionRiskV2RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetPositionRiskV2RespItem struct {
	value *UmfuturesGetPositionRiskV2RespItem
	isSet bool
}

func (v NullableUmfuturesGetPositionRiskV2RespItem) Get() *UmfuturesGetPositionRiskV2RespItem {
	return v.value
}

func (v *NullableUmfuturesGetPositionRiskV2RespItem) Set(val *UmfuturesGetPositionRiskV2RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetPositionRiskV2RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetPositionRiskV2RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetPositionRiskV2RespItem(val *UmfuturesGetPositionRiskV2RespItem) *NullableUmfuturesGetPositionRiskV2RespItem {
	return &NullableUmfuturesGetPositionRiskV2RespItem{value: val, isSet: true}
}

func (v NullableUmfuturesGetPositionRiskV2RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetPositionRiskV2RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
