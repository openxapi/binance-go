...
// checks if the UmfuturesGetUserTradesV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetUserTradesV1RespItem{}

// UmfuturesGetUserTradesV1RespItem struct for UmfuturesGetUserTradesV1RespItem
type UmfuturesGetUserTradesV1RespItem struct {
...
func NewUmfuturesGetUserTradesV1RespItem() *UmfuturesGetUserTradesV1RespItem {
	this := UmfuturesGetUserTradesV1RespItem{}
	return &this
}
...
func (o UmfuturesGetUserTradesV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetUserTradesV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetUserTradesV1RespItem struct {
	value *UmfuturesGetUserTradesV1RespItem
	isSet bool
}

func (v NullableUmfuturesGetUserTradesV1RespItem) Get() *UmfuturesGetUserTradesV1RespItem {
	return v.value
}

func (v *NullableUmfuturesGetUserTradesV1RespItem) Set(val *UmfuturesGetUserTradesV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetUserTradesV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetUserTradesV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetUserTradesV1RespItem(val *UmfuturesGetUserTradesV1RespItem) *NullableUmfuturesGetUserTradesV1RespItem {
	return &NullableUmfuturesGetUserTradesV1RespItem{value: val, isSet: true}
}

func (v NullableUmfuturesGetUserTradesV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetUserTradesV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
