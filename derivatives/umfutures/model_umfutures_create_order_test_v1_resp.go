...
// checks if the UmfuturesCreateOrderTestV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesCreateOrderTestV1Resp{}

// UmfuturesCreateOrderTestV1Resp struct for UmfuturesCreateOrderTestV1Resp
type UmfuturesCreateOrderTestV1Resp struct {
...
func NewUmfuturesCreateOrderTestV1Resp() *UmfuturesCreateOrderTestV1Resp {
	this := UmfuturesCreateOrderTestV1Resp{}
	return &this
}
...
func (o UmfuturesCreateOrderTestV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesCreateOrderTestV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesCreateOrderTestV1Resp struct {
	value *UmfuturesCreateOrderTestV1Resp
	isSet bool
}

func (v NullableUmfuturesCreateOrderTestV1Resp) Get() *UmfuturesCreateOrderTestV1Resp {
	return v.value
}

func (v *NullableUmfuturesCreateOrderTestV1Resp) Set(val *UmfuturesCreateOrderTestV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesCreateOrderTestV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesCreateOrderTestV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesCreateOrderTestV1Resp(val *UmfuturesCreateOrderTestV1Resp) *NullableUmfuturesCreateOrderTestV1Resp {
	return &NullableUmfuturesCreateOrderTestV1Resp{value: val, isSet: true}
}

func (v NullableUmfuturesCreateOrderTestV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesCreateOrderTestV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
