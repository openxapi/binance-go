...
// checks if the UfuturesGetSymbolConfigV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetSymbolConfigV1RespItem{}

// UfuturesGetSymbolConfigV1RespItem struct for UfuturesGetSymbolConfigV1RespItem
type UfuturesGetSymbolConfigV1RespItem struct {
...
func NewUfuturesGetSymbolConfigV1RespItem() *UfuturesGetSymbolConfigV1RespItem {
	this := UfuturesGetSymbolConfigV1RespItem{}
	return &this
}
...
func (o UfuturesGetSymbolConfigV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetSymbolConfigV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetSymbolConfigV1RespItem struct {
	value *UfuturesGetSymbolConfigV1RespItem
	isSet bool
}

func (v NullableUfuturesGetSymbolConfigV1RespItem) Get() *UfuturesGetSymbolConfigV1RespItem {
	return v.value
}

func (v *NullableUfuturesGetSymbolConfigV1RespItem) Set(val *UfuturesGetSymbolConfigV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetSymbolConfigV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetSymbolConfigV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetSymbolConfigV1RespItem(val *UfuturesGetSymbolConfigV1RespItem) *NullableUfuturesGetSymbolConfigV1RespItem {
	return &NullableUfuturesGetSymbolConfigV1RespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetSymbolConfigV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetSymbolConfigV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
