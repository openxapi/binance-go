...
// checks if the UmfuturesGetOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetOrderV1Resp{}

// UmfuturesGetOrderV1Resp struct for UmfuturesGetOrderV1Resp
type UmfuturesGetOrderV1Resp struct {
...
func (o UmfuturesGetOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetOrderV1Resp struct {
	value *UmfuturesGetOrderV1Resp
	isSet bool
}

func (v NullableUmfuturesGetOrderV1Resp) Get() *UmfuturesGetOrderV1Resp {
	return v.value
}

func (v *NullableUmfuturesGetOrderV1Resp) Set(val *UmfuturesGetOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetOrderV1Resp(val *UmfuturesGetOrderV1Resp) *NullableUmfuturesGetOrderV1Resp {
	return &NullableUmfuturesGetOrderV1Resp{value: val, isSet: true}
}

func (v NullableUmfuturesGetOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
