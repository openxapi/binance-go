...
// checks if the UfuturesGetIncomeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetIncomeAsynIdV1Resp{}

// UfuturesGetIncomeAsynIdV1Resp struct for UfuturesGetIncomeAsynIdV1Resp
type UfuturesGetIncomeAsynIdV1Resp struct {
...
func NewUfuturesGetIncomeAsynIdV1Resp() *UfuturesGetIncomeAsynIdV1Resp {
	this := UfuturesGetIncomeAsynIdV1Resp{}
	return &this
}
...
func (o UfuturesGetIncomeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetIncomeAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetIncomeAsynIdV1Resp struct {
	value *UfuturesGetIncomeAsynIdV1Resp
	isSet bool
}

func (v NullableUfuturesGetIncomeAsynIdV1Resp) Get() *UfuturesGetIncomeAsynIdV1Resp {
	return v.value
}

func (v *NullableUfuturesGetIncomeAsynIdV1Resp) Set(val *UfuturesGetIncomeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetIncomeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetIncomeAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetIncomeAsynIdV1Resp(val *UfuturesGetIncomeAsynIdV1Resp) *NullableUfuturesGetIncomeAsynIdV1Resp {
	return &NullableUfuturesGetIncomeAsynIdV1Resp{value: val, isSet: true}
}

func (v NullableUfuturesGetIncomeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetIncomeAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
