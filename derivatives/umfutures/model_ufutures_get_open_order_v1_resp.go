...
// checks if the UfuturesGetOpenOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetOpenOrderV1Resp{}

// UfuturesGetOpenOrderV1Resp struct for UfuturesGetOpenOrderV1Resp
type UfuturesGetOpenOrderV1Resp struct {
...
func NewUfuturesGetOpenOrderV1Resp() *UfuturesGetOpenOrderV1Resp {
	this := UfuturesGetOpenOrderV1Resp{}
	return &this
}
...
func (o UfuturesGetOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetOpenOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetOpenOrderV1Resp struct {
	value *UfuturesGetOpenOrderV1Resp
	isSet bool
}

func (v NullableUfuturesGetOpenOrderV1Resp) Get() *UfuturesGetOpenOrderV1Resp {
	return v.value
}

func (v *NullableUfuturesGetOpenOrderV1Resp) Set(val *UfuturesGetOpenOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetOpenOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetOpenOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetOpenOrderV1Resp(val *UfuturesGetOpenOrderV1Resp) *NullableUfuturesGetOpenOrderV1Resp {
	return &NullableUfuturesGetOpenOrderV1Resp{value: val, isSet: true}
}

func (v NullableUfuturesGetOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetOpenOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
