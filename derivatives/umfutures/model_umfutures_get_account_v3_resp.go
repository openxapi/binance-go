...
// checks if the UmfuturesGetAccountV3Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetAccountV3Resp{}

// UmfuturesGetAccountV3Resp struct for UmfuturesGetAccountV3Resp
type UmfuturesGetAccountV3Resp struct {
	Assets []UmfuturesGetAccountV3RespAssetsInner `json:"assets,omitempty"`
	AvailableBalance *string `json:"availableBalance,omitempty"`
	MaxWithdrawAmount *string `json:"maxWithdrawAmount,omitempty"`
	Positions []UmfuturesGetAccountV3RespPositionsInner `json:"positions,omitempty"`
...
func NewUmfuturesGetAccountV3Resp() *UmfuturesGetAccountV3Resp {
	this := UmfuturesGetAccountV3Resp{}
	return &this
}
...
func (o *UmfuturesGetAccountV3Resp) GetAssets() []UmfuturesGetAccountV3RespAssetsInner {
	if o == nil || IsNil(o.Assets) {
		var ret []UmfuturesGetAccountV3RespAssetsInner
		return ret
	}
	return o.Assets
}
...
// SetAssets gets a reference to the given []UmfuturesGetAccountV3RespAssetsInner and assigns it to the Assets field.
...
func (o *UmfuturesGetAccountV3Resp) GetPositions() []UmfuturesGetAccountV3RespPositionsInner {
	if o == nil || IsNil(o.Positions) {
		var ret []UmfuturesGetAccountV3RespPositionsInner
		return ret
	}
	return o.Positions
}
...
// SetPositions gets a reference to the given []UmfuturesGetAccountV3RespPositionsInner and assigns it to the Positions field.
...
func (o UmfuturesGetAccountV3Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetAccountV3Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetAccountV3Resp struct {
	value *UmfuturesGetAccountV3Resp
	isSet bool
}

func (v NullableUmfuturesGetAccountV3Resp) Get() *UmfuturesGetAccountV3Resp {
	return v.value
}

func (v *NullableUmfuturesGetAccountV3Resp) Set(val *UmfuturesGetAccountV3Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetAccountV3Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetAccountV3Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetAccountV3Resp(val *UmfuturesGetAccountV3Resp) *NullableUmfuturesGetAccountV3Resp {
	return &NullableUmfuturesGetAccountV3Resp{value: val, isSet: true}
}

func (v NullableUmfuturesGetAccountV3Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetAccountV3Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
