...
// checks if the UmfuturesGetLeverageBracketV1RespItemBracketsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetLeverageBracketV1RespItemBracketsInner{}

// UmfuturesGetLeverageBracketV1RespItemBracketsInner struct for UmfuturesGetLeverageBracketV1RespItemBracketsInner
type UmfuturesGetLeverageBracketV1RespItemBracketsInner struct {
...
func NewUmfuturesGetLeverageBracketV1RespItemBracketsInner() *UmfuturesGetLeverageBracketV1RespItemBracketsInner {
	this := UmfuturesGetLeverageBracketV1RespItemBracketsInner{}
	return &this
}
...
func (o *UmfuturesGetLeverageBracketV1RespItemBracketsInner) SetBracket(v int32) {
	o.Bracket = &v
}
...
func (o *UmfuturesGetLeverageBracketV1RespItemBracketsInner) HasInitialLeverage() bool {
	if o != nil && !IsNil(o.InitialLeverage) {
		return true
	}
...
func (o *UmfuturesGetLeverageBracketV1RespItemBracketsInner) GetNotionalFloor() int32 {
...
func (o UmfuturesGetLeverageBracketV1RespItemBracketsInner) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetLeverageBracketV1RespItemBracketsInner) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetLeverageBracketV1RespItemBracketsInner struct {
	value *UmfuturesGetLeverageBracketV1RespItemBracketsInner
	isSet bool
}

func (v NullableUmfuturesGetLeverageBracketV1RespItemBracketsInner) Get() *UmfuturesGetLeverageBracketV1RespItemBracketsInner {
	return v.value
}

func (v *NullableUmfuturesGetLeverageBracketV1RespItemBracketsInner) Set(val *UmfuturesGetLeverageBracketV1RespItemBracketsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetLeverageBracketV1RespItemBracketsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetLeverageBracketV1RespItemBracketsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetLeverageBracketV1RespItemBracketsInner(val *UmfuturesGetLeverageBracketV1RespItemBracketsInner) *NullableUmfuturesGetLeverageBracketV1RespItemBracketsInner {
	return &NullableUmfuturesGetLeverageBracketV1RespItemBracketsInner{value: val, isSet: true}
}

func (v NullableUmfuturesGetLeverageBracketV1RespItemBracketsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetLeverageBracketV1RespItemBracketsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
