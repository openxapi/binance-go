...
// checks if the UmfuturesGetOpenOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetOpenOrdersV1RespItem{}

// UmfuturesGetOpenOrdersV1RespItem struct for UmfuturesGetOpenOrdersV1RespItem
type UmfuturesGetOpenOrdersV1RespItem struct {
...
func NewUmfuturesGetOpenOrdersV1RespItem() *UmfuturesGetOpenOrdersV1RespItem {
	this := UmfuturesGetOpenOrdersV1RespItem{}
	return &this
}
...
func (o UmfuturesGetOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetOpenOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetOpenOrdersV1RespItem struct {
	value *UmfuturesGetOpenOrdersV1RespItem
	isSet bool
}

func (v NullableUmfuturesGetOpenOrdersV1RespItem) Get() *UmfuturesGetOpenOrdersV1RespItem {
	return v.value
}

func (v *NullableUmfuturesGetOpenOrdersV1RespItem) Set(val *UmfuturesGetOpenOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetOpenOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetOpenOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetOpenOrdersV1RespItem(val *UmfuturesGetOpenOrdersV1RespItem) *NullableUmfuturesGetOpenOrdersV1RespItem {
	return &NullableUmfuturesGetOpenOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableUmfuturesGetOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetOpenOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
