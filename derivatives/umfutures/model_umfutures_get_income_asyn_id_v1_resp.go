...
// checks if the UmfuturesGetIncomeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetIncomeAsynIdV1Resp{}

// UmfuturesGetIncomeAsynIdV1Resp struct for UmfuturesGetIncomeAsynIdV1Resp
type UmfuturesGetIncomeAsynIdV1Resp struct {
...
func NewUmfuturesGetIncomeAsynIdV1Resp() *UmfuturesGetIncomeAsynIdV1Resp {
	this := UmfuturesGetIncomeAsynIdV1Resp{}
	return &this
}
...
func (o UmfuturesGetIncomeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetIncomeAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetIncomeAsynIdV1Resp struct {
	value *UmfuturesGetIncomeAsynIdV1Resp
	isSet bool
}

func (v NullableUmfuturesGetIncomeAsynIdV1Resp) Get() *UmfuturesGetIncomeAsynIdV1Resp {
	return v.value
}

func (v *NullableUmfuturesGetIncomeAsynIdV1Resp) Set(val *UmfuturesGetIncomeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetIncomeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetIncomeAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetIncomeAsynIdV1Resp(val *UmfuturesGetIncomeAsynIdV1Resp) *NullableUmfuturesGetIncomeAsynIdV1Resp {
	return &NullableUmfuturesGetIncomeAsynIdV1Resp{value: val, isSet: true}
}

func (v NullableUmfuturesGetIncomeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetIncomeAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
