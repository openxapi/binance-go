...
// checks if the UmfuturesDeleteOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesDeleteOrderV1Resp{}

// UmfuturesDeleteOrderV1Resp struct for UmfuturesDeleteOrderV1Resp
type UmfuturesDeleteOrderV1Resp struct {
...
func NewUmfuturesDeleteOrderV1Resp() *UmfuturesDeleteOrderV1Resp {
	this := UmfuturesDeleteOrderV1Resp{}
	return &this
}
...
func (o UmfuturesDeleteOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesDeleteOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesDeleteOrderV1Resp struct {
	value *UmfuturesDeleteOrderV1Resp
	isSet bool
}

func (v NullableUmfuturesDeleteOrderV1Resp) Get() *UmfuturesDeleteOrderV1Resp {
	return v.value
}

func (v *NullableUmfuturesDeleteOrderV1Resp) Set(val *UmfuturesDeleteOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesDeleteOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesDeleteOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesDeleteOrderV1Resp(val *UmfuturesDeleteOrderV1Resp) *NullableUmfuturesDeleteOrderV1Resp {
	return &NullableUmfuturesDeleteOrderV1Resp{value: val, isSet: true}
}

func (v NullableUmfuturesDeleteOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesDeleteOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
