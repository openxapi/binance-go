...
// checks if the UfuturesGetConvertOrderStatusV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetConvertOrderStatusV1Resp{}

// UfuturesGetConvertOrderStatusV1Resp struct for UfuturesGetConvertOrderStatusV1Resp
type UfuturesGetConvertOrderStatusV1Resp struct {
...
func NewUfuturesGetConvertOrderStatusV1Resp() *UfuturesGetConvertOrderStatusV1Resp {
	this := UfuturesGetConvertOrderStatusV1Resp{}
	return &this
}
...
func (o *UfuturesGetConvertOrderStatusV1Resp) SetCreateTime(v int64) {
	o.CreateTime = &v
}
...
func (o UfuturesGetConvertOrderStatusV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetConvertOrderStatusV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetConvertOrderStatusV1Resp struct {
	value *UfuturesGetConvertOrderStatusV1Resp
	isSet bool
}

func (v NullableUfuturesGetConvertOrderStatusV1Resp) Get() *UfuturesGetConvertOrderStatusV1Resp {
	return v.value
}

func (v *NullableUfuturesGetConvertOrderStatusV1Resp) Set(val *UfuturesGetConvertOrderStatusV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetConvertOrderStatusV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetConvertOrderStatusV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetConvertOrderStatusV1Resp(val *UfuturesGetConvertOrderStatusV1Resp) *NullableUfuturesGetConvertOrderStatusV1Resp {
	return &NullableUfuturesGetConvertOrderStatusV1Resp{value: val, isSet: true}
}

func (v NullableUfuturesGetConvertOrderStatusV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetConvertOrderStatusV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
