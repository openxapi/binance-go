...
// checks if the UmfuturesCreateConvertGetQuoteV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesCreateConvertGetQuoteV1Resp{}

// UmfuturesCreateConvertGetQuoteV1Resp struct for UmfuturesCreateConvertGetQuoteV1Resp
type UmfuturesCreateConvertGetQuoteV1Resp struct {
...
func NewUmfuturesCreateConvertGetQuoteV1Resp() *UmfuturesCreateConvertGetQuoteV1Resp {
	this := UmfuturesCreateConvertGetQuoteV1Resp{}
	return &this
}
...
func (o UmfuturesCreateConvertGetQuoteV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesCreateConvertGetQuoteV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesCreateConvertGetQuoteV1Resp struct {
	value *UmfuturesCreateConvertGetQuoteV1Resp
	isSet bool
}

func (v NullableUmfuturesCreateConvertGetQuoteV1Resp) Get() *UmfuturesCreateConvertGetQuoteV1Resp {
	return v.value
}

func (v *NullableUmfuturesCreateConvertGetQuoteV1Resp) Set(val *UmfuturesCreateConvertGetQuoteV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesCreateConvertGetQuoteV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesCreateConvertGetQuoteV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesCreateConvertGetQuoteV1Resp(val *UmfuturesCreateConvertGetQuoteV1Resp) *NullableUmfuturesCreateConvertGetQuoteV1Resp {
	return &NullableUmfuturesCreateConvertGetQuoteV1Resp{value: val, isSet: true}
}

func (v NullableUmfuturesCreateConvertGetQuoteV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesCreateConvertGetQuoteV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
