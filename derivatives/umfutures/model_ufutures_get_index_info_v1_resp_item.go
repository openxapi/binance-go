...
// checks if the UfuturesGetIndexInfoV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetIndexInfoV1RespItem{}

// UfuturesGetIndexInfoV1RespItem struct for UfuturesGetIndexInfoV1RespItem
type UfuturesGetIndexInfoV1RespItem struct {
	BaseAssetList []UfuturesGetIndexInfoV1RespItemBaseAssetListInner `json:"baseAssetList,omitempty"`
...
func NewUfuturesGetIndexInfoV1RespItem() *UfuturesGetIndexInfoV1RespItem {
	this := UfuturesGetIndexInfoV1RespItem{}
	return &this
}
...
func (o *UfuturesGetIndexInfoV1RespItem) GetBaseAssetList() []UfuturesGetIndexInfoV1RespItemBaseAssetListInner {
	if o == nil || IsNil(o.BaseAssetList) {
		var ret []UfuturesGetIndexInfoV1RespItemBaseAssetListInner
		return ret
	}
...
// SetBaseAssetList gets a reference to the given []UfuturesGetIndexInfoV1RespItemBaseAssetListInner and assigns it to the BaseAssetList field.
...
func (o UfuturesGetIndexInfoV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetIndexInfoV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetIndexInfoV1RespItem struct {
	value *UfuturesGetIndexInfoV1RespItem
	isSet bool
}

func (v NullableUfuturesGetIndexInfoV1RespItem) Get() *UfuturesGetIndexInfoV1RespItem {
	return v.value
}

func (v *NullableUfuturesGetIndexInfoV1RespItem) Set(val *UfuturesGetIndexInfoV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetIndexInfoV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetIndexInfoV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetIndexInfoV1RespItem(val *UfuturesGetIndexInfoV1RespItem) *NullableUfuturesGetIndexInfoV1RespItem {
	return &NullableUfuturesGetIndexInfoV1RespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetIndexInfoV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetIndexInfoV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
