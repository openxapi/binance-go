...
// checks if the UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner{}

// UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner struct for UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner
type UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner struct {
...
func NewUfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner() *UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner {
	this := UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner{}
	return &this
}
...
func (o UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner struct {
	value *UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner
	isSet bool
}

func (v NullableUfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner) Get() *UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner {
	return v.value
}

func (v *NullableUfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner) Set(val *UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner(val *UfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner) *NullableUfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner {
	return &NullableUfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner{value: val, isSet: true}
}

func (v NullableUfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetExchangeInfoV1RespSymbolsInnerFiltersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
