...
// checks if the UmfuturesCreatePositionMarginV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesCreatePositionMarginV1Resp{}

// UmfuturesCreatePositionMarginV1Resp struct for UmfuturesCreatePositionMarginV1Resp
type UmfuturesCreatePositionMarginV1Resp struct {
...
func NewUmfuturesCreatePositionMarginV1Resp() *UmfuturesCreatePositionMarginV1Resp {
	this := UmfuturesCreatePositionMarginV1Resp{}
	return &this
}
...
func (o UmfuturesCreatePositionMarginV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesCreatePositionMarginV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesCreatePositionMarginV1Resp struct {
	value *UmfuturesCreatePositionMarginV1Resp
	isSet bool
}

func (v NullableUmfuturesCreatePositionMarginV1Resp) Get() *UmfuturesCreatePositionMarginV1Resp {
	return v.value
}

func (v *NullableUmfuturesCreatePositionMarginV1Resp) Set(val *UmfuturesCreatePositionMarginV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesCreatePositionMarginV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesCreatePositionMarginV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesCreatePositionMarginV1Resp(val *UmfuturesCreatePositionMarginV1Resp) *NullableUmfuturesCreatePositionMarginV1Resp {
	return &NullableUmfuturesCreatePositionMarginV1Resp{value: val, isSet: true}
}

func (v NullableUmfuturesCreatePositionMarginV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesCreatePositionMarginV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
