...
// checks if the UmfuturesGetAccountV3RespPositionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetAccountV3RespPositionsInner{}

// UmfuturesGetAccountV3RespPositionsInner struct for UmfuturesGetAccountV3RespPositionsInner
type UmfuturesGetAccountV3RespPositionsInner struct {
...
func NewUmfuturesGetAccountV3RespPositionsInner() *UmfuturesGetAccountV3RespPositionsInner {
	this := UmfuturesGetAccountV3RespPositionsInner{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *UmfuturesGetAccountV3RespPositionsInner) GetSymbolOk() (*string, bool) {
	if o == nil || IsNil(o.Symbol) {
		return nil, false
	}
...
func (o *UmfuturesGetAccountV3RespPositionsInner) SetUpdateTime(v int64) {
	o.UpdateTime = &v
}

func (o UmfuturesGetAccountV3RespPositionsInner) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetAccountV3RespPositionsInner) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetAccountV3RespPositionsInner struct {
	value *UmfuturesGetAccountV3RespPositionsInner
	isSet bool
}

func (v NullableUmfuturesGetAccountV3RespPositionsInner) Get() *UmfuturesGetAccountV3RespPositionsInner {
	return v.value
}

func (v *NullableUmfuturesGetAccountV3RespPositionsInner) Set(val *UmfuturesGetAccountV3RespPositionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetAccountV3RespPositionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetAccountV3RespPositionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetAccountV3RespPositionsInner(val *UmfuturesGetAccountV3RespPositionsInner) *NullableUmfuturesGetAccountV3RespPositionsInner {
	return &NullableUmfuturesGetAccountV3RespPositionsInner{value: val, isSet: true}
}

func (v NullableUmfuturesGetAccountV3RespPositionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetAccountV3RespPositionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
