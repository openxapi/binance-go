...
// checks if the UmfuturesGetTradeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetTradeAsynIdV1Resp{}

// UmfuturesGetTradeAsynIdV1Resp struct for UmfuturesGetTradeAsynIdV1Resp
type UmfuturesGetTradeAsynIdV1Resp struct {
...
func NewUmfuturesGetTradeAsynIdV1Resp() *UmfuturesGetTradeAsynIdV1Resp {
	this := UmfuturesGetTradeAsynIdV1Resp{}
	return &this
}
...
func (o UmfuturesGetTradeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetTradeAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetTradeAsynIdV1Resp struct {
	value *UmfuturesGetTradeAsynIdV1Resp
	isSet bool
}

func (v NullableUmfuturesGetTradeAsynIdV1Resp) Get() *UmfuturesGetTradeAsynIdV1Resp {
	return v.value
}

func (v *NullableUmfuturesGetTradeAsynIdV1Resp) Set(val *UmfuturesGetTradeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetTradeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetTradeAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetTradeAsynIdV1Resp(val *UmfuturesGetTradeAsynIdV1Resp) *NullableUmfuturesGetTradeAsynIdV1Resp {
	return &NullableUmfuturesGetTradeAsynIdV1Resp{value: val, isSet: true}
}

func (v NullableUmfuturesGetTradeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetTradeAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
