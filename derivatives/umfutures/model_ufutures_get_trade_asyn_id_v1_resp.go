...
// checks if the UfuturesGetTradeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetTradeAsynIdV1Resp{}

// UfuturesGetTradeAsynIdV1Resp struct for UfuturesGetTradeAsynIdV1Resp
type UfuturesGetTradeAsynIdV1Resp struct {
...
func NewUfuturesGetTradeAsynIdV1Resp() *UfuturesGetTradeAsynIdV1Resp {
	this := UfuturesGetTradeAsynIdV1Resp{}
	return &this
}
...
func (o UfuturesGetTradeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetTradeAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetTradeAsynIdV1Resp struct {
	value *UfuturesGetTradeAsynIdV1Resp
	isSet bool
}

func (v NullableUfuturesGetTradeAsynIdV1Resp) Get() *UfuturesGetTradeAsynIdV1Resp {
	return v.value
}

func (v *NullableUfuturesGetTradeAsynIdV1Resp) Set(val *UfuturesGetTradeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetTradeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetTradeAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetTradeAsynIdV1Resp(val *UfuturesGetTradeAsynIdV1Resp) *NullableUfuturesGetTradeAsynIdV1Resp {
	return &NullableUfuturesGetTradeAsynIdV1Resp{value: val, isSet: true}
}

func (v NullableUfuturesGetTradeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetTradeAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
