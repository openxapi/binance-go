...
// checks if the UmfuturesUpdateOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesUpdateOrderV1Resp{}

// UmfuturesUpdateOrderV1Resp struct for UmfuturesUpdateOrderV1Resp
type UmfuturesUpdateOrderV1Resp struct {
...
func NewUmfuturesUpdateOrderV1Resp() *UmfuturesUpdateOrderV1Resp {
	this := UmfuturesUpdateOrderV1Resp{}
	return &this
}
...
func (o UmfuturesUpdateOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesUpdateOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesUpdateOrderV1Resp struct {
	value *UmfuturesUpdateOrderV1Resp
	isSet bool
}

func (v NullableUmfuturesUpdateOrderV1Resp) Get() *UmfuturesUpdateOrderV1Resp {
	return v.value
}

func (v *NullableUmfuturesUpdateOrderV1Resp) Set(val *UmfuturesUpdateOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesUpdateOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesUpdateOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesUpdateOrderV1Resp(val *UmfuturesUpdateOrderV1Resp) *NullableUmfuturesUpdateOrderV1Resp {
	return &NullableUmfuturesUpdateOrderV1Resp{value: val, isSet: true}
}

func (v NullableUmfuturesUpdateOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesUpdateOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
