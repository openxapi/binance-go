...
// checks if the UmfuturesGetHistoricalTradesV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetHistoricalTradesV1RespItem{}

// UmfuturesGetHistoricalTradesV1RespItem struct for UmfuturesGetHistoricalTradesV1RespItem
type UmfuturesGetHistoricalTradesV1RespItem struct {
...
func NewUmfuturesGetHistoricalTradesV1RespItem() *UmfuturesGetHistoricalTradesV1RespItem {
	this := UmfuturesGetHistoricalTradesV1RespItem{}
	return &this
}
...
func (o UmfuturesGetHistoricalTradesV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetHistoricalTradesV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetHistoricalTradesV1RespItem struct {
	value *UmfuturesGetHistoricalTradesV1RespItem
	isSet bool
}

func (v NullableUmfuturesGetHistoricalTradesV1RespItem) Get() *UmfuturesGetHistoricalTradesV1RespItem {
	return v.value
}

func (v *NullableUmfuturesGetHistoricalTradesV1RespItem) Set(val *UmfuturesGetHistoricalTradesV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetHistoricalTradesV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetHistoricalTradesV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetHistoricalTradesV1RespItem(val *UmfuturesGetHistoricalTradesV1RespItem) *NullableUmfuturesGetHistoricalTradesV1RespItem {
	return &NullableUmfuturesGetHistoricalTradesV1RespItem{value: val, isSet: true}
}

func (v NullableUmfuturesGetHistoricalTradesV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetHistoricalTradesV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
