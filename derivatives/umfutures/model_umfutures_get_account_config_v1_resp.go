...
// checks if the UmfuturesGetAccountConfigV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetAccountConfigV1Resp{}

// UmfuturesGetAccountConfigV1Resp struct for UmfuturesGetAccountConfigV1Resp
type UmfuturesGetAccountConfigV1Resp struct {
...
func NewUmfuturesGetAccountConfigV1Resp() *UmfuturesGetAccountConfigV1Resp {
	this := UmfuturesGetAccountConfigV1Resp{}
	return &this
}
...
func (o UmfuturesGetAccountConfigV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetAccountConfigV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetAccountConfigV1Resp struct {
	value *UmfuturesGetAccountConfigV1Resp
	isSet bool
}

func (v NullableUmfuturesGetAccountConfigV1Resp) Get() *UmfuturesGetAccountConfigV1Resp {
	return v.value
}

func (v *NullableUmfuturesGetAccountConfigV1Resp) Set(val *UmfuturesGetAccountConfigV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetAccountConfigV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetAccountConfigV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetAccountConfigV1Resp(val *UmfuturesGetAccountConfigV1Resp) *NullableUmfuturesGetAccountConfigV1Resp {
	return &NullableUmfuturesGetAccountConfigV1Resp{value: val, isSet: true}
}

func (v NullableUmfuturesGetAccountConfigV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetAccountConfigV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
