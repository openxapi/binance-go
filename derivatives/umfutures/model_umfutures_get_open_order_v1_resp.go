...
// checks if the UmfuturesGetOpenOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetOpenOrderV1Resp{}

// UmfuturesGetOpenOrderV1Resp struct for UmfuturesGetOpenOrderV1Resp
type UmfuturesGetOpenOrderV1Resp struct {
...
func NewUmfuturesGetOpenOrderV1Resp() *UmfuturesGetOpenOrderV1Resp {
	this := UmfuturesGetOpenOrderV1Resp{}
	return &this
}
...
func (o UmfuturesGetOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetOpenOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetOpenOrderV1Resp struct {
	value *UmfuturesGetOpenOrderV1Resp
	isSet bool
}

func (v NullableUmfuturesGetOpenOrderV1Resp) Get() *UmfuturesGetOpenOrderV1Resp {
	return v.value
}

func (v *NullableUmfuturesGetOpenOrderV1Resp) Set(val *UmfuturesGetOpenOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetOpenOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetOpenOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetOpenOrderV1Resp(val *UmfuturesGetOpenOrderV1Resp) *NullableUmfuturesGetOpenOrderV1Resp {
	return &NullableUmfuturesGetOpenOrderV1Resp{value: val, isSet: true}
}

func (v NullableUmfuturesGetOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetOpenOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
