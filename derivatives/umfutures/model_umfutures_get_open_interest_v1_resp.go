...
// checks if the UmfuturesGetOpenInterestV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetOpenInterestV1Resp{}

// UmfuturesGetOpenInterestV1Resp struct for UmfuturesGetOpenInterestV1Resp
type UmfuturesGetOpenInterestV1Resp struct {
...
func NewUmfuturesGetOpenInterestV1Resp() *UmfuturesGetOpenInterestV1Resp {
	this := UmfuturesGetOpenInterestV1Resp{}
	return &this
}
...
func (o UmfuturesGetOpenInterestV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetOpenInterestV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetOpenInterestV1Resp struct {
	value *UmfuturesGetOpenInterestV1Resp
	isSet bool
}

func (v NullableUmfuturesGetOpenInterestV1Resp) Get() *UmfuturesGetOpenInterestV1Resp {
	return v.value
}

func (v *NullableUmfuturesGetOpenInterestV1Resp) Set(val *UmfuturesGetOpenInterestV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetOpenInterestV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetOpenInterestV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetOpenInterestV1Resp(val *UmfuturesGetOpenInterestV1Resp) *NullableUmfuturesGetOpenInterestV1Resp {
	return &NullableUmfuturesGetOpenInterestV1Resp{value: val, isSet: true}
}

func (v NullableUmfuturesGetOpenInterestV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetOpenInterestV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
