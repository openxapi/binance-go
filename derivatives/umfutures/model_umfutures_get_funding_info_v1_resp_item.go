...
// checks if the UmfuturesGetFundingInfoV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetFundingInfoV1RespItem{}

// UmfuturesGetFundingInfoV1RespItem struct for UmfuturesGetFundingInfoV1RespItem
type UmfuturesGetFundingInfoV1RespItem struct {
...
func NewUmfuturesGetFundingInfoV1RespItem() *UmfuturesGetFundingInfoV1RespItem {
	this := UmfuturesGetFundingInfoV1RespItem{}
	return &this
}
...
func (o UmfuturesGetFundingInfoV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetFundingInfoV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetFundingInfoV1RespItem struct {
	value *UmfuturesGetFundingInfoV1RespItem
	isSet bool
}

func (v NullableUmfuturesGetFundingInfoV1RespItem) Get() *UmfuturesGetFundingInfoV1RespItem {
	return v.value
}

func (v *NullableUmfuturesGetFundingInfoV1RespItem) Set(val *UmfuturesGetFundingInfoV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetFundingInfoV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetFundingInfoV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetFundingInfoV1RespItem(val *UmfuturesGetFundingInfoV1RespItem) *NullableUmfuturesGetFundingInfoV1RespItem {
	return &NullableUmfuturesGetFundingInfoV1RespItem{value: val, isSet: true}
}

func (v NullableUmfuturesGetFundingInfoV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetFundingInfoV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
