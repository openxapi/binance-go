...
// checks if the UfuturesGetOrderAmendmentV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetOrderAmendmentV1RespItem{}

// UfuturesGetOrderAmendmentV1RespItem struct for UfuturesGetOrderAmendmentV1RespItem
type UfuturesGetOrderAmendmentV1RespItem struct {
	Amendment *UfuturesGetOrderAmendmentV1RespItemAmendment `json:"amendment,omitempty"`
...
func NewUfuturesGetOrderAmendmentV1RespItem() *UfuturesGetOrderAmendmentV1RespItem {
	this := UfuturesGetOrderAmendmentV1RespItem{}
	return &this
}
...
func (o *UfuturesGetOrderAmendmentV1RespItem) GetAmendment() UfuturesGetOrderAmendmentV1RespItemAmendment {
	if o == nil || IsNil(o.Amendment) {
		var ret UfuturesGetOrderAmendmentV1RespItemAmendment
		return ret
	}
	return *o.Amendment
}
...
// SetAmendment gets a reference to the given UfuturesGetOrderAmendmentV1RespItemAmendment and assigns it to the Amendment field.
...
func (o UfuturesGetOrderAmendmentV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetOrderAmendmentV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetOrderAmendmentV1RespItem struct {
	value *UfuturesGetOrderAmendmentV1RespItem
	isSet bool
}

func (v NullableUfuturesGetOrderAmendmentV1RespItem) Get() *UfuturesGetOrderAmendmentV1RespItem {
	return v.value
}

func (v *NullableUfuturesGetOrderAmendmentV1RespItem) Set(val *UfuturesGetOrderAmendmentV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetOrderAmendmentV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetOrderAmendmentV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetOrderAmendmentV1RespItem(val *UfuturesGetOrderAmendmentV1RespItem) *NullableUfuturesGetOrderAmendmentV1RespItem {
	return &NullableUfuturesGetOrderAmendmentV1RespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetOrderAmendmentV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetOrderAmendmentV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
