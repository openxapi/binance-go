...
// checks if the UfuturesGetPositionRiskV2RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetPositionRiskV2RespItem{}

// UfuturesGetPositionRiskV2RespItem struct for UfuturesGetPositionRiskV2RespItem
type UfuturesGetPositionRiskV2RespItem struct {
...
func NewUfuturesGetPositionRiskV2RespItem() *UfuturesGetPositionRiskV2RespItem {
	this := UfuturesGetPositionRiskV2RespItem{}
	return &this
}
...
func (o *UfuturesGetPositionRiskV2RespItem) GetBreakEvenPriceOk() (*string, bool) {
	if o == nil || IsNil(o.BreakEvenPrice) {
		return nil, false
	}
...
func (o *UfuturesGetPositionRiskV2RespItem) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o UfuturesGetPositionRiskV2RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetPositionRiskV2RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetPositionRiskV2RespItem struct {
	value *UfuturesGetPositionRiskV2RespItem
	isSet bool
}

func (v NullableUfuturesGetPositionRiskV2RespItem) Get() *UfuturesGetPositionRiskV2RespItem {
	return v.value
}

func (v *NullableUfuturesGetPositionRiskV2RespItem) Set(val *UfuturesGetPositionRiskV2RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetPositionRiskV2RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetPositionRiskV2RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetPositionRiskV2RespItem(val *UfuturesGetPositionRiskV2RespItem) *NullableUfuturesGetPositionRiskV2RespItem {
	return &NullableUfuturesGetPositionRiskV2RespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetPositionRiskV2RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetPositionRiskV2RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
