...
// checks if the UmfuturesGetPositionRiskV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetPositionRiskV3RespItem{}

// UmfuturesGetPositionRiskV3RespItem struct for UmfuturesGetPositionRiskV3RespItem
type UmfuturesGetPositionRiskV3RespItem struct {
...
func NewUmfuturesGetPositionRiskV3RespItem() *UmfuturesGetPositionRiskV3RespItem {
	this := UmfuturesGetPositionRiskV3RespItem{}
	return &this
}
...
func (o *UmfuturesGetPositionRiskV3RespItem) GetMaintMargin() string {
...
func (o *UmfuturesGetPositionRiskV3RespItem) SetOpenOrderInitialMargin(v string) {
...
func (o *UmfuturesGetPositionRiskV3RespItem) HasPositionInitialMargin() bool {
	if o != nil && !IsNil(o.PositionInitialMargin) {
		return true
	}
...
func (o UmfuturesGetPositionRiskV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetPositionRiskV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetPositionRiskV3RespItem struct {
	value *UmfuturesGetPositionRiskV3RespItem
	isSet bool
}

func (v NullableUmfuturesGetPositionRiskV3RespItem) Get() *UmfuturesGetPositionRiskV3RespItem {
	return v.value
}

func (v *NullableUmfuturesGetPositionRiskV3RespItem) Set(val *UmfuturesGetPositionRiskV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetPositionRiskV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetPositionRiskV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetPositionRiskV3RespItem(val *UmfuturesGetPositionRiskV3RespItem) *NullableUmfuturesGetPositionRiskV3RespItem {
	return &NullableUmfuturesGetPositionRiskV3RespItem{value: val, isSet: true}
}

func (v NullableUmfuturesGetPositionRiskV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetPositionRiskV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
