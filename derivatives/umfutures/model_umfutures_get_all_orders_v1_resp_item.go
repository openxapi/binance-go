...
// checks if the UmfuturesGetAllOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesGetAllOrdersV1RespItem{}

// UmfuturesGetAllOrdersV1RespItem struct for UmfuturesGetAllOrdersV1RespItem
type UmfuturesGetAllOrdersV1RespItem struct {
...
func NewUmfuturesGetAllOrdersV1RespItem() *UmfuturesGetAllOrdersV1RespItem {
	this := UmfuturesGetAllOrdersV1RespItem{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *UmfuturesGetAllOrdersV1RespItem) GetPriceOk() (*string, bool) {
	if o == nil || IsNil(o.Price) {
		return nil, false
	}
	return o.Price, true
...
func (o *UmfuturesGetAllOrdersV1RespItem) SetPriceProtect(v bool) {
	o.PriceProtect = &v
}
...
func (o *UmfuturesGetAllOrdersV1RespItem) GetStatus() string {
...
func (o UmfuturesGetAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesGetAllOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesGetAllOrdersV1RespItem struct {
	value *UmfuturesGetAllOrdersV1RespItem
	isSet bool
}

func (v NullableUmfuturesGetAllOrdersV1RespItem) Get() *UmfuturesGetAllOrdersV1RespItem {
	return v.value
}

func (v *NullableUmfuturesGetAllOrdersV1RespItem) Set(val *UmfuturesGetAllOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesGetAllOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesGetAllOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesGetAllOrdersV1RespItem(val *UmfuturesGetAllOrdersV1RespItem) *NullableUmfuturesGetAllOrdersV1RespItem {
	return &NullableUmfuturesGetAllOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableUmfuturesGetAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesGetAllOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
