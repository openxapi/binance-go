...
// checks if the PmarginproCreatePortfolioMintV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginproCreatePortfolioMintV1Resp{}

// PmarginproCreatePortfolioMintV1Resp struct for PmarginproCreatePortfolioMintV1Resp
type PmarginproCreatePortfolioMintV1Resp struct {
...
func NewPmarginproCreatePortfolioMintV1Resp() *PmarginproCreatePortfolioMintV1Resp {
	this := PmarginproCreatePortfolioMintV1Resp{}
	return &this
}
...
func (o PmarginproCreatePortfolioMintV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginproCreatePortfolioMintV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginproCreatePortfolioMintV1Resp struct {
	value *PmarginproCreatePortfolioMintV1Resp
	isSet bool
}

func (v NullablePmarginproCreatePortfolioMintV1Resp) Get() *PmarginproCreatePortfolioMintV1Resp {
	return v.value
}

func (v *NullablePmarginproCreatePortfolioMintV1Resp) Set(val *PmarginproCreatePortfolioMintV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginproCreatePortfolioMintV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginproCreatePortfolioMintV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginproCreatePortfolioMintV1Resp(val *PmarginproCreatePortfolioMintV1Resp) *NullablePmarginproCreatePortfolioMintV1Resp {
	return &NullablePmarginproCreatePortfolioMintV1Resp{value: val, isSet: true}
}

func (v NullablePmarginproCreatePortfolioMintV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginproCreatePortfolioMintV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
