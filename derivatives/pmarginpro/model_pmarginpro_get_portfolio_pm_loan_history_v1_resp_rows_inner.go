...
// checks if the PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner{}

// PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner struct for PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner
type PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner struct {
...
func NewPmarginproGetPortfolioPmLoanHistoryV1RespRowsInner() *PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner {
	this := PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner{}
	return &this
}
...
func (o PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner) MarshalJSON() ([]byte, error) {
...
func (o PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginproGetPortfolioPmLoanHistoryV1RespRowsInner struct {
	value *PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner
	isSet bool
}

func (v NullablePmarginproGetPortfolioPmLoanHistoryV1RespRowsInner) Get() *PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner {
	return v.value
}

func (v *NullablePmarginproGetPortfolioPmLoanHistoryV1RespRowsInner) Set(val *PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginproGetPortfolioPmLoanHistoryV1RespRowsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginproGetPortfolioPmLoanHistoryV1RespRowsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginproGetPortfolioPmLoanHistoryV1RespRowsInner(val *PmarginproGetPortfolioPmLoanHistoryV1RespRowsInner) *NullablePmarginproGetPortfolioPmLoanHistoryV1RespRowsInner {
	return &NullablePmarginproGetPortfolioPmLoanHistoryV1RespRowsInner{value: val, isSet: true}
}

func (v NullablePmarginproGetPortfolioPmLoanHistoryV1RespRowsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginproGetPortfolioPmLoanHistoryV1RespRowsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
