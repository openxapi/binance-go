...
// checks if the PmarginproGetPortfolioAccountV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginproGetPortfolioAccountV1Resp{}

// PmarginproGetPortfolioAccountV1Resp struct for PmarginproGetPortfolioAccountV1Resp
type PmarginproGetPortfolioAccountV1Resp struct {
...
func NewPmarginproGetPortfolioAccountV1Resp() *PmarginproGetPortfolioAccountV1Resp {
	this := PmarginproGetPortfolioAccountV1Resp{}
	return &this
}
...
func (o *PmarginproGetPortfolioAccountV1Resp) SetAccountEquity(v string) {
	o.AccountEquity = &v
}
...
func (o *PmarginproGetPortfolioAccountV1Resp) HasAccountMaintMargin() bool {
	if o != nil && !IsNil(o.AccountMaintMargin) {
		return true
	}
...
func (o *PmarginproGetPortfolioAccountV1Resp) GetActualEquity() string {
...
// and a boolean to check if the value has been set.
func (o *PmarginproGetPortfolioAccountV1Resp) GetUniMMROk() (*string, bool) {
	if o == nil || IsNil(o.UniMMR) {
		return nil, false
	}
...
func (o PmarginproGetPortfolioAccountV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginproGetPortfolioAccountV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginproGetPortfolioAccountV1Resp struct {
	value *PmarginproGetPortfolioAccountV1Resp
	isSet bool
}

func (v NullablePmarginproGetPortfolioAccountV1Resp) Get() *PmarginproGetPortfolioAccountV1Resp {
	return v.value
}

func (v *NullablePmarginproGetPortfolioAccountV1Resp) Set(val *PmarginproGetPortfolioAccountV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginproGetPortfolioAccountV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginproGetPortfolioAccountV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginproGetPortfolioAccountV1Resp(val *PmarginproGetPortfolioAccountV1Resp) *NullablePmarginproGetPortfolioAccountV1Resp {
	return &NullablePmarginproGetPortfolioAccountV1Resp{value: val, isSet: true}
}

func (v NullablePmarginproGetPortfolioAccountV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginproGetPortfolioAccountV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
