...
// checks if the PmarginUpdateUmOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginUpdateUmOrderV1Resp{}

// PmarginUpdateUmOrderV1Resp struct for PmarginUpdateUmOrderV1Resp
type PmarginUpdateUmOrderV1Resp struct {
...
func NewPmarginUpdateUmOrderV1Resp() *PmarginUpdateUmOrderV1Resp {
	this := PmarginUpdateUmOrderV1Resp{}
	return &this
}
...
func (o *PmarginUpdateUmOrderV1Resp) HasExecutedQty() bool {
	if o != nil && !IsNil(o.ExecutedQty) {
		return true
	}
...
func (o *PmarginUpdateUmOrderV1Resp) HasPriceMatch() bool {
	if o != nil && !IsNil(o.PriceMatch) {
		return true
	}
...
func (o *PmarginUpdateUmOrderV1Resp) GetSide() string {
...
func (o PmarginUpdateUmOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginUpdateUmOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginUpdateUmOrderV1Resp struct {
	value *PmarginUpdateUmOrderV1Resp
	isSet bool
}

func (v NullablePmarginUpdateUmOrderV1Resp) Get() *PmarginUpdateUmOrderV1Resp {
	return v.value
}

func (v *NullablePmarginUpdateUmOrderV1Resp) Set(val *PmarginUpdateUmOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginUpdateUmOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginUpdateUmOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginUpdateUmOrderV1Resp(val *PmarginUpdateUmOrderV1Resp) *NullablePmarginUpdateUmOrderV1Resp {
	return &NullablePmarginUpdateUmOrderV1Resp{value: val, isSet: true}
}

func (v NullablePmarginUpdateUmOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginUpdateUmOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
