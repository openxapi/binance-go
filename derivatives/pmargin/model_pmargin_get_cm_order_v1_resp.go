...
// checks if the PmarginGetCmOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetCmOrderV1Resp{}

// PmarginGetCmOrderV1Resp struct for PmarginGetCmOrderV1Resp
type PmarginGetCmOrderV1Resp struct {
...
func (o PmarginGetCmOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetCmOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetCmOrderV1Resp struct {
	value *PmarginGetCmOrderV1Resp
	isSet bool
}

func (v NullablePmarginGetCmOrderV1Resp) Get() *PmarginGetCmOrderV1Resp {
	return v.value
}

func (v *NullablePmarginGetCmOrderV1Resp) Set(val *PmarginGetCmOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetCmOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetCmOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetCmOrderV1Resp(val *PmarginGetCmOrderV1Resp) *NullablePmarginGetCmOrderV1Resp {
	return &NullablePmarginGetCmOrderV1Resp{value: val, isSet: true}
}

func (v NullablePmarginGetCmOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetCmOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
