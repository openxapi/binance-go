...
// checks if the PmarginDeleteUmConditionalOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginDeleteUmConditionalOrderV1Resp{}

// PmarginDeleteUmConditionalOrderV1Resp struct for PmarginDeleteUmConditionalOrderV1Resp
type PmarginDeleteUmConditionalOrderV1Resp struct {
...
func NewPmarginDeleteUmConditionalOrderV1Resp() *PmarginDeleteUmConditionalOrderV1Resp {
	this := PmarginDeleteUmConditionalOrderV1Resp{}
	return &this
}
...
func (o *PmarginDeleteUmConditionalOrderV1Resp) HasPrice() bool {
	if o != nil && !IsNil(o.Price) {
		return true
	}
...
func (o *PmarginDeleteUmConditionalOrderV1Resp) SetStopPrice(v string) {
	o.StopPrice = &v
}
...
func (o *PmarginDeleteUmConditionalOrderV1Resp) HasStrategyStatus() bool {
	if o != nil && !IsNil(o.StrategyStatus) {
		return true
	}
...
func (o PmarginDeleteUmConditionalOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginDeleteUmConditionalOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginDeleteUmConditionalOrderV1Resp struct {
	value *PmarginDeleteUmConditionalOrderV1Resp
	isSet bool
}

func (v NullablePmarginDeleteUmConditionalOrderV1Resp) Get() *PmarginDeleteUmConditionalOrderV1Resp {
	return v.value
}

func (v *NullablePmarginDeleteUmConditionalOrderV1Resp) Set(val *PmarginDeleteUmConditionalOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginDeleteUmConditionalOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginDeleteUmConditionalOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginDeleteUmConditionalOrderV1Resp(val *PmarginDeleteUmConditionalOrderV1Resp) *NullablePmarginDeleteUmConditionalOrderV1Resp {
	return &NullablePmarginDeleteUmConditionalOrderV1Resp{value: val, isSet: true}
}

func (v NullablePmarginDeleteUmConditionalOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginDeleteUmConditionalOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
