...
// checks if the PmarginGetCmConditionalAllOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetCmConditionalAllOrdersV1RespItem{}

// PmarginGetCmConditionalAllOrdersV1RespItem struct for PmarginGetCmConditionalAllOrdersV1RespItem
type PmarginGetCmConditionalAllOrdersV1RespItem struct {
...
func NewPmarginGetCmConditionalAllOrdersV1RespItem() *PmarginGetCmConditionalAllOrdersV1RespItem {
	this := PmarginGetCmConditionalAllOrdersV1RespItem{}
	return &this
}
...
func (o *PmarginGetCmConditionalAllOrdersV1RespItem) HasPrice() bool {
	if o != nil && !IsNil(o.Price) {
		return true
	}
...
func (o *PmarginGetCmConditionalAllOrdersV1RespItem) GetTimeInForce() string {
...
func (o PmarginGetCmConditionalAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetCmConditionalAllOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetCmConditionalAllOrdersV1RespItem struct {
	value *PmarginGetCmConditionalAllOrdersV1RespItem
	isSet bool
}

func (v NullablePmarginGetCmConditionalAllOrdersV1RespItem) Get() *PmarginGetCmConditionalAllOrdersV1RespItem {
	return v.value
}

func (v *NullablePmarginGetCmConditionalAllOrdersV1RespItem) Set(val *PmarginGetCmConditionalAllOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetCmConditionalAllOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetCmConditionalAllOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetCmConditionalAllOrdersV1RespItem(val *PmarginGetCmConditionalAllOrdersV1RespItem) *NullablePmarginGetCmConditionalAllOrdersV1RespItem {
	return &NullablePmarginGetCmConditionalAllOrdersV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetCmConditionalAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetCmConditionalAllOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
