...
// checks if the PmarginGetMarginAllOrderListV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetMarginAllOrderListV1RespItem{}

// PmarginGetMarginAllOrderListV1RespItem struct for PmarginGetMarginAllOrderListV1RespItem
type PmarginGetMarginAllOrderListV1RespItem struct {
...
func NewPmarginGetMarginAllOrderListV1RespItem() *PmarginGetMarginAllOrderListV1RespItem {
	this := PmarginGetMarginAllOrderListV1RespItem{}
	return &this
}
...
func (o PmarginGetMarginAllOrderListV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetMarginAllOrderListV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetMarginAllOrderListV1RespItem struct {
	value *PmarginGetMarginAllOrderListV1RespItem
	isSet bool
}

func (v NullablePmarginGetMarginAllOrderListV1RespItem) Get() *PmarginGetMarginAllOrderListV1RespItem {
	return v.value
}

func (v *NullablePmarginGetMarginAllOrderListV1RespItem) Set(val *PmarginGetMarginAllOrderListV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetMarginAllOrderListV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetMarginAllOrderListV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetMarginAllOrderListV1RespItem(val *PmarginGetMarginAllOrderListV1RespItem) *NullablePmarginGetMarginAllOrderListV1RespItem {
	return &NullablePmarginGetMarginAllOrderListV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetMarginAllOrderListV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetMarginAllOrderListV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
