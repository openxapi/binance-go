...
// checks if the PmarginGetUmConditionalOrderHistoryV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmConditionalOrderHistoryV1Resp{}

// PmarginGetUmConditionalOrderHistoryV1Resp struct for PmarginGetUmConditionalOrderHistoryV1Resp
type PmarginGetUmConditionalOrderHistoryV1Resp struct {
...
func NewPmarginGetUmConditionalOrderHistoryV1Resp() *PmarginGetUmConditionalOrderHistoryV1Resp {
	this := PmarginGetUmConditionalOrderHistoryV1Resp{}
	return &this
}
...
func (o PmarginGetUmConditionalOrderHistoryV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmConditionalOrderHistoryV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmConditionalOrderHistoryV1Resp struct {
	value *PmarginGetUmConditionalOrderHistoryV1Resp
	isSet bool
}

func (v NullablePmarginGetUmConditionalOrderHistoryV1Resp) Get() *PmarginGetUmConditionalOrderHistoryV1Resp {
	return v.value
}

func (v *NullablePmarginGetUmConditionalOrderHistoryV1Resp) Set(val *PmarginGetUmConditionalOrderHistoryV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmConditionalOrderHistoryV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmConditionalOrderHistoryV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmConditionalOrderHistoryV1Resp(val *PmarginGetUmConditionalOrderHistoryV1Resp) *NullablePmarginGetUmConditionalOrderHistoryV1Resp {
	return &NullablePmarginGetUmConditionalOrderHistoryV1Resp{value: val, isSet: true}
}

func (v NullablePmarginGetUmConditionalOrderHistoryV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmConditionalOrderHistoryV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
