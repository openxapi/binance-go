...
// checks if the PmarginGetMarginOpenOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetMarginOpenOrdersV1RespItem{}

// PmarginGetMarginOpenOrdersV1RespItem struct for PmarginGetMarginOpenOrdersV1RespItem
type PmarginGetMarginOpenOrdersV1RespItem struct {
...
func NewPmarginGetMarginOpenOrdersV1RespItem() *PmarginGetMarginOpenOrdersV1RespItem {
	this := PmarginGetMarginOpenOrdersV1RespItem{}
	return &this
}
...
func (o PmarginGetMarginOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetMarginOpenOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetMarginOpenOrdersV1RespItem struct {
	value *PmarginGetMarginOpenOrdersV1RespItem
	isSet bool
}

func (v NullablePmarginGetMarginOpenOrdersV1RespItem) Get() *PmarginGetMarginOpenOrdersV1RespItem {
	return v.value
}

func (v *NullablePmarginGetMarginOpenOrdersV1RespItem) Set(val *PmarginGetMarginOpenOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetMarginOpenOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetMarginOpenOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetMarginOpenOrdersV1RespItem(val *PmarginGetMarginOpenOrdersV1RespItem) *NullablePmarginGetMarginOpenOrdersV1RespItem {
	return &NullablePmarginGetMarginOpenOrdersV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetMarginOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetMarginOpenOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
