...
// checks if the PmarginGetMarginOpenOrderListV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetMarginOpenOrderListV1RespItem{}

// PmarginGetMarginOpenOrderListV1RespItem struct for PmarginGetMarginOpenOrderListV1RespItem
type PmarginGetMarginOpenOrderListV1RespItem struct {
...
func NewPmarginGetMarginOpenOrderListV1RespItem() *PmarginGetMarginOpenOrderListV1RespItem {
	this := PmarginGetMarginOpenOrderListV1RespItem{}
	return &this
}
...
func (o PmarginGetMarginOpenOrderListV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetMarginOpenOrderListV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetMarginOpenOrderListV1RespItem struct {
	value *PmarginGetMarginOpenOrderListV1RespItem
	isSet bool
}

func (v NullablePmarginGetMarginOpenOrderListV1RespItem) Get() *PmarginGetMarginOpenOrderListV1RespItem {
	return v.value
}

func (v *NullablePmarginGetMarginOpenOrderListV1RespItem) Set(val *PmarginGetMarginOpenOrderListV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetMarginOpenOrderListV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetMarginOpenOrderListV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetMarginOpenOrderListV1RespItem(val *PmarginGetMarginOpenOrderListV1RespItem) *NullablePmarginGetMarginOpenOrderListV1RespItem {
	return &NullablePmarginGetMarginOpenOrderListV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetMarginOpenOrderListV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetMarginOpenOrderListV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
