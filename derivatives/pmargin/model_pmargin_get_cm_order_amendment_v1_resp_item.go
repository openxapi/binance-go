...
// checks if the PmarginGetCmOrderAmendmentV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetCmOrderAmendmentV1RespItem{}

// PmarginGetCmOrderAmendmentV1RespItem struct for PmarginGetCmOrderAmendmentV1RespItem
type PmarginGetCmOrderAmendmentV1RespItem struct {
...
func NewPmarginGetCmOrderAmendmentV1RespItem() *PmarginGetCmOrderAmendmentV1RespItem {
	this := PmarginGetCmOrderAmendmentV1RespItem{}
	return &this
}
...
func (o PmarginGetCmOrderAmendmentV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetCmOrderAmendmentV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetCmOrderAmendmentV1RespItem struct {
	value *PmarginGetCmOrderAmendmentV1RespItem
	isSet bool
}

func (v NullablePmarginGetCmOrderAmendmentV1RespItem) Get() *PmarginGetCmOrderAmendmentV1RespItem {
	return v.value
}

func (v *NullablePmarginGetCmOrderAmendmentV1RespItem) Set(val *PmarginGetCmOrderAmendmentV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetCmOrderAmendmentV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetCmOrderAmendmentV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetCmOrderAmendmentV1RespItem(val *PmarginGetCmOrderAmendmentV1RespItem) *NullablePmarginGetCmOrderAmendmentV1RespItem {
	return &NullablePmarginGetCmOrderAmendmentV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetCmOrderAmendmentV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetCmOrderAmendmentV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
