...
// checks if the PmarginGetUmOrderAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmOrderAsynIdV1Resp{}

// PmarginGetUmOrderAsynIdV1Resp struct for PmarginGetUmOrderAsynIdV1Resp
type PmarginGetUmOrderAsynIdV1Resp struct {
...
func NewPmarginGetUmOrderAsynIdV1Resp() *PmarginGetUmOrderAsynIdV1Resp {
	this := PmarginGetUmOrderAsynIdV1Resp{}
	return &this
}
...
func (o PmarginGetUmOrderAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmOrderAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmOrderAsynIdV1Resp struct {
	value *PmarginGetUmOrderAsynIdV1Resp
	isSet bool
}

func (v NullablePmarginGetUmOrderAsynIdV1Resp) Get() *PmarginGetUmOrderAsynIdV1Resp {
	return v.value
}

func (v *NullablePmarginGetUmOrderAsynIdV1Resp) Set(val *PmarginGetUmOrderAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmOrderAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmOrderAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmOrderAsynIdV1Resp(val *PmarginGetUmOrderAsynIdV1Resp) *NullablePmarginGetUmOrderAsynIdV1Resp {
	return &NullablePmarginGetUmOrderAsynIdV1Resp{value: val, isSet: true}
}

func (v NullablePmarginGetUmOrderAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmOrderAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
