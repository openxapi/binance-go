...
// checks if the PmarginDeleteCmConditionalOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginDeleteCmConditionalOrderV1Resp{}

// PmarginDeleteCmConditionalOrderV1Resp struct for PmarginDeleteCmConditionalOrderV1Resp
type PmarginDeleteCmConditionalOrderV1Resp struct {
...
func NewPmarginDeleteCmConditionalOrderV1Resp() *PmarginDeleteCmConditionalOrderV1Resp {
	this := PmarginDeleteCmConditionalOrderV1Resp{}
	return &this
}
...
func (o PmarginDeleteCmConditionalOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginDeleteCmConditionalOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginDeleteCmConditionalOrderV1Resp struct {
	value *PmarginDeleteCmConditionalOrderV1Resp
	isSet bool
}

func (v NullablePmarginDeleteCmConditionalOrderV1Resp) Get() *PmarginDeleteCmConditionalOrderV1Resp {
	return v.value
}

func (v *NullablePmarginDeleteCmConditionalOrderV1Resp) Set(val *PmarginDeleteCmConditionalOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginDeleteCmConditionalOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginDeleteCmConditionalOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginDeleteCmConditionalOrderV1Resp(val *PmarginDeleteCmConditionalOrderV1Resp) *NullablePmarginDeleteCmConditionalOrderV1Resp {
	return &NullablePmarginDeleteCmConditionalOrderV1Resp{value: val, isSet: true}
}

func (v NullablePmarginDeleteCmConditionalOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginDeleteCmConditionalOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
