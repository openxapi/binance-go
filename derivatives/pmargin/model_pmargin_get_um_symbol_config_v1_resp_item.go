...
// checks if the PmarginGetUmSymbolConfigV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmSymbolConfigV1RespItem{}

// PmarginGetUmSymbolConfigV1RespItem struct for PmarginGetUmSymbolConfigV1RespItem
type PmarginGetUmSymbolConfigV1RespItem struct {
...
func NewPmarginGetUmSymbolConfigV1RespItem() *PmarginGetUmSymbolConfigV1RespItem {
	this := PmarginGetUmSymbolConfigV1RespItem{}
	return &this
}
...
func (o PmarginGetUmSymbolConfigV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmSymbolConfigV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmSymbolConfigV1RespItem struct {
	value *PmarginGetUmSymbolConfigV1RespItem
	isSet bool
}

func (v NullablePmarginGetUmSymbolConfigV1RespItem) Get() *PmarginGetUmSymbolConfigV1RespItem {
	return v.value
}

func (v *NullablePmarginGetUmSymbolConfigV1RespItem) Set(val *PmarginGetUmSymbolConfigV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmSymbolConfigV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmSymbolConfigV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmSymbolConfigV1RespItem(val *PmarginGetUmSymbolConfigV1RespItem) *NullablePmarginGetUmSymbolConfigV1RespItem {
	return &NullablePmarginGetUmSymbolConfigV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetUmSymbolConfigV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmSymbolConfigV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
