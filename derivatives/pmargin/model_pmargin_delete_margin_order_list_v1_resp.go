...
// checks if the PmarginDeleteMarginOrderListV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginDeleteMarginOrderListV1Resp{}

// PmarginDeleteMarginOrderListV1Resp struct for PmarginDeleteMarginOrderListV1Resp
type PmarginDeleteMarginOrderListV1Resp struct {
	ContingencyType *string `json:"contingencyType,omitempty"`
	ListClientOrderId *string `json:"listClientOrderId,omitempty"`
	ListOrderStatus *string `json:"listOrderStatus,omitempty"`
	ListStatusType *string `json:"listStatusType,omitempty"`
	OrderListId *int64 `json:"orderListId,omitempty"`
	OrderReports []PmarginDeleteMarginOrderListV1RespOrderReportsInner `json:"orderReports,omitempty"`
...
func NewPmarginDeleteMarginOrderListV1Resp() *PmarginDeleteMarginOrderListV1Resp {
	this := PmarginDeleteMarginOrderListV1Resp{}
	return &this
}
...
func (o *PmarginDeleteMarginOrderListV1Resp) GetOrderReports() []PmarginDeleteMarginOrderListV1RespOrderReportsInner {
	if o == nil || IsNil(o.OrderReports) {
		var ret []PmarginDeleteMarginOrderListV1RespOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []PmarginDeleteMarginOrderListV1RespOrderReportsInner and assigns it to the OrderReports field.
...
func (o PmarginDeleteMarginOrderListV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginDeleteMarginOrderListV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginDeleteMarginOrderListV1Resp struct {
	value *PmarginDeleteMarginOrderListV1Resp
	isSet bool
}

func (v NullablePmarginDeleteMarginOrderListV1Resp) Get() *PmarginDeleteMarginOrderListV1Resp {
	return v.value
}

func (v *NullablePmarginDeleteMarginOrderListV1Resp) Set(val *PmarginDeleteMarginOrderListV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginDeleteMarginOrderListV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginDeleteMarginOrderListV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginDeleteMarginOrderListV1Resp(val *PmarginDeleteMarginOrderListV1Resp) *NullablePmarginDeleteMarginOrderListV1Resp {
	return &NullablePmarginDeleteMarginOrderListV1Resp{value: val, isSet: true}
}

func (v NullablePmarginDeleteMarginOrderListV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginDeleteMarginOrderListV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
