...
// checks if the PmarginGetUmIncomeV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmIncomeV1RespItem{}

// PmarginGetUmIncomeV1RespItem struct for PmarginGetUmIncomeV1RespItem
type PmarginGetUmIncomeV1RespItem struct {
...
func NewPmarginGetUmIncomeV1RespItem() *PmarginGetUmIncomeV1RespItem {
	this := PmarginGetUmIncomeV1RespItem{}
	return &this
}
...
func (o *PmarginGetUmIncomeV1RespItem) GetInfo() string {
...
func (o PmarginGetUmIncomeV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmIncomeV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmIncomeV1RespItem struct {
	value *PmarginGetUmIncomeV1RespItem
	isSet bool
}

func (v NullablePmarginGetUmIncomeV1RespItem) Get() *PmarginGetUmIncomeV1RespItem {
	return v.value
}

func (v *NullablePmarginGetUmIncomeV1RespItem) Set(val *PmarginGetUmIncomeV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmIncomeV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmIncomeV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmIncomeV1RespItem(val *PmarginGetUmIncomeV1RespItem) *NullablePmarginGetUmIncomeV1RespItem {
	return &NullablePmarginGetUmIncomeV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetUmIncomeV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmIncomeV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
