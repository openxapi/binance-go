...
// checks if the PmarginGetCmForceOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetCmForceOrdersV1RespItem{}

// PmarginGetCmForceOrdersV1RespItem struct for PmarginGetCmForceOrdersV1RespItem
type PmarginGetCmForceOrdersV1RespItem struct {
...
func NewPmarginGetCmForceOrdersV1RespItem() *PmarginGetCmForceOrdersV1RespItem {
	this := PmarginGetCmForceOrdersV1RespItem{}
	return &this
}
...
func (o *PmarginGetCmForceOrdersV1RespItem) HasOrderId() bool {
	if o != nil && !IsNil(o.OrderId) {
		return true
	}
...
func (o *PmarginGetCmForceOrdersV1RespItem) HasSide() bool {
	if o != nil && !IsNil(o.Side) {
		return true
	}
...
func (o PmarginGetCmForceOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetCmForceOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetCmForceOrdersV1RespItem struct {
	value *PmarginGetCmForceOrdersV1RespItem
	isSet bool
}

func (v NullablePmarginGetCmForceOrdersV1RespItem) Get() *PmarginGetCmForceOrdersV1RespItem {
	return v.value
}

func (v *NullablePmarginGetCmForceOrdersV1RespItem) Set(val *PmarginGetCmForceOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetCmForceOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetCmForceOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetCmForceOrdersV1RespItem(val *PmarginGetCmForceOrdersV1RespItem) *NullablePmarginGetCmForceOrdersV1RespItem {
	return &NullablePmarginGetCmForceOrdersV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetCmForceOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetCmForceOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
