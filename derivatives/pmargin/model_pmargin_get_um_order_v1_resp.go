...
// checks if the PmarginGetUmOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmOrderV1Resp{}

// PmarginGetUmOrderV1Resp struct for PmarginGetUmOrderV1Resp
type PmarginGetUmOrderV1Resp struct {
...
func (o PmarginGetUmOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmOrderV1Resp struct {
	value *PmarginGetUmOrderV1Resp
	isSet bool
}

func (v NullablePmarginGetUmOrderV1Resp) Get() *PmarginGetUmOrderV1Resp {
	return v.value
}

func (v *NullablePmarginGetUmOrderV1Resp) Set(val *PmarginGetUmOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmOrderV1Resp(val *PmarginGetUmOrderV1Resp) *NullablePmarginGetUmOrderV1Resp {
	return &NullablePmarginGetUmOrderV1Resp{value: val, isSet: true}
}

func (v NullablePmarginGetUmOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
