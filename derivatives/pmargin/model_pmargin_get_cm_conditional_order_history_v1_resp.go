...
// checks if the PmarginGetCmConditionalOrderHistoryV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetCmConditionalOrderHistoryV1Resp{}

// PmarginGetCmConditionalOrderHistoryV1Resp struct for PmarginGetCmConditionalOrderHistoryV1Resp
type PmarginGetCmConditionalOrderHistoryV1Resp struct {
...
func NewPmarginGetCmConditionalOrderHistoryV1Resp() *PmarginGetCmConditionalOrderHistoryV1Resp {
	this := PmarginGetCmConditionalOrderHistoryV1Resp{}
	return &this
}
...
func (o *PmarginGetCmConditionalOrderHistoryV1Resp) HasPrice() bool {
	if o != nil && !IsNil(o.Price) {
		return true
	}
...
func (o *PmarginGetCmConditionalOrderHistoryV1Resp) HasStopPrice() bool {
	if o != nil && !IsNil(o.StopPrice) {
		return true
	}
...
func (o *PmarginGetCmConditionalOrderHistoryV1Resp) GetStrategyType() string {
...
func (o PmarginGetCmConditionalOrderHistoryV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetCmConditionalOrderHistoryV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetCmConditionalOrderHistoryV1Resp struct {
	value *PmarginGetCmConditionalOrderHistoryV1Resp
	isSet bool
}

func (v NullablePmarginGetCmConditionalOrderHistoryV1Resp) Get() *PmarginGetCmConditionalOrderHistoryV1Resp {
	return v.value
}

func (v *NullablePmarginGetCmConditionalOrderHistoryV1Resp) Set(val *PmarginGetCmConditionalOrderHistoryV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetCmConditionalOrderHistoryV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetCmConditionalOrderHistoryV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetCmConditionalOrderHistoryV1Resp(val *PmarginGetCmConditionalOrderHistoryV1Resp) *NullablePmarginGetCmConditionalOrderHistoryV1Resp {
	return &NullablePmarginGetCmConditionalOrderHistoryV1Resp{value: val, isSet: true}
}

func (v NullablePmarginGetCmConditionalOrderHistoryV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetCmConditionalOrderHistoryV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
