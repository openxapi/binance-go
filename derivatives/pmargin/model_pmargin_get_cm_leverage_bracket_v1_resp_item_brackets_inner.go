...
// checks if the PmarginGetCmLeverageBracketV1RespItemBracketsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetCmLeverageBracketV1RespItemBracketsInner{}

// PmarginGetCmLeverageBracketV1RespItemBracketsInner struct for PmarginGetCmLeverageBracketV1RespItemBracketsInner
type PmarginGetCmLeverageBracketV1RespItemBracketsInner struct {
...
func NewPmarginGetCmLeverageBracketV1RespItemBracketsInner() *PmarginGetCmLeverageBracketV1RespItemBracketsInner {
	this := PmarginGetCmLeverageBracketV1RespItemBracketsInner{}
	return &this
}
...
func (o PmarginGetCmLeverageBracketV1RespItemBracketsInner) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetCmLeverageBracketV1RespItemBracketsInner) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetCmLeverageBracketV1RespItemBracketsInner struct {
	value *PmarginGetCmLeverageBracketV1RespItemBracketsInner
	isSet bool
}

func (v NullablePmarginGetCmLeverageBracketV1RespItemBracketsInner) Get() *PmarginGetCmLeverageBracketV1RespItemBracketsInner {
	return v.value
}

func (v *NullablePmarginGetCmLeverageBracketV1RespItemBracketsInner) Set(val *PmarginGetCmLeverageBracketV1RespItemBracketsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetCmLeverageBracketV1RespItemBracketsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetCmLeverageBracketV1RespItemBracketsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetCmLeverageBracketV1RespItemBracketsInner(val *PmarginGetCmLeverageBracketV1RespItemBracketsInner) *NullablePmarginGetCmLeverageBracketV1RespItemBracketsInner {
	return &NullablePmarginGetCmLeverageBracketV1RespItemBracketsInner{value: val, isSet: true}
}

func (v NullablePmarginGetCmLeverageBracketV1RespItemBracketsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetCmLeverageBracketV1RespItemBracketsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
