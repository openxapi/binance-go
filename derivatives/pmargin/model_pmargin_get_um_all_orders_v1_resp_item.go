...
// checks if the PmarginGetUmAllOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmAllOrdersV1RespItem{}

// PmarginGetUmAllOrdersV1RespItem struct for PmarginGetUmAllOrdersV1RespItem
type PmarginGetUmAllOrdersV1RespItem struct {
...
func NewPmarginGetUmAllOrdersV1RespItem() *PmarginGetUmAllOrdersV1RespItem {
	this := PmarginGetUmAllOrdersV1RespItem{}
	return &this
}
...
func (o PmarginGetUmAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmAllOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmAllOrdersV1RespItem struct {
	value *PmarginGetUmAllOrdersV1RespItem
	isSet bool
}

func (v NullablePmarginGetUmAllOrdersV1RespItem) Get() *PmarginGetUmAllOrdersV1RespItem {
	return v.value
}

func (v *NullablePmarginGetUmAllOrdersV1RespItem) Set(val *PmarginGetUmAllOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmAllOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmAllOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmAllOrdersV1RespItem(val *PmarginGetUmAllOrdersV1RespItem) *NullablePmarginGetUmAllOrdersV1RespItem {
	return &NullablePmarginGetUmAllOrdersV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetUmAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmAllOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
