...
// checks if the PmarginGetUmLeverageBracketV1RespItemBracketsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmLeverageBracketV1RespItemBracketsInner{}

// PmarginGetUmLeverageBracketV1RespItemBracketsInner struct for PmarginGetUmLeverageBracketV1RespItemBracketsInner
type PmarginGetUmLeverageBracketV1RespItemBracketsInner struct {
...
func NewPmarginGetUmLeverageBracketV1RespItemBracketsInner() *PmarginGetUmLeverageBracketV1RespItemBracketsInner {
	this := PmarginGetUmLeverageBracketV1RespItemBracketsInner{}
	return &this
}
...
func (o *PmarginGetUmLeverageBracketV1RespItemBracketsInner) SetBracket(v int32) {
	o.Bracket = &v
}
...
func (o *PmarginGetUmLeverageBracketV1RespItemBracketsInner) HasInitialLeverage() bool {
	if o != nil && !IsNil(o.InitialLeverage) {
		return true
	}
...
func (o *PmarginGetUmLeverageBracketV1RespItemBracketsInner) GetNotionalFloor() int32 {
...
func (o PmarginGetUmLeverageBracketV1RespItemBracketsInner) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmLeverageBracketV1RespItemBracketsInner) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmLeverageBracketV1RespItemBracketsInner struct {
	value *PmarginGetUmLeverageBracketV1RespItemBracketsInner
	isSet bool
}

func (v NullablePmarginGetUmLeverageBracketV1RespItemBracketsInner) Get() *PmarginGetUmLeverageBracketV1RespItemBracketsInner {
	return v.value
}

func (v *NullablePmarginGetUmLeverageBracketV1RespItemBracketsInner) Set(val *PmarginGetUmLeverageBracketV1RespItemBracketsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmLeverageBracketV1RespItemBracketsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmLeverageBracketV1RespItemBracketsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmLeverageBracketV1RespItemBracketsInner(val *PmarginGetUmLeverageBracketV1RespItemBracketsInner) *NullablePmarginGetUmLeverageBracketV1RespItemBracketsInner {
	return &NullablePmarginGetUmLeverageBracketV1RespItemBracketsInner{value: val, isSet: true}
}

func (v NullablePmarginGetUmLeverageBracketV1RespItemBracketsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmLeverageBracketV1RespItemBracketsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
