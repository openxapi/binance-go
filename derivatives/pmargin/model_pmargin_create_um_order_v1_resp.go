...
// checks if the PmarginCreateUmOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginCreateUmOrderV1Resp{}

// PmarginCreateUmOrderV1Resp struct for PmarginCreateUmOrderV1Resp
type PmarginCreateUmOrderV1Resp struct {
...
func NewPmarginCreateUmOrderV1Resp() *PmarginCreateUmOrderV1Resp {
	this := PmarginCreateUmOrderV1Resp{}
	return &this
}
...
func (o *PmarginCreateUmOrderV1Resp) HasExecutedQty() bool {
	if o != nil && !IsNil(o.ExecutedQty) {
		return true
	}
...
func (o *PmarginCreateUmOrderV1Resp) HasReduceOnly() bool {
	if o != nil && !IsNil(o.ReduceOnly) {
		return true
	}
...
func (o *PmarginCreateUmOrderV1Resp) GetStatus() string {
...
func (o PmarginCreateUmOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginCreateUmOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginCreateUmOrderV1Resp struct {
	value *PmarginCreateUmOrderV1Resp
	isSet bool
}

func (v NullablePmarginCreateUmOrderV1Resp) Get() *PmarginCreateUmOrderV1Resp {
	return v.value
}

func (v *NullablePmarginCreateUmOrderV1Resp) Set(val *PmarginCreateUmOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginCreateUmOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginCreateUmOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginCreateUmOrderV1Resp(val *PmarginCreateUmOrderV1Resp) *NullablePmarginCreateUmOrderV1Resp {
	return &NullablePmarginCreateUmOrderV1Resp{value: val, isSet: true}
}

func (v NullablePmarginCreateUmOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginCreateUmOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
