...
// checks if the PmarginGetCmConditionalOpenOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetCmConditionalOpenOrderV1Resp{}

// PmarginGetCmConditionalOpenOrderV1Resp struct for PmarginGetCmConditionalOpenOrderV1Resp
type PmarginGetCmConditionalOpenOrderV1Resp struct {
...
func NewPmarginGetCmConditionalOpenOrderV1Resp() *PmarginGetCmConditionalOpenOrderV1Resp {
	this := PmarginGetCmConditionalOpenOrderV1Resp{}
	return &this
}
...
func (o *PmarginGetCmConditionalOpenOrderV1Resp) HasPositionSide() bool {
	if o != nil && !IsNil(o.PositionSide) {
		return true
	}
...
func (o *PmarginGetCmConditionalOpenOrderV1Resp) GetTimeInForce() string {
...
func (o PmarginGetCmConditionalOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetCmConditionalOpenOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetCmConditionalOpenOrderV1Resp struct {
	value *PmarginGetCmConditionalOpenOrderV1Resp
	isSet bool
}

func (v NullablePmarginGetCmConditionalOpenOrderV1Resp) Get() *PmarginGetCmConditionalOpenOrderV1Resp {
	return v.value
}

func (v *NullablePmarginGetCmConditionalOpenOrderV1Resp) Set(val *PmarginGetCmConditionalOpenOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetCmConditionalOpenOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetCmConditionalOpenOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetCmConditionalOpenOrderV1Resp(val *PmarginGetCmConditionalOpenOrderV1Resp) *NullablePmarginGetCmConditionalOpenOrderV1Resp {
	return &NullablePmarginGetCmConditionalOpenOrderV1Resp{value: val, isSet: true}
}

func (v NullablePmarginGetCmConditionalOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetCmConditionalOpenOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
