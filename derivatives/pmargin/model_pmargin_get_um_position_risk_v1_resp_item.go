...
// checks if the PmarginGetUmPositionRiskV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmPositionRiskV1RespItem{}

// PmarginGetUmPositionRiskV1RespItem struct for PmarginGetUmPositionRiskV1RespItem
type PmarginGetUmPositionRiskV1RespItem struct {
...
func NewPmarginGetUmPositionRiskV1RespItem() *PmarginGetUmPositionRiskV1RespItem {
	this := PmarginGetUmPositionRiskV1RespItem{}
	return &this
}
...
func (o *PmarginGetUmPositionRiskV1RespItem) SetEntryPrice(v string) {
	o.EntryPrice = &v
}
...
func (o *PmarginGetUmPositionRiskV1RespItem) HasLiquidationPrice() bool {
	if o != nil && !IsNil(o.LiquidationPrice) {
		return true
	}
...
func (o *PmarginGetUmPositionRiskV1RespItem) GetNotional() string {
...
func (o *PmarginGetUmPositionRiskV1RespItem) SetUnRealizedProfit(v string) {
...
func (o PmarginGetUmPositionRiskV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmPositionRiskV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmPositionRiskV1RespItem struct {
	value *PmarginGetUmPositionRiskV1RespItem
	isSet bool
}

func (v NullablePmarginGetUmPositionRiskV1RespItem) Get() *PmarginGetUmPositionRiskV1RespItem {
	return v.value
}

func (v *NullablePmarginGetUmPositionRiskV1RespItem) Set(val *PmarginGetUmPositionRiskV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmPositionRiskV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmPositionRiskV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmPositionRiskV1RespItem(val *PmarginGetUmPositionRiskV1RespItem) *NullablePmarginGetUmPositionRiskV1RespItem {
	return &NullablePmarginGetUmPositionRiskV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetUmPositionRiskV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmPositionRiskV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
