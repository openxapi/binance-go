...
// checks if the PmarginGetUmForceOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmForceOrdersV1RespItem{}

// PmarginGetUmForceOrdersV1RespItem struct for PmarginGetUmForceOrdersV1RespItem
type PmarginGetUmForceOrdersV1RespItem struct {
...
func NewPmarginGetUmForceOrdersV1RespItem() *PmarginGetUmForceOrdersV1RespItem {
	this := PmarginGetUmForceOrdersV1RespItem{}
	return &this
}
...
func (o *PmarginGetUmForceOrdersV1RespItem) GetAvgPriceOk() (*string, bool) {
	if o == nil || IsNil(o.AvgPrice) {
		return nil, false
	}
...
func (o *PmarginGetUmForceOrdersV1RespItem) SetCumQuote(v string) {
	o.CumQuote = &v
}
...
func (o *PmarginGetUmForceOrdersV1RespItem) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o PmarginGetUmForceOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmForceOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmForceOrdersV1RespItem struct {
	value *PmarginGetUmForceOrdersV1RespItem
	isSet bool
}

func (v NullablePmarginGetUmForceOrdersV1RespItem) Get() *PmarginGetUmForceOrdersV1RespItem {
	return v.value
}

func (v *NullablePmarginGetUmForceOrdersV1RespItem) Set(val *PmarginGetUmForceOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmForceOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmForceOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmForceOrdersV1RespItem(val *PmarginGetUmForceOrdersV1RespItem) *NullablePmarginGetUmForceOrdersV1RespItem {
	return &NullablePmarginGetUmForceOrdersV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetUmForceOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmForceOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
