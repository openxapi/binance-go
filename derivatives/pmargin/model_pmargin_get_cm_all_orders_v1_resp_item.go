...
// checks if the PmarginGetCmAllOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetCmAllOrdersV1RespItem{}

// PmarginGetCmAllOrdersV1RespItem struct for PmarginGetCmAllOrdersV1RespItem
type PmarginGetCmAllOrdersV1RespItem struct {
...
func NewPmarginGetCmAllOrdersV1RespItem() *PmarginGetCmAllOrdersV1RespItem {
	this := PmarginGetCmAllOrdersV1RespItem{}
	return &this
}
...
func (o PmarginGetCmAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetCmAllOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetCmAllOrdersV1RespItem struct {
	value *PmarginGetCmAllOrdersV1RespItem
	isSet bool
}

func (v NullablePmarginGetCmAllOrdersV1RespItem) Get() *PmarginGetCmAllOrdersV1RespItem {
	return v.value
}

func (v *NullablePmarginGetCmAllOrdersV1RespItem) Set(val *PmarginGetCmAllOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetCmAllOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetCmAllOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetCmAllOrdersV1RespItem(val *PmarginGetCmAllOrdersV1RespItem) *NullablePmarginGetCmAllOrdersV1RespItem {
	return &NullablePmarginGetCmAllOrdersV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetCmAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetCmAllOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
