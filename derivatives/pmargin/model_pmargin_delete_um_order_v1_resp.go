...
// checks if the PmarginDeleteUmOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginDeleteUmOrderV1Resp{}

// PmarginDeleteUmOrderV1Resp struct for PmarginDeleteUmOrderV1Resp
type PmarginDeleteUmOrderV1Resp struct {
...
func NewPmarginDeleteUmOrderV1Resp() *PmarginDeleteUmOrderV1Resp {
	this := PmarginDeleteUmOrderV1Resp{}
	return &this
}
...
func (o *PmarginDeleteUmOrderV1Resp) HasExecutedQty() bool {
	if o != nil && !IsNil(o.ExecutedQty) {
		return true
	}
...
func (o *PmarginDeleteUmOrderV1Resp) HasReduceOnly() bool {
	if o != nil && !IsNil(o.ReduceOnly) {
		return true
	}
...
func (o *PmarginDeleteUmOrderV1Resp) GetStatus() string {
...
func (o PmarginDeleteUmOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginDeleteUmOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginDeleteUmOrderV1Resp struct {
	value *PmarginDeleteUmOrderV1Resp
	isSet bool
}

func (v NullablePmarginDeleteUmOrderV1Resp) Get() *PmarginDeleteUmOrderV1Resp {
	return v.value
}

func (v *NullablePmarginDeleteUmOrderV1Resp) Set(val *PmarginDeleteUmOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginDeleteUmOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginDeleteUmOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginDeleteUmOrderV1Resp(val *PmarginDeleteUmOrderV1Resp) *NullablePmarginDeleteUmOrderV1Resp {
	return &NullablePmarginDeleteUmOrderV1Resp{value: val, isSet: true}
}

func (v NullablePmarginDeleteUmOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginDeleteUmOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
