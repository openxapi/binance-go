...
// checks if the PmarginGetUmOpenOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmOpenOrdersV1RespItem{}

// PmarginGetUmOpenOrdersV1RespItem struct for PmarginGetUmOpenOrdersV1RespItem
type PmarginGetUmOpenOrdersV1RespItem struct {
...
func NewPmarginGetUmOpenOrdersV1RespItem() *PmarginGetUmOpenOrdersV1RespItem {
	this := PmarginGetUmOpenOrdersV1RespItem{}
	return &this
}
...
func (o PmarginGetUmOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmOpenOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmOpenOrdersV1RespItem struct {
	value *PmarginGetUmOpenOrdersV1RespItem
	isSet bool
}

func (v NullablePmarginGetUmOpenOrdersV1RespItem) Get() *PmarginGetUmOpenOrdersV1RespItem {
	return v.value
}

func (v *NullablePmarginGetUmOpenOrdersV1RespItem) Set(val *PmarginGetUmOpenOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmOpenOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmOpenOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmOpenOrdersV1RespItem(val *PmarginGetUmOpenOrdersV1RespItem) *NullablePmarginGetUmOpenOrdersV1RespItem {
	return &NullablePmarginGetUmOpenOrdersV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetUmOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmOpenOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
