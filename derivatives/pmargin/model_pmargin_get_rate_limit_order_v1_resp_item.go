...
// checks if the PmarginGetRateLimitOrderV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetRateLimitOrderV1RespItem{}

// PmarginGetRateLimitOrderV1RespItem struct for PmarginGetRateLimitOrderV1RespItem
type PmarginGetRateLimitOrderV1RespItem struct {
...
func NewPmarginGetRateLimitOrderV1RespItem() *PmarginGetRateLimitOrderV1RespItem {
	this := PmarginGetRateLimitOrderV1RespItem{}
	return &this
}
...
func (o PmarginGetRateLimitOrderV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetRateLimitOrderV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetRateLimitOrderV1RespItem struct {
	value *PmarginGetRateLimitOrderV1RespItem
	isSet bool
}

func (v NullablePmarginGetRateLimitOrderV1RespItem) Get() *PmarginGetRateLimitOrderV1RespItem {
	return v.value
}

func (v *NullablePmarginGetRateLimitOrderV1RespItem) Set(val *PmarginGetRateLimitOrderV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetRateLimitOrderV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetRateLimitOrderV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetRateLimitOrderV1RespItem(val *PmarginGetRateLimitOrderV1RespItem) *NullablePmarginGetRateLimitOrderV1RespItem {
	return &NullablePmarginGetRateLimitOrderV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetRateLimitOrderV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetRateLimitOrderV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
