...
// checks if the PmarginGetUmConditionalOpenOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmConditionalOpenOrderV1Resp{}

// PmarginGetUmConditionalOpenOrderV1Resp struct for PmarginGetUmConditionalOpenOrderV1Resp
type PmarginGetUmConditionalOpenOrderV1Resp struct {
...
func NewPmarginGetUmConditionalOpenOrderV1Resp() *PmarginGetUmConditionalOpenOrderV1Resp {
	this := PmarginGetUmConditionalOpenOrderV1Resp{}
	return &this
}
...
func (o *PmarginGetUmConditionalOpenOrderV1Resp) GetActivatePrice() string {
...
// and a boolean to check if the value has been set.
func (o *PmarginGetUmConditionalOpenOrderV1Resp) GetGoodTillDateOk() (*int64, bool) {
	if o == nil || IsNil(o.GoodTillDate) {
		return nil, false
	}
...
func (o *PmarginGetUmConditionalOpenOrderV1Resp) SetOrigQty(v string) {
	o.OrigQty = &v
}
...
func (o PmarginGetUmConditionalOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmConditionalOpenOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmConditionalOpenOrderV1Resp struct {
	value *PmarginGetUmConditionalOpenOrderV1Resp
	isSet bool
}

func (v NullablePmarginGetUmConditionalOpenOrderV1Resp) Get() *PmarginGetUmConditionalOpenOrderV1Resp {
	return v.value
}

func (v *NullablePmarginGetUmConditionalOpenOrderV1Resp) Set(val *PmarginGetUmConditionalOpenOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmConditionalOpenOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmConditionalOpenOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmConditionalOpenOrderV1Resp(val *PmarginGetUmConditionalOpenOrderV1Resp) *NullablePmarginGetUmConditionalOpenOrderV1Resp {
	return &NullablePmarginGetUmConditionalOpenOrderV1Resp{value: val, isSet: true}
}

func (v NullablePmarginGetUmConditionalOpenOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmConditionalOpenOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
