...
// checks if the PmarginGetUmUserTradesV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmUserTradesV1RespItem{}

// PmarginGetUmUserTradesV1RespItem struct for PmarginGetUmUserTradesV1RespItem
type PmarginGetUmUserTradesV1RespItem struct {
...
func NewPmarginGetUmUserTradesV1RespItem() *PmarginGetUmUserTradesV1RespItem {
	this := PmarginGetUmUserTradesV1RespItem{}
	return &this
}
...
func (o PmarginGetUmUserTradesV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmUserTradesV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmUserTradesV1RespItem struct {
	value *PmarginGetUmUserTradesV1RespItem
	isSet bool
}

func (v NullablePmarginGetUmUserTradesV1RespItem) Get() *PmarginGetUmUserTradesV1RespItem {
	return v.value
}

func (v *NullablePmarginGetUmUserTradesV1RespItem) Set(val *PmarginGetUmUserTradesV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmUserTradesV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmUserTradesV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmUserTradesV1RespItem(val *PmarginGetUmUserTradesV1RespItem) *NullablePmarginGetUmUserTradesV1RespItem {
	return &NullablePmarginGetUmUserTradesV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetUmUserTradesV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmUserTradesV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
