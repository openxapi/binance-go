...
// checks if the PmarginGetUmAccountConfigV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmAccountConfigV1Resp{}

// PmarginGetUmAccountConfigV1Resp struct for PmarginGetUmAccountConfigV1Resp
type PmarginGetUmAccountConfigV1Resp struct {
...
func NewPmarginGetUmAccountConfigV1Resp() *PmarginGetUmAccountConfigV1Resp {
	this := PmarginGetUmAccountConfigV1Resp{}
	return &this
}
...
func (o PmarginGetUmAccountConfigV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmAccountConfigV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmAccountConfigV1Resp struct {
	value *PmarginGetUmAccountConfigV1Resp
	isSet bool
}

func (v NullablePmarginGetUmAccountConfigV1Resp) Get() *PmarginGetUmAccountConfigV1Resp {
	return v.value
}

func (v *NullablePmarginGetUmAccountConfigV1Resp) Set(val *PmarginGetUmAccountConfigV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmAccountConfigV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmAccountConfigV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmAccountConfigV1Resp(val *PmarginGetUmAccountConfigV1Resp) *NullablePmarginGetUmAccountConfigV1Resp {
	return &NullablePmarginGetUmAccountConfigV1Resp{value: val, isSet: true}
}

func (v NullablePmarginGetUmAccountConfigV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmAccountConfigV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
