...
// checks if the PmarginGetCmOpenOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetCmOpenOrdersV1RespItem{}

// PmarginGetCmOpenOrdersV1RespItem struct for PmarginGetCmOpenOrdersV1RespItem
type PmarginGetCmOpenOrdersV1RespItem struct {
...
func NewPmarginGetCmOpenOrdersV1RespItem() *PmarginGetCmOpenOrdersV1RespItem {
	this := PmarginGetCmOpenOrdersV1RespItem{}
	return &this
}
...
func (o PmarginGetCmOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetCmOpenOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetCmOpenOrdersV1RespItem struct {
	value *PmarginGetCmOpenOrdersV1RespItem
	isSet bool
}

func (v NullablePmarginGetCmOpenOrdersV1RespItem) Get() *PmarginGetCmOpenOrdersV1RespItem {
	return v.value
}

func (v *NullablePmarginGetCmOpenOrdersV1RespItem) Set(val *PmarginGetCmOpenOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetCmOpenOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetCmOpenOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetCmOpenOrdersV1RespItem(val *PmarginGetCmOpenOrdersV1RespItem) *NullablePmarginGetCmOpenOrdersV1RespItem {
	return &NullablePmarginGetCmOpenOrdersV1RespItem{value: val, isSet: true}
}

func (v NullablePmarginGetCmOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetCmOpenOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
