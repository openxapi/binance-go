...
// checks if the PmarginGetUmIncomeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmIncomeAsynIdV1Resp{}

// PmarginGetUmIncomeAsynIdV1Resp struct for PmarginGetUmIncomeAsynIdV1Resp
type PmarginGetUmIncomeAsynIdV1Resp struct {
...
func NewPmarginGetUmIncomeAsynIdV1Resp() *PmarginGetUmIncomeAsynIdV1Resp {
	this := PmarginGetUmIncomeAsynIdV1Resp{}
	return &this
}
...
func (o PmarginGetUmIncomeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmIncomeAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmIncomeAsynIdV1Resp struct {
	value *PmarginGetUmIncomeAsynIdV1Resp
	isSet bool
}

func (v NullablePmarginGetUmIncomeAsynIdV1Resp) Get() *PmarginGetUmIncomeAsynIdV1Resp {
	return v.value
}

func (v *NullablePmarginGetUmIncomeAsynIdV1Resp) Set(val *PmarginGetUmIncomeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmIncomeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmIncomeAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmIncomeAsynIdV1Resp(val *PmarginGetUmIncomeAsynIdV1Resp) *NullablePmarginGetUmIncomeAsynIdV1Resp {
	return &NullablePmarginGetUmIncomeAsynIdV1Resp{value: val, isSet: true}
}

func (v NullablePmarginGetUmIncomeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmIncomeAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
