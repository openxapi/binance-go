...
// checks if the PmarginCreateUmConditionalOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginCreateUmConditionalOrderV1Resp{}

// PmarginCreateUmConditionalOrderV1Resp struct for PmarginCreateUmConditionalOrderV1Resp
type PmarginCreateUmConditionalOrderV1Resp struct {
...
func NewPmarginCreateUmConditionalOrderV1Resp() *PmarginCreateUmConditionalOrderV1Resp {
	this := PmarginCreateUmConditionalOrderV1Resp{}
	return &this
}
...
func (o *PmarginCreateUmConditionalOrderV1Resp) HasPrice() bool {
	if o != nil && !IsNil(o.Price) {
		return true
	}
...
func (o *PmarginCreateUmConditionalOrderV1Resp) SetStopPrice(v string) {
	o.StopPrice = &v
}
...
func (o *PmarginCreateUmConditionalOrderV1Resp) HasStrategyStatus() bool {
	if o != nil && !IsNil(o.StrategyStatus) {
		return true
	}
...
func (o PmarginCreateUmConditionalOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginCreateUmConditionalOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginCreateUmConditionalOrderV1Resp struct {
	value *PmarginCreateUmConditionalOrderV1Resp
	isSet bool
}

func (v NullablePmarginCreateUmConditionalOrderV1Resp) Get() *PmarginCreateUmConditionalOrderV1Resp {
	return v.value
}

func (v *NullablePmarginCreateUmConditionalOrderV1Resp) Set(val *PmarginCreateUmConditionalOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginCreateUmConditionalOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginCreateUmConditionalOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginCreateUmConditionalOrderV1Resp(val *PmarginCreateUmConditionalOrderV1Resp) *NullablePmarginCreateUmConditionalOrderV1Resp {
	return &NullablePmarginCreateUmConditionalOrderV1Resp{value: val, isSet: true}
}

func (v NullablePmarginCreateUmConditionalOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginCreateUmConditionalOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
