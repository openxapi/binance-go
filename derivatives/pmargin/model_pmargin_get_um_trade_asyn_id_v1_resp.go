...
// checks if the PmarginGetUmTradeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetUmTradeAsynIdV1Resp{}

// PmarginGetUmTradeAsynIdV1Resp struct for PmarginGetUmTradeAsynIdV1Resp
type PmarginGetUmTradeAsynIdV1Resp struct {
...
func NewPmarginGetUmTradeAsynIdV1Resp() *PmarginGetUmTradeAsynIdV1Resp {
	this := PmarginGetUmTradeAsynIdV1Resp{}
	return &this
}
...
func (o PmarginGetUmTradeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetUmTradeAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetUmTradeAsynIdV1Resp struct {
	value *PmarginGetUmTradeAsynIdV1Resp
	isSet bool
}

func (v NullablePmarginGetUmTradeAsynIdV1Resp) Get() *PmarginGetUmTradeAsynIdV1Resp {
	return v.value
}

func (v *NullablePmarginGetUmTradeAsynIdV1Resp) Set(val *PmarginGetUmTradeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetUmTradeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetUmTradeAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetUmTradeAsynIdV1Resp(val *PmarginGetUmTradeAsynIdV1Resp) *NullablePmarginGetUmTradeAsynIdV1Resp {
	return &NullablePmarginGetUmTradeAsynIdV1Resp{value: val, isSet: true}
}

func (v NullablePmarginGetUmTradeAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetUmTradeAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
