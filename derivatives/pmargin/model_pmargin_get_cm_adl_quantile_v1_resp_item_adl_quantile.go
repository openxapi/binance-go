...
// checks if the PmarginGetCmAdlQuantileV1RespItemAdlQuantile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PmarginGetCmAdlQuantileV1RespItemAdlQuantile{}

// PmarginGetCmAdlQuantileV1RespItemAdlQuantile struct for PmarginGetCmAdlQuantileV1RespItemAdlQuantile
type PmarginGetCmAdlQuantileV1RespItemAdlQuantile struct {
...
func NewPmarginGetCmAdlQuantileV1RespItemAdlQuantile() *PmarginGetCmAdlQuantileV1RespItemAdlQuantile {
	this := PmarginGetCmAdlQuantileV1RespItemAdlQuantile{}
	return &this
}
...
func (o PmarginGetCmAdlQuantileV1RespItemAdlQuantile) MarshalJSON() ([]byte, error) {
...
func (o PmarginGetCmAdlQuantileV1RespItemAdlQuantile) ToMap() (map[string]interface{}, error) {
...
type NullablePmarginGetCmAdlQuantileV1RespItemAdlQuantile struct {
	value *PmarginGetCmAdlQuantileV1RespItemAdlQuantile
	isSet bool
}

func (v NullablePmarginGetCmAdlQuantileV1RespItemAdlQuantile) Get() *PmarginGetCmAdlQuantileV1RespItemAdlQuantile {
	return v.value
}

func (v *NullablePmarginGetCmAdlQuantileV1RespItemAdlQuantile) Set(val *PmarginGetCmAdlQuantileV1RespItemAdlQuantile) {
	v.value = val
	v.isSet = true
}

func (v NullablePmarginGetCmAdlQuantileV1RespItemAdlQuantile) IsSet() bool {
	return v.isSet
}

func (v *NullablePmarginGetCmAdlQuantileV1RespItemAdlQuantile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePmarginGetCmAdlQuantileV1RespItemAdlQuantile(val *PmarginGetCmAdlQuantileV1RespItemAdlQuantile) *NullablePmarginGetCmAdlQuantileV1RespItemAdlQuantile {
	return &NullablePmarginGetCmAdlQuantileV1RespItemAdlQuantile{value: val, isSet: true}
}

func (v NullablePmarginGetCmAdlQuantileV1RespItemAdlQuantile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePmarginGetCmAdlQuantileV1RespItemAdlQuantile) UnmarshalJSON(src []byte) error {
	v.isSet = true
