...
// checks if the CreateOrderOcoV3Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOrderOcoV3Resp{}

// CreateOrderOcoV3Resp struct for CreateOrderOcoV3Resp
type CreateOrderOcoV3Resp struct {
	ContingencyType *string `json:"contingencyType,omitempty"`
	ListClientOrderId *string `json:"listClientOrderId,omitempty"`
	ListOrderStatus *string `json:"listOrderStatus,omitempty"`
	ListStatusType *string `json:"listStatusType,omitempty"`
	OrderListId *int64 `json:"orderListId,omitempty"`
	OrderReports []CreateOrderOcoV3RespOrderReportsInner `json:"orderReports,omitempty"`
...
func (o *CreateOrderOcoV3Resp) GetOrderReports() []CreateOrderOcoV3RespOrderReportsInner {
	if o == nil || IsNil(o.OrderReports) {
		var ret []CreateOrderOcoV3RespOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []CreateOrderOcoV3RespOrderReportsInner and assigns it to the OrderReports field.
...
func (o CreateOrderOcoV3Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateOrderOcoV3Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateOrderOcoV3Resp struct {
	value *CreateOrderOcoV3Resp
	isSet bool
}

func (v NullableCreateOrderOcoV3Resp) Get() *CreateOrderOcoV3Resp {
	return v.value
}

func (v *NullableCreateOrderOcoV3Resp) Set(val *CreateOrderOcoV3Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOrderOcoV3Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOrderOcoV3Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOrderOcoV3Resp(val *CreateOrderOcoV3Resp) *NullableCreateOrderOcoV3Resp {
	return &NullableCreateOrderOcoV3Resp{value: val, isSet: true}
}

func (v NullableCreateOrderOcoV3Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOrderOcoV3Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
