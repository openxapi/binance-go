...
// checks if the GetOpenOrdersV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOpenOrdersV3RespItem{}

// GetOpenOrdersV3RespItem struct for GetOpenOrdersV3RespItem
type GetOpenOrdersV3RespItem struct {
...
func (o GetOpenOrdersV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetOpenOrdersV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetOpenOrdersV3RespItem struct {
	value *GetOpenOrdersV3RespItem
	isSet bool
}

func (v NullableGetOpenOrdersV3RespItem) Get() *GetOpenOrdersV3RespItem {
	return v.value
}

func (v *NullableGetOpenOrdersV3RespItem) Set(val *GetOpenOrdersV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOpenOrdersV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOpenOrdersV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOpenOrdersV3RespItem(val *GetOpenOrdersV3RespItem) *NullableGetOpenOrdersV3RespItem {
	return &NullableGetOpenOrdersV3RespItem{value: val, isSet: true}
}

func (v NullableGetOpenOrdersV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOpenOrdersV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
