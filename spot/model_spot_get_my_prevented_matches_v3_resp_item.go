...
// checks if the SpotGetMyPreventedMatchesV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotGetMyPreventedMatchesV3RespItem{}

// SpotGetMyPreventedMatchesV3RespItem struct for SpotGetMyPreventedMatchesV3RespItem
type SpotGetMyPreventedMatchesV3RespItem struct {
...
func NewSpotGetMyPreventedMatchesV3RespItem() *SpotGetMyPreventedMatchesV3RespItem {
	this := SpotGetMyPreventedMatchesV3RespItem{}
	return &this
}
...
func (o *SpotGetMyPreventedMatchesV3RespItem) SetMakerOrderId(v int64) {
	o.MakerOrderId = &v
}
...
func (o *SpotGetMyPreventedMatchesV3RespItem) HasMakerSymbol() bool {
	if o != nil && !IsNil(o.MakerSymbol) {
		return true
	}
...
func (o *SpotGetMyPreventedMatchesV3RespItem) GetSelfTradePreventionMode() string {
...
// and a boolean to check if the value has been set.
func (o *SpotGetMyPreventedMatchesV3RespItem) GetTakerOrderIdOk() (*int64, bool) {
	if o == nil || IsNil(o.TakerOrderId) {
		return nil, false
	}
...
func (o *SpotGetMyPreventedMatchesV3RespItem) SetTransactTime(v int64) {
	o.TransactTime = &v
}

func (o SpotGetMyPreventedMatchesV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o SpotGetMyPreventedMatchesV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableSpotGetMyPreventedMatchesV3RespItem struct {
	value *SpotGetMyPreventedMatchesV3RespItem
	isSet bool
}

func (v NullableSpotGetMyPreventedMatchesV3RespItem) Get() *SpotGetMyPreventedMatchesV3RespItem {
	return v.value
}

func (v *NullableSpotGetMyPreventedMatchesV3RespItem) Set(val *SpotGetMyPreventedMatchesV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotGetMyPreventedMatchesV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotGetMyPreventedMatchesV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotGetMyPreventedMatchesV3RespItem(val *SpotGetMyPreventedMatchesV3RespItem) *NullableSpotGetMyPreventedMatchesV3RespItem {
	return &NullableSpotGetMyPreventedMatchesV3RespItem{value: val, isSet: true}
}

func (v NullableSpotGetMyPreventedMatchesV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotGetMyPreventedMatchesV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
