...
// checks if the SpotGetOpenOrderListV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotGetOpenOrderListV3RespItem{}

// SpotGetOpenOrderListV3RespItem struct for SpotGetOpenOrderListV3RespItem
type SpotGetOpenOrderListV3RespItem struct {
...
func NewSpotGetOpenOrderListV3RespItem() *SpotGetOpenOrderListV3RespItem {
	this := SpotGetOpenOrderListV3RespItem{}
	return &this
}
...
func (o SpotGetOpenOrderListV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o SpotGetOpenOrderListV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableSpotGetOpenOrderListV3RespItem struct {
	value *SpotGetOpenOrderListV3RespItem
	isSet bool
}

func (v NullableSpotGetOpenOrderListV3RespItem) Get() *SpotGetOpenOrderListV3RespItem {
	return v.value
}

func (v *NullableSpotGetOpenOrderListV3RespItem) Set(val *SpotGetOpenOrderListV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotGetOpenOrderListV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotGetOpenOrderListV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotGetOpenOrderListV3RespItem(val *SpotGetOpenOrderListV3RespItem) *NullableSpotGetOpenOrderListV3RespItem {
	return &NullableSpotGetOpenOrderListV3RespItem{value: val, isSet: true}
}

func (v NullableSpotGetOpenOrderListV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotGetOpenOrderListV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
