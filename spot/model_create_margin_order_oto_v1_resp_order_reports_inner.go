...
// checks if the CreateMarginOrderOtoV1RespOrderReportsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMarginOrderOtoV1RespOrderReportsInner{}

// CreateMarginOrderOtoV1RespOrderReportsInner struct for CreateMarginOrderOtoV1RespOrderReportsInner
type CreateMarginOrderOtoV1RespOrderReportsInner struct {
...
func NewCreateMarginOrderOtoV1RespOrderReportsInner() *CreateMarginOrderOtoV1RespOrderReportsInner {
	this := CreateMarginOrderOtoV1RespOrderReportsInner{}
	return &this
}
...
func (o CreateMarginOrderOtoV1RespOrderReportsInner) MarshalJSON() ([]byte, error) {
...
func (o CreateMarginOrderOtoV1RespOrderReportsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateMarginOrderOtoV1RespOrderReportsInner struct {
	value *CreateMarginOrderOtoV1RespOrderReportsInner
	isSet bool
}

func (v NullableCreateMarginOrderOtoV1RespOrderReportsInner) Get() *CreateMarginOrderOtoV1RespOrderReportsInner {
	return v.value
}

func (v *NullableCreateMarginOrderOtoV1RespOrderReportsInner) Set(val *CreateMarginOrderOtoV1RespOrderReportsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMarginOrderOtoV1RespOrderReportsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMarginOrderOtoV1RespOrderReportsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMarginOrderOtoV1RespOrderReportsInner(val *CreateMarginOrderOtoV1RespOrderReportsInner) *NullableCreateMarginOrderOtoV1RespOrderReportsInner {
	return &NullableCreateMarginOrderOtoV1RespOrderReportsInner{value: val, isSet: true}
}

func (v NullableCreateMarginOrderOtoV1RespOrderReportsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMarginOrderOtoV1RespOrderReportsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
