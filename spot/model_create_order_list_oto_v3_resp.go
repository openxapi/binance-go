...
// checks if the CreateOrderListOtoV3Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOrderListOtoV3Resp{}

// CreateOrderListOtoV3Resp struct for CreateOrderListOtoV3Resp
type CreateOrderListOtoV3Resp struct {
...
func (o CreateOrderListOtoV3Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateOrderListOtoV3Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateOrderListOtoV3Resp struct {
	value *CreateOrderListOtoV3Resp
	isSet bool
}

func (v NullableCreateOrderListOtoV3Resp) Get() *CreateOrderListOtoV3Resp {
	return v.value
}

func (v *NullableCreateOrderListOtoV3Resp) Set(val *CreateOrderListOtoV3Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOrderListOtoV3Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOrderListOtoV3Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOrderListOtoV3Resp(val *CreateOrderListOtoV3Resp) *NullableCreateOrderListOtoV3Resp {
	return &NullableCreateOrderListOtoV3Resp{value: val, isSet: true}
}

func (v NullableCreateOrderListOtoV3Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOrderListOtoV3Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
