...
// checks if the GetAssetAssetDividendV1RespRowsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAssetAssetDividendV1RespRowsInner{}

// GetAssetAssetDividendV1RespRowsInner struct for GetAssetAssetDividendV1RespRowsInner
type GetAssetAssetDividendV1RespRowsInner struct {
...
func NewGetAssetAssetDividendV1RespRowsInner() *GetAssetAssetDividendV1RespRowsInner {
	this := GetAssetAssetDividendV1RespRowsInner{}
	return &this
}
...
func (o GetAssetAssetDividendV1RespRowsInner) MarshalJSON() ([]byte, error) {
...
func (o GetAssetAssetDividendV1RespRowsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetAssetAssetDividendV1RespRowsInner struct {
	value *GetAssetAssetDividendV1RespRowsInner
	isSet bool
}

func (v NullableGetAssetAssetDividendV1RespRowsInner) Get() *GetAssetAssetDividendV1RespRowsInner {
	return v.value
}

func (v *NullableGetAssetAssetDividendV1RespRowsInner) Set(val *GetAssetAssetDividendV1RespRowsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAssetAssetDividendV1RespRowsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAssetAssetDividendV1RespRowsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAssetAssetDividendV1RespRowsInner(val *GetAssetAssetDividendV1RespRowsInner) *NullableGetAssetAssetDividendV1RespRowsInner {
	return &NullableGetAssetAssetDividendV1RespRowsInner{value: val, isSet: true}
}

func (v NullableGetAssetAssetDividendV1RespRowsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAssetAssetDividendV1RespRowsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
