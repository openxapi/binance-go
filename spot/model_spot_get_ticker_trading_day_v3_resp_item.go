...
// checks if the SpotGetTickerTradingDayV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotGetTickerTradingDayV3RespItem{}

// SpotGetTickerTradingDayV3RespItem struct for SpotGetTickerTradingDayV3RespItem
type SpotGetTickerTradingDayV3RespItem struct {
...
func NewSpotGetTickerTradingDayV3RespItem() *SpotGetTickerTradingDayV3RespItem {
	this := SpotGetTickerTradingDayV3RespItem{}
	return &this
}
...
func (o SpotGetTickerTradingDayV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o SpotGetTickerTradingDayV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableSpotGetTickerTradingDayV3RespItem struct {
	value *SpotGetTickerTradingDayV3RespItem
	isSet bool
}

func (v NullableSpotGetTickerTradingDayV3RespItem) Get() *SpotGetTickerTradingDayV3RespItem {
	return v.value
}

func (v *NullableSpotGetTickerTradingDayV3RespItem) Set(val *SpotGetTickerTradingDayV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotGetTickerTradingDayV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotGetTickerTradingDayV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotGetTickerTradingDayV3RespItem(val *SpotGetTickerTradingDayV3RespItem) *NullableSpotGetTickerTradingDayV3RespItem {
	return &NullableSpotGetTickerTradingDayV3RespItem{value: val, isSet: true}
}

func (v NullableSpotGetTickerTradingDayV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotGetTickerTradingDayV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
