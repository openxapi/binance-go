...
// checks if the GetMarginInterestHistoryV1RespRowsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarginInterestHistoryV1RespRowsInner{}

// GetMarginInterestHistoryV1RespRowsInner struct for GetMarginInterestHistoryV1RespRowsInner
type GetMarginInterestHistoryV1RespRowsInner struct {
...
func NewGetMarginInterestHistoryV1RespRowsInner() *GetMarginInterestHistoryV1RespRowsInner {
	this := GetMarginInterestHistoryV1RespRowsInner{}
	return &this
}
...
func (o *GetMarginInterestHistoryV1RespRowsInner) SetAsset(v string) {
	o.Asset = &v
}
...
func (o *GetMarginInterestHistoryV1RespRowsInner) HasInterestAccuredTime() bool {
	if o != nil && !IsNil(o.InterestAccuredTime) {
		return true
	}
...
func (o *GetMarginInterestHistoryV1RespRowsInner) GetPrincipal() string {
...
func (o GetMarginInterestHistoryV1RespRowsInner) MarshalJSON() ([]byte, error) {
...
func (o GetMarginInterestHistoryV1RespRowsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetMarginInterestHistoryV1RespRowsInner struct {
	value *GetMarginInterestHistoryV1RespRowsInner
	isSet bool
}

func (v NullableGetMarginInterestHistoryV1RespRowsInner) Get() *GetMarginInterestHistoryV1RespRowsInner {
	return v.value
}

func (v *NullableGetMarginInterestHistoryV1RespRowsInner) Set(val *GetMarginInterestHistoryV1RespRowsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarginInterestHistoryV1RespRowsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarginInterestHistoryV1RespRowsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarginInterestHistoryV1RespRowsInner(val *GetMarginInterestHistoryV1RespRowsInner) *NullableGetMarginInterestHistoryV1RespRowsInner {
	return &NullableGetMarginInterestHistoryV1RespRowsInner{value: val, isSet: true}
}

func (v NullableGetMarginInterestHistoryV1RespRowsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarginInterestHistoryV1RespRowsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
