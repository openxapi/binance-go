...
// checks if the GetLocalentityDepositHistoryV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLocalentityDepositHistoryV1RespItem{}

// GetLocalentityDepositHistoryV1RespItem struct for GetLocalentityDepositHistoryV1RespItem
type GetLocalentityDepositHistoryV1RespItem struct {
...
func NewGetLocalentityDepositHistoryV1RespItem() *GetLocalentityDepositHistoryV1RespItem {
	this := GetLocalentityDepositHistoryV1RespItem{}
	return &this
}
...
func (o *GetLocalentityDepositHistoryV1RespItem) HasConfirmTimes() bool {
	if o != nil && !IsNil(o.ConfirmTimes) {
		return true
	}
...
func (o *GetLocalentityDepositHistoryV1RespItem) GetNetwork() string {
...
func (o GetLocalentityDepositHistoryV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetLocalentityDepositHistoryV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetLocalentityDepositHistoryV1RespItem struct {
	value *GetLocalentityDepositHistoryV1RespItem
	isSet bool
}

func (v NullableGetLocalentityDepositHistoryV1RespItem) Get() *GetLocalentityDepositHistoryV1RespItem {
	return v.value
}

func (v *NullableGetLocalentityDepositHistoryV1RespItem) Set(val *GetLocalentityDepositHistoryV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLocalentityDepositHistoryV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLocalentityDepositHistoryV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLocalentityDepositHistoryV1RespItem(val *GetLocalentityDepositHistoryV1RespItem) *NullableGetLocalentityDepositHistoryV1RespItem {
	return &NullableGetLocalentityDepositHistoryV1RespItem{value: val, isSet: true}
}

func (v NullableGetLocalentityDepositHistoryV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLocalentityDepositHistoryV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
