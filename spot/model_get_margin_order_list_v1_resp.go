...
// checks if the GetMarginOrderListV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarginOrderListV1Resp{}
...
type NullableGetMarginOrderListV1Resp struct {
	value *GetMarginOrderListV1Resp
	isSet bool
}

func (v NullableGetMarginOrderListV1Resp) Get() *GetMarginOrderListV1Resp {
	return v.value
}

func (v *NullableGetMarginOrderListV1Resp) Set(val *GetMarginOrderListV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarginOrderListV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarginOrderListV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarginOrderListV1Resp(val *GetMarginOrderListV1Resp) *NullableGetMarginOrderListV1Resp {
	return &NullableGetMarginOrderListV1Resp{value: val, isSet: true}
}
