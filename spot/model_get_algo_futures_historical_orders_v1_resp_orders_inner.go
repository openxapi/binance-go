...
// checks if the GetAlgoFuturesHistoricalOrdersV1RespOrdersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAlgoFuturesHistoricalOrdersV1RespOrdersInner{}

// GetAlgoFuturesHistoricalOrdersV1RespOrdersInner struct for GetAlgoFuturesHistoricalOrdersV1RespOrdersInner
type GetAlgoFuturesHistoricalOrdersV1RespOrdersInner struct {
...
func NewGetAlgoFuturesHistoricalOrdersV1RespOrdersInner() *GetAlgoFuturesHistoricalOrdersV1RespOrdersInner {
	this := GetAlgoFuturesHistoricalOrdersV1RespOrdersInner{}
	return &this
}
...
func (o GetAlgoFuturesHistoricalOrdersV1RespOrdersInner) MarshalJSON() ([]byte, error) {
...
func (o GetAlgoFuturesHistoricalOrdersV1RespOrdersInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetAlgoFuturesHistoricalOrdersV1RespOrdersInner struct {
	value *GetAlgoFuturesHistoricalOrdersV1RespOrdersInner
	isSet bool
}

func (v NullableGetAlgoFuturesHistoricalOrdersV1RespOrdersInner) Get() *GetAlgoFuturesHistoricalOrdersV1RespOrdersInner {
	return v.value
}

func (v *NullableGetAlgoFuturesHistoricalOrdersV1RespOrdersInner) Set(val *GetAlgoFuturesHistoricalOrdersV1RespOrdersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAlgoFuturesHistoricalOrdersV1RespOrdersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAlgoFuturesHistoricalOrdersV1RespOrdersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAlgoFuturesHistoricalOrdersV1RespOrdersInner(val *GetAlgoFuturesHistoricalOrdersV1RespOrdersInner) *NullableGetAlgoFuturesHistoricalOrdersV1RespOrdersInner {
	return &NullableGetAlgoFuturesHistoricalOrdersV1RespOrdersInner{value: val, isSet: true}
}

func (v NullableGetAlgoFuturesHistoricalOrdersV1RespOrdersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAlgoFuturesHistoricalOrdersV1RespOrdersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
