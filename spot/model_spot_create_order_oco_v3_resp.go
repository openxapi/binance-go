...
// checks if the SpotCreateOrderOcoV3Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotCreateOrderOcoV3Resp{}

// SpotCreateOrderOcoV3Resp struct for SpotCreateOrderOcoV3Resp
type SpotCreateOrderOcoV3Resp struct {
	ContingencyType *string `json:"contingencyType,omitempty"`
	ListClientOrderId *string `json:"listClientOrderId,omitempty"`
	ListOrderStatus *string `json:"listOrderStatus,omitempty"`
	ListStatusType *string `json:"listStatusType,omitempty"`
	OrderListId *int64 `json:"orderListId,omitempty"`
	OrderReports []SpotCreateOrderOcoV3RespOrderReportsInner `json:"orderReports,omitempty"`
...
func (o *SpotCreateOrderOcoV3Resp) GetOrderReports() []SpotCreateOrderOcoV3RespOrderReportsInner {
	if o == nil || IsNil(o.OrderReports) {
		var ret []SpotCreateOrderOcoV3RespOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []SpotCreateOrderOcoV3RespOrderReportsInner and assigns it to the OrderReports field.
...
func (o SpotCreateOrderOcoV3Resp) MarshalJSON() ([]byte, error) {
...
func (o SpotCreateOrderOcoV3Resp) ToMap() (map[string]interface{}, error) {
...
type NullableSpotCreateOrderOcoV3Resp struct {
	value *SpotCreateOrderOcoV3Resp
	isSet bool
}

func (v NullableSpotCreateOrderOcoV3Resp) Get() *SpotCreateOrderOcoV3Resp {
	return v.value
}

func (v *NullableSpotCreateOrderOcoV3Resp) Set(val *SpotCreateOrderOcoV3Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotCreateOrderOcoV3Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotCreateOrderOcoV3Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotCreateOrderOcoV3Resp(val *SpotCreateOrderOcoV3Resp) *NullableSpotCreateOrderOcoV3Resp {
	return &NullableSpotCreateOrderOcoV3Resp{value: val, isSet: true}
}

func (v NullableSpotCreateOrderOcoV3Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotCreateOrderOcoV3Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
