...
// checks if the SpotCreateOrderListOcoV3Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotCreateOrderListOcoV3Resp{}

// SpotCreateOrderListOcoV3Resp struct for SpotCreateOrderListOcoV3Resp
type SpotCreateOrderListOcoV3Resp struct {
	ContingencyType *string `json:"contingencyType,omitempty"`
	ListClientOrderId *string `json:"listClientOrderId,omitempty"`
	ListOrderStatus *string `json:"listOrderStatus,omitempty"`
	ListStatusType *string `json:"listStatusType,omitempty"`
	OrderListId *int64 `json:"orderListId,omitempty"`
	OrderReports []SpotCreateOrderListOcoV3RespOrderReportsInner `json:"orderReports,omitempty"`
...
func NewSpotCreateOrderListOcoV3Resp() *SpotCreateOrderListOcoV3Resp {
	this := SpotCreateOrderListOcoV3Resp{}
	return &this
}
...
func (o *SpotCreateOrderListOcoV3Resp) GetOrderReports() []SpotCreateOrderListOcoV3RespOrderReportsInner {
	if o == nil || IsNil(o.OrderReports) {
		var ret []SpotCreateOrderListOcoV3RespOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []SpotCreateOrderListOcoV3RespOrderReportsInner and assigns it to the OrderReports field.
...
func (o SpotCreateOrderListOcoV3Resp) MarshalJSON() ([]byte, error) {
...
func (o SpotCreateOrderListOcoV3Resp) ToMap() (map[string]interface{}, error) {
...
type NullableSpotCreateOrderListOcoV3Resp struct {
	value *SpotCreateOrderListOcoV3Resp
	isSet bool
}

func (v NullableSpotCreateOrderListOcoV3Resp) Get() *SpotCreateOrderListOcoV3Resp {
	return v.value
}

func (v *NullableSpotCreateOrderListOcoV3Resp) Set(val *SpotCreateOrderListOcoV3Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotCreateOrderListOcoV3Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotCreateOrderListOcoV3Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotCreateOrderListOcoV3Resp(val *SpotCreateOrderListOcoV3Resp) *NullableSpotCreateOrderListOcoV3Resp {
	return &NullableSpotCreateOrderListOcoV3Resp{value: val, isSet: true}
}

func (v NullableSpotCreateOrderListOcoV3Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotCreateOrderListOcoV3Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
