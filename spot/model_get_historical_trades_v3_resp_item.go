...
// checks if the GetHistoricalTradesV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetHistoricalTradesV3RespItem{}

// GetHistoricalTradesV3RespItem struct for GetHistoricalTradesV3RespItem
type GetHistoricalTradesV3RespItem struct {
...
func NewGetHistoricalTradesV3RespItem() *GetHistoricalTradesV3RespItem {
	this := GetHistoricalTradesV3RespItem{}
	return &this
}
...
func (o *GetHistoricalTradesV3RespItem) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *GetHistoricalTradesV3RespItem) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *GetHistoricalTradesV3RespItem) SetId(v int32) {
	o.Id = &v
}
...
func (o GetHistoricalTradesV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetHistoricalTradesV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetHistoricalTradesV3RespItem struct {
	value *GetHistoricalTradesV3RespItem
	isSet bool
}

func (v NullableGetHistoricalTradesV3RespItem) Get() *GetHistoricalTradesV3RespItem {
	return v.value
}

func (v *NullableGetHistoricalTradesV3RespItem) Set(val *GetHistoricalTradesV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetHistoricalTradesV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetHistoricalTradesV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetHistoricalTradesV3RespItem(val *GetHistoricalTradesV3RespItem) *NullableGetHistoricalTradesV3RespItem {
	return &NullableGetHistoricalTradesV3RespItem{value: val, isSet: true}
}

func (v NullableGetHistoricalTradesV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetHistoricalTradesV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
