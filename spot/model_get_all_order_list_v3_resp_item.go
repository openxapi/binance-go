...
// checks if the GetAllOrderListV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllOrderListV3RespItem{}

// GetAllOrderListV3RespItem struct for GetAllOrderListV3RespItem
type GetAllOrderListV3RespItem struct {
...
func NewGetAllOrderListV3RespItem() *GetAllOrderListV3RespItem {
	this := GetAllOrderListV3RespItem{}
	return &this
}
...
func (o GetAllOrderListV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetAllOrderListV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetAllOrderListV3RespItem struct {
	value *GetAllOrderListV3RespItem
	isSet bool
}

func (v NullableGetAllOrderListV3RespItem) Get() *GetAllOrderListV3RespItem {
	return v.value
}

func (v *NullableGetAllOrderListV3RespItem) Set(val *GetAllOrderListV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllOrderListV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllOrderListV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllOrderListV3RespItem(val *GetAllOrderListV3RespItem) *NullableGetAllOrderListV3RespItem {
	return &NullableGetAllOrderListV3RespItem{value: val, isSet: true}
}

func (v NullableGetAllOrderListV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllOrderListV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
