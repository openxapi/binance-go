...
// checks if the SpotCreateOrderOcoV3RespOrderReportsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotCreateOrderOcoV3RespOrderReportsInner{}

// SpotCreateOrderOcoV3RespOrderReportsInner struct for SpotCreateOrderOcoV3RespOrderReportsInner
type SpotCreateOrderOcoV3RespOrderReportsInner struct {
...
func NewSpotCreateOrderOcoV3RespOrderReportsInner() *SpotCreateOrderOcoV3RespOrderReportsInner {
	this := SpotCreateOrderOcoV3RespOrderReportsInner{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *SpotCreateOrderOcoV3RespOrderReportsInner) GetExecutedQtyOk() (*string, bool) {
	if o == nil || IsNil(o.ExecutedQty) {
		return nil, false
	}
...
func (o *SpotCreateOrderOcoV3RespOrderReportsInner) SetOrderListId(v int64) {
	o.OrderListId = &v
}
...
func (o *SpotCreateOrderOcoV3RespOrderReportsInner) HasOrigQuoteOrderQty() bool {
	if o != nil && !IsNil(o.OrigQuoteOrderQty) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SpotCreateOrderOcoV3RespOrderReportsInner) GetStopPriceOk() (*string, bool) {
	if o == nil || IsNil(o.StopPrice) {
		return nil, false
	}
...
func (o *SpotCreateOrderOcoV3RespOrderReportsInner) SetTimeInForce(v string) {
	o.TimeInForce = &v
}
...
func (o SpotCreateOrderOcoV3RespOrderReportsInner) MarshalJSON() ([]byte, error) {
...
func (o SpotCreateOrderOcoV3RespOrderReportsInner) ToMap() (map[string]interface{}, error) {
...
type NullableSpotCreateOrderOcoV3RespOrderReportsInner struct {
	value *SpotCreateOrderOcoV3RespOrderReportsInner
	isSet bool
}

func (v NullableSpotCreateOrderOcoV3RespOrderReportsInner) Get() *SpotCreateOrderOcoV3RespOrderReportsInner {
	return v.value
}

func (v *NullableSpotCreateOrderOcoV3RespOrderReportsInner) Set(val *SpotCreateOrderOcoV3RespOrderReportsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotCreateOrderOcoV3RespOrderReportsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotCreateOrderOcoV3RespOrderReportsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotCreateOrderOcoV3RespOrderReportsInner(val *SpotCreateOrderOcoV3RespOrderReportsInner) *NullableSpotCreateOrderOcoV3RespOrderReportsInner {
	return &NullableSpotCreateOrderOcoV3RespOrderReportsInner{value: val, isSet: true}
}

func (v NullableSpotCreateOrderOcoV3RespOrderReportsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotCreateOrderOcoV3RespOrderReportsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
