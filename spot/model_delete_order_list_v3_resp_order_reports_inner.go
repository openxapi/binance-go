...
// checks if the DeleteOrderListV3RespOrderReportsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteOrderListV3RespOrderReportsInner{}

// DeleteOrderListV3RespOrderReportsInner struct for DeleteOrderListV3RespOrderReportsInner
type DeleteOrderListV3RespOrderReportsInner struct {
...
func NewDeleteOrderListV3RespOrderReportsInner() *DeleteOrderListV3RespOrderReportsInner {
	this := DeleteOrderListV3RespOrderReportsInner{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *DeleteOrderListV3RespOrderReportsInner) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *DeleteOrderListV3RespOrderReportsInner) SetSymbol(v string) {
	o.Symbol = &v
}
...
func (o DeleteOrderListV3RespOrderReportsInner) MarshalJSON() ([]byte, error) {
...
func (o DeleteOrderListV3RespOrderReportsInner) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteOrderListV3RespOrderReportsInner struct {
	value *DeleteOrderListV3RespOrderReportsInner
	isSet bool
}

func (v NullableDeleteOrderListV3RespOrderReportsInner) Get() *DeleteOrderListV3RespOrderReportsInner {
	return v.value
}

func (v *NullableDeleteOrderListV3RespOrderReportsInner) Set(val *DeleteOrderListV3RespOrderReportsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteOrderListV3RespOrderReportsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteOrderListV3RespOrderReportsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteOrderListV3RespOrderReportsInner(val *DeleteOrderListV3RespOrderReportsInner) *NullableDeleteOrderListV3RespOrderReportsInner {
	return &NullableDeleteOrderListV3RespOrderReportsInner{value: val, isSet: true}
}

func (v NullableDeleteOrderListV3RespOrderReportsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteOrderListV3RespOrderReportsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
