...
// checks if the CreateMarginOrderOcoV1RespOrderReportsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMarginOrderOcoV1RespOrderReportsInner{}
...
func NewCreateMarginOrderOcoV1RespOrderReportsInner() *CreateMarginOrderOcoV1RespOrderReportsInner {
	this := CreateMarginOrderOcoV1RespOrderReportsInner{}
	return &this
}
...
func (o CreateMarginOrderOcoV1RespOrderReportsInner) MarshalJSON() ([]byte, error) {
...
type NullableCreateMarginOrderOcoV1RespOrderReportsInner struct {
	value *CreateMarginOrderOcoV1RespOrderReportsInner
	isSet bool
}

func (v NullableCreateMarginOrderOcoV1RespOrderReportsInner) Get() *CreateMarginOrderOcoV1RespOrderReportsInner {
	return v.value
}

func (v *NullableCreateMarginOrderOcoV1RespOrderReportsInner) Set(val *CreateMarginOrderOcoV1RespOrderReportsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMarginOrderOcoV1RespOrderReportsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMarginOrderOcoV1RespOrderReportsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMarginOrderOcoV1RespOrderReportsInner(val *CreateMarginOrderOcoV1RespOrderReportsInner) *NullableCreateMarginOrderOcoV1RespOrderReportsInner {
	return &NullableCreateMarginOrderOcoV1RespOrderReportsInner{value: val, isSet: true}
}

func (v NullableCreateMarginOrderOcoV1RespOrderReportsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMarginOrderOcoV1RespOrderReportsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
