...
// checks if the SpotGetTradesV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotGetTradesV3RespItem{}

// SpotGetTradesV3RespItem struct for SpotGetTradesV3RespItem
type SpotGetTradesV3RespItem struct {
...
func (o SpotGetTradesV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o SpotGetTradesV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableSpotGetTradesV3RespItem struct {
	value *SpotGetTradesV3RespItem
	isSet bool
}

func (v NullableSpotGetTradesV3RespItem) Get() *SpotGetTradesV3RespItem {
	return v.value
}

func (v *NullableSpotGetTradesV3RespItem) Set(val *SpotGetTradesV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotGetTradesV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotGetTradesV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotGetTradesV3RespItem(val *SpotGetTradesV3RespItem) *NullableSpotGetTradesV3RespItem {
	return &NullableSpotGetTradesV3RespItem{value: val, isSet: true}
}

func (v NullableSpotGetTradesV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotGetTradesV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
