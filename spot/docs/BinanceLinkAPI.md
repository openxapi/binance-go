...
> CreateBrokerSubAccountApiPermissionUniversalTransferV1Resp CreateBrokerSubAccountApiPermissionUniversalTransferV1(ctx).CanUniversalTransfer(canUniversalTransfer).SubAccountApiKey(subAccountApiKey).SubAccountId(subAccountId).Timestamp(timestamp).RecvWindow(recvWindow).Execute()
...
## CreateBrokerUniversalTransferV1
...
> map[string]interface{} DeleteBrokerSubAccountApiV1(ctx).SubAccountId(subAccountId).SubAccountApiKey(subAccountApiKey).Timestamp(timestamp).RecvWindow(recvWindow).Execute()
...
Other parameters are passed through a pointer to a apiGetBrokerSubAccountSpotSummaryV1Request struct via the builder pattern
...
## GetBrokerSubAccountV1

> []GetBrokerSubAccountV1RespItem GetBrokerSubAccountV1(ctx).Timestamp(timestamp).SubAccountId(subAccountId).Page(page).Size(size).RecvWindow(recvWindow).Execute()
...
func main() {
	...
	subAccountId := "subAccountId_example" // string |  (optional) (default to "")
	page := int64(789) // int64 | default 1 (optional) (default to 1)
	size := int64(789) // int64 | default 500 (optional) (default to 500)
	recvWindow := int64(789) // int64 |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.BinanceLinkAPI.GetBrokerSubAccountV1(context.Background()).Timestamp(timestamp).SubAccountId(subAccountId).Page(page).Size(size).RecvWindow(recvWindow).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinanceLinkAPI.GetBrokerSubAccountV1``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetBrokerSubAccountV1`: []GetBrokerSubAccountV1RespItem
	fmt.Fprintf(os.Stdout, "Response from `BinanceLinkAPI.GetBrokerSubAccountV1`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetBrokerSubAccountV1Request struct via the builder pattern
 ...
 **subAccountId** | **string** |  | [default to &quot;&quot;]
 **page** | **int64** | default 1 | [default to 1]
 **size** | **int64** | default 500 | [default to 500]
 **recvWindow** | **int64** |  | 

### Return type

[**[]GetBrokerSubAccountV1RespItem**](GetBrokerSubAccountV1RespItem.md)
...
## GetBrokerTransferFuturesV1

> GetBrokerTransferFuturesV1Resp GetBrokerTransferFuturesV1(ctx).SubAccountId(subAccountId).FuturesType(futuresType).Timestamp(timestamp).ClientTranId(clientTranId).StartTime(startTime).EndTime(endTime).Page(page).Limit(limit).RecvWindow(recvWindow).Execute()
...
func main() {
	...
	timestamp := int64(789) // int64 | 
	clientTranId := "clientTranId_example" // string |  (optional) (default to "")
	startTime := int64(789) // int64 | default 30 days records (optional)
	endTime := int64(789) // int64 | default 30 days records (optional)
	page := int32(56) // int32 | default 1 (optional) (default to 1)
	limit := int32(56) // int32 | default 50, max 500 (optional) (default to 50)
	recvWindow := int64(789) // int64 |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.BinanceLinkAPI.GetBrokerTransferFuturesV1(context.Background()).SubAccountId(subAccountId).FuturesType(futuresType).Timestamp(timestamp).ClientTranId(clientTranId).StartTime(startTime).EndTime(endTime).Page(page).Limit(limit).RecvWindow(recvWindow).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinanceLinkAPI.GetBrokerTransferFuturesV1``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetBrokerTransferFuturesV1`: GetBrokerTransferFuturesV1Resp
	fmt.Fprintf(os.Stdout, "Response from `BinanceLinkAPI.GetBrokerTransferFuturesV1`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetBrokerTransferFuturesV1Request struct via the builder pattern
 ...
 **timestamp** | **int64** |  | 
 **clientTranId** | **string** |  | [default to &quot;&quot;]
 **startTime** | **int64** | default 30 days records | 
 **endTime** | **int64** | default 30 days records | 
 **page** | **int32** | default 1 | [default to 1]
 **limit** | **int32** | default 50, max 500 | [default to 50]
 **recvWindow** | **int64** |  | 
...
> []GetBrokerTransferV1RespItem GetBrokerTransferV1(ctx).Timestamp(timestamp).FromId(fromId).ToId(toId).ClientTranId(clientTranId).ShowAllStatus(showAllStatus).StartTime(startTime).EndTime(endTime).Page(page).Limit(limit).RecvWindow(recvWindow).Execute()
...
func main() {
	...
	fromId := "fromId_example" // string |  (optional) (default to "")
	toId := "toId_example" // string |  (optional) (default to "")
	clientTranId := "clientTranId_example" // string | client transfer id (optional) (default to "")
	showAllStatus := "showAllStatus_example" // string | true or false, default: false (optional) (default to "false")
	startTime := int64(789) // int64 |  (optional)
	endTime := int64(789) // int64 |  (optional)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.BinanceLinkAPI.GetBrokerTransferV1(context.Background()).Timestamp(timestamp).FromId(fromId).ToId(toId).ClientTranId(clientTranId).ShowAllStatus(showAllStatus).StartTime(startTime).EndTime(endTime).Page(page).Limit(limit).RecvWindow(recvWindow).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinanceLinkAPI.GetBrokerTransferV1``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetBrokerTransferV1`: []GetBrokerTransferV1RespItem
	fmt.Fprintf(os.Stdout, "Response from `BinanceLinkAPI.GetBrokerTransferV1`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetBrokerTransferV1Request struct via the builder pattern
 ...
 **fromId** | **string** |  | [default to &quot;&quot;]
 **toId** | **string** |  | [default to &quot;&quot;]
 **clientTranId** | **string** | client transfer id | [default to &quot;&quot;]
 **showAllStatus** | **string** | true or false, default: false | [default to &quot;false&quot;]
 **startTime** | **int64** |  | 
 **endTime** | **int64** |  | 
 **page** | **int32** |  | 
...
[**[]GetBrokerTransferV1RespItem**](GetBrokerTransferV1RespItem.md)
...
## GetBrokerUniversalTransferV1

> []GetBrokerUniversalTransferV1RespItem GetBrokerUniversalTransferV1(ctx).Timestamp(timestamp).FromId(fromId).ToId(toId).ClientTranId(clientTranId).StartTime(startTime).EndTime(endTime).Page(page).Limit(limit).ShowAllStatus(showAllStatus).RecvWindow(recvWindow).Execute()
...
func main() {
	...
	page := int32(56) // int32 | default 1 (optional) (default to 1)
	limit := int32(56) // int32 | default 500, max 500 (optional) (default to 500)
	showAllStatus := true // bool | TRUE or FALSE (optional)
	recvWindow := int64(789) // int64 |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.BinanceLinkAPI.GetBrokerUniversalTransferV1(context.Background()).Timestamp(timestamp).FromId(fromId).ToId(toId).ClientTranId(clientTranId).StartTime(startTime).EndTime(endTime).Page(page).Limit(limit).ShowAllStatus(showAllStatus).RecvWindow(recvWindow).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `BinanceLinkAPI.GetBrokerUniversalTransferV1``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetBrokerUniversalTransferV1`: []GetBrokerUniversalTransferV1RespItem
	fmt.Fprintf(os.Stdout, "Response from `BinanceLinkAPI.GetBrokerUniversalTransferV1`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetBrokerUniversalTransferV1Request struct via the builder pattern
 ...
 **page** | **int32** | default 1 | [default to 1]
 **limit** | **int32** | default 500, max 500 | [default to 500]
 **showAllStatus** | **bool** | TRUE or FALSE | 
 **recvWindow** | **int64** |  | 

### Return type

[**[]GetBrokerUniversalTransferV1RespItem**](GetBrokerUniversalTransferV1RespItem.md)
