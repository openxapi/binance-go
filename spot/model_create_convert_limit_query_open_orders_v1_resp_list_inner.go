...
// checks if the CreateConvertLimitQueryOpenOrdersV1RespListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateConvertLimitQueryOpenOrdersV1RespListInner{}

// CreateConvertLimitQueryOpenOrdersV1RespListInner struct for CreateConvertLimitQueryOpenOrdersV1RespListInner
type CreateConvertLimitQueryOpenOrdersV1RespListInner struct {
...
func NewCreateConvertLimitQueryOpenOrdersV1RespListInner() *CreateConvertLimitQueryOpenOrdersV1RespListInner {
	this := CreateConvertLimitQueryOpenOrdersV1RespListInner{}
	return &this
}
...
func (o *CreateConvertLimitQueryOpenOrdersV1RespListInner) SetFromAmount(v string) {
	o.FromAmount = &v
}
...
func (o CreateConvertLimitQueryOpenOrdersV1RespListInner) MarshalJSON() ([]byte, error) {
...
func (o CreateConvertLimitQueryOpenOrdersV1RespListInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateConvertLimitQueryOpenOrdersV1RespListInner struct {
	value *CreateConvertLimitQueryOpenOrdersV1RespListInner
	isSet bool
}

func (v NullableCreateConvertLimitQueryOpenOrdersV1RespListInner) Get() *CreateConvertLimitQueryOpenOrdersV1RespListInner {
	return v.value
}

func (v *NullableCreateConvertLimitQueryOpenOrdersV1RespListInner) Set(val *CreateConvertLimitQueryOpenOrdersV1RespListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateConvertLimitQueryOpenOrdersV1RespListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateConvertLimitQueryOpenOrdersV1RespListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateConvertLimitQueryOpenOrdersV1RespListInner(val *CreateConvertLimitQueryOpenOrdersV1RespListInner) *NullableCreateConvertLimitQueryOpenOrdersV1RespListInner {
	return &NullableCreateConvertLimitQueryOpenOrdersV1RespListInner{value: val, isSet: true}
}

func (v NullableCreateConvertLimitQueryOpenOrdersV1RespListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateConvertLimitQueryOpenOrdersV1RespListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
