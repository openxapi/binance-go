...
// checks if the DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp{}

// DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp struct for DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp
type DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp struct {
...
func NewDeleteBrokerSubAccountApiIpRestrictionIpListV1Resp() *DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp {
	this := DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp{}
	return &this
}
...
func (o DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp) MarshalJSON() ([]byte, error) {
...
func (o DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteBrokerSubAccountApiIpRestrictionIpListV1Resp struct {
	value *DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp
	isSet bool
}

func (v NullableDeleteBrokerSubAccountApiIpRestrictionIpListV1Resp) Get() *DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp {
	return v.value
}

func (v *NullableDeleteBrokerSubAccountApiIpRestrictionIpListV1Resp) Set(val *DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteBrokerSubAccountApiIpRestrictionIpListV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteBrokerSubAccountApiIpRestrictionIpListV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteBrokerSubAccountApiIpRestrictionIpListV1Resp(val *DeleteBrokerSubAccountApiIpRestrictionIpListV1Resp) *NullableDeleteBrokerSubAccountApiIpRestrictionIpListV1Resp {
	return &NullableDeleteBrokerSubAccountApiIpRestrictionIpListV1Resp{value: val, isSet: true}
}

func (v NullableDeleteBrokerSubAccountApiIpRestrictionIpListV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteBrokerSubAccountApiIpRestrictionIpListV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
