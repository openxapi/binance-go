...
// checks if the MarginGetMarginOpenOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarginGetMarginOpenOrdersV1RespItem{}

// MarginGetMarginOpenOrdersV1RespItem struct for MarginGetMarginOpenOrdersV1RespItem
type MarginGetMarginOpenOrdersV1RespItem struct {
...
func NewMarginGetMarginOpenOrdersV1RespItem() *MarginGetMarginOpenOrdersV1RespItem {
	this := MarginGetMarginOpenOrdersV1RespItem{}
	return &this
}
...
func (o MarginGetMarginOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o MarginGetMarginOpenOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableMarginGetMarginOpenOrdersV1RespItem struct {
	value *MarginGetMarginOpenOrdersV1RespItem
	isSet bool
}

func (v NullableMarginGetMarginOpenOrdersV1RespItem) Get() *MarginGetMarginOpenOrdersV1RespItem {
	return v.value
}

func (v *NullableMarginGetMarginOpenOrdersV1RespItem) Set(val *MarginGetMarginOpenOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableMarginGetMarginOpenOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableMarginGetMarginOpenOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarginGetMarginOpenOrdersV1RespItem(val *MarginGetMarginOpenOrdersV1RespItem) *NullableMarginGetMarginOpenOrdersV1RespItem {
	return &NullableMarginGetMarginOpenOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableMarginGetMarginOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarginGetMarginOpenOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
