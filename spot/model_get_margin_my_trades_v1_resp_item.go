...
// checks if the GetMarginMyTradesV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarginMyTradesV1RespItem{}
...
func NewGetMarginMyTradesV1RespItem() *GetMarginMyTradesV1RespItem {
	this := GetMarginMyTradesV1RespItem{}
	return &this
}
...
type NullableGetMarginMyTradesV1RespItem struct {
	value *GetMarginMyTradesV1RespItem
	isSet bool
}

func (v NullableGetMarginMyTradesV1RespItem) Get() *GetMarginMyTradesV1RespItem {
	return v.value
}

func (v *NullableGetMarginMyTradesV1RespItem) Set(val *GetMarginMyTradesV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarginMyTradesV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarginMyTradesV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarginMyTradesV1RespItem(val *GetMarginMyTradesV1RespItem) *NullableGetMarginMyTradesV1RespItem {
	return &NullableGetMarginMyTradesV1RespItem{value: val, isSet: true}
}
