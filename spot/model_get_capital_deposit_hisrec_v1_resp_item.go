...
// checks if the GetCapitalDepositHisrecV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCapitalDepositHisrecV1RespItem{}

// GetCapitalDepositHisrecV1RespItem struct for GetCapitalDepositHisrecV1RespItem
type GetCapitalDepositHisrecV1RespItem struct {
...
func NewGetCapitalDepositHisrecV1RespItem() *GetCapitalDepositHisrecV1RespItem {
	this := GetCapitalDepositHisrecV1RespItem{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *GetCapitalDepositHisrecV1RespItem) GetInsertTimeOk() (*int64, bool) {
	if o == nil || IsNil(o.InsertTime) {
		return nil, false
	}
...
func (o *GetCapitalDepositHisrecV1RespItem) SetStatus(v int32) {
	o.Status = &v
}
...
func (o GetCapitalDepositHisrecV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetCapitalDepositHisrecV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetCapitalDepositHisrecV1RespItem struct {
	value *GetCapitalDepositHisrecV1RespItem
	isSet bool
}

func (v NullableGetCapitalDepositHisrecV1RespItem) Get() *GetCapitalDepositHisrecV1RespItem {
	return v.value
}

func (v *NullableGetCapitalDepositHisrecV1RespItem) Set(val *GetCapitalDepositHisrecV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCapitalDepositHisrecV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCapitalDepositHisrecV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCapitalDepositHisrecV1RespItem(val *GetCapitalDepositHisrecV1RespItem) *NullableGetCapitalDepositHisrecV1RespItem {
	return &NullableGetCapitalDepositHisrecV1RespItem{value: val, isSet: true}
}

func (v NullableGetCapitalDepositHisrecV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCapitalDepositHisrecV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
