...
// checks if the SpotGetOrderListV3Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotGetOrderListV3Resp{}

// SpotGetOrderListV3Resp struct for SpotGetOrderListV3Resp
type SpotGetOrderListV3Resp struct {
...
func (o SpotGetOrderListV3Resp) MarshalJSON() ([]byte, error) {
...
func (o SpotGetOrderListV3Resp) ToMap() (map[string]interface{}, error) {
...
type NullableSpotGetOrderListV3Resp struct {
	value *SpotGetOrderListV3Resp
	isSet bool
}

func (v NullableSpotGetOrderListV3Resp) Get() *SpotGetOrderListV3Resp {
	return v.value
}

func (v *NullableSpotGetOrderListV3Resp) Set(val *SpotGetOrderListV3Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotGetOrderListV3Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotGetOrderListV3Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotGetOrderListV3Resp(val *SpotGetOrderListV3Resp) *NullableSpotGetOrderListV3Resp {
	return &NullableSpotGetOrderListV3Resp{value: val, isSet: true}
}

func (v NullableSpotGetOrderListV3Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotGetOrderListV3Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
