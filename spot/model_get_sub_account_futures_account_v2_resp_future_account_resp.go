...
// checks if the GetSubAccountFuturesAccountV2RespFutureAccountResp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSubAccountFuturesAccountV2RespFutureAccountResp{}

// GetSubAccountFuturesAccountV2RespFutureAccountResp struct for GetSubAccountFuturesAccountV2RespFutureAccountResp
type GetSubAccountFuturesAccountV2RespFutureAccountResp struct {
...
func NewGetSubAccountFuturesAccountV2RespFutureAccountResp() *GetSubAccountFuturesAccountV2RespFutureAccountResp {
	this := GetSubAccountFuturesAccountV2RespFutureAccountResp{}
	return &this
}
...
func (o GetSubAccountFuturesAccountV2RespFutureAccountResp) MarshalJSON() ([]byte, error) {
...
func (o GetSubAccountFuturesAccountV2RespFutureAccountResp) ToMap() (map[string]interface{}, error) {
...
type NullableGetSubAccountFuturesAccountV2RespFutureAccountResp struct {
	value *GetSubAccountFuturesAccountV2RespFutureAccountResp
	isSet bool
}

func (v NullableGetSubAccountFuturesAccountV2RespFutureAccountResp) Get() *GetSubAccountFuturesAccountV2RespFutureAccountResp {
	return v.value
}

func (v *NullableGetSubAccountFuturesAccountV2RespFutureAccountResp) Set(val *GetSubAccountFuturesAccountV2RespFutureAccountResp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSubAccountFuturesAccountV2RespFutureAccountResp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSubAccountFuturesAccountV2RespFutureAccountResp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSubAccountFuturesAccountV2RespFutureAccountResp(val *GetSubAccountFuturesAccountV2RespFutureAccountResp) *NullableGetSubAccountFuturesAccountV2RespFutureAccountResp {
	return &NullableGetSubAccountFuturesAccountV2RespFutureAccountResp{value: val, isSet: true}
}

func (v NullableGetSubAccountFuturesAccountV2RespFutureAccountResp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSubAccountFuturesAccountV2RespFutureAccountResp) UnmarshalJSON(src []byte) error {
	v.isSet = true
