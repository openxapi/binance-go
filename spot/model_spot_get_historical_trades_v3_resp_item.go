...
// checks if the SpotGetHistoricalTradesV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotGetHistoricalTradesV3RespItem{}

// SpotGetHistoricalTradesV3RespItem struct for SpotGetHistoricalTradesV3RespItem
type SpotGetHistoricalTradesV3RespItem struct {
...
func NewSpotGetHistoricalTradesV3RespItem() *SpotGetHistoricalTradesV3RespItem {
	this := SpotGetHistoricalTradesV3RespItem{}
	return &this
}
...
func (o SpotGetHistoricalTradesV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o SpotGetHistoricalTradesV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableSpotGetHistoricalTradesV3RespItem struct {
	value *SpotGetHistoricalTradesV3RespItem
	isSet bool
}

func (v NullableSpotGetHistoricalTradesV3RespItem) Get() *SpotGetHistoricalTradesV3RespItem {
	return v.value
}

func (v *NullableSpotGetHistoricalTradesV3RespItem) Set(val *SpotGetHistoricalTradesV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotGetHistoricalTradesV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotGetHistoricalTradesV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotGetHistoricalTradesV3RespItem(val *SpotGetHistoricalTradesV3RespItem) *NullableSpotGetHistoricalTradesV3RespItem {
	return &NullableSpotGetHistoricalTradesV3RespItem{value: val, isSet: true}
}

func (v NullableSpotGetHistoricalTradesV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotGetHistoricalTradesV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
