...
// checks if the CreateSorOrderV3RespFillsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSorOrderV3RespFillsInner{}

// CreateSorOrderV3RespFillsInner struct for CreateSorOrderV3RespFillsInner
type CreateSorOrderV3RespFillsInner struct {
...
func NewCreateSorOrderV3RespFillsInner() *CreateSorOrderV3RespFillsInner {
	this := CreateSorOrderV3RespFillsInner{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *CreateSorOrderV3RespFillsInner) GetQtyOk() (*string, bool) {
	if o == nil || IsNil(o.Qty) {
		return nil, false
	}
	return o.Qty, true
...
func (o CreateSorOrderV3RespFillsInner) MarshalJSON() ([]byte, error) {
...
func (o CreateSorOrderV3RespFillsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSorOrderV3RespFillsInner struct {
	value *CreateSorOrderV3RespFillsInner
	isSet bool
}

func (v NullableCreateSorOrderV3RespFillsInner) Get() *CreateSorOrderV3RespFillsInner {
	return v.value
}

func (v *NullableCreateSorOrderV3RespFillsInner) Set(val *CreateSorOrderV3RespFillsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSorOrderV3RespFillsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSorOrderV3RespFillsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSorOrderV3RespFillsInner(val *CreateSorOrderV3RespFillsInner) *NullableCreateSorOrderV3RespFillsInner {
	return &NullableCreateSorOrderV3RespFillsInner{value: val, isSet: true}
}

func (v NullableCreateSorOrderV3RespFillsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSorOrderV3RespFillsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
