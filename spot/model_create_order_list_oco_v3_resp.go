...
// checks if the CreateOrderListOcoV3Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOrderListOcoV3Resp{}

// CreateOrderListOcoV3Resp struct for CreateOrderListOcoV3Resp
type CreateOrderListOcoV3Resp struct {
	ContingencyType *string `json:"contingencyType,omitempty"`
	ListClientOrderId *string `json:"listClientOrderId,omitempty"`
	ListOrderStatus *string `json:"listOrderStatus,omitempty"`
	ListStatusType *string `json:"listStatusType,omitempty"`
	OrderListId *int64 `json:"orderListId,omitempty"`
	OrderReports []CreateOrderListOcoV3RespOrderReportsInner `json:"orderReports,omitempty"`
...
func (o *CreateOrderListOcoV3Resp) GetOrderReports() []CreateOrderListOcoV3RespOrderReportsInner {
	if o == nil || IsNil(o.OrderReports) {
		var ret []CreateOrderListOcoV3RespOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []CreateOrderListOcoV3RespOrderReportsInner and assigns it to the OrderReports field.
...
func (o CreateOrderListOcoV3Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateOrderListOcoV3Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateOrderListOcoV3Resp struct {
	value *CreateOrderListOcoV3Resp
	isSet bool
}

func (v NullableCreateOrderListOcoV3Resp) Get() *CreateOrderListOcoV3Resp {
	return v.value
}

func (v *NullableCreateOrderListOcoV3Resp) Set(val *CreateOrderListOcoV3Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOrderListOcoV3Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOrderListOcoV3Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOrderListOcoV3Resp(val *CreateOrderListOcoV3Resp) *NullableCreateOrderListOcoV3Resp {
	return &NullableCreateOrderListOcoV3Resp{value: val, isSet: true}
}

func (v NullableCreateOrderListOcoV3Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOrderListOcoV3Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
