...
// checks if the GetConvertOrderStatusV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetConvertOrderStatusV1Resp{}

// GetConvertOrderStatusV1Resp struct for GetConvertOrderStatusV1Resp
type GetConvertOrderStatusV1Resp struct {
...
func NewGetConvertOrderStatusV1Resp() *GetConvertOrderStatusV1Resp {
	this := GetConvertOrderStatusV1Resp{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *GetConvertOrderStatusV1Resp) GetOrderStatusOk() (*string, bool) {
	if o == nil || IsNil(o.OrderStatus) {
		return nil, false
	}
...
func (o *GetConvertOrderStatusV1Resp) SetToAmount(v string) {
	o.ToAmount = &v
}
...
func (o GetConvertOrderStatusV1Resp) MarshalJSON() ([]byte, error) {
...
func (o GetConvertOrderStatusV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetConvertOrderStatusV1Resp struct {
	value *GetConvertOrderStatusV1Resp
	isSet bool
}

func (v NullableGetConvertOrderStatusV1Resp) Get() *GetConvertOrderStatusV1Resp {
	return v.value
}

func (v *NullableGetConvertOrderStatusV1Resp) Set(val *GetConvertOrderStatusV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetConvertOrderStatusV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetConvertOrderStatusV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetConvertOrderStatusV1Resp(val *GetConvertOrderStatusV1Resp) *NullableGetConvertOrderStatusV1Resp {
	return &NullableGetConvertOrderStatusV1Resp{value: val, isSet: true}
}

func (v NullableGetConvertOrderStatusV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetConvertOrderStatusV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
