...
// checks if the CreateAlgoSpotNewOrderTwapV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAlgoSpotNewOrderTwapV1Resp{}

// CreateAlgoSpotNewOrderTwapV1Resp struct for CreateAlgoSpotNewOrderTwapV1Resp
type CreateAlgoSpotNewOrderTwapV1Resp struct {
...
func NewCreateAlgoSpotNewOrderTwapV1Resp() *CreateAlgoSpotNewOrderTwapV1Resp {
	this := CreateAlgoSpotNewOrderTwapV1Resp{}
	return &this
}
...
func (o CreateAlgoSpotNewOrderTwapV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateAlgoSpotNewOrderTwapV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAlgoSpotNewOrderTwapV1Resp struct {
	value *CreateAlgoSpotNewOrderTwapV1Resp
	isSet bool
}

func (v NullableCreateAlgoSpotNewOrderTwapV1Resp) Get() *CreateAlgoSpotNewOrderTwapV1Resp {
	return v.value
}

func (v *NullableCreateAlgoSpotNewOrderTwapV1Resp) Set(val *CreateAlgoSpotNewOrderTwapV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAlgoSpotNewOrderTwapV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAlgoSpotNewOrderTwapV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAlgoSpotNewOrderTwapV1Resp(val *CreateAlgoSpotNewOrderTwapV1Resp) *NullableCreateAlgoSpotNewOrderTwapV1Resp {
	return &NullableCreateAlgoSpotNewOrderTwapV1Resp{value: val, isSet: true}
}

func (v NullableCreateAlgoSpotNewOrderTwapV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAlgoSpotNewOrderTwapV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
