...
// checks if the CreateMarginOrderOtocoV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMarginOrderOtocoV1Resp{}

// CreateMarginOrderOtocoV1Resp struct for CreateMarginOrderOtocoV1Resp
type CreateMarginOrderOtocoV1Resp struct {
	...
	OrderReports []CreateMarginOrderOtoV1RespOrderReportsInner `json:"orderReports,omitempty"`
...
func NewCreateMarginOrderOtocoV1Resp() *CreateMarginOrderOtocoV1Resp {
	this := CreateMarginOrderOtocoV1Resp{}
	return &this
}
...
func (o *CreateMarginOrderOtocoV1Resp) GetOrderReports() []CreateMarginOrderOtoV1RespOrderReportsInner {
	if o == nil || IsNil(o.OrderReports) {
		var ret []CreateMarginOrderOtoV1RespOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []CreateMarginOrderOtoV1RespOrderReportsInner and assigns it to the OrderReports field.
...
func (o CreateMarginOrderOtocoV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateMarginOrderOtocoV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateMarginOrderOtocoV1Resp struct {
	value *CreateMarginOrderOtocoV1Resp
	isSet bool
}

func (v NullableCreateMarginOrderOtocoV1Resp) Get() *CreateMarginOrderOtocoV1Resp {
	return v.value
}

func (v *NullableCreateMarginOrderOtocoV1Resp) Set(val *CreateMarginOrderOtocoV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMarginOrderOtocoV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMarginOrderOtocoV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMarginOrderOtocoV1Resp(val *CreateMarginOrderOtocoV1Resp) *NullableCreateMarginOrderOtocoV1Resp {
	return &NullableCreateMarginOrderOtocoV1Resp{value: val, isSet: true}
}

func (v NullableCreateMarginOrderOtocoV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMarginOrderOtocoV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
