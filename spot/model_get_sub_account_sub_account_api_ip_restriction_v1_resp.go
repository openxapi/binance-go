...
// checks if the GetSubAccountSubAccountApiIpRestrictionV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSubAccountSubAccountApiIpRestrictionV1Resp{}

// GetSubAccountSubAccountApiIpRestrictionV1Resp struct for GetSubAccountSubAccountApiIpRestrictionV1Resp
type GetSubAccountSubAccountApiIpRestrictionV1Resp struct {
...
func NewGetSubAccountSubAccountApiIpRestrictionV1Resp() *GetSubAccountSubAccountApiIpRestrictionV1Resp {
	this := GetSubAccountSubAccountApiIpRestrictionV1Resp{}
	return &this
}
...
func (o GetSubAccountSubAccountApiIpRestrictionV1Resp) MarshalJSON() ([]byte, error) {
...
func (o GetSubAccountSubAccountApiIpRestrictionV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetSubAccountSubAccountApiIpRestrictionV1Resp struct {
	value *GetSubAccountSubAccountApiIpRestrictionV1Resp
	isSet bool
}

func (v NullableGetSubAccountSubAccountApiIpRestrictionV1Resp) Get() *GetSubAccountSubAccountApiIpRestrictionV1Resp {
	return v.value
}

func (v *NullableGetSubAccountSubAccountApiIpRestrictionV1Resp) Set(val *GetSubAccountSubAccountApiIpRestrictionV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSubAccountSubAccountApiIpRestrictionV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSubAccountSubAccountApiIpRestrictionV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSubAccountSubAccountApiIpRestrictionV1Resp(val *GetSubAccountSubAccountApiIpRestrictionV1Resp) *NullableGetSubAccountSubAccountApiIpRestrictionV1Resp {
	return &NullableGetSubAccountSubAccountApiIpRestrictionV1Resp{value: val, isSet: true}
}

func (v NullableGetSubAccountSubAccountApiIpRestrictionV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSubAccountSubAccountApiIpRestrictionV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
