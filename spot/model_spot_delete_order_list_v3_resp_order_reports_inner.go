...
// checks if the SpotDeleteOrderListV3RespOrderReportsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotDeleteOrderListV3RespOrderReportsInner{}

// SpotDeleteOrderListV3RespOrderReportsInner struct for SpotDeleteOrderListV3RespOrderReportsInner
type SpotDeleteOrderListV3RespOrderReportsInner struct {
...
func NewSpotDeleteOrderListV3RespOrderReportsInner() *SpotDeleteOrderListV3RespOrderReportsInner {
	this := SpotDeleteOrderListV3RespOrderReportsInner{}
	return &this
}
...
func (o SpotDeleteOrderListV3RespOrderReportsInner) MarshalJSON() ([]byte, error) {
...
func (o SpotDeleteOrderListV3RespOrderReportsInner) ToMap() (map[string]interface{}, error) {
...
type NullableSpotDeleteOrderListV3RespOrderReportsInner struct {
	value *SpotDeleteOrderListV3RespOrderReportsInner
	isSet bool
}

func (v NullableSpotDeleteOrderListV3RespOrderReportsInner) Get() *SpotDeleteOrderListV3RespOrderReportsInner {
	return v.value
}

func (v *NullableSpotDeleteOrderListV3RespOrderReportsInner) Set(val *SpotDeleteOrderListV3RespOrderReportsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotDeleteOrderListV3RespOrderReportsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotDeleteOrderListV3RespOrderReportsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotDeleteOrderListV3RespOrderReportsInner(val *SpotDeleteOrderListV3RespOrderReportsInner) *NullableSpotDeleteOrderListV3RespOrderReportsInner {
	return &NullableSpotDeleteOrderListV3RespOrderReportsInner{value: val, isSet: true}
}

func (v NullableSpotDeleteOrderListV3RespOrderReportsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotDeleteOrderListV3RespOrderReportsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
