...
// checks if the GetAlgoFuturesSubOrdersV1RespSubOrdersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAlgoFuturesSubOrdersV1RespSubOrdersInner{}

// GetAlgoFuturesSubOrdersV1RespSubOrdersInner struct for GetAlgoFuturesSubOrdersV1RespSubOrdersInner
type GetAlgoFuturesSubOrdersV1RespSubOrdersInner struct {
...
func NewGetAlgoFuturesSubOrdersV1RespSubOrdersInner() *GetAlgoFuturesSubOrdersV1RespSubOrdersInner {
	this := GetAlgoFuturesSubOrdersV1RespSubOrdersInner{}
	return &this
}
...
func (o GetAlgoFuturesSubOrdersV1RespSubOrdersInner) MarshalJSON() ([]byte, error) {
...
func (o GetAlgoFuturesSubOrdersV1RespSubOrdersInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetAlgoFuturesSubOrdersV1RespSubOrdersInner struct {
	value *GetAlgoFuturesSubOrdersV1RespSubOrdersInner
	isSet bool
}

func (v NullableGetAlgoFuturesSubOrdersV1RespSubOrdersInner) Get() *GetAlgoFuturesSubOrdersV1RespSubOrdersInner {
	return v.value
}

func (v *NullableGetAlgoFuturesSubOrdersV1RespSubOrdersInner) Set(val *GetAlgoFuturesSubOrdersV1RespSubOrdersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAlgoFuturesSubOrdersV1RespSubOrdersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAlgoFuturesSubOrdersV1RespSubOrdersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAlgoFuturesSubOrdersV1RespSubOrdersInner(val *GetAlgoFuturesSubOrdersV1RespSubOrdersInner) *NullableGetAlgoFuturesSubOrdersV1RespSubOrdersInner {
	return &NullableGetAlgoFuturesSubOrdersV1RespSubOrdersInner{value: val, isSet: true}
}

func (v NullableGetAlgoFuturesSubOrdersV1RespSubOrdersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAlgoFuturesSubOrdersV1RespSubOrdersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
