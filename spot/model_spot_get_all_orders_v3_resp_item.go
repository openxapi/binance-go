...
// checks if the SpotGetAllOrdersV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotGetAllOrdersV3RespItem{}

// SpotGetAllOrdersV3RespItem struct for SpotGetAllOrdersV3RespItem
type SpotGetAllOrdersV3RespItem struct {
...
func NewSpotGetAllOrdersV3RespItem() *SpotGetAllOrdersV3RespItem {
	this := SpotGetAllOrdersV3RespItem{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *SpotGetAllOrdersV3RespItem) GetUpdateTimeOk() (*int64, bool) {
	if o == nil || IsNil(o.UpdateTime) {
		return nil, false
	}
...
func (o SpotGetAllOrdersV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o SpotGetAllOrdersV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableSpotGetAllOrdersV3RespItem struct {
	value *SpotGetAllOrdersV3RespItem
	isSet bool
}

func (v NullableSpotGetAllOrdersV3RespItem) Get() *SpotGetAllOrdersV3RespItem {
	return v.value
}

func (v *NullableSpotGetAllOrdersV3RespItem) Set(val *SpotGetAllOrdersV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotGetAllOrdersV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotGetAllOrdersV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotGetAllOrdersV3RespItem(val *SpotGetAllOrdersV3RespItem) *NullableSpotGetAllOrdersV3RespItem {
	return &NullableSpotGetAllOrdersV3RespItem{value: val, isSet: true}
}

func (v NullableSpotGetAllOrdersV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotGetAllOrdersV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
