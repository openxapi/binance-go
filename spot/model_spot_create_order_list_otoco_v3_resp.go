...
// checks if the SpotCreateOrderListOtocoV3Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotCreateOrderListOtocoV3Resp{}

// SpotCreateOrderListOtocoV3Resp struct for SpotCreateOrderListOtocoV3Resp
type SpotCreateOrderListOtocoV3Resp struct {
	ContingencyType *string `json:"contingencyType,omitempty"`
	ListClientOrderId *string `json:"listClientOrderId,omitempty"`
	ListOrderStatus *string `json:"listOrderStatus,omitempty"`
	ListStatusType *string `json:"listStatusType,omitempty"`
	OrderListId *int64 `json:"orderListId,omitempty"`
	OrderReports []SpotCreateOrderListOtoV3RespOrderReportsInner `json:"orderReports,omitempty"`
...
func NewSpotCreateOrderListOtocoV3Resp() *SpotCreateOrderListOtocoV3Resp {
	this := SpotCreateOrderListOtocoV3Resp{}
	return &this
}
...
func (o *SpotCreateOrderListOtocoV3Resp) GetOrderReports() []SpotCreateOrderListOtoV3RespOrderReportsInner {
	if o == nil || IsNil(o.OrderReports) {
		var ret []SpotCreateOrderListOtoV3RespOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []SpotCreateOrderListOtoV3RespOrderReportsInner and assigns it to the OrderReports field.
...
func (o SpotCreateOrderListOtocoV3Resp) MarshalJSON() ([]byte, error) {
...
func (o SpotCreateOrderListOtocoV3Resp) ToMap() (map[string]interface{}, error) {
...
type NullableSpotCreateOrderListOtocoV3Resp struct {
	value *SpotCreateOrderListOtocoV3Resp
	isSet bool
}

func (v NullableSpotCreateOrderListOtocoV3Resp) Get() *SpotCreateOrderListOtocoV3Resp {
	return v.value
}

func (v *NullableSpotCreateOrderListOtocoV3Resp) Set(val *SpotCreateOrderListOtocoV3Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotCreateOrderListOtocoV3Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotCreateOrderListOtocoV3Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotCreateOrderListOtocoV3Resp(val *SpotCreateOrderListOtocoV3Resp) *NullableSpotCreateOrderListOtocoV3Resp {
	return &NullableSpotCreateOrderListOtocoV3Resp{value: val, isSet: true}
}

func (v NullableSpotCreateOrderListOtocoV3Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotCreateOrderListOtocoV3Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
