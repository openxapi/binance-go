...
// checks if the GetBrokerRebateFuturesRecentRecordV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBrokerRebateFuturesRecentRecordV1RespItem{}

// GetBrokerRebateFuturesRecentRecordV1RespItem struct for GetBrokerRebateFuturesRecentRecordV1RespItem
type GetBrokerRebateFuturesRecentRecordV1RespItem struct {
...
func NewGetBrokerRebateFuturesRecentRecordV1RespItem() *GetBrokerRebateFuturesRecentRecordV1RespItem {
	this := GetBrokerRebateFuturesRecentRecordV1RespItem{}
	return &this
}
...
func (o *GetBrokerRebateFuturesRecentRecordV1RespItem) SetAsset(v string) {
	o.Asset = &v
}
...
func (o GetBrokerRebateFuturesRecentRecordV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetBrokerRebateFuturesRecentRecordV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetBrokerRebateFuturesRecentRecordV1RespItem struct {
	value *GetBrokerRebateFuturesRecentRecordV1RespItem
	isSet bool
}

func (v NullableGetBrokerRebateFuturesRecentRecordV1RespItem) Get() *GetBrokerRebateFuturesRecentRecordV1RespItem {
	return v.value
}

func (v *NullableGetBrokerRebateFuturesRecentRecordV1RespItem) Set(val *GetBrokerRebateFuturesRecentRecordV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBrokerRebateFuturesRecentRecordV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBrokerRebateFuturesRecentRecordV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBrokerRebateFuturesRecentRecordV1RespItem(val *GetBrokerRebateFuturesRecentRecordV1RespItem) *NullableGetBrokerRebateFuturesRecentRecordV1RespItem {
	return &NullableGetBrokerRebateFuturesRecentRecordV1RespItem{value: val, isSet: true}
}

func (v NullableGetBrokerRebateFuturesRecentRecordV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBrokerRebateFuturesRecentRecordV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
