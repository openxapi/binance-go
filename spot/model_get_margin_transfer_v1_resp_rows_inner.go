...
// checks if the GetMarginTransferV1RespRowsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarginTransferV1RespRowsInner{}

// GetMarginTransferV1RespRowsInner struct for GetMarginTransferV1RespRowsInner
type GetMarginTransferV1RespRowsInner struct {
...
func NewGetMarginTransferV1RespRowsInner() *GetMarginTransferV1RespRowsInner {
	this := GetMarginTransferV1RespRowsInner{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *GetMarginTransferV1RespRowsInner) GetTransToOk() (*string, bool) {
	if o == nil || IsNil(o.TransTo) {
		return nil, false
	}
...
func (o *GetMarginTransferV1RespRowsInner) SetType(v string) {
	o.Type = &v
}

func (o GetMarginTransferV1RespRowsInner) MarshalJSON() ([]byte, error) {
...
func (o GetMarginTransferV1RespRowsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetMarginTransferV1RespRowsInner struct {
	value *GetMarginTransferV1RespRowsInner
	isSet bool
}

func (v NullableGetMarginTransferV1RespRowsInner) Get() *GetMarginTransferV1RespRowsInner {
	return v.value
}

func (v *NullableGetMarginTransferV1RespRowsInner) Set(val *GetMarginTransferV1RespRowsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarginTransferV1RespRowsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarginTransferV1RespRowsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarginTransferV1RespRowsInner(val *GetMarginTransferV1RespRowsInner) *NullableGetMarginTransferV1RespRowsInner {
	return &NullableGetMarginTransferV1RespRowsInner{value: val, isSet: true}
}

func (v NullableGetMarginTransferV1RespRowsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarginTransferV1RespRowsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
