...
// checks if the GetMarginIsolatedAllPairsV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarginIsolatedAllPairsV1RespItem{}

// GetMarginIsolatedAllPairsV1RespItem struct for GetMarginIsolatedAllPairsV1RespItem
type GetMarginIsolatedAllPairsV1RespItem struct {
...
func NewGetMarginIsolatedAllPairsV1RespItem() *GetMarginIsolatedAllPairsV1RespItem {
	this := GetMarginIsolatedAllPairsV1RespItem{}
	return &this
}
...
func (o GetMarginIsolatedAllPairsV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetMarginIsolatedAllPairsV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetMarginIsolatedAllPairsV1RespItem struct {
	value *GetMarginIsolatedAllPairsV1RespItem
	isSet bool
}

func (v NullableGetMarginIsolatedAllPairsV1RespItem) Get() *GetMarginIsolatedAllPairsV1RespItem {
	return v.value
}

func (v *NullableGetMarginIsolatedAllPairsV1RespItem) Set(val *GetMarginIsolatedAllPairsV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarginIsolatedAllPairsV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarginIsolatedAllPairsV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarginIsolatedAllPairsV1RespItem(val *GetMarginIsolatedAllPairsV1RespItem) *NullableGetMarginIsolatedAllPairsV1RespItem {
	return &NullableGetMarginIsolatedAllPairsV1RespItem{value: val, isSet: true}
}

func (v NullableGetMarginIsolatedAllPairsV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarginIsolatedAllPairsV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
