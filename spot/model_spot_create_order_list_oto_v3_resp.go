...
// checks if the SpotCreateOrderListOtoV3Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpotCreateOrderListOtoV3Resp{}

// SpotCreateOrderListOtoV3Resp struct for SpotCreateOrderListOtoV3Resp
type SpotCreateOrderListOtoV3Resp struct {
...
func NewSpotCreateOrderListOtoV3Resp() *SpotCreateOrderListOtoV3Resp {
	this := SpotCreateOrderListOtoV3Resp{}
	return &this
}
...
func (o SpotCreateOrderListOtoV3Resp) MarshalJSON() ([]byte, error) {
...
func (o SpotCreateOrderListOtoV3Resp) ToMap() (map[string]interface{}, error) {
...
type NullableSpotCreateOrderListOtoV3Resp struct {
	value *SpotCreateOrderListOtoV3Resp
	isSet bool
}

func (v NullableSpotCreateOrderListOtoV3Resp) Get() *SpotCreateOrderListOtoV3Resp {
	return v.value
}

func (v *NullableSpotCreateOrderListOtoV3Resp) Set(val *SpotCreateOrderListOtoV3Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableSpotCreateOrderListOtoV3Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableSpotCreateOrderListOtoV3Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpotCreateOrderListOtoV3Resp(val *SpotCreateOrderListOtoV3Resp) *NullableSpotCreateOrderListOtoV3Resp {
	return &NullableSpotCreateOrderListOtoV3Resp{value: val, isSet: true}
}

func (v NullableSpotCreateOrderListOtoV3Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpotCreateOrderListOtoV3Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
