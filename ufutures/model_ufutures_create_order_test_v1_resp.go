...
// checks if the UfuturesCreateOrderTestV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesCreateOrderTestV1Resp{}

// UfuturesCreateOrderTestV1Resp struct for UfuturesCreateOrderTestV1Resp
type UfuturesCreateOrderTestV1Resp struct {
...
func NewUfuturesCreateOrderTestV1Resp() *UfuturesCreateOrderTestV1Resp {
	this := UfuturesCreateOrderTestV1Resp{}
	return &this
}
...
func (o UfuturesCreateOrderTestV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UfuturesCreateOrderTestV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesCreateOrderTestV1Resp struct {
	value *UfuturesCreateOrderTestV1Resp
	isSet bool
}

func (v NullableUfuturesCreateOrderTestV1Resp) Get() *UfuturesCreateOrderTestV1Resp {
	return v.value
}

func (v *NullableUfuturesCreateOrderTestV1Resp) Set(val *UfuturesCreateOrderTestV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesCreateOrderTestV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesCreateOrderTestV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesCreateOrderTestV1Resp(val *UfuturesCreateOrderTestV1Resp) *NullableUfuturesCreateOrderTestV1Resp {
	return &NullableUfuturesCreateOrderTestV1Resp{value: val, isSet: true}
}

func (v NullableUfuturesCreateOrderTestV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesCreateOrderTestV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
