...
// checks if the UfuturesUpdateOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesUpdateOrderV1Resp{}

// UfuturesUpdateOrderV1Resp struct for UfuturesUpdateOrderV1Resp
type UfuturesUpdateOrderV1Resp struct {
...
func NewUfuturesUpdateOrderV1Resp() *UfuturesUpdateOrderV1Resp {
	this := UfuturesUpdateOrderV1Resp{}
	return &this
}
...
func (o UfuturesUpdateOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UfuturesUpdateOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesUpdateOrderV1Resp struct {
	value *UfuturesUpdateOrderV1Resp
	isSet bool
}

func (v NullableUfuturesUpdateOrderV1Resp) Get() *UfuturesUpdateOrderV1Resp {
	return v.value
}

func (v *NullableUfuturesUpdateOrderV1Resp) Set(val *UfuturesUpdateOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesUpdateOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesUpdateOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesUpdateOrderV1Resp(val *UfuturesUpdateOrderV1Resp) *NullableUfuturesUpdateOrderV1Resp {
	return &NullableUfuturesUpdateOrderV1Resp{value: val, isSet: true}
}

func (v NullableUfuturesUpdateOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesUpdateOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
