...
// checks if the UfuturesGetOpenOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetOpenOrdersV1RespItem{}

// UfuturesGetOpenOrdersV1RespItem struct for UfuturesGetOpenOrdersV1RespItem
type UfuturesGetOpenOrdersV1RespItem struct {
...
func NewUfuturesGetOpenOrdersV1RespItem() *UfuturesGetOpenOrdersV1RespItem {
	this := UfuturesGetOpenOrdersV1RespItem{}
	return &this
}
...
func (o UfuturesGetOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetOpenOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetOpenOrdersV1RespItem struct {
	value *UfuturesGetOpenOrdersV1RespItem
	isSet bool
}

func (v NullableUfuturesGetOpenOrdersV1RespItem) Get() *UfuturesGetOpenOrdersV1RespItem {
	return v.value
}

func (v *NullableUfuturesGetOpenOrdersV1RespItem) Set(val *UfuturesGetOpenOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetOpenOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetOpenOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetOpenOrdersV1RespItem(val *UfuturesGetOpenOrdersV1RespItem) *NullableUfuturesGetOpenOrdersV1RespItem {
	return &NullableUfuturesGetOpenOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetOpenOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
