...
// checks if the UfuturesDeleteBatchOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesDeleteBatchOrdersV1RespItem{}

// UfuturesDeleteBatchOrdersV1RespItem struct for UfuturesDeleteBatchOrdersV1RespItem
type UfuturesDeleteBatchOrdersV1RespItem struct {
...
func NewUfuturesDeleteBatchOrdersV1RespItem() *UfuturesDeleteBatchOrdersV1RespItem {
	this := UfuturesDeleteBatchOrdersV1RespItem{}
	return &this
}
...
func (o UfuturesDeleteBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesDeleteBatchOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesDeleteBatchOrdersV1RespItem struct {
	value *UfuturesDeleteBatchOrdersV1RespItem
	isSet bool
}

func (v NullableUfuturesDeleteBatchOrdersV1RespItem) Get() *UfuturesDeleteBatchOrdersV1RespItem {
	return v.value
}

func (v *NullableUfuturesDeleteBatchOrdersV1RespItem) Set(val *UfuturesDeleteBatchOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesDeleteBatchOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesDeleteBatchOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesDeleteBatchOrdersV1RespItem(val *UfuturesDeleteBatchOrdersV1RespItem) *NullableUfuturesDeleteBatchOrdersV1RespItem {
	return &NullableUfuturesDeleteBatchOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableUfuturesDeleteBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesDeleteBatchOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
