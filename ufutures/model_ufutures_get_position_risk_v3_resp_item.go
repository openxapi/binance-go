...
// checks if the UfuturesGetPositionRiskV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetPositionRiskV3RespItem{}

// UfuturesGetPositionRiskV3RespItem struct for UfuturesGetPositionRiskV3RespItem
type UfuturesGetPositionRiskV3RespItem struct {
...
func NewUfuturesGetPositionRiskV3RespItem() *UfuturesGetPositionRiskV3RespItem {
	this := UfuturesGetPositionRiskV3RespItem{}
	return &this
}
...
func (o *UfuturesGetPositionRiskV3RespItem) GetMaintMargin() string {
...
func (o *UfuturesGetPositionRiskV3RespItem) SetOpenOrderInitialMargin(v string) {
...
func (o *UfuturesGetPositionRiskV3RespItem) HasPositionInitialMargin() bool {
	if o != nil && !IsNil(o.PositionInitialMargin) {
		return true
	}
...
func (o UfuturesGetPositionRiskV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetPositionRiskV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetPositionRiskV3RespItem struct {
	value *UfuturesGetPositionRiskV3RespItem
	isSet bool
}

func (v NullableUfuturesGetPositionRiskV3RespItem) Get() *UfuturesGetPositionRiskV3RespItem {
	return v.value
}

func (v *NullableUfuturesGetPositionRiskV3RespItem) Set(val *UfuturesGetPositionRiskV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetPositionRiskV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetPositionRiskV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetPositionRiskV3RespItem(val *UfuturesGetPositionRiskV3RespItem) *NullableUfuturesGetPositionRiskV3RespItem {
	return &NullableUfuturesGetPositionRiskV3RespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetPositionRiskV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetPositionRiskV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
