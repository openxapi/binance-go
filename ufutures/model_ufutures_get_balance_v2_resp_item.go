...
// checks if the UfuturesGetBalanceV2RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetBalanceV2RespItem{}

// UfuturesGetBalanceV2RespItem struct for UfuturesGetBalanceV2RespItem
type UfuturesGetBalanceV2RespItem struct {
...
func NewUfuturesGetBalanceV2RespItem() *UfuturesGetBalanceV2RespItem {
	this := UfuturesGetBalanceV2RespItem{}
	return &this
}
...
func (o UfuturesGetBalanceV2RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetBalanceV2RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetBalanceV2RespItem struct {
	value *UfuturesGetBalanceV2RespItem
	isSet bool
}

func (v NullableUfuturesGetBalanceV2RespItem) Get() *UfuturesGetBalanceV2RespItem {
	return v.value
}

func (v *NullableUfuturesGetBalanceV2RespItem) Set(val *UfuturesGetBalanceV2RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetBalanceV2RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetBalanceV2RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetBalanceV2RespItem(val *UfuturesGetBalanceV2RespItem) *NullableUfuturesGetBalanceV2RespItem {
	return &NullableUfuturesGetBalanceV2RespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetBalanceV2RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetBalanceV2RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
