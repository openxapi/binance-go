...
// checks if the UfuturesGetFuturesDataTopLongShortPositionRatioRespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetFuturesDataTopLongShortPositionRatioRespItem{}

// UfuturesGetFuturesDataTopLongShortPositionRatioRespItem struct for UfuturesGetFuturesDataTopLongShortPositionRatioRespItem
type UfuturesGetFuturesDataTopLongShortPositionRatioRespItem struct {
...
func NewUfuturesGetFuturesDataTopLongShortPositionRatioRespItem() *UfuturesGetFuturesDataTopLongShortPositionRatioRespItem {
	this := UfuturesGetFuturesDataTopLongShortPositionRatioRespItem{}
	return &this
}
...
func (o UfuturesGetFuturesDataTopLongShortPositionRatioRespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetFuturesDataTopLongShortPositionRatioRespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetFuturesDataTopLongShortPositionRatioRespItem struct {
	value *UfuturesGetFuturesDataTopLongShortPositionRatioRespItem
	isSet bool
}

func (v NullableUfuturesGetFuturesDataTopLongShortPositionRatioRespItem) Get() *UfuturesGetFuturesDataTopLongShortPositionRatioRespItem {
	return v.value
}

func (v *NullableUfuturesGetFuturesDataTopLongShortPositionRatioRespItem) Set(val *UfuturesGetFuturesDataTopLongShortPositionRatioRespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetFuturesDataTopLongShortPositionRatioRespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetFuturesDataTopLongShortPositionRatioRespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetFuturesDataTopLongShortPositionRatioRespItem(val *UfuturesGetFuturesDataTopLongShortPositionRatioRespItem) *NullableUfuturesGetFuturesDataTopLongShortPositionRatioRespItem {
	return &NullableUfuturesGetFuturesDataTopLongShortPositionRatioRespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetFuturesDataTopLongShortPositionRatioRespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetFuturesDataTopLongShortPositionRatioRespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
