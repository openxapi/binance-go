...
// checks if the UfuturesCreateOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesCreateOrderV1Resp{}

// UfuturesCreateOrderV1Resp struct for UfuturesCreateOrderV1Resp
type UfuturesCreateOrderV1Resp struct {
...
func NewUfuturesCreateOrderV1Resp() *UfuturesCreateOrderV1Resp {
	this := UfuturesCreateOrderV1Resp{}
	return &this
}
...
func (o UfuturesCreateOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UfuturesCreateOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesCreateOrderV1Resp struct {
	value *UfuturesCreateOrderV1Resp
	isSet bool
}

func (v NullableUfuturesCreateOrderV1Resp) Get() *UfuturesCreateOrderV1Resp {
	return v.value
}

func (v *NullableUfuturesCreateOrderV1Resp) Set(val *UfuturesCreateOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesCreateOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesCreateOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesCreateOrderV1Resp(val *UfuturesCreateOrderV1Resp) *NullableUfuturesCreateOrderV1Resp {
	return &NullableUfuturesCreateOrderV1Resp{value: val, isSet: true}
}

func (v NullableUfuturesCreateOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesCreateOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
