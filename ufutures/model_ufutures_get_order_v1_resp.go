...
// checks if the UfuturesGetOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetOrderV1Resp{}

// UfuturesGetOrderV1Resp struct for UfuturesGetOrderV1Resp
type UfuturesGetOrderV1Resp struct {
...
func (o UfuturesGetOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetOrderV1Resp struct {
	value *UfuturesGetOrderV1Resp
	isSet bool
}

func (v NullableUfuturesGetOrderV1Resp) Get() *UfuturesGetOrderV1Resp {
	return v.value
}

func (v *NullableUfuturesGetOrderV1Resp) Set(val *UfuturesGetOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetOrderV1Resp(val *UfuturesGetOrderV1Resp) *NullableUfuturesGetOrderV1Resp {
	return &NullableUfuturesGetOrderV1Resp{value: val, isSet: true}
}

func (v NullableUfuturesGetOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
