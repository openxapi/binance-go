...
// checks if the UfuturesGetFundingRateV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetFundingRateV1RespItem{}

// UfuturesGetFundingRateV1RespItem struct for UfuturesGetFundingRateV1RespItem
type UfuturesGetFundingRateV1RespItem struct {
...
func NewUfuturesGetFundingRateV1RespItem() *UfuturesGetFundingRateV1RespItem {
	this := UfuturesGetFundingRateV1RespItem{}
	return &this
}
...
func (o UfuturesGetFundingRateV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetFundingRateV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetFundingRateV1RespItem struct {
	value *UfuturesGetFundingRateV1RespItem
	isSet bool
}

func (v NullableUfuturesGetFundingRateV1RespItem) Get() *UfuturesGetFundingRateV1RespItem {
	return v.value
}

func (v *NullableUfuturesGetFundingRateV1RespItem) Set(val *UfuturesGetFundingRateV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetFundingRateV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetFundingRateV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetFundingRateV1RespItem(val *UfuturesGetFundingRateV1RespItem) *NullableUfuturesGetFundingRateV1RespItem {
	return &NullableUfuturesGetFundingRateV1RespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetFundingRateV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetFundingRateV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
