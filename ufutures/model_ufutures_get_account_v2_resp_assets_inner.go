...
// checks if the UfuturesGetAccountV2RespAssetsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetAccountV2RespAssetsInner{}

// UfuturesGetAccountV2RespAssetsInner struct for UfuturesGetAccountV2RespAssetsInner
type UfuturesGetAccountV2RespAssetsInner struct {
...
func NewUfuturesGetAccountV2RespAssetsInner() *UfuturesGetAccountV2RespAssetsInner {
	this := UfuturesGetAccountV2RespAssetsInner{}
	return &this
}
...
func (o *UfuturesGetAccountV2RespAssetsInner) SetCrossUnPnl(v string) {
	o.CrossUnPnl = &v
}
...
func (o *UfuturesGetAccountV2RespAssetsInner) HasInitialMargin() bool {
	if o != nil && !IsNil(o.InitialMargin) {
		return true
	}
...
func (o *UfuturesGetAccountV2RespAssetsInner) GetMarginBalance() string {
...
func (o *UfuturesGetAccountV2RespAssetsInner) SetWalletBalance(v string) {
	o.WalletBalance = &v
}

func (o UfuturesGetAccountV2RespAssetsInner) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetAccountV2RespAssetsInner) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetAccountV2RespAssetsInner struct {
	value *UfuturesGetAccountV2RespAssetsInner
	isSet bool
}

func (v NullableUfuturesGetAccountV2RespAssetsInner) Get() *UfuturesGetAccountV2RespAssetsInner {
	return v.value
}

func (v *NullableUfuturesGetAccountV2RespAssetsInner) Set(val *UfuturesGetAccountV2RespAssetsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetAccountV2RespAssetsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetAccountV2RespAssetsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetAccountV2RespAssetsInner(val *UfuturesGetAccountV2RespAssetsInner) *NullableUfuturesGetAccountV2RespAssetsInner {
	return &NullableUfuturesGetAccountV2RespAssetsInner{value: val, isSet: true}
}

func (v NullableUfuturesGetAccountV2RespAssetsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetAccountV2RespAssetsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
