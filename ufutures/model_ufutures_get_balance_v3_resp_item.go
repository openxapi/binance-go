...
// checks if the UfuturesGetBalanceV3RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetBalanceV3RespItem{}

// UfuturesGetBalanceV3RespItem struct for UfuturesGetBalanceV3RespItem
type UfuturesGetBalanceV3RespItem struct {
...
func NewUfuturesGetBalanceV3RespItem() *UfuturesGetBalanceV3RespItem {
	this := UfuturesGetBalanceV3RespItem{}
	return &this
}
...
func (o UfuturesGetBalanceV3RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetBalanceV3RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetBalanceV3RespItem struct {
	value *UfuturesGetBalanceV3RespItem
	isSet bool
}

func (v NullableUfuturesGetBalanceV3RespItem) Get() *UfuturesGetBalanceV3RespItem {
	return v.value
}

func (v *NullableUfuturesGetBalanceV3RespItem) Set(val *UfuturesGetBalanceV3RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetBalanceV3RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetBalanceV3RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetBalanceV3RespItem(val *UfuturesGetBalanceV3RespItem) *NullableUfuturesGetBalanceV3RespItem {
	return &NullableUfuturesGetBalanceV3RespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetBalanceV3RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetBalanceV3RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
