...
// checks if the UfuturesGetForceOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetForceOrdersV1RespItem{}

// UfuturesGetForceOrdersV1RespItem struct for UfuturesGetForceOrdersV1RespItem
type UfuturesGetForceOrdersV1RespItem struct {
...
func NewUfuturesGetForceOrdersV1RespItem() *UfuturesGetForceOrdersV1RespItem {
	this := UfuturesGetForceOrdersV1RespItem{}
	return &this
}
...
func (o *UfuturesGetForceOrdersV1RespItem) SetExecutedQty(v string) {
	o.ExecutedQty = &v
}
...
func (o *UfuturesGetForceOrdersV1RespItem) HasStopPrice() bool {
	if o != nil && !IsNil(o.StopPrice) {
		return true
	}
...
func (o UfuturesGetForceOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetForceOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetForceOrdersV1RespItem struct {
	value *UfuturesGetForceOrdersV1RespItem
	isSet bool
}

func (v NullableUfuturesGetForceOrdersV1RespItem) Get() *UfuturesGetForceOrdersV1RespItem {
	return v.value
}

func (v *NullableUfuturesGetForceOrdersV1RespItem) Set(val *UfuturesGetForceOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetForceOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetForceOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetForceOrdersV1RespItem(val *UfuturesGetForceOrdersV1RespItem) *NullableUfuturesGetForceOrdersV1RespItem {
	return &NullableUfuturesGetForceOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableUfuturesGetForceOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetForceOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
