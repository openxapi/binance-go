...
// checks if the UfuturesGetExchangeInfoV1RespAssetsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesGetExchangeInfoV1RespAssetsInner{}

// UfuturesGetExchangeInfoV1RespAssetsInner struct for UfuturesGetExchangeInfoV1RespAssetsInner
type UfuturesGetExchangeInfoV1RespAssetsInner struct {
...
func NewUfuturesGetExchangeInfoV1RespAssetsInner() *UfuturesGetExchangeInfoV1RespAssetsInner {
	this := UfuturesGetExchangeInfoV1RespAssetsInner{}
	return &this
}
...
func (o UfuturesGetExchangeInfoV1RespAssetsInner) MarshalJSON() ([]byte, error) {
...
func (o UfuturesGetExchangeInfoV1RespAssetsInner) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesGetExchangeInfoV1RespAssetsInner struct {
	value *UfuturesGetExchangeInfoV1RespAssetsInner
	isSet bool
}

func (v NullableUfuturesGetExchangeInfoV1RespAssetsInner) Get() *UfuturesGetExchangeInfoV1RespAssetsInner {
	return v.value
}

func (v *NullableUfuturesGetExchangeInfoV1RespAssetsInner) Set(val *UfuturesGetExchangeInfoV1RespAssetsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesGetExchangeInfoV1RespAssetsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesGetExchangeInfoV1RespAssetsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesGetExchangeInfoV1RespAssetsInner(val *UfuturesGetExchangeInfoV1RespAssetsInner) *NullableUfuturesGetExchangeInfoV1RespAssetsInner {
	return &NullableUfuturesGetExchangeInfoV1RespAssetsInner{value: val, isSet: true}
}

func (v NullableUfuturesGetExchangeInfoV1RespAssetsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesGetExchangeInfoV1RespAssetsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
