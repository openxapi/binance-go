...
// checks if the UfuturesDeleteOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UfuturesDeleteOrderV1Resp{}

// UfuturesDeleteOrderV1Resp struct for UfuturesDeleteOrderV1Resp
type UfuturesDeleteOrderV1Resp struct {
...
func NewUfuturesDeleteOrderV1Resp() *UfuturesDeleteOrderV1Resp {
	this := UfuturesDeleteOrderV1Resp{}
	return &this
}
...
func (o UfuturesDeleteOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UfuturesDeleteOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUfuturesDeleteOrderV1Resp struct {
	value *UfuturesDeleteOrderV1Resp
	isSet bool
}

func (v NullableUfuturesDeleteOrderV1Resp) Get() *UfuturesDeleteOrderV1Resp {
	return v.value
}

func (v *NullableUfuturesDeleteOrderV1Resp) Set(val *UfuturesDeleteOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUfuturesDeleteOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUfuturesDeleteOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUfuturesDeleteOrderV1Resp(val *UfuturesDeleteOrderV1Resp) *NullableUfuturesDeleteOrderV1Resp {
	return &NullableUfuturesDeleteOrderV1Resp{value: val, isSet: true}
}

func (v NullableUfuturesDeleteOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUfuturesDeleteOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
