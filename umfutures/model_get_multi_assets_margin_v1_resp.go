...
// checks if the GetMultiAssetsMarginV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMultiAssetsMarginV1Resp{}

// GetMultiAssetsMarginV1Resp struct for GetMultiAssetsMarginV1Resp
type GetMultiAssetsMarginV1Resp struct {
...
func NewGetMultiAssetsMarginV1Resp() *GetMultiAssetsMarginV1Resp {
	this := GetMultiAssetsMarginV1Resp{}
	return &this
}
...
func (o GetMultiAssetsMarginV1Resp) MarshalJSON() ([]byte, error) {
...
func (o GetMultiAssetsMarginV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetMultiAssetsMarginV1Resp struct {
	value *GetMultiAssetsMarginV1Resp
	isSet bool
}

func (v NullableGetMultiAssetsMarginV1Resp) Get() *GetMultiAssetsMarginV1Resp {
	return v.value
}

func (v *NullableGetMultiAssetsMarginV1Resp) Set(val *GetMultiAssetsMarginV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMultiAssetsMarginV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMultiAssetsMarginV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMultiAssetsMarginV1Resp(val *GetMultiAssetsMarginV1Resp) *NullableGetMultiAssetsMarginV1Resp {
	return &NullableGetMultiAssetsMarginV1Resp{value: val, isSet: true}
}

func (v NullableGetMultiAssetsMarginV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMultiAssetsMarginV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
