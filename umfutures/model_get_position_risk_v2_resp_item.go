...
// checks if the GetPositionRiskV2RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPositionRiskV2RespItem{}

// GetPositionRiskV2RespItem struct for GetPositionRiskV2RespItem
type GetPositionRiskV2RespItem struct {
...
func NewGetPositionRiskV2RespItem() *GetPositionRiskV2RespItem {
	this := GetPositionRiskV2RespItem{}
	return &this
}
...
func (o *GetPositionRiskV2RespItem) SetIsAutoAddMargin(v string) {
	o.IsAutoAddMargin = &v
}
...
func (o *GetPositionRiskV2RespItem) HasIsolatedWallet() bool {
	if o != nil && !IsNil(o.IsolatedWallet) {
		return true
	}
...
func (o *GetPositionRiskV2RespItem) GetMarginType() string {
...
func (o *GetPositionRiskV2RespItem) SetPositionAmt(v string) {
	o.PositionAmt = &v
}
...
func (o GetPositionRiskV2RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetPositionRiskV2RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetPositionRiskV2RespItem struct {
	value *GetPositionRiskV2RespItem
	isSet bool
}

func (v NullableGetPositionRiskV2RespItem) Get() *GetPositionRiskV2RespItem {
	return v.value
}

func (v *NullableGetPositionRiskV2RespItem) Set(val *GetPositionRiskV2RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPositionRiskV2RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPositionRiskV2RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPositionRiskV2RespItem(val *GetPositionRiskV2RespItem) *NullableGetPositionRiskV2RespItem {
	return &NullableGetPositionRiskV2RespItem{value: val, isSet: true}
}

func (v NullableGetPositionRiskV2RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPositionRiskV2RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
