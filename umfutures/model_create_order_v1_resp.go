...
// checks if the CreateOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOrderV1Resp{}

// CreateOrderV1Resp struct for CreateOrderV1Resp
type CreateOrderV1Resp struct {
...
func (o CreateOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateOrderV1Resp struct {
	value *CreateOrderV1Resp
	isSet bool
}

func (v NullableCreateOrderV1Resp) Get() *CreateOrderV1Resp {
	return v.value
}

func (v *NullableCreateOrderV1Resp) Set(val *CreateOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOrderV1Resp(val *CreateOrderV1Resp) *NullableCreateOrderV1Resp {
	return &NullableCreateOrderV1Resp{value: val, isSet: true}
}

func (v NullableCreateOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
