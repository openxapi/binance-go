...
// checks if the GetAccountV2RespPositionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountV2RespPositionsInner{}

// GetAccountV2RespPositionsInner struct for GetAccountV2RespPositionsInner
type GetAccountV2RespPositionsInner struct {
...
func NewGetAccountV2RespPositionsInner() *GetAccountV2RespPositionsInner {
	this := GetAccountV2RespPositionsInner{}
	return &this
}
...
func (o GetAccountV2RespPositionsInner) MarshalJSON() ([]byte, error) {
...
func (o GetAccountV2RespPositionsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountV2RespPositionsInner struct {
	value *GetAccountV2RespPositionsInner
	isSet bool
}

func (v NullableGetAccountV2RespPositionsInner) Get() *GetAccountV2RespPositionsInner {
	return v.value
}

func (v *NullableGetAccountV2RespPositionsInner) Set(val *GetAccountV2RespPositionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountV2RespPositionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountV2RespPositionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountV2RespPositionsInner(val *GetAccountV2RespPositionsInner) *NullableGetAccountV2RespPositionsInner {
	return &NullableGetAccountV2RespPositionsInner{value: val, isSet: true}
}

func (v NullableGetAccountV2RespPositionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountV2RespPositionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
