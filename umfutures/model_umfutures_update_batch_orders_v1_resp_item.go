...
// checks if the UmfuturesUpdateBatchOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UmfuturesUpdateBatchOrdersV1RespItem{}

// UmfuturesUpdateBatchOrdersV1RespItem struct for UmfuturesUpdateBatchOrdersV1RespItem
type UmfuturesUpdateBatchOrdersV1RespItem struct {
	...
	GoodTillDate *int32 `json:"goodTillDate,omitempty"`
...
func NewUmfuturesUpdateBatchOrdersV1RespItem() *UmfuturesUpdateBatchOrdersV1RespItem {
	this := UmfuturesUpdateBatchOrdersV1RespItem{}
	return &this
}
...
func (o *UmfuturesUpdateBatchOrdersV1RespItem) HasGoodTillDate() bool {
	if o != nil && !IsNil(o.GoodTillDate) {
		return true
	}
...
// SetGoodTillDate gets a reference to the given int32 and assigns it to the GoodTillDate field.
...
func (o *UmfuturesUpdateBatchOrdersV1RespItem) HasPriceMatch() bool {
	if o != nil && !IsNil(o.PriceMatch) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *UmfuturesUpdateBatchOrdersV1RespItem) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *UmfuturesUpdateBatchOrdersV1RespItem) SetSymbol(v string) {
	o.Symbol = &v
}
...
func (o UmfuturesUpdateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o UmfuturesUpdateBatchOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableUmfuturesUpdateBatchOrdersV1RespItem struct {
	value *UmfuturesUpdateBatchOrdersV1RespItem
	isSet bool
}

func (v NullableUmfuturesUpdateBatchOrdersV1RespItem) Get() *UmfuturesUpdateBatchOrdersV1RespItem {
	return v.value
}

func (v *NullableUmfuturesUpdateBatchOrdersV1RespItem) Set(val *UmfuturesUpdateBatchOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableUmfuturesUpdateBatchOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableUmfuturesUpdateBatchOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUmfuturesUpdateBatchOrdersV1RespItem(val *UmfuturesUpdateBatchOrdersV1RespItem) *NullableUmfuturesUpdateBatchOrdersV1RespItem {
	return &NullableUmfuturesUpdateBatchOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableUmfuturesUpdateBatchOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUmfuturesUpdateBatchOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
