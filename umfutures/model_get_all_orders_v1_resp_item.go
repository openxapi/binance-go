...
// checks if the GetAllOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllOrdersV1RespItem{}

// GetAllOrdersV1RespItem struct for GetAllOrdersV1RespItem
type GetAllOrdersV1RespItem struct {
...
func (o GetAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetAllOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetAllOrdersV1RespItem struct {
	value *GetAllOrdersV1RespItem
	isSet bool
}

func (v NullableGetAllOrdersV1RespItem) Get() *GetAllOrdersV1RespItem {
	return v.value
}

func (v *NullableGetAllOrdersV1RespItem) Set(val *GetAllOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllOrdersV1RespItem(val *GetAllOrdersV1RespItem) *NullableGetAllOrdersV1RespItem {
	return &NullableGetAllOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableGetAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
