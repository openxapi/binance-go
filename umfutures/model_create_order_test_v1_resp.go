...
// checks if the CreateOrderTestV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOrderTestV1Resp{}

// CreateOrderTestV1Resp struct for CreateOrderTestV1Resp
type CreateOrderTestV1Resp struct {
...
func (o CreateOrderTestV1Resp) MarshalJSON() ([]byte, error) {
...
func (o CreateOrderTestV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateOrderTestV1Resp struct {
	value *CreateOrderTestV1Resp
	isSet bool
}

func (v NullableCreateOrderTestV1Resp) Get() *CreateOrderTestV1Resp {
	return v.value
}

func (v *NullableCreateOrderTestV1Resp) Set(val *CreateOrderTestV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOrderTestV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOrderTestV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOrderTestV1Resp(val *CreateOrderTestV1Resp) *NullableCreateOrderTestV1Resp {
	return &NullableCreateOrderTestV1Resp{value: val, isSet: true}
}

func (v NullableCreateOrderTestV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOrderTestV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
