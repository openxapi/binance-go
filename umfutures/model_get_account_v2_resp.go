...
// checks if the GetAccountV2Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAccountV2Resp{}

// GetAccountV2Resp struct for GetAccountV2Resp
type GetAccountV2Resp struct {
	Assets []GetAccountV2RespAssetsInner `json:"assets,omitempty"`
	...
	Positions []GetAccountV2RespPositionsInner `json:"positions,omitempty"`
...
func (o *GetAccountV2Resp) GetAssets() []GetAccountV2RespAssetsInner {
	if o == nil || IsNil(o.Assets) {
		var ret []GetAccountV2RespAssetsInner
		return ret
	}
	return o.Assets
}
...
// SetAssets gets a reference to the given []GetAccountV2RespAssetsInner and assigns it to the Assets field.
...
func (o *GetAccountV2Resp) GetPositions() []GetAccountV2RespPositionsInner {
	if o == nil || IsNil(o.Positions) {
		var ret []GetAccountV2RespPositionsInner
		return ret
	}
	return o.Positions
}
...
// SetPositions gets a reference to the given []GetAccountV2RespPositionsInner and assigns it to the Positions field.
...
func (o GetAccountV2Resp) MarshalJSON() ([]byte, error) {
...
func (o GetAccountV2Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetAccountV2Resp struct {
	value *GetAccountV2Resp
	isSet bool
}

func (v NullableGetAccountV2Resp) Get() *GetAccountV2Resp {
	return v.value
}

func (v *NullableGetAccountV2Resp) Set(val *GetAccountV2Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAccountV2Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAccountV2Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAccountV2Resp(val *GetAccountV2Resp) *NullableGetAccountV2Resp {
	return &NullableGetAccountV2Resp{value: val, isSet: true}
}

func (v NullableGetAccountV2Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAccountV2Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
