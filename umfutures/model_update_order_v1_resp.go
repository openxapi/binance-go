...
// checks if the UpdateOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateOrderV1Resp{}

// UpdateOrderV1Resp struct for UpdateOrderV1Resp
type UpdateOrderV1Resp struct {
...
func (o UpdateOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o UpdateOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateOrderV1Resp struct {
	value *UpdateOrderV1Resp
	isSet bool
}

func (v NullableUpdateOrderV1Resp) Get() *UpdateOrderV1Resp {
	return v.value
}

func (v *NullableUpdateOrderV1Resp) Set(val *UpdateOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateOrderV1Resp(val *UpdateOrderV1Resp) *NullableUpdateOrderV1Resp {
	return &NullableUpdateOrderV1Resp{value: val, isSet: true}
}

func (v NullableUpdateOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
