...
// checks if the GetOrderAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrderAsynIdV1Resp{}

// GetOrderAsynIdV1Resp struct for GetOrderAsynIdV1Resp
type GetOrderAsynIdV1Resp struct {
...
func (o GetOrderAsynIdV1Resp) MarshalJSON() ([]byte, error) {
...
func (o GetOrderAsynIdV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableGetOrderAsynIdV1Resp struct {
	value *GetOrderAsynIdV1Resp
	isSet bool
}

func (v NullableGetOrderAsynIdV1Resp) Get() *GetOrderAsynIdV1Resp {
	return v.value
}

func (v *NullableGetOrderAsynIdV1Resp) Set(val *GetOrderAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrderAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrderAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrderAsynIdV1Resp(val *GetOrderAsynIdV1Resp) *NullableGetOrderAsynIdV1Resp {
	return &NullableGetOrderAsynIdV1Resp{value: val, isSet: true}
}

func (v NullableGetOrderAsynIdV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrderAsynIdV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
