...
// checks if the MarginDeleteMarginOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarginDeleteMarginOrderV1Resp{}

// MarginDeleteMarginOrderV1Resp struct for MarginDeleteMarginOrderV1Resp
type MarginDeleteMarginOrderV1Resp struct {
...
func NewMarginDeleteMarginOrderV1Resp() *MarginDeleteMarginOrderV1Resp {
	this := MarginDeleteMarginOrderV1Resp{}
	return &this
}
...
func (o *MarginDeleteMarginOrderV1Resp) GetOrigClientOrderId() string {
...
// and a boolean to check if the value has been set.
func (o *MarginDeleteMarginOrderV1Resp) GetPriceOk() (*string, bool) {
	if o == nil || IsNil(o.Price) {
		return nil, false
	}
	return o.Price, true
...
func (o *MarginDeleteMarginOrderV1Resp) SetStatus(v string) {
	o.Status = &v
}
...
func (o MarginDeleteMarginOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o MarginDeleteMarginOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableMarginDeleteMarginOrderV1Resp struct {
	value *MarginDeleteMarginOrderV1Resp
	isSet bool
}

func (v NullableMarginDeleteMarginOrderV1Resp) Get() *MarginDeleteMarginOrderV1Resp {
	return v.value
}

func (v *NullableMarginDeleteMarginOrderV1Resp) Set(val *MarginDeleteMarginOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableMarginDeleteMarginOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableMarginDeleteMarginOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarginDeleteMarginOrderV1Resp(val *MarginDeleteMarginOrderV1Resp) *NullableMarginDeleteMarginOrderV1Resp {
	return &NullableMarginDeleteMarginOrderV1Resp{value: val, isSet: true}
}

func (v NullableMarginDeleteMarginOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarginDeleteMarginOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
