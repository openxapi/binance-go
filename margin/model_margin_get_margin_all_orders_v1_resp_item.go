...
// checks if the MarginGetMarginAllOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarginGetMarginAllOrdersV1RespItem{}

// MarginGetMarginAllOrdersV1RespItem struct for MarginGetMarginAllOrdersV1RespItem
type MarginGetMarginAllOrdersV1RespItem struct {
...
func NewMarginGetMarginAllOrdersV1RespItem() *MarginGetMarginAllOrdersV1RespItem {
	this := MarginGetMarginAllOrdersV1RespItem{}
	return &this
}
...
func (o MarginGetMarginAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o MarginGetMarginAllOrdersV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableMarginGetMarginAllOrdersV1RespItem struct {
	value *MarginGetMarginAllOrdersV1RespItem
	isSet bool
}

func (v NullableMarginGetMarginAllOrdersV1RespItem) Get() *MarginGetMarginAllOrdersV1RespItem {
	return v.value
}

func (v *NullableMarginGetMarginAllOrdersV1RespItem) Set(val *MarginGetMarginAllOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableMarginGetMarginAllOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableMarginGetMarginAllOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarginGetMarginAllOrdersV1RespItem(val *MarginGetMarginAllOrdersV1RespItem) *NullableMarginGetMarginAllOrdersV1RespItem {
	return &NullableMarginGetMarginAllOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableMarginGetMarginAllOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarginGetMarginAllOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
