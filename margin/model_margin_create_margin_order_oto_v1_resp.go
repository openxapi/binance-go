...
// checks if the MarginCreateMarginOrderOtoV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarginCreateMarginOrderOtoV1Resp{}

// MarginCreateMarginOrderOtoV1Resp struct for MarginCreateMarginOrderOtoV1Resp
type MarginCreateMarginOrderOtoV1Resp struct {
...
func NewMarginCreateMarginOrderOtoV1Resp() *MarginCreateMarginOrderOtoV1Resp {
	this := MarginCreateMarginOrderOtoV1Resp{}
	return &this
}
...
func (o MarginCreateMarginOrderOtoV1Resp) MarshalJSON() ([]byte, error) {
...
func (o MarginCreateMarginOrderOtoV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableMarginCreateMarginOrderOtoV1Resp struct {
	value *MarginCreateMarginOrderOtoV1Resp
	isSet bool
}

func (v NullableMarginCreateMarginOrderOtoV1Resp) Get() *MarginCreateMarginOrderOtoV1Resp {
	return v.value
}

func (v *NullableMarginCreateMarginOrderOtoV1Resp) Set(val *MarginCreateMarginOrderOtoV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableMarginCreateMarginOrderOtoV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableMarginCreateMarginOrderOtoV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarginCreateMarginOrderOtoV1Resp(val *MarginCreateMarginOrderOtoV1Resp) *NullableMarginCreateMarginOrderOtoV1Resp {
	return &NullableMarginCreateMarginOrderOtoV1Resp{value: val, isSet: true}
}

func (v NullableMarginCreateMarginOrderOtoV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarginCreateMarginOrderOtoV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
