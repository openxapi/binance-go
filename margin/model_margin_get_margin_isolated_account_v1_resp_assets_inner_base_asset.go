...
// checks if the MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset{}

// MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset struct for MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset
type MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset struct {
...
func NewMarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset() *MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset {
	this := MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset{}
	return &this
}
...
func (o *MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) SetBorrowed(v string) {
	o.Borrowed = &v
}
...
func (o *MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) HasInterest() bool {
	if o != nil && !IsNil(o.Interest) {
		return true
	}
...
func (o *MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) GetNetAssetOfBtc() string {
...
func (o MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) MarshalJSON() ([]byte, error) {
...
func (o MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) ToMap() (map[string]interface{}, error) {
...
type NullableMarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset struct {
	value *MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset
	isSet bool
}

func (v NullableMarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) Get() *MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset {
	return v.value
}

func (v *NullableMarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) Set(val *MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) {
	v.value = val
	v.isSet = true
}

func (v NullableMarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) IsSet() bool {
	return v.isSet
}

func (v *NullableMarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset(val *MarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) *NullableMarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset {
	return &NullableMarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset{value: val, isSet: true}
}

func (v NullableMarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarginGetMarginIsolatedAccountV1RespAssetsInnerBaseAsset) UnmarshalJSON(src []byte) error {
	v.isSet = true
