...
// checks if the MarginCreateMarginOrderOcoV1RespOrderReportsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarginCreateMarginOrderOcoV1RespOrderReportsInner{}

// MarginCreateMarginOrderOcoV1RespOrderReportsInner struct for MarginCreateMarginOrderOcoV1RespOrderReportsInner
type MarginCreateMarginOrderOcoV1RespOrderReportsInner struct {
...
func NewMarginCreateMarginOrderOcoV1RespOrderReportsInner() *MarginCreateMarginOrderOcoV1RespOrderReportsInner {
	this := MarginCreateMarginOrderOcoV1RespOrderReportsInner{}
	return &this
}
...
func (o *MarginCreateMarginOrderOcoV1RespOrderReportsInner) HasTransactTime() bool {
	if o != nil && !IsNil(o.TransactTime) {
		return true
	}
...
func (o MarginCreateMarginOrderOcoV1RespOrderReportsInner) MarshalJSON() ([]byte, error) {
...
func (o MarginCreateMarginOrderOcoV1RespOrderReportsInner) ToMap() (map[string]interface{}, error) {
...
type NullableMarginCreateMarginOrderOcoV1RespOrderReportsInner struct {
	value *MarginCreateMarginOrderOcoV1RespOrderReportsInner
	isSet bool
}

func (v NullableMarginCreateMarginOrderOcoV1RespOrderReportsInner) Get() *MarginCreateMarginOrderOcoV1RespOrderReportsInner {
	return v.value
}

func (v *NullableMarginCreateMarginOrderOcoV1RespOrderReportsInner) Set(val *MarginCreateMarginOrderOcoV1RespOrderReportsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableMarginCreateMarginOrderOcoV1RespOrderReportsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableMarginCreateMarginOrderOcoV1RespOrderReportsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarginCreateMarginOrderOcoV1RespOrderReportsInner(val *MarginCreateMarginOrderOcoV1RespOrderReportsInner) *NullableMarginCreateMarginOrderOcoV1RespOrderReportsInner {
	return &NullableMarginCreateMarginOrderOcoV1RespOrderReportsInner{value: val, isSet: true}
}

func (v NullableMarginCreateMarginOrderOcoV1RespOrderReportsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarginCreateMarginOrderOcoV1RespOrderReportsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
