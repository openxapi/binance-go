...
// checks if the MarginCreateMarginOrderOtocoV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarginCreateMarginOrderOtocoV1Resp{}

// MarginCreateMarginOrderOtocoV1Resp struct for MarginCreateMarginOrderOtocoV1Resp
type MarginCreateMarginOrderOtocoV1Resp struct {
	...
	OrderReports []MarginCreateMarginOrderOtoV1RespOrderReportsInner `json:"orderReports,omitempty"`
...
func NewMarginCreateMarginOrderOtocoV1Resp() *MarginCreateMarginOrderOtocoV1Resp {
	this := MarginCreateMarginOrderOtocoV1Resp{}
	return &this
}
...
func (o *MarginCreateMarginOrderOtocoV1Resp) GetOrderReports() []MarginCreateMarginOrderOtoV1RespOrderReportsInner {
	if o == nil || IsNil(o.OrderReports) {
		var ret []MarginCreateMarginOrderOtoV1RespOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []MarginCreateMarginOrderOtoV1RespOrderReportsInner and assigns it to the OrderReports field.
...
func (o MarginCreateMarginOrderOtocoV1Resp) MarshalJSON() ([]byte, error) {
...
func (o MarginCreateMarginOrderOtocoV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableMarginCreateMarginOrderOtocoV1Resp struct {
	value *MarginCreateMarginOrderOtocoV1Resp
	isSet bool
}

func (v NullableMarginCreateMarginOrderOtocoV1Resp) Get() *MarginCreateMarginOrderOtocoV1Resp {
	return v.value
}

func (v *NullableMarginCreateMarginOrderOtocoV1Resp) Set(val *MarginCreateMarginOrderOtocoV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableMarginCreateMarginOrderOtocoV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableMarginCreateMarginOrderOtocoV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarginCreateMarginOrderOtocoV1Resp(val *MarginCreateMarginOrderOtocoV1Resp) *NullableMarginCreateMarginOrderOtocoV1Resp {
	return &NullableMarginCreateMarginOrderOtocoV1Resp{value: val, isSet: true}
}

func (v NullableMarginCreateMarginOrderOtocoV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarginCreateMarginOrderOtocoV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
