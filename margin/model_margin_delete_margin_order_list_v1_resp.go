...
// checks if the MarginDeleteMarginOrderListV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarginDeleteMarginOrderListV1Resp{}

// MarginDeleteMarginOrderListV1Resp struct for MarginDeleteMarginOrderListV1Resp
type MarginDeleteMarginOrderListV1Resp struct {
	...
	OrderReports []MarginDeleteMarginOrderListV1RespOrderReportsInner `json:"orderReports,omitempty"`
...
func NewMarginDeleteMarginOrderListV1Resp() *MarginDeleteMarginOrderListV1Resp {
	this := MarginDeleteMarginOrderListV1Resp{}
	return &this
}
...
func (o *MarginDeleteMarginOrderListV1Resp) GetOrderReports() []MarginDeleteMarginOrderListV1RespOrderReportsInner {
	if o == nil || IsNil(o.OrderReports) {
		var ret []MarginDeleteMarginOrderListV1RespOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []MarginDeleteMarginOrderListV1RespOrderReportsInner and assigns it to the OrderReports field.
...
func (o MarginDeleteMarginOrderListV1Resp) MarshalJSON() ([]byte, error) {
...
func (o MarginDeleteMarginOrderListV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableMarginDeleteMarginOrderListV1Resp struct {
	value *MarginDeleteMarginOrderListV1Resp
	isSet bool
}

func (v NullableMarginDeleteMarginOrderListV1Resp) Get() *MarginDeleteMarginOrderListV1Resp {
	return v.value
}

func (v *NullableMarginDeleteMarginOrderListV1Resp) Set(val *MarginDeleteMarginOrderListV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableMarginDeleteMarginOrderListV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableMarginDeleteMarginOrderListV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarginDeleteMarginOrderListV1Resp(val *MarginDeleteMarginOrderListV1Resp) *NullableMarginDeleteMarginOrderListV1Resp {
	return &NullableMarginDeleteMarginOrderListV1Resp{value: val, isSet: true}
}

func (v NullableMarginDeleteMarginOrderListV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarginDeleteMarginOrderListV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
