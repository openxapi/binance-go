...
// checks if the MarginGetMarginInterestHistoryV1RespRowsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarginGetMarginInterestHistoryV1RespRowsInner{}

// MarginGetMarginInterestHistoryV1RespRowsInner struct for MarginGetMarginInterestHistoryV1RespRowsInner
type MarginGetMarginInterestHistoryV1RespRowsInner struct {
...
func NewMarginGetMarginInterestHistoryV1RespRowsInner() *MarginGetMarginInterestHistoryV1RespRowsInner {
	this := MarginGetMarginInterestHistoryV1RespRowsInner{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *MarginGetMarginInterestHistoryV1RespRowsInner) GetTxIdOk() (*int64, bool) {
	if o == nil || IsNil(o.TxId) {
		return nil, false
	}
	return o.TxId, true
...
func (o MarginGetMarginInterestHistoryV1RespRowsInner) MarshalJSON() ([]byte, error) {
...
func (o MarginGetMarginInterestHistoryV1RespRowsInner) ToMap() (map[string]interface{}, error) {
...
type NullableMarginGetMarginInterestHistoryV1RespRowsInner struct {
	value *MarginGetMarginInterestHistoryV1RespRowsInner
	isSet bool
}

func (v NullableMarginGetMarginInterestHistoryV1RespRowsInner) Get() *MarginGetMarginInterestHistoryV1RespRowsInner {
	return v.value
}

func (v *NullableMarginGetMarginInterestHistoryV1RespRowsInner) Set(val *MarginGetMarginInterestHistoryV1RespRowsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableMarginGetMarginInterestHistoryV1RespRowsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableMarginGetMarginInterestHistoryV1RespRowsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarginGetMarginInterestHistoryV1RespRowsInner(val *MarginGetMarginInterestHistoryV1RespRowsInner) *NullableMarginGetMarginInterestHistoryV1RespRowsInner {
	return &NullableMarginGetMarginInterestHistoryV1RespRowsInner{value: val, isSet: true}
}

func (v NullableMarginGetMarginInterestHistoryV1RespRowsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarginGetMarginInterestHistoryV1RespRowsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
