...
// checks if the ConvertCreateConvertGetQuoteV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConvertCreateConvertGetQuoteV1Resp{}

// ConvertCreateConvertGetQuoteV1Resp struct for ConvertCreateConvertGetQuoteV1Resp
type ConvertCreateConvertGetQuoteV1Resp struct {
...
func NewConvertCreateConvertGetQuoteV1Resp() *ConvertCreateConvertGetQuoteV1Resp {
	this := ConvertCreateConvertGetQuoteV1Resp{}
	return &this
}
...
func (o ConvertCreateConvertGetQuoteV1Resp) MarshalJSON() ([]byte, error) {
...
func (o ConvertCreateConvertGetQuoteV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableConvertCreateConvertGetQuoteV1Resp struct {
	value *ConvertCreateConvertGetQuoteV1Resp
	isSet bool
}

func (v NullableConvertCreateConvertGetQuoteV1Resp) Get() *ConvertCreateConvertGetQuoteV1Resp {
	return v.value
}

func (v *NullableConvertCreateConvertGetQuoteV1Resp) Set(val *ConvertCreateConvertGetQuoteV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertCreateConvertGetQuoteV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertCreateConvertGetQuoteV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertCreateConvertGetQuoteV1Resp(val *ConvertCreateConvertGetQuoteV1Resp) *NullableConvertCreateConvertGetQuoteV1Resp {
	return &NullableConvertCreateConvertGetQuoteV1Resp{value: val, isSet: true}
}

func (v NullableConvertCreateConvertGetQuoteV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertCreateConvertGetQuoteV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
