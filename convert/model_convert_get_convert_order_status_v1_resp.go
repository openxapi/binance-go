...
// checks if the ConvertGetConvertOrderStatusV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConvertGetConvertOrderStatusV1Resp{}

// ConvertGetConvertOrderStatusV1Resp struct for ConvertGetConvertOrderStatusV1Resp
type ConvertGetConvertOrderStatusV1Resp struct {
...
func NewConvertGetConvertOrderStatusV1Resp() *ConvertGetConvertOrderStatusV1Resp {
	this := ConvertGetConvertOrderStatusV1Resp{}
	return &this
}
...
func (o *ConvertGetConvertOrderStatusV1Resp) SetCreateTime(v int64) {
	o.CreateTime = &v
}
...
func (o ConvertGetConvertOrderStatusV1Resp) MarshalJSON() ([]byte, error) {
...
func (o ConvertGetConvertOrderStatusV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableConvertGetConvertOrderStatusV1Resp struct {
	value *ConvertGetConvertOrderStatusV1Resp
	isSet bool
}

func (v NullableConvertGetConvertOrderStatusV1Resp) Get() *ConvertGetConvertOrderStatusV1Resp {
	return v.value
}

func (v *NullableConvertGetConvertOrderStatusV1Resp) Set(val *ConvertGetConvertOrderStatusV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertGetConvertOrderStatusV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertGetConvertOrderStatusV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertGetConvertOrderStatusV1Resp(val *ConvertGetConvertOrderStatusV1Resp) *NullableConvertGetConvertOrderStatusV1Resp {
	return &NullableConvertGetConvertOrderStatusV1Resp{value: val, isSet: true}
}

func (v NullableConvertGetConvertOrderStatusV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertGetConvertOrderStatusV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
