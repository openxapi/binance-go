...
// checks if the ConvertGetConvertTradeFlowV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConvertGetConvertTradeFlowV1Resp{}

// ConvertGetConvertTradeFlowV1Resp struct for ConvertGetConvertTradeFlowV1Resp
type ConvertGetConvertTradeFlowV1Resp struct {
	EndTime *int64 `json:"endTime,omitempty"`
	Limit *int32 `json:"limit,omitempty"`
	List []ConvertGetConvertTradeFlowV1RespListInner `json:"list,omitempty"`
...
func NewConvertGetConvertTradeFlowV1Resp() *ConvertGetConvertTradeFlowV1Resp {
	this := ConvertGetConvertTradeFlowV1Resp{}
	return &this
}
...
func (o *ConvertGetConvertTradeFlowV1Resp) GetList() []ConvertGetConvertTradeFlowV1RespListInner {
	if o == nil || IsNil(o.List) {
		var ret []ConvertGetConvertTradeFlowV1RespListInner
		return ret
	}
	return o.List
}
...
// SetList gets a reference to the given []ConvertGetConvertTradeFlowV1RespListInner and assigns it to the List field.
...
func (o ConvertGetConvertTradeFlowV1Resp) MarshalJSON() ([]byte, error) {
...
func (o ConvertGetConvertTradeFlowV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableConvertGetConvertTradeFlowV1Resp struct {
	value *ConvertGetConvertTradeFlowV1Resp
	isSet bool
}

func (v NullableConvertGetConvertTradeFlowV1Resp) Get() *ConvertGetConvertTradeFlowV1Resp {
	return v.value
}

func (v *NullableConvertGetConvertTradeFlowV1Resp) Set(val *ConvertGetConvertTradeFlowV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertGetConvertTradeFlowV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertGetConvertTradeFlowV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertGetConvertTradeFlowV1Resp(val *ConvertGetConvertTradeFlowV1Resp) *NullableConvertGetConvertTradeFlowV1Resp {
	return &NullableConvertGetConvertTradeFlowV1Resp{value: val, isSet: true}
}

func (v NullableConvertGetConvertTradeFlowV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertGetConvertTradeFlowV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
