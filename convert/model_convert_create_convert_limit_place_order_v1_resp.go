...
// checks if the ConvertCreateConvertLimitPlaceOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConvertCreateConvertLimitPlaceOrderV1Resp{}

// ConvertCreateConvertLimitPlaceOrderV1Resp struct for ConvertCreateConvertLimitPlaceOrderV1Resp
type ConvertCreateConvertLimitPlaceOrderV1Resp struct {
...
func NewConvertCreateConvertLimitPlaceOrderV1Resp() *ConvertCreateConvertLimitPlaceOrderV1Resp {
	this := ConvertCreateConvertLimitPlaceOrderV1Resp{}
	return &this
}
...
func (o ConvertCreateConvertLimitPlaceOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o ConvertCreateConvertLimitPlaceOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableConvertCreateConvertLimitPlaceOrderV1Resp struct {
	value *ConvertCreateConvertLimitPlaceOrderV1Resp
	isSet bool
}

func (v NullableConvertCreateConvertLimitPlaceOrderV1Resp) Get() *ConvertCreateConvertLimitPlaceOrderV1Resp {
	return v.value
}

func (v *NullableConvertCreateConvertLimitPlaceOrderV1Resp) Set(val *ConvertCreateConvertLimitPlaceOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableConvertCreateConvertLimitPlaceOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableConvertCreateConvertLimitPlaceOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvertCreateConvertLimitPlaceOrderV1Resp(val *ConvertCreateConvertLimitPlaceOrderV1Resp) *NullableConvertCreateConvertLimitPlaceOrderV1Resp {
	return &NullableConvertCreateConvertLimitPlaceOrderV1Resp{value: val, isSet: true}
}

func (v NullableConvertCreateConvertLimitPlaceOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvertCreateConvertLimitPlaceOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
