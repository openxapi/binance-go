...
// checks if the GetUmTradeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUmTradeAsynIdV1Resp{}
...
type NullableGetUmTradeAsynIdV1Resp struct {
	value *GetUmTradeAsynIdV1Resp
	isSet bool
}

func (v NullableGetUmTradeAsynIdV1Resp) Get() *GetUmTradeAsynIdV1Resp {
	return v.value
}

func (v *NullableGetUmTradeAsynIdV1Resp) Set(val *GetUmTradeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUmTradeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}
...
func NewNullableGetUmTradeAsynIdV1Resp(val *GetUmTradeAsynIdV1Resp) *NullableGetUmTradeAsynIdV1Resp {
	return &NullableGetUmTradeAsynIdV1Resp{value: val, isSet: true}
}
