...
// checks if the GetUmConditionalOpenOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUmConditionalOpenOrderV1Resp{}
...
func NewGetUmConditionalOpenOrderV1Resp() *GetUmConditionalOpenOrderV1Resp {
	this := GetUmConditionalOpenOrderV1Resp{}
	return &this
}
...
type NullableGetUmConditionalOpenOrderV1Resp struct {
	value *GetUmConditionalOpenOrderV1Resp
	isSet bool
}

func (v NullableGetUmConditionalOpenOrderV1Resp) Get() *GetUmConditionalOpenOrderV1Resp {
	return v.value
}

func (v *NullableGetUmConditionalOpenOrderV1Resp) Set(val *GetUmConditionalOpenOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUmConditionalOpenOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUmConditionalOpenOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUmConditionalOpenOrderV1Resp(val *GetUmConditionalOpenOrderV1Resp) *NullableGetUmConditionalOpenOrderV1Resp {
	return &NullableGetUmConditionalOpenOrderV1Resp{value: val, isSet: true}
}
