...
// checks if the GetCmAllOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCmAllOrdersV1RespItem{}
...
type NullableGetCmAllOrdersV1RespItem struct {
	value *GetCmAllOrdersV1RespItem
	isSet bool
}

func (v NullableGetCmAllOrdersV1RespItem) Get() *GetCmAllOrdersV1RespItem {
	return v.value
}

func (v *NullableGetCmAllOrdersV1RespItem) Set(val *GetCmAllOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCmAllOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCmAllOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCmAllOrdersV1RespItem(val *GetCmAllOrdersV1RespItem) *NullableGetCmAllOrdersV1RespItem {
	return &NullableGetCmAllOrdersV1RespItem{value: val, isSet: true}
}
