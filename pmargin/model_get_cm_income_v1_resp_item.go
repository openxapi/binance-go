...
// checks if the GetCmIncomeV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCmIncomeV1RespItem{}
...
type NullableGetCmIncomeV1RespItem struct {
	value *GetCmIncomeV1RespItem
	isSet bool
}

func (v NullableGetCmIncomeV1RespItem) Get() *GetCmIncomeV1RespItem {
	return v.value
}

func (v *NullableGetCmIncomeV1RespItem) Set(val *GetCmIncomeV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCmIncomeV1RespItem) IsSet() bool {
	return v.isSet
}
...
func NewNullableGetCmIncomeV1RespItem(val *GetCmIncomeV1RespItem) *NullableGetCmIncomeV1RespItem {
	return &NullableGetCmIncomeV1RespItem{value: val, isSet: true}
}
