...
// checks if the GetUmOrderAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUmOrderAsynIdV1Resp{}
...
type NullableGetUmOrderAsynIdV1Resp struct {
	value *GetUmOrderAsynIdV1Resp
	isSet bool
}

func (v NullableGetUmOrderAsynIdV1Resp) Get() *GetUmOrderAsynIdV1Resp {
	return v.value
}

func (v *NullableGetUmOrderAsynIdV1Resp) Set(val *GetUmOrderAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUmOrderAsynIdV1Resp) IsSet() bool {
	return v.isSet
}
...
func NewNullableGetUmOrderAsynIdV1Resp(val *GetUmOrderAsynIdV1Resp) *NullableGetUmOrderAsynIdV1Resp {
	return &NullableGetUmOrderAsynIdV1Resp{value: val, isSet: true}
}
