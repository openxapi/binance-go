...
// checks if the GetUmForceOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUmForceOrdersV1RespItem{}
...
func NewGetUmForceOrdersV1RespItem() *GetUmForceOrdersV1RespItem {
	this := GetUmForceOrdersV1RespItem{}
	return &this
}
...
type NullableGetUmForceOrdersV1RespItem struct {
	value *GetUmForceOrdersV1RespItem
	isSet bool
}

func (v NullableGetUmForceOrdersV1RespItem) Get() *GetUmForceOrdersV1RespItem {
	return v.value
}

func (v *NullableGetUmForceOrdersV1RespItem) Set(val *GetUmForceOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUmForceOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUmForceOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUmForceOrdersV1RespItem(val *GetUmForceOrdersV1RespItem) *NullableGetUmForceOrdersV1RespItem {
	return &NullableGetUmForceOrdersV1RespItem{value: val, isSet: true}
}
