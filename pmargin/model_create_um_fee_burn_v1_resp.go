...
// checks if the CreateUmFeeBurnV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateUmFeeBurnV1Resp{}
...
type NullableCreateUmFeeBurnV1Resp struct {
	value *CreateUmFeeBurnV1Resp
	isSet bool
}

func (v NullableCreateUmFeeBurnV1Resp) Get() *CreateUmFeeBurnV1Resp {
	return v.value
}

func (v *NullableCreateUmFeeBurnV1Resp) Set(val *CreateUmFeeBurnV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateUmFeeBurnV1Resp) IsSet() bool {
	return v.isSet
}
...
func NewNullableCreateUmFeeBurnV1Resp(val *CreateUmFeeBurnV1Resp) *NullableCreateUmFeeBurnV1Resp {
	return &NullableCreateUmFeeBurnV1Resp{value: val, isSet: true}
}
