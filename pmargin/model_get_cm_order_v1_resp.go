...
// checks if the GetCmOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCmOrderV1Resp{}
...
type NullableGetCmOrderV1Resp struct {
	value *GetCmOrderV1Resp
	isSet bool
}

func (v NullableGetCmOrderV1Resp) Get() *GetCmOrderV1Resp {
	return v.value
}

func (v *NullableGetCmOrderV1Resp) Set(val *GetCmOrderV1Resp) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGetCmOrderV1Resp(val *GetCmOrderV1Resp) *NullableGetCmOrderV1Resp {
	return &NullableGetCmOrderV1Resp{value: val, isSet: true}
}
