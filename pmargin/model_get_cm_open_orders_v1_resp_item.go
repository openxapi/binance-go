...
// checks if the GetCmOpenOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCmOpenOrdersV1RespItem{}
...
func NewGetCmOpenOrdersV1RespItem() *GetCmOpenOrdersV1RespItem {
	this := GetCmOpenOrdersV1RespItem{}
	return &this
}
...
type NullableGetCmOpenOrdersV1RespItem struct {
	value *GetCmOpenOrdersV1RespItem
	isSet bool
}

func (v NullableGetCmOpenOrdersV1RespItem) Get() *GetCmOpenOrdersV1RespItem {
	return v.value
}

func (v *NullableGetCmOpenOrdersV1RespItem) Set(val *GetCmOpenOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCmOpenOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCmOpenOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCmOpenOrdersV1RespItem(val *GetCmOpenOrdersV1RespItem) *NullableGetCmOpenOrdersV1RespItem {
	return &NullableGetCmOpenOrdersV1RespItem{value: val, isSet: true}
}
