...
// checks if the CreateCmConditionalOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCmConditionalOrderV1Resp{}
...
func NewCreateCmConditionalOrderV1Resp() *CreateCmConditionalOrderV1Resp {
	this := CreateCmConditionalOrderV1Resp{}
	return &this
}
...
type NullableCreateCmConditionalOrderV1Resp struct {
	value *CreateCmConditionalOrderV1Resp
	isSet bool
}

func (v NullableCreateCmConditionalOrderV1Resp) Get() *CreateCmConditionalOrderV1Resp {
	return v.value
}

func (v *NullableCreateCmConditionalOrderV1Resp) Set(val *CreateCmConditionalOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCmConditionalOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCmConditionalOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCmConditionalOrderV1Resp(val *CreateCmConditionalOrderV1Resp) *NullableCreateCmConditionalOrderV1Resp {
	return &NullableCreateCmConditionalOrderV1Resp{value: val, isSet: true}
}
