...
// checks if the GetMarginOpenOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarginOpenOrdersV1RespItem{}
...
func NewGetMarginOpenOrdersV1RespItem() *GetMarginOpenOrdersV1RespItem {
	this := GetMarginOpenOrdersV1RespItem{}
	return &this
}
...
type NullableGetMarginOpenOrdersV1RespItem struct {
	value *GetMarginOpenOrdersV1RespItem
	isSet bool
}

func (v NullableGetMarginOpenOrdersV1RespItem) Get() *GetMarginOpenOrdersV1RespItem {
	return v.value
}

func (v *NullableGetMarginOpenOrdersV1RespItem) Set(val *GetMarginOpenOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarginOpenOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarginOpenOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarginOpenOrdersV1RespItem(val *GetMarginOpenOrdersV1RespItem) *NullableGetMarginOpenOrdersV1RespItem {
	return &NullableGetMarginOpenOrdersV1RespItem{value: val, isSet: true}
}
