...
// checks if the GetCmConditionalOpenOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCmConditionalOpenOrdersV1RespItem{}
...
func NewGetCmConditionalOpenOrdersV1RespItem() *GetCmConditionalOpenOrdersV1RespItem {
	this := GetCmConditionalOpenOrdersV1RespItem{}
	return &this
}
...
type NullableGetCmConditionalOpenOrdersV1RespItem struct {
	value *GetCmConditionalOpenOrdersV1RespItem
	isSet bool
}

func (v NullableGetCmConditionalOpenOrdersV1RespItem) Get() *GetCmConditionalOpenOrdersV1RespItem {
	return v.value
}

func (v *NullableGetCmConditionalOpenOrdersV1RespItem) Set(val *GetCmConditionalOpenOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCmConditionalOpenOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCmConditionalOpenOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCmConditionalOpenOrdersV1RespItem(val *GetCmConditionalOpenOrdersV1RespItem) *NullableGetCmConditionalOpenOrdersV1RespItem {
	return &NullableGetCmConditionalOpenOrdersV1RespItem{value: val, isSet: true}
}

func (v NullableGetCmConditionalOpenOrdersV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCmConditionalOpenOrdersV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
