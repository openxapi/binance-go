...
// checks if the DeleteUmAllOpenOrdersV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteUmAllOpenOrdersV1Resp{}
...
func NewDeleteUmAllOpenOrdersV1Resp() *DeleteUmAllOpenOrdersV1Resp {
	this := DeleteUmAllOpenOrdersV1Resp{}
	return &this
}
...
type NullableDeleteUmAllOpenOrdersV1Resp struct {
	value *DeleteUmAllOpenOrdersV1Resp
	isSet bool
}

func (v NullableDeleteUmAllOpenOrdersV1Resp) Get() *DeleteUmAllOpenOrdersV1Resp {
	return v.value
}

func (v *NullableDeleteUmAllOpenOrdersV1Resp) Set(val *DeleteUmAllOpenOrdersV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteUmAllOpenOrdersV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteUmAllOpenOrdersV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteUmAllOpenOrdersV1Resp(val *DeleteUmAllOpenOrdersV1Resp) *NullableDeleteUmAllOpenOrdersV1Resp {
	return &NullableDeleteUmAllOpenOrdersV1Resp{value: val, isSet: true}
}
