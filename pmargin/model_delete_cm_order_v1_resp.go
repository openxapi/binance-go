...
// checks if the DeleteCmOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteCmOrderV1Resp{}
...
type NullableDeleteCmOrderV1Resp struct {
	value *DeleteCmOrderV1Resp
	isSet bool
}

func (v NullableDeleteCmOrderV1Resp) Get() *DeleteCmOrderV1Resp {
	return v.value
}

func (v *NullableDeleteCmOrderV1Resp) Set(val *DeleteCmOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteCmOrderV1Resp) IsSet() bool {
	return v.isSet
}
...
func NewNullableDeleteCmOrderV1Resp(val *DeleteCmOrderV1Resp) *NullableDeleteCmOrderV1Resp {
	return &NullableDeleteCmOrderV1Resp{value: val, isSet: true}
}
