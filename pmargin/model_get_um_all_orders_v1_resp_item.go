...
// checks if the GetUmAllOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUmAllOrdersV1RespItem{}
...
type NullableGetUmAllOrdersV1RespItem struct {
	value *GetUmAllOrdersV1RespItem
	isSet bool
}

func (v NullableGetUmAllOrdersV1RespItem) Get() *GetUmAllOrdersV1RespItem {
	return v.value
}

func (v *NullableGetUmAllOrdersV1RespItem) Set(val *GetUmAllOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUmAllOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUmAllOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUmAllOrdersV1RespItem(val *GetUmAllOrdersV1RespItem) *NullableGetUmAllOrdersV1RespItem {
	return &NullableGetUmAllOrdersV1RespItem{value: val, isSet: true}
}
