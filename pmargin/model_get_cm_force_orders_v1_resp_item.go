...
// checks if the GetCmForceOrdersV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCmForceOrdersV1RespItem{}
...
func NewGetCmForceOrdersV1RespItem() *GetCmForceOrdersV1RespItem {
	this := GetCmForceOrdersV1RespItem{}
	return &this
}
...
type NullableGetCmForceOrdersV1RespItem struct {
	value *GetCmForceOrdersV1RespItem
	isSet bool
}

func (v NullableGetCmForceOrdersV1RespItem) Get() *GetCmForceOrdersV1RespItem {
	return v.value
}

func (v *NullableGetCmForceOrdersV1RespItem) Set(val *GetCmForceOrdersV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCmForceOrdersV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCmForceOrdersV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCmForceOrdersV1RespItem(val *GetCmForceOrdersV1RespItem) *NullableGetCmForceOrdersV1RespItem {
	return &NullableGetCmForceOrdersV1RespItem{value: val, isSet: true}
}
