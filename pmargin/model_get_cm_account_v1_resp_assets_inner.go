...
// checks if the GetCmAccountV1RespAssetsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCmAccountV1RespAssetsInner{}
...
func NewGetCmAccountV1RespAssetsInner() *GetCmAccountV1RespAssetsInner {
	this := GetCmAccountV1RespAssetsInner{}
	return &this
}
...
type NullableGetCmAccountV1RespAssetsInner struct {
	value *GetCmAccountV1RespAssetsInner
	isSet bool
}

func (v NullableGetCmAccountV1RespAssetsInner) Get() *GetCmAccountV1RespAssetsInner {
	return v.value
}

func (v *NullableGetCmAccountV1RespAssetsInner) Set(val *GetCmAccountV1RespAssetsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCmAccountV1RespAssetsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCmAccountV1RespAssetsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCmAccountV1RespAssetsInner(val *GetCmAccountV1RespAssetsInner) *NullableGetCmAccountV1RespAssetsInner {
	return &NullableGetCmAccountV1RespAssetsInner{value: val, isSet: true}
}
