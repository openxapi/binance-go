...
// checks if the GetUmIncomeV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUmIncomeV1RespItem{}
...
type NullableGetUmIncomeV1RespItem struct {
	value *GetUmIncomeV1RespItem
	isSet bool
}

func (v NullableGetUmIncomeV1RespItem) Get() *GetUmIncomeV1RespItem {
	return v.value
}

func (v *NullableGetUmIncomeV1RespItem) Set(val *GetUmIncomeV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUmIncomeV1RespItem) IsSet() bool {
	return v.isSet
}
...
func NewNullableGetUmIncomeV1RespItem(val *GetUmIncomeV1RespItem) *NullableGetUmIncomeV1RespItem {
	return &NullableGetUmIncomeV1RespItem{value: val, isSet: true}
}
