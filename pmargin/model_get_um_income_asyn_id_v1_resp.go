...
// checks if the GetUmIncomeAsynIdV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUmIncomeAsynIdV1Resp{}
...
type NullableGetUmIncomeAsynIdV1Resp struct {
	value *GetUmIncomeAsynIdV1Resp
	isSet bool
}

func (v NullableGetUmIncomeAsynIdV1Resp) Get() *GetUmIncomeAsynIdV1Resp {
	return v.value
}

func (v *NullableGetUmIncomeAsynIdV1Resp) Set(val *GetUmIncomeAsynIdV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUmIncomeAsynIdV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUmIncomeAsynIdV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUmIncomeAsynIdV1Resp(val *GetUmIncomeAsynIdV1Resp) *NullableGetUmIncomeAsynIdV1Resp {
	return &NullableGetUmIncomeAsynIdV1Resp{value: val, isSet: true}
}
