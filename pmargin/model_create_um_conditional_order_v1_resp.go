...
// checks if the CreateUmConditionalOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateUmConditionalOrderV1Resp{}
...
func NewCreateUmConditionalOrderV1Resp() *CreateUmConditionalOrderV1Resp {
	this := CreateUmConditionalOrderV1Resp{}
	return &this
}
...
type NullableCreateUmConditionalOrderV1Resp struct {
	value *CreateUmConditionalOrderV1Resp
	isSet bool
}

func (v NullableCreateUmConditionalOrderV1Resp) Get() *CreateUmConditionalOrderV1Resp {
	return v.value
}

func (v *NullableCreateUmConditionalOrderV1Resp) Set(val *CreateUmConditionalOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateUmConditionalOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateUmConditionalOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateUmConditionalOrderV1Resp(val *CreateUmConditionalOrderV1Resp) *NullableCreateUmConditionalOrderV1Resp {
	return &NullableCreateUmConditionalOrderV1Resp{value: val, isSet: true}
}
