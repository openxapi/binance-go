...
// checks if the CreateUmOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateUmOrderV1Resp{}
...
type NullableCreateUmOrderV1Resp struct {
	value *CreateUmOrderV1Resp
	isSet bool
}

func (v NullableCreateUmOrderV1Resp) Get() *CreateUmOrderV1Resp {
	return v.value
}

func (v *NullableCreateUmOrderV1Resp) Set(val *CreateUmOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateUmOrderV1Resp) IsSet() bool {
	return v.isSet
}
...
func NewNullableCreateUmOrderV1Resp(val *CreateUmOrderV1Resp) *NullableCreateUmOrderV1Resp {
	return &NullableCreateUmOrderV1Resp{value: val, isSet: true}
}
