...
// checks if the UpdateCmOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCmOrderV1Resp{}
...
type NullableUpdateCmOrderV1Resp struct {
	value *UpdateCmOrderV1Resp
	isSet bool
}

func (v NullableUpdateCmOrderV1Resp) Get() *UpdateCmOrderV1Resp {
	return v.value
}

func (v *NullableUpdateCmOrderV1Resp) Set(val *UpdateCmOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCmOrderV1Resp) IsSet() bool {
	return v.isSet
}
...
func NewNullableUpdateCmOrderV1Resp(val *UpdateCmOrderV1Resp) *NullableUpdateCmOrderV1Resp {
	return &NullableUpdateCmOrderV1Resp{value: val, isSet: true}
}
