...
// checks if the GetCmAccountV1RespPositionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCmAccountV1RespPositionsInner{}
...
func NewGetCmAccountV1RespPositionsInner() *GetCmAccountV1RespPositionsInner {
	this := GetCmAccountV1RespPositionsInner{}
	return &this
}
...
type NullableGetCmAccountV1RespPositionsInner struct {
	value *GetCmAccountV1RespPositionsInner
	isSet bool
}

func (v NullableGetCmAccountV1RespPositionsInner) Get() *GetCmAccountV1RespPositionsInner {
	return v.value
}

func (v *NullableGetCmAccountV1RespPositionsInner) Set(val *GetCmAccountV1RespPositionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCmAccountV1RespPositionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCmAccountV1RespPositionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCmAccountV1RespPositionsInner(val *GetCmAccountV1RespPositionsInner) *NullableGetCmAccountV1RespPositionsInner {
	return &NullableGetCmAccountV1RespPositionsInner{value: val, isSet: true}
}

func (v NullableGetCmAccountV1RespPositionsInner) MarshalJSON() ([]byte, error) {
