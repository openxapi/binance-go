...
// checks if the WalletGetCapitalConfigGetallV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletGetCapitalConfigGetallV1RespItem{}

// WalletGetCapitalConfigGetallV1RespItem struct for WalletGetCapitalConfigGetallV1RespItem
type WalletGetCapitalConfigGetallV1RespItem struct {
	...
	NetworkList []WalletGetCapitalConfigGetallV1RespItemNetworkListInner `json:"networkList,omitempty"`
...
func NewWalletGetCapitalConfigGetallV1RespItem() *WalletGetCapitalConfigGetallV1RespItem {
	this := WalletGetCapitalConfigGetallV1RespItem{}
	return &this
}
...
func (o *WalletGetCapitalConfigGetallV1RespItem) GetCoinOk() (*string, bool) {
	if o == nil || IsNil(o.Coin) {
		return nil, false
	}
	return o.Coin, true
...
func (o *WalletGetCapitalConfigGetallV1RespItem) SetFree(v string) {
	o.Free = &v
}
...
func (o *WalletGetCapitalConfigGetallV1RespItem) GetNetworkList() []WalletGetCapitalConfigGetallV1RespItemNetworkListInner {
	if o == nil || IsNil(o.NetworkList) {
		var ret []WalletGetCapitalConfigGetallV1RespItemNetworkListInner
		return ret
	}
...
// SetNetworkList gets a reference to the given []WalletGetCapitalConfigGetallV1RespItemNetworkListInner and assigns it to the NetworkList field.
...
func (o *WalletGetCapitalConfigGetallV1RespItem) SetTrading(v bool) {
	o.Trading = &v
}
...
func (o WalletGetCapitalConfigGetallV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o WalletGetCapitalConfigGetallV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableWalletGetCapitalConfigGetallV1RespItem struct {
	value *WalletGetCapitalConfigGetallV1RespItem
	isSet bool
}

func (v NullableWalletGetCapitalConfigGetallV1RespItem) Get() *WalletGetCapitalConfigGetallV1RespItem {
	return v.value
}

func (v *NullableWalletGetCapitalConfigGetallV1RespItem) Set(val *WalletGetCapitalConfigGetallV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletGetCapitalConfigGetallV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletGetCapitalConfigGetallV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletGetCapitalConfigGetallV1RespItem(val *WalletGetCapitalConfigGetallV1RespItem) *NullableWalletGetCapitalConfigGetallV1RespItem {
	return &NullableWalletGetCapitalConfigGetallV1RespItem{value: val, isSet: true}
}

func (v NullableWalletGetCapitalConfigGetallV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletGetCapitalConfigGetallV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
