...
// checks if the WalletGetLocalentityWithdrawHistoryV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletGetLocalentityWithdrawHistoryV1RespItem{}

// WalletGetLocalentityWithdrawHistoryV1RespItem struct for WalletGetLocalentityWithdrawHistoryV1RespItem
type WalletGetLocalentityWithdrawHistoryV1RespItem struct {
...
func NewWalletGetLocalentityWithdrawHistoryV1RespItem() *WalletGetLocalentityWithdrawHistoryV1RespItem {
	this := WalletGetLocalentityWithdrawHistoryV1RespItem{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *WalletGetLocalentityWithdrawHistoryV1RespItem) GetAmountOk() (*string, bool) {
	if o == nil || IsNil(o.Amount) {
		return nil, false
	}
...
func (o *WalletGetLocalentityWithdrawHistoryV1RespItem) SetCoin(v string) {
	o.Coin = &v
}
...
// and a boolean to check if the value has been set.
func (o *WalletGetLocalentityWithdrawHistoryV1RespItem) GetWithdrawOrderIdOk() (*string, bool) {
	if o == nil || IsNil(o.WithdrawOrderId) {
		return nil, false
	}
...
func (o WalletGetLocalentityWithdrawHistoryV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o WalletGetLocalentityWithdrawHistoryV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableWalletGetLocalentityWithdrawHistoryV1RespItem struct {
	value *WalletGetLocalentityWithdrawHistoryV1RespItem
	isSet bool
}

func (v NullableWalletGetLocalentityWithdrawHistoryV1RespItem) Get() *WalletGetLocalentityWithdrawHistoryV1RespItem {
	return v.value
}

func (v *NullableWalletGetLocalentityWithdrawHistoryV1RespItem) Set(val *WalletGetLocalentityWithdrawHistoryV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletGetLocalentityWithdrawHistoryV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletGetLocalentityWithdrawHistoryV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletGetLocalentityWithdrawHistoryV1RespItem(val *WalletGetLocalentityWithdrawHistoryV1RespItem) *NullableWalletGetLocalentityWithdrawHistoryV1RespItem {
	return &NullableWalletGetLocalentityWithdrawHistoryV1RespItem{value: val, isSet: true}
}

func (v NullableWalletGetLocalentityWithdrawHistoryV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletGetLocalentityWithdrawHistoryV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
