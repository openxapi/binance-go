...
// checks if the WalletGetCapitalWithdrawHistoryV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletGetCapitalWithdrawHistoryV1RespItem{}

// WalletGetCapitalWithdrawHistoryV1RespItem struct for WalletGetCapitalWithdrawHistoryV1RespItem
type WalletGetCapitalWithdrawHistoryV1RespItem struct {
...
func NewWalletGetCapitalWithdrawHistoryV1RespItem() *WalletGetCapitalWithdrawHistoryV1RespItem {
	this := WalletGetCapitalWithdrawHistoryV1RespItem{}
	return &this
}
...
func (o *WalletGetCapitalWithdrawHistoryV1RespItem) HasCompleteTime() bool {
	if o != nil && !IsNil(o.CompleteTime) {
		return true
	}
...
func (o *WalletGetCapitalWithdrawHistoryV1RespItem) GetWalletType() int32 {
...
func (o WalletGetCapitalWithdrawHistoryV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o WalletGetCapitalWithdrawHistoryV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableWalletGetCapitalWithdrawHistoryV1RespItem struct {
	value *WalletGetCapitalWithdrawHistoryV1RespItem
	isSet bool
}

func (v NullableWalletGetCapitalWithdrawHistoryV1RespItem) Get() *WalletGetCapitalWithdrawHistoryV1RespItem {
	return v.value
}

func (v *NullableWalletGetCapitalWithdrawHistoryV1RespItem) Set(val *WalletGetCapitalWithdrawHistoryV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletGetCapitalWithdrawHistoryV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletGetCapitalWithdrawHistoryV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletGetCapitalWithdrawHistoryV1RespItem(val *WalletGetCapitalWithdrawHistoryV1RespItem) *NullableWalletGetCapitalWithdrawHistoryV1RespItem {
	return &NullableWalletGetCapitalWithdrawHistoryV1RespItem{value: val, isSet: true}
}

func (v NullableWalletGetCapitalWithdrawHistoryV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletGetCapitalWithdrawHistoryV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
