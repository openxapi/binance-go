...
// checks if the WalletGetAccountApiRestrictionsV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletGetAccountApiRestrictionsV1Resp{}

// WalletGetAccountApiRestrictionsV1Resp struct for WalletGetAccountApiRestrictionsV1Resp
type WalletGetAccountApiRestrictionsV1Resp struct {
...
func NewWalletGetAccountApiRestrictionsV1Resp() *WalletGetAccountApiRestrictionsV1Resp {
	this := WalletGetAccountApiRestrictionsV1Resp{}
	return &this
}
...
func (o WalletGetAccountApiRestrictionsV1Resp) MarshalJSON() ([]byte, error) {
...
func (o WalletGetAccountApiRestrictionsV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableWalletGetAccountApiRestrictionsV1Resp struct {
	value *WalletGetAccountApiRestrictionsV1Resp
	isSet bool
}

func (v NullableWalletGetAccountApiRestrictionsV1Resp) Get() *WalletGetAccountApiRestrictionsV1Resp {
	return v.value
}

func (v *NullableWalletGetAccountApiRestrictionsV1Resp) Set(val *WalletGetAccountApiRestrictionsV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletGetAccountApiRestrictionsV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletGetAccountApiRestrictionsV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletGetAccountApiRestrictionsV1Resp(val *WalletGetAccountApiRestrictionsV1Resp) *NullableWalletGetAccountApiRestrictionsV1Resp {
	return &NullableWalletGetAccountApiRestrictionsV1Resp{value: val, isSet: true}
}

func (v NullableWalletGetAccountApiRestrictionsV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletGetAccountApiRestrictionsV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
