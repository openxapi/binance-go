...
// checks if the SubaccountGetSubAccountFuturesAccountV1RespAssetsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubaccountGetSubAccountFuturesAccountV1RespAssetsInner{}

// SubaccountGetSubAccountFuturesAccountV1RespAssetsInner struct for SubaccountGetSubAccountFuturesAccountV1RespAssetsInner
type SubaccountGetSubAccountFuturesAccountV1RespAssetsInner struct {
...
func NewSubaccountGetSubAccountFuturesAccountV1RespAssetsInner() *SubaccountGetSubAccountFuturesAccountV1RespAssetsInner {
	this := SubaccountGetSubAccountFuturesAccountV1RespAssetsInner{}
	return &this
}
...
func (o *SubaccountGetSubAccountFuturesAccountV1RespAssetsInner) SetMaxWithdrawAmount(v string) {
...
func (o *SubaccountGetSubAccountFuturesAccountV1RespAssetsInner) SetPositionInitialMargin(v string) {
...
func (o SubaccountGetSubAccountFuturesAccountV1RespAssetsInner) MarshalJSON() ([]byte, error) {
...
func (o SubaccountGetSubAccountFuturesAccountV1RespAssetsInner) ToMap() (map[string]interface{}, error) {
...
type NullableSubaccountGetSubAccountFuturesAccountV1RespAssetsInner struct {
	value *SubaccountGetSubAccountFuturesAccountV1RespAssetsInner
	isSet bool
}

func (v NullableSubaccountGetSubAccountFuturesAccountV1RespAssetsInner) Get() *SubaccountGetSubAccountFuturesAccountV1RespAssetsInner {
	return v.value
}

func (v *NullableSubaccountGetSubAccountFuturesAccountV1RespAssetsInner) Set(val *SubaccountGetSubAccountFuturesAccountV1RespAssetsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSubaccountGetSubAccountFuturesAccountV1RespAssetsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSubaccountGetSubAccountFuturesAccountV1RespAssetsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubaccountGetSubAccountFuturesAccountV1RespAssetsInner(val *SubaccountGetSubAccountFuturesAccountV1RespAssetsInner) *NullableSubaccountGetSubAccountFuturesAccountV1RespAssetsInner {
	return &NullableSubaccountGetSubAccountFuturesAccountV1RespAssetsInner{value: val, isSet: true}
}

func (v NullableSubaccountGetSubAccountFuturesAccountV1RespAssetsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubaccountGetSubAccountFuturesAccountV1RespAssetsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
