...
// checks if the SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner{}

// SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner struct for SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner
type SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner struct {
...
func NewSubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner() *SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner {
	this := SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner{}
	return &this
}
...
func (o *SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner) GetFromUserEmailOk() (*string, bool) {
	if o == nil || IsNil(o.FromUserEmail) {
		return nil, false
	}
...
func (o SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner) MarshalJSON() ([]byte, error) {
...
func (o SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner) ToMap() (map[string]interface{}, error) {
...
type NullableSubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner struct {
	value *SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner
	isSet bool
}

func (v NullableSubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner) Get() *SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner {
	return v.value
}

func (v *NullableSubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner) Set(val *SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner(val *SubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner) *NullableSubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner {
	return &NullableSubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner{value: val, isSet: true}
}

func (v NullableSubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubaccountCreateSubAccountFuturesMovePositionV1RespMovePositionOrdersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
