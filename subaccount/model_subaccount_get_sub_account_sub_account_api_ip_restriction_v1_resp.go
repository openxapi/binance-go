...
// checks if the SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp{}

// SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp struct for SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp
type SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp struct {
...
func NewSubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp() *SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp {
	this := SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp{}
	return &this
}
...
func (o SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp) MarshalJSON() ([]byte, error) {
...
func (o SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableSubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp struct {
	value *SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp
	isSet bool
}

func (v NullableSubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp) Get() *SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp {
	return v.value
}

func (v *NullableSubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp) Set(val *SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableSubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableSubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp(val *SubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp) *NullableSubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp {
	return &NullableSubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp{value: val, isSet: true}
}

func (v NullableSubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubaccountGetSubAccountSubAccountApiIpRestrictionV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
