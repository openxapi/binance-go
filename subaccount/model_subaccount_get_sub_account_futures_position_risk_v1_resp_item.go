...
// checks if the SubaccountGetSubAccountFuturesPositionRiskV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubaccountGetSubAccountFuturesPositionRiskV1RespItem{}

// SubaccountGetSubAccountFuturesPositionRiskV1RespItem struct for SubaccountGetSubAccountFuturesPositionRiskV1RespItem
type SubaccountGetSubAccountFuturesPositionRiskV1RespItem struct {
...
func NewSubaccountGetSubAccountFuturesPositionRiskV1RespItem() *SubaccountGetSubAccountFuturesPositionRiskV1RespItem {
	this := SubaccountGetSubAccountFuturesPositionRiskV1RespItem{}
	return &this
}
...
func (o SubaccountGetSubAccountFuturesPositionRiskV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o SubaccountGetSubAccountFuturesPositionRiskV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableSubaccountGetSubAccountFuturesPositionRiskV1RespItem struct {
	value *SubaccountGetSubAccountFuturesPositionRiskV1RespItem
	isSet bool
}

func (v NullableSubaccountGetSubAccountFuturesPositionRiskV1RespItem) Get() *SubaccountGetSubAccountFuturesPositionRiskV1RespItem {
	return v.value
}

func (v *NullableSubaccountGetSubAccountFuturesPositionRiskV1RespItem) Set(val *SubaccountGetSubAccountFuturesPositionRiskV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSubaccountGetSubAccountFuturesPositionRiskV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSubaccountGetSubAccountFuturesPositionRiskV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubaccountGetSubAccountFuturesPositionRiskV1RespItem(val *SubaccountGetSubAccountFuturesPositionRiskV1RespItem) *NullableSubaccountGetSubAccountFuturesPositionRiskV1RespItem {
	return &NullableSubaccountGetSubAccountFuturesPositionRiskV1RespItem{value: val, isSet: true}
}

func (v NullableSubaccountGetSubAccountFuturesPositionRiskV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubaccountGetSubAccountFuturesPositionRiskV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
