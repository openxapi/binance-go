...
// checks if the SubaccountGetSubAccountTransferSubUserHistoryV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubaccountGetSubAccountTransferSubUserHistoryV1RespItem{}

// SubaccountGetSubAccountTransferSubUserHistoryV1RespItem struct for SubaccountGetSubAccountTransferSubUserHistoryV1RespItem
type SubaccountGetSubAccountTransferSubUserHistoryV1RespItem struct {
...
func NewSubaccountGetSubAccountTransferSubUserHistoryV1RespItem() *SubaccountGetSubAccountTransferSubUserHistoryV1RespItem {
	this := SubaccountGetSubAccountTransferSubUserHistoryV1RespItem{}
	return &this
}
...
func (o *SubaccountGetSubAccountTransferSubUserHistoryV1RespItem) SetEmail(v string) {
	o.Email = &v
}
...
func (o *SubaccountGetSubAccountTransferSubUserHistoryV1RespItem) HasQty() bool {
	if o != nil && !IsNil(o.Qty) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SubaccountGetSubAccountTransferSubUserHistoryV1RespItem) GetTypeOk() (*int32, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o SubaccountGetSubAccountTransferSubUserHistoryV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o SubaccountGetSubAccountTransferSubUserHistoryV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableSubaccountGetSubAccountTransferSubUserHistoryV1RespItem struct {
	value *SubaccountGetSubAccountTransferSubUserHistoryV1RespItem
	isSet bool
}

func (v NullableSubaccountGetSubAccountTransferSubUserHistoryV1RespItem) Get() *SubaccountGetSubAccountTransferSubUserHistoryV1RespItem {
	return v.value
}

func (v *NullableSubaccountGetSubAccountTransferSubUserHistoryV1RespItem) Set(val *SubaccountGetSubAccountTransferSubUserHistoryV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSubaccountGetSubAccountTransferSubUserHistoryV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSubaccountGetSubAccountTransferSubUserHistoryV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubaccountGetSubAccountTransferSubUserHistoryV1RespItem(val *SubaccountGetSubAccountTransferSubUserHistoryV1RespItem) *NullableSubaccountGetSubAccountTransferSubUserHistoryV1RespItem {
	return &NullableSubaccountGetSubAccountTransferSubUserHistoryV1RespItem{value: val, isSet: true}
}

func (v NullableSubaccountGetSubAccountTransferSubUserHistoryV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubaccountGetSubAccountTransferSubUserHistoryV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
