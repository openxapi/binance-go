...
// checks if the SubaccountGetSubAccountFuturesAccountV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubaccountGetSubAccountFuturesAccountV1Resp{}

// SubaccountGetSubAccountFuturesAccountV1Resp struct for SubaccountGetSubAccountFuturesAccountV1Resp
type SubaccountGetSubAccountFuturesAccountV1Resp struct {
...
func NewSubaccountGetSubAccountFuturesAccountV1Resp() *SubaccountGetSubAccountFuturesAccountV1Resp {
	this := SubaccountGetSubAccountFuturesAccountV1Resp{}
	return &this
}
...
func (o SubaccountGetSubAccountFuturesAccountV1Resp) MarshalJSON() ([]byte, error) {
...
func (o SubaccountGetSubAccountFuturesAccountV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableSubaccountGetSubAccountFuturesAccountV1Resp struct {
	value *SubaccountGetSubAccountFuturesAccountV1Resp
	isSet bool
}

func (v NullableSubaccountGetSubAccountFuturesAccountV1Resp) Get() *SubaccountGetSubAccountFuturesAccountV1Resp {
	return v.value
}

func (v *NullableSubaccountGetSubAccountFuturesAccountV1Resp) Set(val *SubaccountGetSubAccountFuturesAccountV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableSubaccountGetSubAccountFuturesAccountV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableSubaccountGetSubAccountFuturesAccountV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubaccountGetSubAccountFuturesAccountV1Resp(val *SubaccountGetSubAccountFuturesAccountV1Resp) *NullableSubaccountGetSubAccountFuturesAccountV1Resp {
	return &NullableSubaccountGetSubAccountFuturesAccountV1Resp{value: val, isSet: true}
}

func (v NullableSubaccountGetSubAccountFuturesAccountV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubaccountGetSubAccountFuturesAccountV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
