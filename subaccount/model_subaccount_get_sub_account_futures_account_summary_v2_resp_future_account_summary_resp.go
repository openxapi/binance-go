...
// checks if the SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp{}

// SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp struct for SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp
type SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp struct {
...
func NewSubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp() *SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp {
	this := SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp{}
	return &this
}
...
func (o *SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) GetAssetOk() (*string, bool) {
	if o == nil || IsNil(o.Asset) {
		return nil, false
	}
	return o.Asset, true
...
func (o *SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) GetTotalMarginBalance() string {
...
func (o SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) MarshalJSON() ([]byte, error) {
...
func (o SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) ToMap() (map[string]interface{}, error) {
...
type NullableSubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp struct {
	value *SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp
	isSet bool
}

func (v NullableSubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) Get() *SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp {
	return v.value
}

func (v *NullableSubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) Set(val *SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) {
	v.value = val
	v.isSet = true
}

func (v NullableSubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) IsSet() bool {
	return v.isSet
}

func (v *NullableSubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp(val *SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) *NullableSubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp {
	return &NullableSubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp{value: val, isSet: true}
}

func (v NullableSubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp) UnmarshalJSON(src []byte) error {
	v.isSet = true
