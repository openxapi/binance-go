...
// checks if the SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner{}

// SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner struct for SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner
type SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner struct {
...
func NewSubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner() *SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner {
	this := SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner{}
	return &this
}
...
func (o *SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) GetEmail() string {
...
func (o *SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) GetIsFutureEnabled() bool {
...
func (o SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) MarshalJSON() ([]byte, error) {
...
func (o SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) ToMap() (map[string]interface{}, error) {
...
type NullableSubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner struct {
	value *SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner
	isSet bool
}

func (v NullableSubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) Get() *SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner {
	return v.value
}

func (v *NullableSubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) Set(val *SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner(val *SubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) *NullableSubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner {
	return &NullableSubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner{value: val, isSet: true}
}

func (v NullableSubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubaccountGetManagedSubaccountInfoV1RespManagerSubUserInfoVoListInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
