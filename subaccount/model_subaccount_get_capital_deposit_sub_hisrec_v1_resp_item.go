...
// checks if the SubaccountGetCapitalDepositSubHisrecV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubaccountGetCapitalDepositSubHisrecV1RespItem{}

// SubaccountGetCapitalDepositSubHisrecV1RespItem struct for SubaccountGetCapitalDepositSubHisrecV1RespItem
type SubaccountGetCapitalDepositSubHisrecV1RespItem struct {
...
func NewSubaccountGetCapitalDepositSubHisrecV1RespItem() *SubaccountGetCapitalDepositSubHisrecV1RespItem {
	this := SubaccountGetCapitalDepositSubHisrecV1RespItem{}
	return &this
}
...
func (o *SubaccountGetCapitalDepositSubHisrecV1RespItem) GetAddressOk() (*string, bool) {
	if o == nil || IsNil(o.Address) {
		return nil, false
	}
...
func (o *SubaccountGetCapitalDepositSubHisrecV1RespItem) SetAmount(v string) {
	o.Amount = &v
}
...
func (o SubaccountGetCapitalDepositSubHisrecV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o SubaccountGetCapitalDepositSubHisrecV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableSubaccountGetCapitalDepositSubHisrecV1RespItem struct {
	value *SubaccountGetCapitalDepositSubHisrecV1RespItem
	isSet bool
}

func (v NullableSubaccountGetCapitalDepositSubHisrecV1RespItem) Get() *SubaccountGetCapitalDepositSubHisrecV1RespItem {
	return v.value
}

func (v *NullableSubaccountGetCapitalDepositSubHisrecV1RespItem) Set(val *SubaccountGetCapitalDepositSubHisrecV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSubaccountGetCapitalDepositSubHisrecV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSubaccountGetCapitalDepositSubHisrecV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubaccountGetCapitalDepositSubHisrecV1RespItem(val *SubaccountGetCapitalDepositSubHisrecV1RespItem) *NullableSubaccountGetCapitalDepositSubHisrecV1RespItem {
	return &NullableSubaccountGetCapitalDepositSubHisrecV1RespItem{value: val, isSet: true}
}

func (v NullableSubaccountGetCapitalDepositSubHisrecV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubaccountGetCapitalDepositSubHisrecV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
