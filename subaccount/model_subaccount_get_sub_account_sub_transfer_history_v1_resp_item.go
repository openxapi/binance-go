...
// checks if the SubaccountGetSubAccountSubTransferHistoryV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubaccountGetSubAccountSubTransferHistoryV1RespItem{}

// SubaccountGetSubAccountSubTransferHistoryV1RespItem struct for SubaccountGetSubAccountSubTransferHistoryV1RespItem
type SubaccountGetSubAccountSubTransferHistoryV1RespItem struct {
...
func NewSubaccountGetSubAccountSubTransferHistoryV1RespItem() *SubaccountGetSubAccountSubTransferHistoryV1RespItem {
	this := SubaccountGetSubAccountSubTransferHistoryV1RespItem{}
	return &this
}
...
func (o *SubaccountGetSubAccountSubTransferHistoryV1RespItem) SetAsset(v string) {
	o.Asset = &v
}
...
func (o SubaccountGetSubAccountSubTransferHistoryV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o SubaccountGetSubAccountSubTransferHistoryV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableSubaccountGetSubAccountSubTransferHistoryV1RespItem struct {
	value *SubaccountGetSubAccountSubTransferHistoryV1RespItem
	isSet bool
}

func (v NullableSubaccountGetSubAccountSubTransferHistoryV1RespItem) Get() *SubaccountGetSubAccountSubTransferHistoryV1RespItem {
	return v.value
}

func (v *NullableSubaccountGetSubAccountSubTransferHistoryV1RespItem) Set(val *SubaccountGetSubAccountSubTransferHistoryV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSubaccountGetSubAccountSubTransferHistoryV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSubaccountGetSubAccountSubTransferHistoryV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubaccountGetSubAccountSubTransferHistoryV1RespItem(val *SubaccountGetSubAccountSubTransferHistoryV1RespItem) *NullableSubaccountGetSubAccountSubTransferHistoryV1RespItem {
	return &NullableSubaccountGetSubAccountSubTransferHistoryV1RespItem{value: val, isSet: true}
}

func (v NullableSubaccountGetSubAccountSubTransferHistoryV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubaccountGetSubAccountSubTransferHistoryV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
