...
// Update speeds:
//   - 1000ms
// HandleRollingWindowTickerEvent registers a handler for unwrapped event 'rollingWindowTickerEvent' on combinedMarketStream
func (ch *CombinedMarketStreamChannel) HandleRollingWindowTickerEvent(fn func(context.Context, *models.RollingWindowTickerEvent) error) {
	if fn == nil { return }
	if ch.msgHandlers == nil { ch.msgHandlers = make(map[string]func(context.Context, []byte) error) }
	ch.client.handlersMu.Lock()
	ch.msgHandlers["evt:1hTicker"] = func(ctx context.Context, b []byte) error {
	...
	ch.msgHandlers["evt:4hTicker"] = func(ctx context.Context, b []byte) error {
	...
	ch.msgHandlers["evt:1dTicker"] = func(ctx context.Context, b []byte) error {
...
func (ch *CombinedMarketStreamChannel) UnregisterRollingWindowTickerEvent() {
	ch.client.handlersMu.Lock()
	delete(ch.msgHandlers, "evt:1hTicker")
	delete(ch.msgHandlers, "evt:4hTicker")
	delete(ch.msgHandlers, "evt:1dTicker")
	ch.client.handlersMu.Unlock()
}
...
// Update speeds:
//   - 1000ms
// HandleAllRollingWindowTickersEvent registers a handler for unwrapped event 'allRollingWindowTickersEvent' on combinedMarketStream
func (ch *CombinedMarketStreamChannel) HandleAllRollingWindowTickersEvent(fn func(context.Context, *models.AllRollingWindowTickersEvent) error) {
	if fn == nil { return }
	if ch.msgHandlers == nil { ch.msgHandlers = make(map[string]func(context.Context, []byte) error) }
	ch.client.handlersMu.Lock()
	ch.msgHandlers["evt:1hTicker:array"] = func(ctx context.Context, b []byte) error {
	...
	ch.msgHandlers["evt:4hTicker:array"] = func(ctx context.Context, b []byte) error {
	...
	ch.msgHandlers["evt:1dTicker:array"] = func(ctx context.Context, b []byte) error {
...
func (ch *CombinedMarketStreamChannel) UnregisterAllRollingWindowTickersEvent() {
	ch.client.handlersMu.Lock()
	delete(ch.msgHandlers, "evt:1hTicker:array")
	delete(ch.msgHandlers, "evt:4hTicker:array")
	delete(ch.msgHandlers, "evt:1dTicker:array")
	ch.client.handlersMu.Unlock()
}
...
func (ch *CombinedMarketStreamChannel) HandleBookTickerEvent(fn func(context.Context, *models.BookTickerEvent) error) {
	...
	if ch.msgHandlers == nil { ch.msgHandlers = make(map[string]func(context.Context, []byte) error) }
	ch.client.handlersMu.Lock()
	ch.msgHandlers["bookTickerEvent"] = func(ctx context.Context, b []byte) error {
...
func (ch *CombinedMarketStreamChannel) UnregisterBookTickerEvent() {
	ch.client.handlersMu.Lock()
	delete(ch.msgHandlers, "bookTickerEvent")
	ch.client.handlersMu.Unlock()
}
...
// Update speeds:
//   - 1000ms
// HandleAveragePriceEvent registers a handler for unwrapped event 'averagePriceEvent' on combinedMarketStream
func (ch *CombinedMarketStreamChannel) HandleAveragePriceEvent(fn func(context.Context, *models.AveragePriceEvent) error) {
	if fn == nil { return }
	if ch.msgHandlers == nil { ch.msgHandlers = make(map[string]func(context.Context, []byte) error) }
	ch.client.handlersMu.Lock()
	ch.msgHandlers["evt:avgPrice"] = func(ctx context.Context, b []byte) error {
...
func (ch *CombinedMarketStreamChannel) UnregisterAveragePriceEvent() {
	ch.client.handlersMu.Lock()
	delete(ch.msgHandlers, "evt:avgPrice")
	ch.client.handlersMu.Unlock()
}
...
func (ch *CombinedMarketStreamChannel) HandlePartialDepthEvent(fn func(context.Context, *models.PartialDepthEvent) error) {
	...
	if ch.msgHandlers == nil { ch.msgHandlers = make(map[string]func(context.Context, []byte) error) }
	ch.client.handlersMu.Lock()
	ch.msgHandlers["partialDepthEvent"] = func(ctx context.Context, b []byte) error {
...
func (ch *CombinedMarketStreamChannel) UnregisterPartialDepthEvent() {
	ch.client.handlersMu.Lock()
	delete(ch.msgHandlers, "partialDepthEvent")
	ch.client.handlersMu.Unlock()
}
