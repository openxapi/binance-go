...
// Ticker24hrResponse represents global message '#/components/messages/ticker24hrResponse'
type Ticker24hrResponse struct {
	...
	Result struct {
		...
		LastQty string `json:"lastQty,omitempty"` // lastQty property
		...
		PrevClosePrice string `json:"prevClosePrice,omitempty"` // prevClosePrice property
