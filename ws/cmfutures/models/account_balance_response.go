...
// AccountBalanceResponse represents global message '#/components/messages/accountBalanceResponse'
type AccountBalanceResponse struct {
	...
	Result []struct {
		...
		WithdrawAvailable string `json:"withdrawAvailable,omitempty"` // withdrawAvailable property
