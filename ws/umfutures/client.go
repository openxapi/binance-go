...
func NewClientWithOptions(opts *ClientOptions) *Client {
  ...
  _ = c.AddServer("mainnet", "wss://ws-fapi.binance.com/ws-fapi/v1", "Binance Mainnet Server", "WebSocket server for binance exchange umfutures API (mainnet environment)")
  _ = c.AddServer("testnet", "wss://testnet.binancefuture.com/ws-fapi/v1", "Binance Testnet Server", "WebSocket server for binance exchange umfutures API (testnet environment)")
  return c
}
