...
type AccountConfigUpdateEvent struct {
	...
	UserAccountConfiguration *AccountConfigUpdateEventUserAccountConfiguration `json:"ai,omitempty"`
	// Event Type
...
// AccountConfigUpdateEventUserAccountConfiguration represents a nested object structure
type AccountConfigUpdateEventUserAccountConfiguration struct {
	// Multi-Assets Mode
