...
type OrderPlaceRequest struct {
	...
	Params struct {
		...
		Quantity string `json:"quantity,omitempty"` // Cannot be sent with closePosition=true(Close-All)
		RecvWindow int64 `json:"recvWindow,omitempty"`
		ReduceOnly string `json:"reduceOnly,omitempty"` // "true" or "false". default "false". Cannot be sent in Hedge Mode; cannot be sent with closePosition=true
