...
// SetGoodTillDate sets the goodTillDate parameter and returns the struct for method chaining
func (r *OrderPlaceRequest) SetGoodTillDate(value int64) *OrderPlaceRequest {
	if r.Params == nil {
		r.Params = &OrderPlaceRequestParams{}
	}
	r.Params.GoodTillDate = &value
	return r
}
