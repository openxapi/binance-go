...
var MarkPriceEventStreamExamples = []string{ "btcusdt@markPrice", "btcusdt@markPrice@1s" }
var MarkPriceEventUpdateSpeeds = []string{ "1000ms", "3000ms" }
...
var ValidMarkPriceEventSpeeds = []MarkPriceEventSpeed{ MarkPriceEventSpeed1000ms, MarkPriceEventSpeed3000ms }
...
var AllMarkPricesEventUpdateSpeeds = []string{ "1000ms", "3000ms" }
...
var ValidAllMarkPricesEventSpeeds = []AllMarkPricesEventSpeed{ AllMarkPricesEventSpeed1000ms, AllMarkPricesEventSpeed3000ms }
...
var ContinuousKlineEventStreamExamples = []string{ "BTCUSDT_PERPETUAL@continuousKline_1m" }
...
var MiniTickerEventUpdateSpeeds = []string{ "2s" }

// MiniTickerEventSpeed is a typed alias for supported update speeds
type MiniTickerEventSpeed string
const MiniTickerEventSpeed2s MiniTickerEventSpeed = "2s"

var ValidMiniTickerEventSpeeds = []MiniTickerEventSpeed{ MiniTickerEventSpeed2s }
...
var TickerEventUpdateSpeeds = []string{ "2000ms" }

// TickerEventSpeed is a typed alias for supported update speeds
type TickerEventSpeed string
const TickerEventSpeed2000ms TickerEventSpeed = "2000ms"

var ValidTickerEventSpeeds = []TickerEventSpeed{ TickerEventSpeed2000ms }
...
var LiquidationEventStreamExamples = []string{ "btcusdt@forceOrder" }
...
// AllLiquidationsEvent stream metadata (patterns, examples)
...
// CompositeIndexEvent stream metadata (patterns, examples, update speeds)
var CompositeIndexEventStreamPatterns = []string{ "{symbol}@compositeIndex" }
var CompositeIndexEventStreamExamples = []string{ "btcusdt@compositeIndex" }
var CompositeIndexEventUpdateSpeeds = []string{ "1000ms" }

// CompositeIndexEventSpeed is a typed alias for supported update speeds
type CompositeIndexEventSpeed string
const CompositeIndexEventSpeed1000ms CompositeIndexEventSpeed = "1000ms"

var ValidCompositeIndexEventSpeeds = []CompositeIndexEventSpeed{ CompositeIndexEventSpeed1000ms }

func (s CompositeIndexEventSpeed) String() string { return string(s) }

// CompositeIndexEventStreamParams defines placeholders for stream patterns of CompositeIndexEvent
type CompositeIndexEventStreamParams struct {
	Symbol models.Symbol // symbol
}

// Values returns non-empty placeholder values from params for CompositeIndexEvent patterns
func (p CompositeIndexEventStreamParams) Values() map[string]string {
	out := make(map[string]string)
	if s := fmt.Sprint(p.Symbol); s != "" { out["symbol"] = s }
	return out
}

// BuildCompositeIndexEventStream builds a CompositeIndexEvent stream name using a pattern index and placeholder values
// Required placeholders depend on the selected pattern (see CompositeIndexEventStreamPatterns).
func BuildCompositeIndexEventStream(patternIndex int, values map[string]string) (string, error) {
	if patternIndex < 0 || patternIndex >= len(CompositeIndexEventStreamPatterns) { return "", fmt.Errorf("invalid pattern index") }
	pat := CompositeIndexEventStreamPatterns[patternIndex]
	return buildFromPattern(pat, values)
}

// BuildCompositeIndexEventStreams attempts to build all CompositeIndexEvent stream names satisfiable by provided values
func BuildCompositeIndexEventStreams(values map[string]string) ([]string, error) {
	out := make([]string, 0, len(CompositeIndexEventStreamPatterns))
	for i := range CompositeIndexEventStreamPatterns {
		if s, err := BuildCompositeIndexEventStream(i, values); err == nil { out = append(out, s) }
	}
	if len(out) == 0 { return nil, fmt.Errorf("no patterns satisfied by provided values") }
	return out, nil
}
...
// AssetIndexEvent stream metadata (patterns, examples, update speeds)
var AssetIndexEventStreamPatterns = []string{ "{assetSymbol}@assetIndex" }
var AssetIndexEventStreamExamples = []string{ "btcusd@assetIndex" }
var AssetIndexEventUpdateSpeeds = []string{ "1s" }

// AssetIndexEventSpeed is a typed alias for supported update speeds
type AssetIndexEventSpeed string
const AssetIndexEventSpeed1s AssetIndexEventSpeed = "1s"

var ValidAssetIndexEventSpeeds = []AssetIndexEventSpeed{ AssetIndexEventSpeed1s }

func (s AssetIndexEventSpeed) String() string { return string(s) }

// AssetIndexEventStreamParams defines placeholders for stream patterns of AssetIndexEvent
type AssetIndexEventStreamParams struct {
	AssetSymbol models.AssetSymbol // assetSymbol
}

// Values returns non-empty placeholder values from params for AssetIndexEvent patterns
func (p AssetIndexEventStreamParams) Values() map[string]string {
	out := make(map[string]string)
	if s := fmt.Sprint(p.AssetSymbol); s != "" { out["assetSymbol"] = s }
	return out
}

// BuildAssetIndexEventStream builds a AssetIndexEvent stream name using a pattern index and placeholder values
// Required placeholders depend on the selected pattern (see AssetIndexEventStreamPatterns).
func BuildAssetIndexEventStream(patternIndex int, values map[string]string) (string, error) {
	if patternIndex < 0 || patternIndex >= len(AssetIndexEventStreamPatterns) { return "", fmt.Errorf("invalid pattern index") }
	pat := AssetIndexEventStreamPatterns[patternIndex]
	return buildFromPattern(pat, values)
}

// BuildAssetIndexEventStreams attempts to build all AssetIndexEvent stream names satisfiable by provided values
func BuildAssetIndexEventStreams(values map[string]string) ([]string, error) {
	out := make([]string, 0, len(AssetIndexEventStreamPatterns))
	for i := range AssetIndexEventStreamPatterns {
		if s, err := BuildAssetIndexEventStream(i, values); err == nil { out = append(out, s) }
	}
	if len(out) == 0 { return nil, fmt.Errorf("no patterns satisfied by provided values") }
	return out, nil
}

// AllAssetIndexesEvent stream metadata (patterns, examples, update speeds)
var AllAssetIndexesEventStreamPatterns = []string{ "!assetIndex@arr" }
var AllAssetIndexesEventStreamExamples = []string{ "!assetIndex@arr" }
var AllAssetIndexesEventUpdateSpeeds = []string{ "1s" }

// AllAssetIndexesEventSpeed is a typed alias for supported update speeds
type AllAssetIndexesEventSpeed string
const AllAssetIndexesEventSpeed1s AllAssetIndexesEventSpeed = "1s"

var ValidAllAssetIndexesEventSpeeds = []AllAssetIndexesEventSpeed{ AllAssetIndexesEventSpeed1s }

func (s AllAssetIndexesEventSpeed) String() string { return string(s) }

// BuildAllAssetIndexesEventStream builds a AllAssetIndexesEvent stream name using a pattern index and placeholder values
// Required placeholders depend on the selected pattern (see AllAssetIndexesEventStreamPatterns).
func BuildAllAssetIndexesEventStream(patternIndex int, values map[string]string) (string, error) {
	if patternIndex < 0 || patternIndex >= len(AllAssetIndexesEventStreamPatterns) { return "", fmt.Errorf("invalid pattern index") }
	pat := AllAssetIndexesEventStreamPatterns[patternIndex]
	return buildFromPattern(pat, values)
}

// BuildAllAssetIndexesEventStreams attempts to build all AllAssetIndexesEvent stream names satisfiable by provided values
func BuildAllAssetIndexesEventStreams(values map[string]string) ([]string, error) {
	out := make([]string, 0, len(AllAssetIndexesEventStreamPatterns))
	for i := range AllAssetIndexesEventStreamPatterns {
		if s, err := BuildAllAssetIndexesEventStream(i, values); err == nil { out = append(out, s) }
	}
	if len(out) == 0 { return nil, fmt.Errorf("no patterns satisfied by provided values") }
	return out, nil
}
