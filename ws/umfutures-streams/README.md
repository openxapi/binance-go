...
import (
  "context"
  "log"
  ws "github.com/openxapi/binance-go/ws/umfutures-streams"
  wsmodels "github.com/openxapi/binance-go/ws/umfutures-streams/models"
)
...
func main() {
  ...
  // _ = client.AddOrUpdateServer("alt", "wss://fstream.binance.com/", "Alt Server", "Optional override")
...
ch.HandleCombinedStreamDataEvent(func(ctx context.Context, ev *wsmodels.CombinedStreamDataEvent) error {
