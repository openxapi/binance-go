...
func NewClientWithOptions(opts *ClientOptions) *Client {
  ...
  _ = c.AddServer("mainnet", "wss://fstream.binance.com/pm-classic", "Binance Portfolio Margin Pro Server", "WebSocket server for Binance Portfolio Margin Pro accounts (mainnet environment)")
  return c
}
