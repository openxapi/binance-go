...
func NewClientWithOptions(opts *ClientOptions) *Client {
  ...
  _ = c.AddServer("mainnet", "wss://dstream.binance.com/", "Binance COIN-M Margined Futures Server", "WebSocket server for Binance COIN-M margined futures market data streams (mainnet)")
  _ = c.AddServer("testnet", "wss://dstream.binancefuture.com/", "Binance COIN-M Margined Futures Testnet Server", "WebSocket server for Binance COIN-M margined futures market data streams (testnet)")
  return c
}
