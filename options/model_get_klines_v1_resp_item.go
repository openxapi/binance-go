...
// checks if the GetKlinesV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetKlinesV1RespItem{}

// GetKlinesV1RespItem struct for GetKlinesV1RespItem
type GetKlinesV1RespItem struct {
...
func (o *GetKlinesV1RespItem) SetAmount(v string) {
	o.Amount = &v
}
...
func (o *GetKlinesV1RespItem) HasTakerVolume() bool {
	if o != nil && !IsNil(o.TakerVolume) {
		return true
	}
...
func (o GetKlinesV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetKlinesV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetKlinesV1RespItem struct {
	value *GetKlinesV1RespItem
	isSet bool
}

func (v NullableGetKlinesV1RespItem) Get() *GetKlinesV1RespItem {
	return v.value
}

func (v *NullableGetKlinesV1RespItem) Set(val *GetKlinesV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetKlinesV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetKlinesV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetKlinesV1RespItem(val *GetKlinesV1RespItem) *NullableGetKlinesV1RespItem {
	return &NullableGetKlinesV1RespItem{value: val, isSet: true}
}

func (v NullableGetKlinesV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetKlinesV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
