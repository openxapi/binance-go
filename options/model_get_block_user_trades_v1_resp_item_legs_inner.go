...
// checks if the GetBlockUserTradesV1RespItemLegsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBlockUserTradesV1RespItemLegsInner{}

// GetBlockUserTradesV1RespItemLegsInner struct for GetBlockUserTradesV1RespItemLegsInner
type GetBlockUserTradesV1RespItemLegsInner struct {
...
func NewGetBlockUserTradesV1RespItemLegsInner() *GetBlockUserTradesV1RespItemLegsInner {
	this := GetBlockUserTradesV1RespItemLegsInner{}
	return &this
}
...
func (o *GetBlockUserTradesV1RespItemLegsInner) GetCommission() float32 {
...
func (o *GetBlockUserTradesV1RespItemLegsInner) SetFee(v float32) {
	o.Fee = &v
}
...
func (o *GetBlockUserTradesV1RespItemLegsInner) HasSymbol() bool {
	if o != nil && !IsNil(o.Symbol) {
		return true
	}
...
func (o GetBlockUserTradesV1RespItemLegsInner) MarshalJSON() ([]byte, error) {
...
func (o GetBlockUserTradesV1RespItemLegsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetBlockUserTradesV1RespItemLegsInner struct {
	value *GetBlockUserTradesV1RespItemLegsInner
	isSet bool
}

func (v NullableGetBlockUserTradesV1RespItemLegsInner) Get() *GetBlockUserTradesV1RespItemLegsInner {
	return v.value
}

func (v *NullableGetBlockUserTradesV1RespItemLegsInner) Set(val *GetBlockUserTradesV1RespItemLegsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBlockUserTradesV1RespItemLegsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBlockUserTradesV1RespItemLegsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBlockUserTradesV1RespItemLegsInner(val *GetBlockUserTradesV1RespItemLegsInner) *NullableGetBlockUserTradesV1RespItemLegsInner {
	return &NullableGetBlockUserTradesV1RespItemLegsInner{value: val, isSet: true}
}

func (v NullableGetBlockUserTradesV1RespItemLegsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBlockUserTradesV1RespItemLegsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
