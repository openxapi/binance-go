...
// checks if the GetExerciseRecordV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetExerciseRecordV1RespItem{}
...
func NewGetExerciseRecordV1RespItem() *GetExerciseRecordV1RespItem {
	this := GetExerciseRecordV1RespItem{}
	return &this
}
...
func (o GetExerciseRecordV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetExerciseRecordV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetExerciseRecordV1RespItem struct {
	value *GetExerciseRecordV1RespItem
	isSet bool
}

func (v NullableGetExerciseRecordV1RespItem) Get() *GetExerciseRecordV1RespItem {
	return v.value
}

func (v *NullableGetExerciseRecordV1RespItem) Set(val *GetExerciseRecordV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetExerciseRecordV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetExerciseRecordV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetExerciseRecordV1RespItem(val *GetExerciseRecordV1RespItem) *NullableGetExerciseRecordV1RespItem {
	return &NullableGetExerciseRecordV1RespItem{value: val, isSet: true}
}

func (v NullableGetExerciseRecordV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetExerciseRecordV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
