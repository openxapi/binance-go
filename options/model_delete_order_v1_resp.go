...
// checks if the DeleteOrderV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteOrderV1Resp{}

// DeleteOrderV1Resp struct for DeleteOrderV1Resp
...
func (o DeleteOrderV1Resp) MarshalJSON() ([]byte, error) {
...
func (o DeleteOrderV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteOrderV1Resp struct {
	value *DeleteOrderV1Resp
	isSet bool
}

func (v NullableDeleteOrderV1Resp) Get() *DeleteOrderV1Resp {
	return v.value
}

func (v *NullableDeleteOrderV1Resp) Set(val *DeleteOrderV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteOrderV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteOrderV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteOrderV1Resp(val *DeleteOrderV1Resp) *NullableDeleteOrderV1Resp {
	return &NullableDeleteOrderV1Resp{value: val, isSet: true}
}

func (v NullableDeleteOrderV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteOrderV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
