...
// checks if the GetMarkV1RespItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMarkV1RespItem{}

// GetMarkV1RespItem struct for GetMarkV1RespItem
type GetMarkV1RespItem struct {
...
func (o *GetMarkV1RespItem) SetAskIV(v string) {
	o.AskIV = &v
}
...
func (o *GetMarkV1RespItem) SetSymbol(v string) {
	o.Symbol = &v
}
...
func (o GetMarkV1RespItem) MarshalJSON() ([]byte, error) {
...
func (o GetMarkV1RespItem) ToMap() (map[string]interface{}, error) {
...
type NullableGetMarkV1RespItem struct {
	value *GetMarkV1RespItem
	isSet bool
}

func (v NullableGetMarkV1RespItem) Get() *GetMarkV1RespItem {
	return v.value
}

func (v *NullableGetMarkV1RespItem) Set(val *GetMarkV1RespItem) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarkV1RespItem) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarkV1RespItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarkV1RespItem(val *GetMarkV1RespItem) *NullableGetMarkV1RespItem {
	return &NullableGetMarkV1RespItem{value: val, isSet: true}
}

func (v NullableGetMarkV1RespItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarkV1RespItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
