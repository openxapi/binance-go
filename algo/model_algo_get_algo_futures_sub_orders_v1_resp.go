...
// checks if the AlgoGetAlgoFuturesSubOrdersV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlgoGetAlgoFuturesSubOrdersV1Resp{}

// AlgoGetAlgoFuturesSubOrdersV1Resp struct for AlgoGetAlgoFuturesSubOrdersV1Resp
type AlgoGetAlgoFuturesSubOrdersV1Resp struct {
	ExecutedAmt *string `json:"executedAmt,omitempty"`
	ExecutedQty *string `json:"executedQty,omitempty"`
	SubOrders []AlgoGetAlgoFuturesSubOrdersV1RespSubOrdersInner `json:"subOrders,omitempty"`
...
func NewAlgoGetAlgoFuturesSubOrdersV1Resp() *AlgoGetAlgoFuturesSubOrdersV1Resp {
	this := AlgoGetAlgoFuturesSubOrdersV1Resp{}
	return &this
}
...
func (o *AlgoGetAlgoFuturesSubOrdersV1Resp) GetSubOrders() []AlgoGetAlgoFuturesSubOrdersV1RespSubOrdersInner {
	if o == nil || IsNil(o.SubOrders) {
		var ret []AlgoGetAlgoFuturesSubOrdersV1RespSubOrdersInner
		return ret
	}
	return o.SubOrders
}
...
// SetSubOrders gets a reference to the given []AlgoGetAlgoFuturesSubOrdersV1RespSubOrdersInner and assigns it to the SubOrders field.
...
func (o AlgoGetAlgoFuturesSubOrdersV1Resp) MarshalJSON() ([]byte, error) {
...
func (o AlgoGetAlgoFuturesSubOrdersV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableAlgoGetAlgoFuturesSubOrdersV1Resp struct {
	value *AlgoGetAlgoFuturesSubOrdersV1Resp
	isSet bool
}

func (v NullableAlgoGetAlgoFuturesSubOrdersV1Resp) Get() *AlgoGetAlgoFuturesSubOrdersV1Resp {
	return v.value
}

func (v *NullableAlgoGetAlgoFuturesSubOrdersV1Resp) Set(val *AlgoGetAlgoFuturesSubOrdersV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableAlgoGetAlgoFuturesSubOrdersV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableAlgoGetAlgoFuturesSubOrdersV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlgoGetAlgoFuturesSubOrdersV1Resp(val *AlgoGetAlgoFuturesSubOrdersV1Resp) *NullableAlgoGetAlgoFuturesSubOrdersV1Resp {
	return &NullableAlgoGetAlgoFuturesSubOrdersV1Resp{value: val, isSet: true}
}

func (v NullableAlgoGetAlgoFuturesSubOrdersV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlgoGetAlgoFuturesSubOrdersV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
