...
// checks if the AlgoGetAlgoSpotSubOrdersV1Resp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlgoGetAlgoSpotSubOrdersV1Resp{}

// AlgoGetAlgoSpotSubOrdersV1Resp struct for AlgoGetAlgoSpotSubOrdersV1Resp
type AlgoGetAlgoSpotSubOrdersV1Resp struct {
...
func NewAlgoGetAlgoSpotSubOrdersV1Resp() *AlgoGetAlgoSpotSubOrdersV1Resp {
	this := AlgoGetAlgoSpotSubOrdersV1Resp{}
	return &this
}
...
func (o AlgoGetAlgoSpotSubOrdersV1Resp) MarshalJSON() ([]byte, error) {
...
func (o AlgoGetAlgoSpotSubOrdersV1Resp) ToMap() (map[string]interface{}, error) {
...
type NullableAlgoGetAlgoSpotSubOrdersV1Resp struct {
	value *AlgoGetAlgoSpotSubOrdersV1Resp
	isSet bool
}

func (v NullableAlgoGetAlgoSpotSubOrdersV1Resp) Get() *AlgoGetAlgoSpotSubOrdersV1Resp {
	return v.value
}

func (v *NullableAlgoGetAlgoSpotSubOrdersV1Resp) Set(val *AlgoGetAlgoSpotSubOrdersV1Resp) {
	v.value = val
	v.isSet = true
}

func (v NullableAlgoGetAlgoSpotSubOrdersV1Resp) IsSet() bool {
	return v.isSet
}

func (v *NullableAlgoGetAlgoSpotSubOrdersV1Resp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlgoGetAlgoSpotSubOrdersV1Resp(val *AlgoGetAlgoSpotSubOrdersV1Resp) *NullableAlgoGetAlgoSpotSubOrdersV1Resp {
	return &NullableAlgoGetAlgoSpotSubOrdersV1Resp{value: val, isSet: true}
}

func (v NullableAlgoGetAlgoSpotSubOrdersV1Resp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlgoGetAlgoSpotSubOrdersV1Resp) UnmarshalJSON(src []byte) error {
	v.isSet = true
