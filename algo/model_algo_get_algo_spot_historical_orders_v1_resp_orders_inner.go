...
// checks if the AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner{}

// AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner struct for AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner
type AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner struct {
...
func NewAlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner() *AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner {
	this := AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner{}
	return &this
}
...
func (o *AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) GetAlgoIdOk() (*int64, bool) {
	if o == nil || IsNil(o.AlgoId) {
		return nil, false
	}
...
func (o *AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) SetAlgoType(v string) {
	o.AlgoType = &v
}
...
func (o *AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) HasTotalQty() bool {
	if o != nil && !IsNil(o.TotalQty) {
		return true
	}
...
func (o AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) MarshalJSON() ([]byte, error) {
...
func (o AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) ToMap() (map[string]interface{}, error) {
...
type NullableAlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner struct {
	value *AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner
	isSet bool
}

func (v NullableAlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) Get() *AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner {
	return v.value
}

func (v *NullableAlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) Set(val *AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner(val *AlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) *NullableAlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner {
	return &NullableAlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner{value: val, isSet: true}
}

func (v NullableAlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlgoGetAlgoSpotHistoricalOrdersV1RespOrdersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
